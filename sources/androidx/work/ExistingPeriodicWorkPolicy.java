...
public final class ExistingPeriodicWorkPolicy {
    public static final /* synthetic */ ExistingPeriodicWorkPolicy[] d = {new ExistingPeriodicWorkPolicy("REPLACE", 0), new ExistingPeriodicWorkPolicy("KEEP", 1), new ExistingPeriodicWorkPolicy("UPDATE", 2), new ExistingPeriodicWorkPolicy("CANCEL_AND_REENQUEUE", 3)};
    ...
    public static ExistingPeriodicWorkPolicy[] values() {
        return (ExistingPeriodicWorkPolicy[]) d.clone();
    }
}
