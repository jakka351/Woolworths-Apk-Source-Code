...
public final class AdIdManagerApi33Ext4Impl extends AdIdManagerImplCommon {
    ...
    public AdIdManagerApi33Ext4Impl(@NotNull Context context) {
        Intrinsics.h(context, "context");
        Object systemService = context.getSystemService((Class<Object>) c.o());
        Intrinsics.g(systemService, "context.getSystemService….AdIdManager::class.java)");
        super(c.c(systemService));
    }
}
