...
public final class MeasurementManagerApi33Ext5Impl extends MeasurementManagerImplCommon {
    ...
    public MeasurementManagerApi33Ext5Impl(@NotNull Context context) {
        ...
        Object systemService = context.getSystemService((Class<Object>) androidx.privacysandbox.ads.adservices.adselection.a.z());
        Intrinsics.g(systemService, "context.getSystemService…ementManager::class.java)");
        super(androidx.privacysandbox.ads.adservices.adselection.a.o(systemService));
    }
}
