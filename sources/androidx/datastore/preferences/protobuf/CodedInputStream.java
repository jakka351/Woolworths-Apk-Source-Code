...
public abstract class CodedInputStream {
    ...
    public static final class ArrayDecoder extends CodedInputStream {
        ...
        */
        public final androidx.datastore.preferences.protobuf.ByteString k() throws androidx.datastore.preferences.protobuf.InvalidProtocolBufferException {
            /*
                r4 = this;
                int r0 = r4.F()
                byte[] r1 = r4.c
                ...
                int r2 = r2 - r3
                if (r0 > r2) goto L19
                androidx.datastore.preferences.protobuf.ByteString r1 = androidx.datastore.preferences.protobuf.ByteString.i(r3, r0, r1)
                int r2 = r4.f
                int r2 = r2 + r0
                r4.f = r2
                return r1
            L19:
                if (r0 != 0) goto L1e
                androidx.datastore.preferences.protobuf.ByteString r0 = androidx.datastore.preferences.protobuf.ByteString.e
                return r0
            L1e:
                if (r0 <= 0) goto L2f
                int r2 = r4.d
            ...
            L2f:
                if (r0 > 0) goto L42
                if (r0 != 0) goto L3d
                byte[] r0 = androidx.datastore.preferences.protobuf.Internal.b
            L35:
                androidx.datastore.preferences.protobuf.ByteString r1 = androidx.datastore.preferences.protobuf.ByteString.e
            ...
            L42:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.CodedInputStream.ArrayDecoder.k():androidx.datastore.preferences.protobuf.ByteString");
        }
        ...
        public final String w() throws InvalidProtocolBufferException {
            ...
            if (iF > 0) {
                ...
                int i2 = this.f;
                if (iF <= i - i2) {
                    String str = new String(this.c, i2, iF, Internal.f2648a);
                    this.f += iF;
                    return str;
                }
            }
        ...
        public final String x() throws InvalidProtocolBufferException {
            ...
            if (iF > 0) {
                ...
                int i2 = this.f;
                if (iF <= i - i2) {
                    String strA = Utf8.f2683a.a(i2, iF, this.c);
                    this.f += iF;
                    return strA;
                }
            }
    ...
    public static final class IterableDirectByteBufferDecoder extends CodedInputStream {
        ...
        public final void F(int i, byte[] bArr) throws InvalidProtocolBufferException {
            ...
            while (i2 > 0) {
                ...
                long j = iMin;
                UnsafeUtil.c.c(this.j, bArr, i - i2, j);
                i2 -= iMin;
                this.j += j;
            }
        }
        ...
        public final void M(int i) throws InvalidProtocolBufferException {
            if (i < 0 || i > ((this.e - this.i) - this.j) + this.k) {
                if (i >= 0) {
                    throw InvalidProtocolBufferException.h();
                }
                throw InvalidProtocolBufferException.f();
        ...
        public final String w() throws InvalidProtocolBufferException {
            ...
            if (I > 0) {
                ...
                if (j <= j2 - j3) {
                    byte[] bArr = new byte[I];
                    UnsafeUtil.c.c(j3, bArr, 0L, j);
                    String str = new String(bArr, Internal.f2648a);
                    this.j += j;
                    return str;
                }
            }
            if (I > 0 && I <= L()) {
                byte[] bArr2 = new byte[I];
                F(I, bArr2);
                return new String(bArr2, Internal.f2648a);
            }
            if (I == 0) {
                return "";
            }
        ...
        public final String x() throws InvalidProtocolBufferException {
            ...
            if (I > 0) {
                ...
                long j3 = this.j;
                if (j <= j2 - j3) {
                    String strC = Utf8.c(this.d, (int) (j3 - this.k), I);
                    this.j += j;
                    return strC;
                }
            }
    ...
    public static final class StreamDecoder extends CodedInputStream {
        ...
        public final ByteString k() throws IOException {
            ...
            byte[] bArr = this.d;
            if (I <= i3 && I > 0) {
                ByteString byteStringI = ByteString.i(i2, I, bArr);
                this.g += I;
                return byteStringI;
            }
            if (I == 0) {
            ...
            byte[] bArrE = E(I);
            if (bArrE != null) {
                return ByteString.i(0, bArrE.length, bArrE);
            }
            int i4 = this.g;
            int i5 = this.e;
            int length = i5 - i4;
        ...
        public final String w() throws InvalidProtocolBufferException {
            ...
            if (I > 0) {
                ...
                int i2 = this.g;
                if (I <= i - i2) {
                    String str = new String(bArr, i2, I, Internal.f2648a);
                    this.g += I;
                    return str;
                }
            }
            ...
            if (I > this.e) {
                return new String(D(I), Internal.f2648a);
            }
            M(I);
            String str2 = new String(bArr, this.g, I, Internal.f2648a);
            this.g += I;
            return str2;
        }
        ...
        public final String x() throws IOException {
            ...
            return Utf8.f2683a.a(i, I, bArrD);
        }
        ...
        */
        public final int F() {
            ...
            La:
                r2 = 1
                long r2 = r2 + r0
                androidx.datastore.preferences.protobuf.UnsafeUtil$MemoryAccessor r4 = androidx.datastore.preferences.protobuf.UnsafeUtil.c
                byte r5 = r4.f(r0)
                if (r5 < 0) goto L18
                r12.f = r2
                return r5
        ...
        public final String x() throws InvalidProtocolBufferException {
            ...
            if (iF > 0) {
                ...
                long j2 = this.f;
                if (iF <= ((int) (j - j2))) {
                    String strC = Utf8.c(this.c, (int) (j2 - this.d), iF);
                    this.f += iF;
                    return strC;
                }
            }
