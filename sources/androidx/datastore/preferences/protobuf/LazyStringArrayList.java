...
public class LazyStringArrayList extends AbstractProtobufList<String> implements LazyStringList, RandomAccess {
    ...
    public final Object get(int i) {
        ...
        if (obj instanceof ByteString) {
            ...
            String strW = byteString.size() == 0 ? "" : byteString.w(Internal.f2648a);
            if (byteString.m()) {
                list.set(i, strW);
            }
            return strW;
        ...
        if (Utf8.f2683a.e(0, bArr.length, bArr)) {
            list.set(i, str);
        }
        return str;
    }
    ...
    public final Object remove(int i) {
        ...
        if (!(objRemove instanceof ByteString)) {
            return new String((byte[]) objRemove, Internal.f2648a);
        }
        ByteString byteString = (ByteString) objRemove;
        return byteString.size() == 0 ? "" : byteString.w(Internal.f2648a);
    }
    ...
    public final Object set(int i, Object obj) {
        ...
        if (!(obj2 instanceof ByteString)) {
            return new String((byte[]) obj2, Internal.f2648a);
        }
