...
final class RopeByteString extends ByteString {
    ...
    public RopeByteString(ByteString byteString, ByteString byteString2) {
        ...
        this.k = Math.max(byteString.k(), byteString2.k()) + 1;
    }
            ...
            if (i == size) {
                ...
                if (i2 == 0 || i3 == 0 || i2 == i3) {
                    ...
                    while (true) {
                        ...
                        if (!(i4 == 0 ? next.z(next2, i5, iMin) : next2.z(next, i4, iMin))) {
                            break;
                        }
                        i6 += iMin;
                        if (i6 >= i) {
    ...
    public final void j(int i, int i2, byte[] bArr, int i3) {
        ...
        int i5 = this.j;
        if (i4 <= i5) {
            byteString.j(i, i2, bArr, i3);
            return;
        }
        ByteString byteString2 = this.i;
        if (i >= i5) {
            byteString2.j(i - i5, i2, bArr, i3);
            return;
        }
        int i6 = i5 - i;
        byteString.j(i, i2, bArr, i6);
        byteString2.j(0, i2 + i6, bArr, i3 - i6);
    }
    ...
    public final byte l(int i) {
        int i2 = this.j;
        return i < i2 ? this.h.l(i) : this.i.l(i - i2);
    }

    @Override // androidx.datastore.preferences.protobuf.ByteString
    public final boolean m() {
        int iS = this.h.s(0, 0, this.j);
        ByteString byteString = this.i;
        return byteString.s(iS, 0, byteString.size()) == 0;
    }
        ...
        public final int b(int i, int i2, byte[] bArr) {
            ...
            while (i3 > 0) {
                ...
                if (bArr != null) {
                    ...
                    ByteString.h(i, i + iMin, bArr.length);
                    if (iMin > 0) {
                        leafByteString.j(i4, i, bArr, iMin);
                    }
                    i += iMin;
                }
                this.g += iMin;
