...
class UnknownFieldSetLiteSchema extends UnknownFieldSchema<UnknownFieldSetLite, UnknownFieldSetLite> {
    ...
    public final int i(Object obj) {
        ...
        int iS = 0;
        for (int i2 = 0; i2 < unknownFieldSetLite.f2680a; i2++) {
            int i3 = unknownFieldSetLite.b[i2] >>> 3;
            iS += CodedOutputStream.S(3, (ByteString) unknownFieldSetLite.c[i2]) + CodedOutputStream.Y(i3) + CodedOutputStream.X(2) + (CodedOutputStream.X(1) * 2);
        }
    ...
    public final UnknownFieldSetLite k(Object obj, Object obj2) {
        ...
        if (unknownFieldSetLite3.equals(unknownFieldSetLite)) {
            int i = unknownFieldSetLite.f2680a + unknownFieldSetLite2.f2680a;
            int[] iArrCopyOf = Arrays.copyOf(unknownFieldSetLite.b, i);
            System.arraycopy(unknownFieldSetLite2.b, 0, iArrCopyOf, unknownFieldSetLite.f2680a, unknownFieldSetLite2.f2680a);
            Object[] objArrCopyOf = Arrays.copyOf(unknownFieldSetLite.c, i);
            System.arraycopy(unknownFieldSetLite2.c, 0, objArrCopyOf, unknownFieldSetLite.f2680a, unknownFieldSetLite2.f2680a);
        ...
        int i2 = unknownFieldSetLite.f2680a + unknownFieldSetLite2.f2680a;
        unknownFieldSetLite.a(i2);
        System.arraycopy(unknownFieldSetLite2.b, 0, unknownFieldSetLite.b, unknownFieldSetLite.f2680a, unknownFieldSetLite2.f2680a);
        System.arraycopy(unknownFieldSetLite2.c, 0, unknownFieldSetLite.c, unknownFieldSetLite.f2680a, unknownFieldSetLite2.f2680a);
        unknownFieldSetLite.f2680a = i2;
        return unknownFieldSetLite;
    }
    ...
    public final void q(Object obj, Writer writer) {
        ...
        if (writer.B() == Writer.FieldOrder.e) {
            for (int i = unknownFieldSetLite.f2680a - 1; i >= 0; i--) {
