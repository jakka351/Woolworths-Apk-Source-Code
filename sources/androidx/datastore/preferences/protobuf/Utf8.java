...
final class Utf8 {
    ...
    public static final Processor f2683a;
    ...
    public static abstract class Processor {
        ...
        public static int h(ByteBuffer byteBuffer, int i, int i2, int i3) {
            ...
            Processor processor = Utf8.f2683a;
            int i9 = i3 - 7;
            int i10 = i6;
    ...
    public static final class SafeProcessor extends Processor {
        ...
        */
        public final int f(int r12, int r13, byte[] r14, int r15) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.Utf8.SafeProcessor.f(int, int, byte[], int):int");
        }
    ...
    public static final class UnsafeProcessor extends Processor {
        ...
        public final String c(ByteBuffer byteBuffer, int i, int i2) throws InvalidProtocolBufferException {
            ...
            while (true) {
                j = 1;
                if (jB >= j2 || (bF2 = UnsafeUtil.c.f(jB)) < 0) {
                    break;
                }
                jB++;
                cArr[i3] = (char) bF2;
            ...
            while (jB < j2) {
                ...
                if (bF3 >= 0) {
                    int i5 = i4 + 1;
                    cArr[i4] = (char) bF3;
                    while (j3 < j2 && (bF = UnsafeUtil.c.f(j3)) >= 0) {
                        j3 += j;
                        cArr[i5] = (char) bF;
                        i5++;
                    }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:13:0x0036, code lost:
            ...
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.h(r4, r22) > (-65)) goto L17;
         */
        /* JADX WARN: Code restructure failed: missing block: B:32:0x0069, code lost:
        
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.h(r4, r22) > (-65)) goto L33;
         */
        /* JADX WARN: Code restructure failed: missing block: B:53:0x00b0, code lost:
        
            if (androidx.datastore.preferences.protobuf.UnsafeUtil.h(r4, r22) > (-65)) goto L54;
         */
        @Override // androidx.datastore.preferences.protobuf.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        public final int f(int r20, int r21, byte[] r22, int r23) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.Utf8.UnsafeProcessor.f(int, int, byte[], int):int");
        }
    ...
    static {
        f2683a = (UnsafeUtil.e && UnsafeUtil.d && !Android.a()) ? new UnsafeProcessor() : new SafeProcessor();
    }
