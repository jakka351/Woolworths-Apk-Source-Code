...
final class TextFieldSelectionManager$cut$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new TextFieldSelectionManager$cut$1(this.q, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((TextFieldSelectionManager$cut$1) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.f24250a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        AnnotatedString annotatedStringC = TextFieldValueKt.c(textFieldSelectionManager.m(), textFieldSelectionManager.m().f2127a.e.length());
        ...
        AnnotatedString.Builder builder = new AnnotatedString.Builder(annotatedStringC);
        builder.d(annotatedStringB);
        AnnotatedString annotatedStringM = builder.m();
        int iF = TextRange.f(textFieldSelectionManager.m().b);
        textFieldSelectionManager.c.invoke(TextFieldSelectionManager.e(annotatedStringM, TextRangeKt.a(iF, iF)));
