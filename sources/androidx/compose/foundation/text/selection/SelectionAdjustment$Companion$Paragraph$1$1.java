...
public final class SelectionAdjustment$Companion$Paragraph$1$1 implements BoundaryFunction {
    ...
    public static final SelectionAdjustment$Companion$Paragraph$1$1 f1207a = new SelectionAdjustment$Companion$Paragraph$1$1();

    @Override // androidx.compose.foundation.text.selection.BoundaryFunction
    public final long a(SelectableInfo selectableInfo, int i) {
        String str = selectableInfo.f.f2064a.f2063a.e;
