...
final class FlowRowOverflow$Companion$expandOrCollapseIndicator$1$collapseGetter$1 extends Lambda implements Function1<FlowLayoutOverflowState, Function2<? super Composer, ? super Integer, ? extends Unit>> {
    ...
    public final Object invoke(Object obj) {
        ...
        return new ComposableLambdaImpl(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.FlowRowOverflow$Companion$expandOrCollapseIndicator$1$collapseGetter$1.1
            {
                super(2);
            }
            ...
            public final Object invoke(Object obj2, Object obj3) {
                ...
                if (composer.z(iIntValue & 1, (iIntValue & 3) != 2)) {
                    new FlowRowOverflowScopeImpl(flowLayoutOverflowState);
                    throw null;
                }
                composer.j();
                return Unit.f24250a;
