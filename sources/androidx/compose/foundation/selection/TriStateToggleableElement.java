...
final class TriStateToggleableElement extends ModifierNodeElement<TriStateToggleableNode> {
    ...
    public final Modifier.Node a() {
        TriStateToggleableNode triStateToggleableNode = new TriStateToggleableNode(this.e, this.f, this.g, null, this.h, this.i);
        triStateToggleableNode.K = this.d;
    ...
    public final void b(Modifier.Node node) {
        ...
        ToggleableState toggleableState = triStateToggleableNode.K;
        ToggleableState toggleableState2 = this.d;
        if (toggleableState != toggleableState2) {
            triStateToggleableNode.K = toggleableState2;
            SemanticsModifierNodeKt.a(triStateToggleableNode);
        }
        triStateToggleableNode.C2(this.e, this.f, this.g, null, this.h, this.i);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.d == triStateToggleableElement.d && Intrinsics.c(this.e, triStateToggleableElement.e) && Intrinsics.c(this.f, triStateToggleableElement.f) && this.g == triStateToggleableElement.g && Intrinsics.c(this.h, triStateToggleableElement.h) && this.i == triStateToggleableElement.i;
    }
