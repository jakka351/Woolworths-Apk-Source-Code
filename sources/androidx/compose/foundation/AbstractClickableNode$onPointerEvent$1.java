...
final class AbstractClickableNode$onPointerEvent$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new AbstractClickableNode$onPointerEvent$1(this.p, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (abstractClickableNode.D == null) {
            ...
            if (mutableInteractionSource != null) {
                BuildersKt.c(abstractClickableNode.g2(), null, null, new AbstractClickableNode$emitHoverEnter$1$1(mutableInteractionSource, enter, null), 3);
            }
            abstractClickableNode.D = enter;
        }
        return Unit.f24250a;
    }
}
