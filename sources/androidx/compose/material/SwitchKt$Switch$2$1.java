...
final class SwitchKt$Switch$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new SwitchKt$Switch$2$1(this.q, this.r, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((SwitchKt$Switch$2$1) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.f24250a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            boolean zBooleanValue = ((Boolean) ((SnapshotMutableStateImpl) anchoredDraggableState.g).getD()).booleanValue();
            boolean z = this.q;
            if (z != zBooleanValue) {
                Boolean boolValueOf = Boolean.valueOf(z);
                this.p = 1;
                if (AnchoredDraggableKt.e(anchoredDraggableState, boolValueOf, this) == coroutineSingletons) {
