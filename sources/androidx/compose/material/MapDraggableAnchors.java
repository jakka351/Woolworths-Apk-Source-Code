...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0002\u0018\u0000*\u0004\b\u0000\u0010\u00012\b\u0012\u0004\u0012\u00028\u00000\u0002¨\u0006\u0003"}, d2 = {"Landroidx/compose/material/MapDraggableAnchors;", RequestConfiguration.MAX_AD_CONTENT_RATING_T, "Landroidx/compose/material/DraggableAnchors;", "material_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes.dex */
final class MapDraggableAnchors<T> implements DraggableAnchors<T> {

    /* renamed from: a, reason: collision with root package name */
    public final Map f1296a;
    ...
    public final Object a(float f, boolean z) {
        T next;
        Iterator<T> it = this.f1296a.entrySet().iterator();
        if (it.hasNext()) {
            next = it.next();
            if (it.hasNext()) {
    ...
    public final float c(Object obj) {
        Float f = (Float) this.f1296a.get(obj);
        if (f != null) {
            return f.floatValue();
        }
        return Float.NaN;
    ...
    public final boolean d(Object obj) {
        return this.f1296a.containsKey(obj);
    }

    @Override // androidx.compose.material.DraggableAnchors
    public final float e() {
        Float fW = CollectionsKt.W(this.f1296a.values());
        if (fW != null) {
    ...
    public final boolean equals(Object obj) {
        ...
        return Intrinsics.c(this.f1296a, ((MapDraggableAnchors) obj).f1296a);
    }

    @Override // androidx.compose.material.DraggableAnchors
    public final float f() {
        Float fU = CollectionsKt.U(this.f1296a.values());
        if (fU != null) {
    ...
    public final int hashCode() {
        return this.f1296a.hashCode() * 31;
    }

    public final String toString() {
        return a.u(new StringBuilder("MapDraggableAnchors("), this.f1296a, ')');
    }
}
