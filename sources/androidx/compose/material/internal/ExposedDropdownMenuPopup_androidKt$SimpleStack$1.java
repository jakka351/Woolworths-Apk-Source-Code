...
public final class ExposedDropdownMenuPopup_androidKt$SimpleStack$1 implements MeasurePolicy {
    ...
    public static final ExposedDropdownMenuPopup_androidKt$SimpleStack$1 f1378a = new ExposedDropdownMenuPopup_androidKt$SimpleStack$1();
    ...
    public final MeasureResult c(MeasureScope measureScope, List list, long j) {
        ...
        if (size == 1) {
            ...
            return measureScope.L0(placeableC0.d, placeableC0.e, EmptyMap.d, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopup_androidKt$SimpleStack$1.2
                {
                    super(1);
                }
        ...
        if (I >= 0) {
            ...
            while (true) {
                ...
                iMax2 = Math.max(iMax2, placeable.d);
                iMax = Math.max(iMax, placeable.e);
                if (i == I) {
                    break;
                }
                i++;
        ...
        return measureScope.L0(i, iMax, EmptyMap.d, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.internal.ExposedDropdownMenuPopup_androidKt$SimpleStack$1.3
