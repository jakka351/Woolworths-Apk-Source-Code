...
@DebugMetadata(c = "androidx.compose.material.InternalMutatorMutex$mutate$2", f = "InternalMutatorMutex.kt", l = {SubsamplingScaleImageView.ORIENTATION_180, 103}, m = "invokeSuspend")
        ...
        try {
            try {
                if (r1 == 0) {
                    ...
                    InternalMutatorMutex.Mutator mutator4 = new InternalMutatorMutex.Mutator(this.u, (Job) element);
                    internalMutatorMutex = this.v;
                    AtomicReference atomicReference3 = internalMutatorMutex.f1292a;
                    do {
                        mutator = (InternalMutatorMutex.Mutator) atomicReference3.get();
                        if (mutator != null) {
                            if (!(mutator4.f1293a.compareTo(mutator.f1293a) >= 0)) {
                                throw new CancellationException("Current mutation had a higher priority");
                            }
                        }
                    } while (!a.D(atomicReference3, mutator, mutator4));
                    if (mutator != null) {
                        mutator.b.cancel((CancellationException) null);
                    }
                ...
                if (r1 != 1) {
                    ...
                    mutex2 = this.p;
                    mutator3 = (InternalMutatorMutex.Mutator) this.t;
                    try {
                        ResultKt.b(obj);
                        atomicReference2 = internalMutatorMutex2.f1292a;
                        ...
                        th = th2;
                        atomicReference = internalMutatorMutex2.f1292a;
