...
public final class ComposableSingletons$TabRowKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    public static final ComposableSingletons$TabRowKt$lambda1$1 h = new ComposableSingletons$TabRowKt$lambda1$1(2);
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if (composer.z(iIntValue & 1, (iIntValue & 3) != 2)) {
            TabRowDefaults.f1337a.a(null, BitmapDescriptorFactory.HUE_RED, 0L, composer, 3072);
        } else {
            composer.j();
        }
        return Unit.f24250a;
