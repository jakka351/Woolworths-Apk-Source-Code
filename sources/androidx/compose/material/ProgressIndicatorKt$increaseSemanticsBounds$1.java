...
final class ProgressIndicatorKt$increaseSemanticsBounds$1 extends Lambda implements Function3<MeasureScope, Measurable, Constraints, MeasureResult> {
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        final int iR1 = measureScope.r1(this.h);
        int i = iR1 * 2;
        final Placeable placeableC0 = ((Measurable) obj2).c0(ConstraintsKt.i(0, i, j));
        int i2 = placeableC0.e - i;
        return measureScope.L0(placeableC0.d, i2, EmptyMap.d, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material.ProgressIndicatorKt$increaseSemanticsBounds$1.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
