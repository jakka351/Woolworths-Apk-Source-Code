...
final class SwipeableState$animateInternalToOffset$2 extends SuspendLambda implements Function2<DragScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        SwipeableState$animateInternalToOffset$2 swipeableState$animateInternalToOffset$2 = new SwipeableState$animateInternalToOffset$2(this.r, this.s, this.t, continuation);
        swipeableState$animateInternalToOffset$2.q = obj;
        return swipeableState$animateInternalToOffset$2;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((SwipeableState$animateInternalToOffset$2) create((DragScope) obj, (Continuation) obj2)).invokeSuspend(Unit.f24250a);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Object invokeSuspend(Object obj) {
        SwipeableState swipeableState = this.r;
        ...
        try {
            if (i == 0) {
                ...
                floatRef.d = ((SnapshotMutableFloatStateImpl) swipeableState.g).a();
                float f = this.s;
                ...
                this.p = 1;
                if (Animatable.d(animatableA, f2, animationSpec, null, function1, this, 4) == coroutineSingletons) {
