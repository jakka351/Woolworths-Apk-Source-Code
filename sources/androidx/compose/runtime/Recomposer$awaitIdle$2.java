...
final class Recomposer$awaitIdle$2 extends SuspendLambda implements Function2<Recomposer.State, Continuation<? super Boolean>, Object> {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        Recomposer$awaitIdle$2 recomposer$awaitIdle$2 = new Recomposer$awaitIdle$2(2, continuation);
        recomposer$awaitIdle$2.p = obj;
        return recomposer$awaitIdle$2;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((Recomposer$awaitIdle$2) create((Recomposer.State) obj, (Continuation) obj2)).invokeSuspend(Unit.f24250a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        ResultKt.b(obj);
        return Boolean.valueOf(((Recomposer.State) this.p).compareTo(Recomposer.State.h) > 0);
    }
}
