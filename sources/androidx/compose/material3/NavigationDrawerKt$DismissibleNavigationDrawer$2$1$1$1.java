...
final class NavigationDrawerKt$DismissibleNavigationDrawer$2$1$1$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    final class AnonymousClass1 extends Lambda implements Function0<Boolean> {
        ...
        @DebugMetadata(c = "androidx.compose.material3.NavigationDrawerKt$DismissibleNavigationDrawer$2$1$1$1$1$1", f = "NavigationDrawer.kt", l = {473}, m = "invokeSuspend")
        ...
        final class C00561 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public C00561(DrawerState drawerState, Continuation continuation) {
            ...
            public final Continuation create(Object obj, Continuation continuation) {
                return new C00561(this.q, continuation);
            }

            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return ((C00561) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.f24250a);
            }
        ...
        public final Object invoke() {
            ...
            if (((Boolean) drawerState.f1441a.d.invoke(DrawerValue.d)).booleanValue()) {
                BuildersKt.c(this.i, null, null, new C00561(drawerState, null), 3);
            }
            return Boolean.TRUE;
        }
    }
