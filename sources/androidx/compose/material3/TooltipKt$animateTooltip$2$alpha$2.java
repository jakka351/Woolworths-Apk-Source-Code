...
final class TooltipKt$animateTooltip$2$alpha$2 extends Lambda implements Function3<Transition.Segment<Boolean>, Composer, Integer, FiniteAnimationSpec<Float>> {
    public static final TooltipKt$animateTooltip$2$alpha$2 h = new TooltipKt$animateTooltip$2$alpha$2(3);

    @Override // kotlin.jvm.functions.Function3
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        Composer composer = (Composer) obj2;
        ((Number) obj3).intValue();
        composer.o(-281714272);
        TweenSpec tweenSpecE = ((Transition.Segment) obj).c(Boolean.FALSE, Boolean.TRUE) ? AnimationSpecKt.e(150, 0, EasingKt.d, 2) : AnimationSpecKt.e(75, 0, EasingKt.d, 2);
        composer.l();
        return tweenSpecE;
    }
}
