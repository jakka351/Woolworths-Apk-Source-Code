...
public final class TopAppBarState$Companion$Saver$1 extends Lambda implements Function2<SaverScope, TopAppBarState, List<? extends Float>> {
    public static final TopAppBarState$Companion$Saver$1 h = new TopAppBarState$Companion$Saver$1(2);

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        TopAppBarState topAppBarState = (TopAppBarState) obj2;
        return CollectionsKt.R(Float.valueOf(((SnapshotMutableFloatStateImpl) topAppBarState.f1527a).a()), Float.valueOf(topAppBarState.b()), Float.valueOf(((SnapshotMutableFloatStateImpl) topAppBarState.b).a()));
    }
}
