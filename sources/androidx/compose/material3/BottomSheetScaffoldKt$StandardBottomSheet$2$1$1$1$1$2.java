...
final class BottomSheetScaffoldKt$StandardBottomSheet$2$1$1$1$1$2 extends Lambda implements Function0<Boolean> {
    ...
    @DebugMetadata(c = "androidx.compose.material3.BottomSheetScaffoldKt$StandardBottomSheet$2$1$1$1$1$2$1", f = "BottomSheetScaffold.kt", l = {DilithiumEngine.DilithiumPolyT1PackedBytes}, m = "invokeSuspend")
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BottomSheetScaffoldKt$StandardBottomSheet$2$1$1$1$1$2(SheetState sheetState, CoroutineScope coroutineScope) {
        super(0);
