...
public final class ComposableSingletons$DatePickerKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    public static final ComposableSingletons$DatePickerKt$lambda1$1 h = new ComposableSingletons$DatePickerKt$lambda1$1(2);
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((((Number) obj2).intValue() & 3) == 2 && composer.c()) {
            ...
            ImageVector imageVectorD = EditKt.f1361a;
            if (imageVectorD == null) {
                ...
                EditKt.f1361a = imageVectorD;
            }
            IconKt.b(imageVectorD, Strings_androidKt.a(composer, com.woolworths.R.string.m3c_date_picker_switch_to_input_mode), null, 0L, composer, 0, 12);
        }
        return Unit.f24250a;
    }
}
