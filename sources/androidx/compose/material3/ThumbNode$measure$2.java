...
final class ThumbNode$measure$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ThumbNode$measure$2(ThumbNode thumbNode, float f, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new ThumbNode$measure$2(this.q, this.r, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((ThumbNode$measure$2) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.f24250a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Animatable animatable = thumbNode.u;
            if (animatable != null) {
