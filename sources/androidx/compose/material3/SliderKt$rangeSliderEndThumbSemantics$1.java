...
final class SliderKt$rangeSliderEndThumbSemantics$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    ...
    public SliderKt$rangeSliderEndThumbSemantics$1(boolean z, ClosedFloatingPointRange closedFloatingPointRange, RangeSliderState rangeSliderState) {
        super(1);
        this.h = z;
    ...
    public final Object invoke(Object obj) {
        ...
        SemanticsPropertiesKt.p(semanticsPropertyReceiver, new Function1<Float, Boolean>() { // from class: androidx.compose.material3.SliderKt$rangeSliderEndThumbSemantics$1.1
            ...
            public final Object invoke(Object obj2) {
                ...
                boolean z = false;
                if (rangeSliderState2.e() > 0 && (iE = rangeSliderState2.e() + 1) >= 0) {
                    float fAbs = fB;
                    float f = fAbs;
                    int i = 0;
                    while (true) {
                        float fB2 = MathHelpersKt.b(((Number) closedFloatingPointRange2.getStart()).floatValue(), ((Number) closedFloatingPointRange2.getEndInclusive()).floatValue(), i / (rangeSliderState2.e() + 1));
                        float f2 = fB2 - fB;
                        if (Math.abs(f2) <= fAbs) {
                            fAbs = Math.abs(f2);
                            f = fB2;
                ...
                if (fB != rangeSliderState2.a()) {
                    long jC = SliderKt.c(rangeSliderState2.b(), fB);
