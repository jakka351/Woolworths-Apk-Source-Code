...
public class CredentialProviderBaseController {
    ...
    @NotNull
    private static final Set<Integer> retryables = ArraysKt.r0(new Integer[]{7, 20});
    ...
    public static final class Companion {
        ...
        public final CreateCredentialException createCredentialExceptionTypeToException$credentials_play_services_auth_release(@Nullable String typeName, @Nullable String msg) {
            return Intrinsics.c(typeName, CredentialProviderBaseController.CREATE_CANCELED) ? new CreateCredentialCancellationException(msg) : Intrinsics.c(typeName, CredentialProviderBaseController.CREATE_INTERRUPTED) ? new CreateCredentialInterruptedException(msg, "android.credentials.CreateCredentialException.TYPE_INTERRUPTED") : new CreateCredentialUnknownException(msg);
        }
                ...
                if (iHashCode != -1567968963) {
                    if (iHashCode != -154594663) {
                        if (iHashCode == 1996705159 && typeName.equals(CredentialProviderBaseController.GET_NO_CREDENTIALS)) {
                            return new NoCredentialException(msg, "android.credentials.GetCredentialException.TYPE_NO_CREDENTIAL");
                        }
    ...
    public final void generateHiddenActivityIntent(@NotNull ResultReceiver resultReceiver, @NotNull Intent hiddenIntent, @NotNull String typeTag) {
        ...
        Intrinsics.h(hiddenIntent, "hiddenIntent");
    ...
    public final <T extends ResultReceiver> ResultReceiver toIpcFriendlyResultReceiver(T resultReceiver) {
        ...
        Intrinsics.g(parcelObtain, "obtain()");
