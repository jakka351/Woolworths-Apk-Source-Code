...
public final class CredentialProviderBeginSignInController extends CredentialProviderController<GetCredentialRequest, BeginSignInRequest, SignInCredential, GetCredentialResponse, GetCredentialException> {
    ...
    public static final class Companion {
        ...
        public final CredentialProviderBeginSignInController getInstance(@NotNull Context context) {
            ...
            Intrinsics.e(credentialProviderBeginSignInController);
    ...
    @VisibleForTesting
    @NotNull
    public GetCredentialResponse convertResponseToCredentialManager(@NotNull SignInCredential response) throws GetCredentialException {
        ...
        if (response.getPassword() != null) {
            ...
            publicKeyCredential = new PasswordCredential();
            ...
            Intrinsics.h(authenticationResponseJson, "authenticationResponseJson");
            ...
            if (!RequestValidationHelper.Companion.a(authenticationResponseJson)) {
