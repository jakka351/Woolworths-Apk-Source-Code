...
public /* synthetic */ class CredentialProviderBeginSignInController$resultReceiver$1$onReceiveResult$1 extends FunctionReferenceImpl implements Function2<String, String, GetCredentialException> {
    ...
    @NotNull
    public final GetCredentialException invoke(@Nullable String str, @Nullable String str2) {
