...
@Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\"\n\u0002\u0010&\n\u0000\b\u0002\u0018\u0000*\u0004\b\u0000\u0010\u0001*\u0004\b\u0001\u0010\u00022\u0014\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00028\u00010\u00040\u0003¨\u0006\u0005"}, d2 = {"Landroidx/collection/Entries;", "K", "V", "", "", "collection"}, k = 1, mv = {1, 9, 0}, xi = 48)
...
final class Entries<K, V> implements Set<Map.Entry<? extends K, ? extends V>>, KMappedMarker {
    ...
    final class AnonymousClass1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Map.Entry<Object, Object>>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:12:0x0050 -> B:22:0x00a2). Please report as a decompilation issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:13:0x0052 -> B:14:0x0064). Please report as a decompilation issue!!! */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:16:0x006d -> B:19:0x0099). Please report as a decompilation issue!!! */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        /*
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r21) {
            ...
            L2f:
                ...
                androidx.collection.ScatterMap r7 = r6.d
                long[] r7 = r7.f698a
                int r8 = r7.length
                int r8 = r8 + (-2)
                if (r8 < 0) goto La7
            ...
            L64:
                ...
                androidx.collection.ScatterMap r14 = r12.d
    ...
    public final boolean contains(Object obj) {
        ...
        return Intrinsics.c(this.d.e(entry.getKey()), entry.getValue());
    }
    ...
    public final boolean containsAll(Collection elements) {
        ...
        for (Map.Entry entry : collection) {
            if (!Intrinsics.c(this.d.e(entry.getKey()), entry.getValue())) {
                return false;
            }
        }
        return true;
