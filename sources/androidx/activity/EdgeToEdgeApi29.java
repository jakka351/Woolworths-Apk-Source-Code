...
class EdgeToEdgeApi29 extends EdgeToEdgeApi28 {
    ...
    public void b(@NotNull SystemBarStyle statusBarStyle, @NotNull SystemBarStyle navigationBarStyle, @NotNull Window window, @NotNull View view, boolean statusBarIsDark, boolean navigationBarIsDark) {
        ...
        window.setStatusBarColor(statusBarStyle.c == 0 ? 0 : statusBarIsDark ? statusBarStyle.b : statusBarStyle.f59a);
        window.setNavigationBarColor(i == 0 ? 0 : navigationBarIsDark ? navigationBarStyle.b : navigationBarStyle.f59a);
        window.setStatusBarContrastEnforced(false);
        window.setNavigationBarContrastEnforced(i == 0);
        WindowInsetsControllerCompat windowInsetsControllerCompat = new WindowInsetsControllerCompat(window, view);
        windowInsetsControllerCompat.e(!statusBarIsDark);
        windowInsetsControllerCompat.d(true ^ navigationBarIsDark);
    }
}
