...
class RoundRectDrawable extends Drawable {
    ...
    public final void b(Rect rect) {
        ...
        rect2.set(rect);
        if (this.f) {
            rect2.inset((int) Math.ceil(RoundRectDrawableWithShadow.a(this.e, this.f667a, this.g)), (int) Math.ceil(RoundRectDrawableWithShadow.b(this.e, this.f667a, this.g)));
            rectF.set(rect2);
        }
    }
    ...
    public final void getOutline(Outline outline) {
        outline.setRoundRect(this.d, this.f667a);
    }
