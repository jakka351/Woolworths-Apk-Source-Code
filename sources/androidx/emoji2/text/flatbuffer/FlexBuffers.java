...
public class FlexBuffers {
    ...
    public static final ArrayReadWriteBuf f2715a;

    public static class Blob extends Sized {
        public static final Blob e = new Blob(FlexBuffers.f2715a, 1, 1);

        @Override // androidx.emoji2.text.flatbuffer.FlexBuffers.Object
        public final StringBuilder a(StringBuilder sb) {
            sb.append('\"');
            sb.append(this.f2717a.a(this.b, this.d));
            sb.append('\"');
            return sb;
        }
        ...
        public final String toString() {
            return this.f2717a.a(this.b, this.d);
        }
    }
    ...
    public static class Key extends Object {
        public static final Key d = new Key(FlexBuffers.f2715a, 0, 0);
    ...
    public static class KeyVector {
        ...
        /* renamed from: a, reason: collision with root package name */
        public final TypedVector f2716a;

        public KeyVector(TypedVector typedVector) {
            this.f2716a = typedVector;
        }

        public final String toString() throws NumberFormatException {
            TypedVector typedVector = this.f2716a;
            int i = typedVector.d;
    ...
    public static class Map extends Vector {
        public static final Map f = new Map(FlexBuffers.f2715a, 1, 1);
        ...
        public final StringBuilder a(StringBuilder sb) {
            ...
            while (true) {
                ...
                sb.append('\"');
                TypedVector typedVector = keyVector.f2716a;
                ...
                if (i4 >= i6) {
                    ...
                    ReadBuf readBuf2 = typedVector.f2717a;
    ...
    public static class Reference {
        public static final Reference f = new Reference(FlexBuffers.f2715a, 0, 1, 0);

        /* renamed from: a, reason: collision with root package name */
        public final ReadBuf f2718a;
        public final int b;
        public final int c;
        public final int d;
        public final int e;
    ...
    public static class TypedVector extends Vector {
        ...
        static {
            new TypedVector(FlexBuffers.f2715a, 1, 1, 1);
        }
        ...
        public final Reference b(int i) {
            ...
            return new Reference(this.f2717a, (i * this.c) + this.b, this.c, 1, this.f);
        }
    }
    ...
    public static class Vector extends Sized {
        public static final Vector e = new Vector(FlexBuffers.f2715a, 1, 1);
    ...
    static {
        ...
        arrayReadWriteBuf.f2714a = new byte[]{0};
        f2715a = arrayReadWriteBuf;
    }
