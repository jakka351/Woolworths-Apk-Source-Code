...
public class SwitchPreference extends TwoStatePreference {
    ...
    public SwitchPreference(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.U = new Listener();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.m, i, 0);
    ...
    public final void q(PreferenceViewHolder preferenceViewHolder) {
        ...
        E(preferenceViewHolder.c(android.R.id.switch_widget));
    ...
    public SwitchPreference(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, TypedArrayUtils.a(context, com.woolworths.R.attr.switchPreferenceStyle, android.R.attr.switchPreferenceStyle));
    }
