...
public abstract class PreferenceDialogFragmentCompat extends DialogFragment implements DialogInterface.OnClickListener {
    ...
    public final DialogPreference I1() {
        if (this.d == null) {
            this.d = (DialogPreference) ((DialogPreference.TargetFragment) getTargetFragment()).C(requireArguments().getString("key"));
        }
        return this.d;
    }
    ...
    public void b2(AlertDialog.Builder builder) {
    }
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        this.k = -2;
        AlertDialog.Builder negativeButton = new AlertDialog.Builder(requireContext()).setTitle(this.e).setIcon(this.j).setPositiveButton(this.f, this).setNegativeButton(this.g, this);
        requireContext();
        int i = this.i;
        ...
        if (this instanceof EditTextPreferenceDialogFragmentCompat) {
            ...
            editTextPreferenceDialogFragmentCompat.o = SystemClock.currentThreadTimeMillis();
            editTextPreferenceDialogFragmentCompat.h2();
        }
        return alertDialogCreate;
    }
