...
public class ListPreferenceDialogFragment extends PreferenceDialogFragment {
    ...
    public final void d(AlertDialog.Builder builder) {
        builder.setSingleChoiceItems(this.m, this.l, new DialogInterface.OnClickListener() { // from class: androidx.preference.ListPreferenceDialogFragment.1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                ListPreferenceDialogFragment listPreferenceDialogFragment = ListPreferenceDialogFragment.this;
                listPreferenceDialogFragment.l = i;
                listPreferenceDialogFragment.k = -1;
