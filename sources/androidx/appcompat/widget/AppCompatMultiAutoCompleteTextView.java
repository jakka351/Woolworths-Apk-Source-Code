...
public class AppCompatMultiAutoCompleteTextView extends MultiAutoCompleteTextView implements TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion {
        ...
        public final void mapProperties(PropertyMapper propertyMapper) {
            this.f163a = propertyMapper.mapObject("backgroundTint", com.woolworths.R.attr.backgroundTint);
        ...
        public final void readProperties(Object obj, PropertyReader propertyReader) {
            ...
            propertyReader.readObject(this.f163a, appCompatMultiAutoCompleteTextView.getBackgroundTintList());
            propertyReader.readObject(this.b, appCompatMultiAutoCompleteTextView.getBackgroundTintMode());
            propertyReader.readObject(this.c, appCompatMultiAutoCompleteTextView.getCompoundDrawableTintList());
