...
public class AppCompatImageView extends ImageView implements TintableBackgroundView, TintableImageSourceView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion {
        ...
        public final void mapProperties(PropertyMapper propertyMapper) {
            this.f162a = propertyMapper.mapObject("backgroundTint", R.attr.backgroundTint);
        ...
        public final void readProperties(Object obj, PropertyReader propertyReader) {
            ...
            propertyReader.readObject(this.f162a, appCompatImageView.getBackgroundTintList());
            propertyReader.readObject(this.b, appCompatImageView.getBackgroundTintMode());
            propertyReader.readObject(this.c, appCompatImageView.getImageTintList());
