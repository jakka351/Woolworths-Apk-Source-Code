...
final class EmittedSource$disposeNow$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public final /* synthetic */ EmittedSource p;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EmittedSource$disposeNow$2(EmittedSource emittedSource, Continuation continuation) {
        super(2, continuation);
        this.p = emittedSource;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        return new EmittedSource$disposeNow$2(this.p, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        EmittedSource$disposeNow$2 emittedSource$disposeNow$2 = (EmittedSource$disposeNow$2) create((CoroutineScope) obj, (Continuation) obj2);
        Unit unit = Unit.f24250a;
        emittedSource$disposeNow$2.invokeSuspend(unit);
        return unit;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        ResultKt.b(obj);
        EmittedSource emittedSource = this.p;
        if (!emittedSource.f) {
