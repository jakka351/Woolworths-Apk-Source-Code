...
public class CustomTabsCallback {
    ...
    public void onActivityLayout(@Dimension int i, @Dimension int i2, @Dimension int i3, @Dimension int i4, int i5, @NonNull Bundle bundle) {
    }

    public void onActivityResized(@Dimension int i, @Dimension int i2, @NonNull Bundle bundle) {
    }
