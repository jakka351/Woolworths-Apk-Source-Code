...
@StabilityInferred
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u0007\n\u0002\b\u0002\bÁ\u0002\u0018\u00002\u00020\u0001¨\u0006\u0004²\u0006\f\u0010\u0003\u001a\u00020\u00028\nX\u008a\u0084\u0002"}, d2 = {"Lau/com/woolworths/sdui/legacy/downloadableasset/Lottie;", "", "", "progress", "legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes4.dex */
public final class Lottie {

    /* renamed from: a, reason: collision with root package name */
    public static final Lottie f10004a = new Lottie();
    ...
    public final void a(ContentScale contentScale, LottieCompositionSpec.Url url, Modifier modifier, Composer composer, int i) {
        ...
        ComposerImpl composerImplV = composer.v(-100707194);
        if ((i & 6) == 0) {
        ...
        if ((i2 & 9363) == 9362 && composerImplV.c()) {
            ...
            if (((Boolean) lottieCompositionResultImplC.i.getD()).booleanValue()) {
                Timber.f27013a.d("Failed to load lottie.", (Throwable) ((SnapshotMutableStateImpl) lottieCompositionResultImplC.f).getD(), new Object[0]);
            }
            ...
            if (zN || objG == Composer.Companion.f1624a) {
                objG = new h(lottieAnimatableA, 9);
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new b(this, contentScale, url, modifier, i, 6);
        }
    }

    public final void b(String url, ContentScale contentScale, Modifier modifier, Composer composer, int i) {
        int i2;
        Intrinsics.h(url, "url");
        Intrinsics.h(contentScale, "contentScale");
        ComposerImpl composerImplV = composer.v(159212901);
        if ((i & 6) == 0) {
            i2 = (composerImplV.n(url) ? 4 : 2) | i;
        } else {
            i2 = i;
        }
        if ((i & 48) == 0) {
        ...
        if ((74899 & i2) == 74898 && composerImplV.c()) {
            ...
            a(contentScale, new LottieCompositionSpec.Url(url), modifier, composerImplV, ((i2 >> 3) & 14) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (i2 & 458752));
        }
        RecomposeScopeImpl recomposeScopeImplX = composerImplV.X();
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new b((Object) this, url, contentScale, modifier, i, 5);
        }
    }
}
