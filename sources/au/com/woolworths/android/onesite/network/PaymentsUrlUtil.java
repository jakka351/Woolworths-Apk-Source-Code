...
public class PaymentsUrlUtil {
    public static String a(ShopAccountInteractor shopAccountInteractor, AppBuildConfig appBuildConfig) {
        if (shopAccountInteractor.S() && !Strings.b(shopAccountInteractor.n().getPaymentUrl())) {
            return shopAccountInteractor.n().getPaymentUrl();
        }
        return appBuildConfig.a() + "/commerce/checkout/payment";
    }
}
