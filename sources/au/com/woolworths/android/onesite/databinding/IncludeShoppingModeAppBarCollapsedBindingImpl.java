...
public class IncludeShoppingModeAppBarCollapsedBindingImpl extends IncludeShoppingModeAppBarCollapsedBinding implements OnClickListener.Listener {
    ...
    static {
        ...
        I = sparseIntArray;
        sparseIntArray.put(R.id.change_button_barrier_collapsed, 4);
    }

    /* JADX WARN: Illegal instructions before constructor call */
    public IncludeShoppingModeAppBarCollapsedBindingImpl(DataBindingComponent dataBindingComponent, View view) {
    ...
    public final void j() {
        ...
        if ((j & 16) != 0) {
            this.y.L(HomepageModeSelectorBadge.f);
            this.y.M(2);
