...
abstract class Hilt_DeliveryAddressSearchActivity extends BaseShopAppActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder x;
    public volatile ActivityComponentManager y;
    public final Object z = new Object();
    public boolean A = false;

    public Hilt_DeliveryAddressSearchActivity() {
        final DeliveryAddressSearchActivity deliveryAddressSearchActivity = (DeliveryAddressSearchActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.android.onesite.modules.deliveryaddress.search.Hilt_DeliveryAddressSearchActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                DeliveryAddressSearchActivity deliveryAddressSearchActivity2 = deliveryAddressSearchActivity;
                if (deliveryAddressSearchActivity2.A) {
                    return;
                }
                deliveryAddressSearchActivity2.A = true;
                ((DeliveryAddressSearchActivity_GeneratedInjector) deliveryAddressSearchActivity2.t3()).F(deliveryAddressSearchActivity2);
            }
        });
    }
