...
@DebugMetadata(c = "au.com.woolworths.android.onesite.modules.search.searchscreen.SearchViewModel$onCancellationSuccess$1", f = "SearchViewModel.kt", l = {293}, m = "invokeSuspend")
/* loaded from: classes3.dex */
final class SearchViewModel$onCancellationSuccess$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int p;
    public final /* synthetic */ SearchViewModel q;
    public final /* synthetic */ Text r;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SearchViewModel$onCancellationSuccess$1(SearchViewModel searchViewModel, Text text, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new SearchViewModel$onCancellationSuccess$1(this.q, this.r, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((SearchViewModel$onCancellationSuccess$1) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.f24250a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            searchViewModel.h.c(new EditOrderActions.CancellationSuccess(SearchScreens.d));
