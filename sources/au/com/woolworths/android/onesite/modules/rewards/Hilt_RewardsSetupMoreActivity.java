...
public abstract class Hilt_RewardsSetupMoreActivity extends BaseShopAppActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder x;
    public volatile ActivityComponentManager y;
    public final Object z = new Object();
    public boolean A = false;

    public Hilt_RewardsSetupMoreActivity() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.android.onesite.modules.rewards.Hilt_RewardsSetupMoreActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                Hilt_RewardsSetupMoreActivity hilt_RewardsSetupMoreActivity = Hilt_RewardsSetupMoreActivity.this;
                if (hilt_RewardsSetupMoreActivity.A) {
                    return;
                }
                hilt_RewardsSetupMoreActivity.A = true;
                ((RewardsSetupMoreActivity_GeneratedInjector) hilt_RewardsSetupMoreActivity.t3()).B0((RewardsSetupMoreActivity) hilt_RewardsSetupMoreActivity);
            }
        });
    }
