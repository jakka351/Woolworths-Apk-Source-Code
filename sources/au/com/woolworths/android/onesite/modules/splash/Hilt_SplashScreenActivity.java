...
public abstract class Hilt_SplashScreenActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    ...
    public Hilt_SplashScreenActivity() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.android.onesite.modules.splash.Hilt_SplashScreenActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                Hilt_SplashScreenActivity hilt_SplashScreenActivity = Hilt_SplashScreenActivity.this;
                if (hilt_SplashScreenActivity.w) {
                    return;
                }
                hilt_SplashScreenActivity.w = true;
                ((SplashScreenActivity_GeneratedInjector) hilt_SplashScreenActivity.t3()).z0((SplashScreenActivity) hilt_SplashScreenActivity);
            }
        });
    }
