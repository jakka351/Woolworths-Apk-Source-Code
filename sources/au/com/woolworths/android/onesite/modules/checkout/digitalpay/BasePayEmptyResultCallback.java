...
public abstract class BasePayEmptyResultCallback implements PayEmptyResultCallback {
    public final SchedulersProvider d;
    public final ShopAppTokenAuthenticator e;
    public final PayError g = new AnonymousClass1();
    public int f = 0;

    /* renamed from: au.com.woolworths.android.onesite.modules.checkout.digitalpay.BasePayEmptyResultCallback$1, reason: invalid class name */
    ...
    public BasePayEmptyResultCallback(SchedulersProvider schedulersProvider, ShopAppTokenAuthenticator shopAppTokenAuthenticator) {
    ...
    public final void A(final Retryable retryable) {
        ...
        this.f = i + 1;
        MaybeDefer maybeDefer = new MaybeDefer(new a(0, this));
        ...
        new MaybeObserveOn(new MaybeSubscribeOn(maybeDefer, schedulerD), schedulersProvider.b()).a(new DisposableMaybeObserver<String>(this) { // from class: au.com.woolworths.android.onesite.modules.checkout.digitalpay.BasePayEmptyResultCallback.2
            public final /* synthetic */ BasePayEmptyResultCallback f;
            ...
            public final void onComplete() {
                BasePayEmptyResultCallback basePayEmptyResultCallback = this.f;
                basePayEmptyResultCallback.v(basePayEmptyResultCallback.g);
            }
