...
import au.com.woolworths.shop.graphql.adapter.ProductsByFacetQuery_ResponseAdapter;
...
@StabilityInferred
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0011\b\u0087\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0010\u0003\u0004\u0005\u0006\u0007\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012¨\u0006\u0013"}, d2 = {"Lau/com/woolworths/shop/graphql/ProductsByFacetQuery;", "Lcom/apollographql/apollo/api/Query;", "Lau/com/woolworths/shop/graphql/ProductsByFacetQuery$Data;", "Data", "ProductsByFacet", "Product", "Filter", "FilterItem", "Banner", "Action", "SortOption", "SortOptionsBanner", "MarketplaceInfo", "Item", "Footer", "MarketplaceBottomSheet", "PrimaryCta", "SecondaryCta", "Companion", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes4.dex */
public final /* data */ class ProductsByFacetQuery implements Query<Data> {

    /* renamed from: a, reason: collision with root package name */
    public final ProductListChannelType f10925a;
    ...
    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/graphql/ProductsByFacetQuery$Action;", "", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Action {

        /* renamed from: a, reason: collision with root package name */
        public final InsetBannerActionPlacement f10926a;
        ...
        public Action(InsetBannerActionPlacement insetBannerActionPlacement, InsetBannerActionType insetBannerActionType, String str, String str2) {
            this.f10926a = insetBannerActionPlacement;
        ...
        public final boolean equals(Object obj) {
            ...
            return this.f10926a == action.f10926a && this.b == action.b && Intrinsics.c(this.c, action.c) && Intrinsics.c(this.d, action.d);
        }

        public final int hashCode() {
            int iC = b.c(d.c(this.b, this.f10926a.hashCode() * 31, 31), 31, this.c);
            String str = this.d;
            return iC + (str == null ? 0 : str.hashCode());
        }

        public final String toString() {
            return a.l(d.t("Action(placement=", this.f10926a, ", type=", this.b, ", label="), this.c, ", url=", this.d, ")");
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/graphql/ProductsByFacetQuery$Banner;", "", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Banner {

        /* renamed from: a, reason: collision with root package name */
        public final InsetBannerDisplayType f10927a;
        ...
        public Banner(InsetBannerDisplayType insetBannerDisplayType, String str, String str2, String str3, Action action) {
            this.f10927a = insetBannerDisplayType;
            this.b = str;
            this.c = str2;
            this.d = str3;
            this.e = action;
        ...
        public final boolean equals(Object obj) {
            ...
            return this.f10927a == banner.f10927a && Intrinsics.c(this.b, banner.b) && Intrinsics.c(this.c, banner.c) && Intrinsics.c(this.d, banner.d) && Intrinsics.c(this.e, banner.e);
        }

        public final int hashCode() {
            int iC = b.c(this.f10927a.hashCode() * 31, 31, this.b);
            String str = this.c;
        ...
        public final String toString() {
            StringBuilder sbU = d.u("Banner(displayType=", this.f10927a, ", message=", this.b, ", bannerTitle=");
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, d2 = {"Lau/com/woolworths/shop/graphql/ProductsByFacetQuery$Companion;", "", "", "OPERATION_ID", "Ljava/lang/String;", "OPERATION_NAME", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/graphql/ProductsByFacetQuery$Data;", "Lcom/apollographql/apollo/api/Query$Data;", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Data implements Query.Data {

        /* renamed from: a, reason: collision with root package name */
        public final ProductsByFacet f10928a;

        public Data(ProductsByFacet productsByFacet) {
            this.f10928a = productsByFacet;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.c(this.f10928a, ((Data) obj).f10928a);
        }

        public final int hashCode() {
            ProductsByFacet productsByFacet = this.f10928a;
        ...
        public final String toString() {
            return "Data(productsByFacet=" + this.f10928a + ")";
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/graphql/ProductsByFacetQuery$Filter;", "", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Filter {
        ...
        public final boolean equals(Object obj) {
            ...
            return this.f10929a.equals(filter.f10929a) && this.b.equals(filter.b) && this.c.equals(filter.c) && Intrinsics.c(this.d, filter.d);
        }

        public final int hashCode() {
            int iB = androidx.compose.ui.input.pointer.a.b(b.c(this.f10929a.hashCode() * 31, 31, this.b), 31, this.c);
            Banner banner = this.d;
            return iB + (banner == null ? 0 : banner.hashCode());
        }

        public final String toString() {
            StringBuilder sbV = YU.a.v("Filter(headerKey=", this.f10929a, ", headerTitle=", this.b, ", filterItems=");
            sbV.append(this.c);
            sbV.append(", banner=");
            sbV.append(this.d);
            sbV.append(")");
    ...
    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/graphql/ProductsByFacetQuery$FilterItem;", "", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class FilterItem {
        ...
        public final boolean equals(Object obj) {
            ...
            return Intrinsics.c(this.f10930a, filterItem.f10930a) && Intrinsics.c(this.b, filterItem.b) && Intrinsics.c(this.c, filterItem.c) && Intrinsics.c(this.d, filterItem.d) && this.e == filterItem.e && this.f == filterItem.f;
        }

        public final int hashCode() {
            int iC = b.c(b.c(this.f10930a.hashCode() * 31, 31, this.b), 31, this.c);
            String str = this.d;
            return Boolean.hashCode(this.f) + b.e((iC + (str == null ? 0 : str.hashCode())) * 31, 31, this.e);
        }

        public final String toString() {
            StringBuilder sbV = YU.a.v("FilterItem(key=", this.f10930a, ", title=", this.b, ", label=");
    ...
    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/graphql/ProductsByFacetQuery$Footer;", "", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Footer {
        ...
        public final boolean equals(Object obj) {
            ...
            return Intrinsics.c(this.f10931a, footer.f10931a) && Intrinsics.c(this.b, footer.b) && Intrinsics.c(this.c, footer.c);
        }

        public final int hashCode() {
            return this.c.hashCode() + b.c(this.f10931a.hashCode() * 31, 31, this.b);
        }

        public final String toString() {
            return YU.a.o(YU.a.v("Footer(title=", this.f10931a, ", subtitle=", this.b, ", linkUrl="), this.c, ")");
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/graphql/ProductsByFacetQuery$Item;", "", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Item {
        ...
        public final boolean equals(Object obj) {
            ...
            Item item = (Item) obj;
            return Intrinsics.c(this.f10932a, item.f10932a) && Intrinsics.c(this.b, item.b) && Intrinsics.c(this.c, item.c);
        }

        public final int hashCode() {
            return this.c.hashCode() + b.c(this.f10932a.hashCode() * 31, 31, this.b);
        }

        public final String toString() {
            return YU.a.o(YU.a.v("Item(title=", this.f10932a, ", description=", this.b, ", imageUrl="), this.c, ")");
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/graphql/ProductsByFacetQuery$MarketplaceBottomSheet;", "", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class MarketplaceBottomSheet {
        ...
        public final boolean equals(Object obj) {
            ...
            return Intrinsics.c(this.f10933a, marketplaceBottomSheet.f10933a) && Intrinsics.c(this.b, marketplaceBottomSheet.b) && Intrinsics.c(this.c, marketplaceBottomSheet.c) && Intrinsics.c(this.d, marketplaceBottomSheet.d) && Intrinsics.c(this.e, marketplaceBottomSheet.e);
        }

        public final int hashCode() {
            int iC = b.c(this.f10933a.hashCode() * 31, 31, this.b);
            PrimaryCta primaryCta = this.c;
            int iHashCode = (iC + (primaryCta == null ? 0 : primaryCta.f10935a.hashCode())) * 31;
            SecondaryCta secondaryCta = this.d;
            int iHashCode2 = (iHashCode + (secondaryCta == null ? 0 : secondaryCta.f10938a.hashCode())) * 31;
            Boolean bool = this.e;
            return iHashCode2 + (bool != null ? bool.hashCode() : 0);
        }

        public final String toString() {
            StringBuilder sbV = YU.a.v("MarketplaceBottomSheet(bottomSheetTitle=", this.f10933a, ", bottomSheetBody=", this.b, ", primaryCta=");
            sbV.append(this.c);
    ...
    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/graphql/ProductsByFacetQuery$MarketplaceInfo;", "", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class MarketplaceInfo {
        ...
        public final boolean equals(Object obj) {
            ...
            return this.f10934a.equals(marketplaceInfo.f10934a) && this.b.equals(marketplaceInfo.b) && Intrinsics.c(this.c, marketplaceInfo.c);
        }

        public final int hashCode() {
            int iB = androidx.compose.ui.input.pointer.a.b(this.f10934a.hashCode() * 31, 31, this.b);
            Footer footer = this.c;
            return iB + (footer == null ? 0 : footer.hashCode());
        }

        public final String toString() {
            StringBuilder sbX = d.x("MarketplaceInfo(title=", this.f10934a, ", items=", ", footer=", this.b);
            sbX.append(this.c);
            sbX.append(")");
            return sbX.toString();
        }
    ...
    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/graphql/ProductsByFacetQuery$PrimaryCta;", "", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class PrimaryCta {
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof PrimaryCta) && Intrinsics.c(this.f10935a, ((PrimaryCta) obj).f10935a);
        }
        ...
        public final String toString() {
            return YU.a.h("PrimaryCta(label=", this.f10935a, ")");
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/graphql/ProductsByFacetQuery$Product;", "", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Product {
        ...
        public final boolean equals(Object obj) {
            ...
            return Intrinsics.c(this.f10936a, product.f10936a) && Intrinsics.c(this.b, product.b);
        }

        public final int hashCode() {
            return this.b.hashCode() + (this.f10936a.hashCode() * 31);
        }

        public final String toString() {
            return d.o("Product(__typename=", this.f10936a, ", productCard=", this.b, ")");
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/graphql/ProductsByFacetQuery$ProductsByFacet;", "", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class ProductsByFacet {

        /* renamed from: a, reason: collision with root package name */
        public final Integer f10937a;
        ...
        public final String toString() {
            StringBuilder sbV = d.v("ProductsByFacet(totalNumberOfProducts=", this.f10937a, ", nextPage=", this.b, ", products=");
            sbV.append(this.c);
            sbV.append(", filters=");
            sbV.append(this.d);
    ...
    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/graphql/ProductsByFacetQuery$SecondaryCta;", "", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class SecondaryCta {
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof SecondaryCta) && Intrinsics.c(this.f10938a, ((SecondaryCta) obj).f10938a);
        }
        ...
        public final String toString() {
            return YU.a.h("SecondaryCta(label=", this.f10938a, ")");
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/graphql/ProductsByFacetQuery$SortOption;", "", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class SortOption {
        ...
        public final boolean equals(Object obj) {
            ...
            return Intrinsics.c(this.f10939a, sortOption.f10939a) && Intrinsics.c(this.b, sortOption.b) && Intrinsics.c(this.c, sortOption.c) && this.d == sortOption.d;
        }

        public final int hashCode() {
            int iC = b.c(this.f10939a.hashCode() * 31, 31, this.b);
            String str = this.c;
            return Boolean.hashCode(this.d) + ((iC + (str == null ? 0 : str.hashCode())) * 31);
        }

        public final String toString() {
            return d.r(this.c, ", isApplied=", ")", YU.a.v("SortOption(key=", this.f10939a, ", title=", this.b, ", subtitle="), this.d);
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/graphql/ProductsByFacetQuery$SortOptionsBanner;", "", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class SortOptionsBanner {
        ...
        public final boolean equals(Object obj) {
            ...
            return Intrinsics.c(this.f10940a, sortOptionsBanner.f10940a) && Intrinsics.c(this.b, sortOptionsBanner.b);
        }

        public final int hashCode() {
            return this.b.hashCode() + (this.f10940a.hashCode() * 31);
        }

        public final String toString() {
            return "SortOptionsBanner(__typename=" + this.f10940a + ", insetBanner=" + this.b + ")";
        }
    }
    ...
    public final Adapter adapter() {
        return Adapters.c(ProductsByFacetQuery_ResponseAdapter.Data.f10962a, false);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f10925a == productsByFacetQuery.f10925a && this.b == productsByFacetQuery.b && this.c.equals(productsByFacetQuery.c) && this.d.equals(productsByFacetQuery.d) && this.e.equals(productsByFacetQuery.e) && Intrinsics.c(this.f, productsByFacetQuery.f) && this.g.equals(productsByFacetQuery.g) && this.h.equals(productsByFacetQuery.h) && this.i.equals(productsByFacetQuery.i) && this.j == productsByFacetQuery.j && this.k.equals(productsByFacetQuery.k) && this.l.equals(productsByFacetQuery.l) && this.m == productsByFacetQuery.m;
    }

    public final int hashCode() {
        return Boolean.hashCode(this.m) + au.com.woolworths.feature.rewards.everydayextras.signup.selections.a.c(this.l, au.com.woolworths.feature.rewards.everydayextras.signup.selections.a.c(this.k, b.e(b.e(b.e(au.com.woolworths.feature.rewards.everydayextras.signup.selections.a.c(this.i, au.com.woolworths.feature.rewards.everydayextras.signup.selections.a.c(this.h, au.com.woolworths.feature.rewards.everydayextras.signup.selections.a.c(this.g, b.c(au.com.woolworths.feature.rewards.everydayextras.signup.selections.a.c(this.e, au.com.woolworths.feature.rewards.everydayextras.signup.selections.a.c(this.d, au.com.woolworths.feature.rewards.everydayextras.signup.selections.a.c(this.c, (this.b.hashCode() + (this.f10925a.hashCode() * 31)) * 31, 31), 31), 31), 31, this.f), 31), 31), 31), 31, true), 31, false), 31, this.j), 31), 31);
    }
    ...
    public final void serializeVariables(JsonWriter jsonWriter, CustomScalarAdapters customScalarAdapters, boolean z) {
        ...
        ProductListChannelType_ResponseAdapter.b(jsonWriter, customScalarAdapters, this.f10925a);
        jsonWriter.F1("facet");
