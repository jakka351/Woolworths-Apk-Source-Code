...
abstract class Hilt_SubCategoryActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder t;
    public volatile ActivityComponentManager u;
    public final Object v = new Object();
    public boolean w = false;

    public Hilt_SubCategoryActivity() {
        final SubCategoryActivity subCategoryActivity = (SubCategoryActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.shop.product.navigation.ui.subcategory.Hilt_SubCategoryActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                SubCategoryActivity subCategoryActivity2 = subCategoryActivity;
                if (subCategoryActivity2.w) {
                    return;
                }
                subCategoryActivity2.w = true;
                ((SubCategoryActivity_GeneratedInjector) subCategoryActivity2.t3()).v0(subCategoryActivity2);
            }
        });
    }
