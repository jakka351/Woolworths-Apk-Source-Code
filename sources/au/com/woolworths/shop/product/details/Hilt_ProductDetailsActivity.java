...
abstract class Hilt_ProductDetailsActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    ...
    public Hilt_ProductDetailsActivity() {
        ...
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.shop.product.details.Hilt_ProductDetailsActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                ProductDetailsActivity productDetailsActivity2 = productDetailsActivity;
                if (productDetailsActivity2.w) {
                    return;
                }
                productDetailsActivity2.w = true;
                ((ProductDetailsActivity_GeneratedInjector) productDetailsActivity2.t3()).r0(productDetailsActivity2);
            }
        });
    }
