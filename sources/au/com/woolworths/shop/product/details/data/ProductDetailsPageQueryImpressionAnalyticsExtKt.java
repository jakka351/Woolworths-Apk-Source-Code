...
public final class ProductDetailsPageQueryImpressionAnalyticsExtKt {
    public static final AnalyticsData a(ProductDetailsPageQuery.ImpressionAnalytics impressionAnalytics) {
        List arrayList;
        Intrinsics.h(impressionAnalytics, "<this>");
        AnalyticsFields analyticsFields = impressionAnalytics.b;
