package au.com.woolworths.shop.product.ui;
...
public class DataBinderMapperImpl extends DataBinderMapper {
    ...
    public static final SparseIntArray f12649a = new SparseIntArray(0);
    ...
    public static class InnerLayoutIdLookup {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final HashMap f12650a = new HashMap(0);
    }
    ...
    public final ViewDataBinding b(DataBindingComponent dataBindingComponent, View view, int i) {
        if (f12649a.get(i) <= 0 || view.getTag() != null) {
            return null;
        }
    ...
    public final ViewDataBinding c(DataBindingComponent dataBindingComponent, View[] viewArr, int i) {
        if (viewArr.length != 0 && f12649a.get(i) > 0 && viewArr[0].getTag() == null) {
            throw new RuntimeException("view must have a tag");
        }
        return null;
    }
    ...
    public final int d(String str) {
        Integer num = (Integer) InnerLayoutIdLookup.f12650a.get(str);
        if (num == null) {
            return 0;
        }
        return num.intValue();
