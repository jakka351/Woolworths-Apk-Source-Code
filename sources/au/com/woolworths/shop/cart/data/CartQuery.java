...
import au.com.woolworths.shop.cart.data.adapter.CartQuery_ResponseAdapter;
...
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0086\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0003\u0003\u0004\u0005¨\u0006\u0006"}, d2 = {"Lau/com/woolworths/shop/cart/data/CartQuery;", "Lcom/apollographql/apollo/api/Query;", "Lau/com/woolworths/shop/cart/data/CartQuery$Data;", "Data", "Cart", "Companion", "cart-data_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes4.dex */
public final /* data */ class CartQuery implements Query<Data> {
    ...
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0086\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/cart/data/CartQuery$Cart;", "", "cart-data_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Cart {
        ...
        public final au.com.woolworths.shop.cart.data.common.fragment.Cart getB() {
            return this.b;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            Cart cart = (Cart) obj;
            return Intrinsics.c(this.f10302a, cart.f10302a) && Intrinsics.c(this.b, cart.b);
        }

        public final int hashCode() {
            return this.b.hashCode() + (this.f10302a.hashCode() * 31);
        }

        public final String toString() {
            return "Cart(__typename=" + this.f10302a + ", cart=" + this.b + ")";
        }
    }

    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, d2 = {"Lau/com/woolworths/shop/cart/data/CartQuery$Companion;", "", "", "OPERATION_ID", "Ljava/lang/String;", "OPERATION_NAME", "cart-data_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
    }

    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/cart/data/CartQuery$Data;", "Lcom/apollographql/apollo/api/Query$Data;", "cart-data_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Data implements Query.Data {

        /* renamed from: a, reason: collision with root package name */
        public final Cart f10303a;
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.c(this.f10303a, ((Data) obj).f10303a);
        }
        ...
        public final String toString() {
            return "Data(cart=" + this.f10303a + ")";
        }
    }

    public CartQuery(boolean z, boolean z2, boolean z3, boolean z4, boolean z5) {
        this.f10301a = z;
        this.b = z2;
        this.c = z3;
        this.d = z4;
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof CartQuery)) {
            return false;
        }
        CartQuery cartQuery = (CartQuery) obj;
        return this.f10301a == cartQuery.f10301a && this.b == cartQuery.b && this.c == cartQuery.c && this.d == cartQuery.d && this.e == cartQuery.e;
    }

    public final int hashCode() {
        return Boolean.hashCode(this.e) + b.e(b.e(b.e(Boolean.hashCode(this.f10301a) * 31, 31, this.b), 31, this.c), 31, this.d);
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String id() {
        return "09457d61be50f4a04b8043a684444f9401f49585e97233ece4af3f3aa3504f1b";
    }
    ...
    public final void serializeVariables(JsonWriter jsonWriter, CustomScalarAdapters customScalarAdapters, boolean z) {
        ...
        d.B(this.f10301a, adapters$BooleanAdapter$1, jsonWriter, customScalarAdapters, "everydayMarketFreightRePlatformEnabled");
    ...
    public final String toString() {
        StringBuilder sbV = b.v("CartQuery(isSpecialSavingLabelsEnabled=", ", everydayMarketFreightRePlatformEnabled=", ", isCartBundlesEnabled=", this.f10301a, this.b);
