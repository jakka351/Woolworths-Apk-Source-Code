...
@DebugMetadata(c = "au.com.woolworths.shop.cart.domain.interactor.CartUpdateInteractor$addOrUpdateTrolleyItemsNoBoost$2$quantitiesResponse$1", f = "CartUpdateInteractor.kt", l = {135}, m = "invokeSuspend")
@SourceDebugExtension
/* loaded from: classes4.dex */
final class CartUpdateInteractor$addOrUpdateTrolleyItemsNoBoost$2$quantitiesResponse$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends CartProductQuantitiesUpdatedResponse>>, Object> {
    public int p;
    ...
    public CartUpdateInteractor$addOrUpdateTrolleyItemsNoBoost$2$quantitiesResponse$1(CartUpdateInteractor cartUpdateInteractor, Continuation continuation, UpdateProductInCartExtras[] updateProductInCartExtrasArr) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        CartUpdateInteractor$addOrUpdateTrolleyItemsNoBoost$2$quantitiesResponse$1 cartUpdateInteractor$addOrUpdateTrolleyItemsNoBoost$2$quantitiesResponse$1 = new CartUpdateInteractor$addOrUpdateTrolleyItemsNoBoost$2$quantitiesResponse$1(this.r, continuation, this.s);
        cartUpdateInteractor$addOrUpdateTrolleyItemsNoBoost$2$quantitiesResponse$1.q = obj;
        return cartUpdateInteractor$addOrUpdateTrolleyItemsNoBoost$2$quantitiesResponse$1;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((CartUpdateInteractor$addOrUpdateTrolleyItemsNoBoost$2$quantitiesResponse$1) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.f24250a);
    }
