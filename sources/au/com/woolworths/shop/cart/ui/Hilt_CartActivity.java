...
public abstract class Hilt_CartActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    ...
    public Hilt_CartActivity() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.shop.cart.ui.Hilt_CartActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                Hilt_CartActivity hilt_CartActivity = Hilt_CartActivity.this;
                if (hilt_CartActivity.w) {
                    return;
                }
                hilt_CartActivity.w = true;
                ((CartActivity_GeneratedInjector) hilt_CartActivity.t3()).N0((CartActivity) hilt_CartActivity);
            }
        });
    }
