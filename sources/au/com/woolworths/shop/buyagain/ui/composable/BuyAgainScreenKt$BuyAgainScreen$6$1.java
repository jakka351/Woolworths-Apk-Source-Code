...
final /* synthetic */ class BuyAgainScreenKt$BuyAgainScreen$6$1 extends FunctionReferenceImpl implements Function1<ProductCard, Unit> {
    ...
    public final Object invoke(Object obj) {
        ...
        companion.getClass();
        analyticsManager.i(new Event(arrayList, arrayList2, arrayList3) { // from class: au.com.woolworths.analytics.supers.buyagain.BuyAgainAnalytics$BuyAgain$Action$Companion$stepperAdd$1
...

            {
                ...
                spreadBuilder.a(new Pair("event.Label", "Stepper Add"));
        ...
        if (trolley != null) {
            buyAgainViewModel.r6(p0, trolley.getMinimum());
        }
        return Unit.f24250a;
    }
}
