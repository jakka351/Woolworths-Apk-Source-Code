...
final /* synthetic */ class BuyAgainScreenKt$BuyAgainScreen$1$1 extends FunctionReferenceImpl implements Function0<Unit> {
    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        BuyAgainViewModel buyAgainViewModel = (BuyAgainViewModel) this.receiver;
        buyAgainViewModel.g.g(BuyAgainAnalytics.BuyAgain.Action.o);
        buyAgainViewModel.k.k(BuyAgainContract.Actions.OpenSearch.f10268a);
        return Unit.f24250a;
    }
}
