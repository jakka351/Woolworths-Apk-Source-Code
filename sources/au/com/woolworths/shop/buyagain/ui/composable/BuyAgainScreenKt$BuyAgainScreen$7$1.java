...
final /* synthetic */ class BuyAgainScreenKt$BuyAgainScreen$7$1 extends FunctionReferenceImpl implements Function2<ProductCard, Double, Unit> {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        companion.getClass();
        analyticsManager.i(new Event(arrayList, arrayList2, arrayList3) { // from class: au.com.woolworths.analytics.supers.buyagain.BuyAgainAnalytics$BuyAgain$Action$Companion$stepperPlus$1
...

            {
                ...
                spreadBuilder.a(new Pair("event.Label", "Stepper Plus"));
        ...
        if (trolley != null) {
            buyAgainViewModel.r6(p0, new BigDecimal(Math.min(trolley.getIncrement() + dDoubleValue, trolley.getMaximum())).setScale(2, RoundingMode.HALF_UP).doubleValue());
        }
        return Unit.f24250a;
    }
}
