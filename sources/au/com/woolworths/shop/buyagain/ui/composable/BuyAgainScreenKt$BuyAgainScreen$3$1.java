...
final /* synthetic */ class BuyAgainScreenKt$BuyAgainScreen$3$1 extends FunctionReferenceImpl implements Function0<Unit> {
    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        BuyAgainViewModel buyAgainViewModel = (BuyAgainViewModel) this.receiver;
        buyAgainViewModel.g.g(BuyAgainAnalytics.BuyAgain.Action.j);
        buyAgainViewModel.k.k(BuyAgainContract.Actions.GoToProducts.f10261a);
        return Unit.f24250a;
    }
}
