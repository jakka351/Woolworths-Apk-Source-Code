package au.com.woolworths.shop.lists.ui.snapalist.dialog;
...
public final class NoPermissionDialogKt {
    public static final void a(int i, Composer composer, Modifier modifier, Function0 onPrimaryAction, Function0 onDismissAction) {
        ...
        ComposerImpl composerImplV = composer.v(-1673238494);
        if ((i & 6) == 0) {
        ...
        if ((i3 & 147) == 146 && composerImplV.c()) {
            ...
            String strC = StringResources_androidKt.c(composerImplV, R.string.shop_lists_snap_no_permission_dialog_title);
            String strC2 = StringResources_androidKt.c(composerImplV, R.string.shop_lists_snap_no_permission_dialog_body);
            String strC3 = StringResources_androidKt.c(composerImplV, R.string.shop_lists_snap_action_settings);
            String strC4 = StringResources_androidKt.c(composerImplV, R.string.shop_lists_snap_action_cancel);
            composerImplV.o(5004770);
            boolean z = (i3 & 14) == 4;
            Object objG = composerImplV.G();
            Composer$Companion$Empty$1 composer$Companion$Empty$1 = Composer.Companion.f1624a;
            if (z || objG == composer$Companion$Empty$1) {
                objG = new c(5, onPrimaryAction);
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new a(onPrimaryAction, onDismissAction, modifier2, i, 7);
        }
    }
}
