...
@DebugMetadata(c = "au.com.woolworths.shop.lists.ui.shoppinglist.main.ShoppingListDetailsViewModel$onUndoDeleteItem$1", f = "ShoppingListDetailsViewModel.kt", l = {}, m = "invokeSuspend")
/* loaded from: classes4.dex */
final class ShoppingListDetailsViewModel$onUndoDeleteItem$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public final /* synthetic */ ShoppingListItemUiModel p;
    public final /* synthetic */ ShoppingListDetailsViewModel q;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ShoppingListDetailsViewModel$onUndoDeleteItem$1(ShoppingListItemUiModel shoppingListItemUiModel, ShoppingListDetailsViewModel shoppingListDetailsViewModel, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new ShoppingListDetailsViewModel$onUndoDeleteItem$1(this.p, this.q, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        ShoppingListDetailsViewModel$onUndoDeleteItem$1 shoppingListDetailsViewModel$onUndoDeleteItem$1 = (ShoppingListDetailsViewModel$onUndoDeleteItem$1) create((CoroutineScope) obj, (Continuation) obj2);
        Unit unit = Unit.f24250a;
        shoppingListDetailsViewModel$onUndoDeleteItem$1.invokeSuspend(unit);
        return unit;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (shoppingListItemUiModel instanceof ProductItemUiModel) {
            ...
            } while (!mutableStateFlow.d(value2, SetsKt.d((Set) value2, new Pair(listId, productId))));
        } else {
            ...
            } while (!mutableStateFlow2.d(value, SetsKt.d((Set) value, textItemId)));
        }
        return Unit.f24250a;
    }
}
