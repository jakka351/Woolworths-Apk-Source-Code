...
abstract class Hilt_ShoppingListDetailsActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder t;
    public volatile ActivityComponentManager u;
    public final Object v = new Object();
    public boolean w = false;

    public Hilt_ShoppingListDetailsActivity() {
        final ShoppingListDetailsActivity shoppingListDetailsActivity = (ShoppingListDetailsActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.shop.lists.ui.shoppinglist.main.Hilt_ShoppingListDetailsActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                ShoppingListDetailsActivity shoppingListDetailsActivity2 = shoppingListDetailsActivity;
                if (shoppingListDetailsActivity2.w) {
                    return;
                }
                shoppingListDetailsActivity2.w = true;
                ((ShoppingListDetailsActivity_GeneratedInjector) shoppingListDetailsActivity2.t3()).j0(shoppingListDetailsActivity2);
            }
        });
    }
