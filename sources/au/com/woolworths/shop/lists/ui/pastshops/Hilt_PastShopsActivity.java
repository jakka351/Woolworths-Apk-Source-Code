...
abstract class Hilt_PastShopsActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder t;
    public volatile ActivityComponentManager u;
    public final Object v = new Object();
    public boolean w = false;

    public Hilt_PastShopsActivity() {
        final PastShopsActivity pastShopsActivity = (PastShopsActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.shop.lists.ui.pastshops.Hilt_PastShopsActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                PastShopsActivity pastShopsActivity2 = pastShopsActivity;
                if (pastShopsActivity2.w) {
                    return;
                }
                pastShopsActivity2.w = true;
                ((PastShopsActivity_GeneratedInjector) pastShopsActivity2.t3()).b(pastShopsActivity2);
            }
        });
    }
