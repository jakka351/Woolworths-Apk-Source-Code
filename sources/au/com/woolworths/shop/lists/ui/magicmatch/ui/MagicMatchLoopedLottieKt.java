...
public final class MagicMatchLoopedLottieKt {
    public static final void a(Composer composer, int i) {
        ComposerImpl composerImplV = composer.v(1900889834);
        if (i == 0 && composerImplV.c()) {
            composerImplV.j();
        } else {
            final LottieCompositionResultImpl lottieCompositionResultImplC = RememberLottieCompositionKt.c(new LottieCompositionSpec.RawRes(R.raw.magic_match_intro_then_loop), composerImplV, 0);
            ...
            if (zN || objG2 == obj) {
                objG2 = new MagicMatchLoopedLottieKt$MagicMatchLoopedLottie$1$1(mutableState, lottieCompositionResultImplC, lottieAnimatableA, null);
                composerImplV.A(objG2);
            }
            composerImplV.V(false);
            EffectsKt.e(composerImplV, d, (Function2) objG2);
            AnimatedVisibilityKt.d(((Boolean) mutableState.getD()).booleanValue(), null, null, null, null, ComposableLambdaKt.c(1151278018, new Function3<AnimatedVisibilityScope, Composer, Integer, Unit>() { // from class: au.com.woolworths.shop.lists.ui.magicmatch.ui.MagicMatchLoopedLottieKt$MagicMatchLoopedLottie$2
                ...
                public final Object invoke(Object obj2, Object obj3, Object obj4) {
                    ...
                    if (zN2 || objG3 == Composer.Companion.f1624a) {
                        objG3 = new au.com.woolworths.feature.shop.instore.navigation.map.ui.calibration.b(lottieAnimatable, 4);
                        composer2.A(objG3);
                    }
                    composer2.l();
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new au.com.woolworths.foundation.shop.olive.voice.ui.permission.a(i, 19);
        }
    }
}
