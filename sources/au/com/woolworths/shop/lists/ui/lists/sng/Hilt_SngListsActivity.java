...
abstract class Hilt_SngListsActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder t;
    public volatile ActivityComponentManager u;
    public final Object v = new Object();
    public boolean w = false;

    public Hilt_SngListsActivity() {
        final SngListsActivity sngListsActivity = (SngListsActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.shop.lists.ui.lists.sng.Hilt_SngListsActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                SngListsActivity sngListsActivity2 = sngListsActivity;
                if (sngListsActivity2.w) {
                    return;
                }
                sngListsActivity2.w = true;
                ((SngListsActivity_GeneratedInjector) sngListsActivity2.t3()).getClass();
            }
        });
    }
