...
final /* synthetic */ class MyListScreenKt$MyListScreen$1$1$1$7$1$1 extends FunctionReferenceImpl implements Function0<Unit> {
    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        MyListsViewModel myListsViewModel = (MyListsViewModel) this.receiver;
        myListsViewModel.j.c(new ListsActions.BoostedOffersClick(myListsViewModel.k.a()));
        myListsViewModel.o.f(MyListsContract.Actions.LaunchBoostedOffers.f12330a);
        return Unit.f24250a;
    }
}
