...
@Metadata(d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u001a\n\u0010\u0000\u001a\u00020\u0001*\u00020\u0002¨\u0006\u0003"}, d2 = {"toUiModel", "Lau/com/woolworths/product/models/ProductCard;", "Lau/com/woolworths/shop/lists/data/remote/AlternativeProductsQuery$TargetProduct;", "shop-lists-data_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes4.dex */
public final class AlternativeProductsQueryTargetProductExtKt {
    @NotNull
    public static final ProductCard toUiModel(@NotNull AlternativeProductsQuery.TargetProduct targetProduct) {
        List arrayList;
        List arrayList2;
        String str;
        List arrayList3;
        Intrinsics.h(targetProduct, "<this>");
        String str2 = targetProduct.getProductCard().f8949a;
        String str3 = targetProduct.getProductCard().b;
        String str4 = targetProduct.getProductCard().e;
        String str5 = targetProduct.getProductCard().j;
        Integer num = targetProduct.getProductCard().h;
        String str6 = targetProduct.getProductCard().i;
        String str7 = targetProduct.getProductCard().l;
        boolean z = targetProduct.getProductCard().f;
        boolean z2 = targetProduct.getProductCard().c;
        String str8 = targetProduct.getProductCard().m;
        String str9 = targetProduct.getProductCard().n;
        ProductCard.Trolley trolley = targetProduct.getProductCard().p;
        ProductTrolleyData uiModel = trolley != null ? ProductCardKt.toUiModel(trolley) : null;
        List list = targetProduct.getProductCard().q;
        if (list != null) {
            List list2 = list;
        ...
        ProductShoppingList uiModel2 = ProductCardListExtKt.toUiModel(targetProduct.getProductCard().r);
        ProductCard.InStoreDetails inStoreDetails = targetProduct.getProductCard().s;
        InstoreDetailsData uiModel3 = inStoreDetails != null ? ProductCardInStoreDetailsExtKt.toUiModel(inStoreDetails) : null;
        PurchaseRestriction purchaseRestriction = targetProduct.getProductCard().d;
        ...
        List<ProductCard.InlineLabel> list5 = targetProduct.getProductCard().o;
        if (list5 != null) {
        ...
        ProductCard.PromotionInfo promotionInfo = targetProduct.getProductCard().k;
        PromotionInfo uiModel6 = promotionInfo != null ? ProductCardPromotionInfoExtKt.toUiModel(promotionInfo) : null;
        String str10 = targetProduct.getProductCard().u;
        String str11 = targetProduct.getProductCard().v;
        ProductCard.Marketplace marketplace = targetProduct.getProductCard().w;
        ProductListMarketplace uiModel7 = marketplace != null ? ProductCardMarketplaceExtKt.toUiModel(marketplace) : null;
        ProductCard.RewardsOfferInfo rewardsOfferInfo = targetProduct.getProductCard().x;
        RewardsOfferInfo uiModel8 = rewardsOfferInfo != null ? ProductCardRewardsOfferInfoExtKt.toUiModel(rewardsOfferInfo) : null;
        String str12 = targetProduct.getProductCard().y;
        ProductCard.TagLabel tagLabel = targetProduct.getProductCard().z;
        TagLabel uiModel9 = tagLabel != null ? ProductCardTagLabelExtKt.toUiModel(tagLabel) : null;
        ProductCard.InStoreAvailabilityInfo inStoreAvailabilityInfo = targetProduct.getProductCard().g;
        ...
        ProductCard.ProductVarieties productVarieties = targetProduct.getProductCard().A;
        ProductVarieties uiModel11 = productVarieties != null ? ProductCardProductVarietiesExtKt.toUiModel(productVarieties) : null;
        List list6 = targetProduct.getProductCard().B;
        if (list6 != null) {
            List list7 = list6;
            str = str2;
