...
abstract class Hilt_ShopReceiptListActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder t;
    public volatile ActivityComponentManager u;
    public final Object v = new Object();
    public boolean w = false;

    public Hilt_ShopReceiptListActivity() {
        final ShopReceiptListActivity shopReceiptListActivity = (ShopReceiptListActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.shop.receipts.Hilt_ShopReceiptListActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                ShopReceiptListActivity shopReceiptListActivity2 = shopReceiptListActivity;
                if (shopReceiptListActivity2.w) {
                    return;
                }
                shopReceiptListActivity2.w = true;
                ((ShopReceiptListActivity_GeneratedInjector) shopReceiptListActivity2.t3()).getClass();
            }
        });
    }
