...
import au.com.woolworths.shop.legacy.graphql.adapter.ProductsByHaveYouForgottenQuery_ResponseAdapter;
...
@StabilityInferred
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0087\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0005\u0003\u0004\u0005\u0006\u0007¨\u0006\b"}, d2 = {"Lau/com/woolworths/shop/legacy/graphql/ProductsByHaveYouForgottenQuery;", "Lcom/apollographql/apollo/api/Query;", "Lau/com/woolworths/shop/legacy/graphql/ProductsByHaveYouForgottenQuery$Data;", "Data", "ProductsByHaveYouForgotten", "ProductsFeed", "OnProductCard", "Companion", "product-list-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes4.dex */
public final /* data */ class ProductsByHaveYouForgottenQuery implements Query<Data> {

    /* renamed from: a, reason: collision with root package name */
    public final Optional f12159a = Optional.Absent.f13523a;
    public final Optional b;
    public final boolean c;

    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, d2 = {"Lau/com/woolworths/shop/legacy/graphql/ProductsByHaveYouForgottenQuery$Companion;", "", "", "OPERATION_ID", "Ljava/lang/String;", "OPERATION_NAME", "product-list-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/legacy/graphql/ProductsByHaveYouForgottenQuery$Data;", "Lcom/apollographql/apollo/api/Query$Data;", "product-list-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Data implements Query.Data {

        /* renamed from: a, reason: collision with root package name */
        public final ProductsByHaveYouForgotten f12160a;

        public Data(ProductsByHaveYouForgotten productsByHaveYouForgotten) {
            this.f12160a = productsByHaveYouForgotten;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.c(this.f12160a, ((Data) obj).f12160a);
        }

        public final int hashCode() {
            ProductsByHaveYouForgotten productsByHaveYouForgotten = this.f12160a;
        ...
        public final String toString() {
            return "Data(productsByHaveYouForgotten=" + this.f12160a + ")";
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/legacy/graphql/ProductsByHaveYouForgottenQuery$OnProductCard;", "", "product-list-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class OnProductCard {
        ...
        public final boolean equals(Object obj) {
            ...
            return Intrinsics.c(this.f12161a, onProductCard.f12161a) && Intrinsics.c(this.b, onProductCard.b);
        }

        public final int hashCode() {
            return this.b.hashCode() + (this.f12161a.hashCode() * 31);
        }

        public final String toString() {
            return d.o("OnProductCard(__typename=", this.f12161a, ", productCard=", this.b, ")");
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/legacy/graphql/ProductsByHaveYouForgottenQuery$ProductsByHaveYouForgotten;", "", "product-list-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class ProductsByHaveYouForgotten {

        /* renamed from: a, reason: collision with root package name */
        public final Integer f12162a;
        ...
        public final boolean equals(Object obj) {
            ...
            return Intrinsics.c(this.f12162a, productsByHaveYouForgotten.f12162a) && this.b.equals(productsByHaveYouForgotten.b);
        }

        public final int hashCode() {
            Integer num = this.f12162a;
            return this.b.hashCode() + ((num == null ? 0 : num.hashCode()) * 31);
        }

        public final String toString() {
            return "ProductsByHaveYouForgotten(totalNumberOfProducts=" + this.f12162a + ", productsFeed=" + this.b + ")";
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shop/legacy/graphql/ProductsByHaveYouForgottenQuery$ProductsFeed;", "", "product-list-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class ProductsFeed {
        ...
        public final boolean equals(Object obj) {
            ...
            return Intrinsics.c(this.f12163a, productsFeed.f12163a) && Intrinsics.c(this.b, productsFeed.b);
        }

        public final int hashCode() {
            int iHashCode = this.f12163a.hashCode() * 31;
            OnProductCard onProductCard = this.b;
            return iHashCode + (onProductCard == null ? 0 : onProductCard.hashCode());
        }

        public final String toString() {
            return "ProductsFeed(__typename=" + this.f12163a + ", onProductCard=" + this.b + ")";
        }
    }
    ...
    public final Adapter adapter() {
        return Adapters.c(ProductsByHaveYouForgottenQuery_ResponseAdapter.Data.f12193a, false);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f12159a.equals(productsByHaveYouForgottenQuery.f12159a) && this.b.equals(productsByHaveYouForgottenQuery.b) && this.c == productsByHaveYouForgottenQuery.c;
    }

    public final int hashCode() {
        return Boolean.hashCode(this.c) + a.c(this.b, a.c(this.f12159a, b.e(Boolean.hashCode(false) * 31, 31, false), 31), 31);
    }
    ...
    public final void serializeVariables(JsonWriter jsonWriter, CustomScalarAdapters customScalarAdapters, boolean z) {
        ...
        adapters$BooleanAdapter$1.toJson(jsonWriter, customScalarAdapters, bool);
        Optional optional = this.f12159a;
    ...
    public final String toString() {
        return YU.a.k(")", a.p("ProductsByHaveYouForgottenQuery(includeProductAvailabilityStates=false, includeOfferMinimumSpend=false, includeAvailabilityInfoStatus=", this.f12159a, ", includePricingFootnote=", this.b, ", includeLowestPrice14Days="), this.c);
    }
}
