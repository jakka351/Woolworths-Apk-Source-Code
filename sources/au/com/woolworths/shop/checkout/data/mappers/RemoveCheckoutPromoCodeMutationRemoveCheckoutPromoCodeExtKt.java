...
public final class RemoveCheckoutPromoCodeMutationRemoveCheckoutPromoCodeExtKt {
    ...
    public static final RemoveCheckoutPromoCode a(RemoveCheckoutPromoCodeMutation.RemoveCheckoutPromoCode removeCheckoutPromoCode) {
        SnackBarData snackBarDataA;
        ArrayList arrayList;
        ArrayList arrayList2;
        CheckoutRewardsAndDiscounts checkoutRewardsAndDiscountsA;
        boolean z = removeCheckoutPromoCode.f21882a;
        String str = removeCheckoutPromoCode.b;
        RemoveCheckoutPromoCodeMutation.CheckoutSummary checkoutSummary = removeCheckoutPromoCode.c;
        ...
        return new RemoveCheckoutPromoCode(z, str, checkout);
    }
}
