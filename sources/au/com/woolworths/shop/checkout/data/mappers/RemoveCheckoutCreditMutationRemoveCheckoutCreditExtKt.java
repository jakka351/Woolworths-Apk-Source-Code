...
public final class RemoveCheckoutCreditMutationRemoveCheckoutCreditExtKt {
    ...
    public static final RemoveCheckoutCredit a(RemoveCheckoutCreditMutation.RemoveCheckoutCredit removeCheckoutCredit) {
        SnackBarData snackBarDataA;
        ArrayList arrayList;
        ArrayList arrayList2;
        CheckoutRewardsAndDiscounts checkoutRewardsAndDiscountsA;
        boolean z = removeCheckoutCredit.f21878a;
        String str = removeCheckoutCredit.b;
        RemoveCheckoutCreditMutation.CheckoutSummary checkoutSummary = removeCheckoutCredit.c;
        ...
        return new RemoveCheckoutCredit(z, str, checkout);
    }
}
