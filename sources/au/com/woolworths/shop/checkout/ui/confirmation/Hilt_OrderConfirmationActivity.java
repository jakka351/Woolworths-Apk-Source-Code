...
abstract class Hilt_OrderConfirmationActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    ...
    public Hilt_OrderConfirmationActivity() {
        ...
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.shop.checkout.ui.confirmation.Hilt_OrderConfirmationActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                OrderConfirmationActivity orderConfirmationActivity2 = orderConfirmationActivity;
                if (orderConfirmationActivity2.w) {
                    return;
                }
                orderConfirmationActivity2.w = true;
                ((OrderConfirmationActivity_GeneratedInjector) orderConfirmationActivity2.t3()).getClass();
            }
        });
    }
