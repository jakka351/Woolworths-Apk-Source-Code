...
@DebugMetadata(c = "au.com.woolworths.shop.checkout.ui.product.CheckoutProductViewModel$onToggleSubstitution$1", f = "CheckoutProductViewModel.kt", l = {233}, m = "invokeSuspend")
@SourceDebugExtension
/* loaded from: classes4.dex */
final class CheckoutProductViewModel$onToggleSubstitution$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public CheckoutProductViewModel p;
    public CheckoutProductViewModel q;
    public int r;
    public int s;
    public final /* synthetic */ CheckoutProductViewModel t;
    public final /* synthetic */ CheckoutProduct u;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CheckoutProductViewModel$onToggleSubstitution$1(CheckoutProductViewModel checkoutProductViewModel, CheckoutProduct checkoutProduct, Continuation continuation) {
        super(2, continuation);
        this.t = checkoutProductViewModel;
        this.u = checkoutProduct;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        return new CheckoutProductViewModel$onToggleSubstitution$1(this.t, this.u, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((CheckoutProductViewModel$onToggleSubstitution$1) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.f24250a);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Exception {
        ...
        if (i2 == 0) {
            ResultKt.b(obj);
            CheckoutProduct checkoutProduct = this.u;
            ...
            try {
                ...
                List listQ = CollectionsKt.Q(checkoutProduct);
                boolean z = !checkoutProduct.k;
                this.p = checkoutProductViewModel;
                this.q = checkoutProductViewModel;
                this.r = 1;
                this.s = 1;
                obj = checkoutContentInteractor.d(listQ, z, this);
