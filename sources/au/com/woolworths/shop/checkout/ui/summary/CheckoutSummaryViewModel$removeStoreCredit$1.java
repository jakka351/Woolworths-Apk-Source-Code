...
import au.com.woolworths.shop.checkout.domain.model.RemoveCheckoutCredit;
...
@DebugMetadata(c = "au.com.woolworths.shop.checkout.ui.summary.CheckoutSummaryViewModel$removeStoreCredit$1", f = "CheckoutSummaryViewModel.kt", l = {369}, m = "invokeSuspend")
@SourceDebugExtension
/* loaded from: classes4.dex */
final class CheckoutSummaryViewModel$removeStoreCredit$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int p;
    public final /* synthetic */ CheckoutSummaryViewModel q;
    public final /* synthetic */ CheckoutStoreCreditItem r;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CheckoutSummaryViewModel$removeStoreCredit$1(CheckoutSummaryViewModel checkoutSummaryViewModel, CheckoutStoreCreditItem checkoutStoreCreditItem, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new CheckoutSummaryViewModel$removeStoreCredit$1(this.q, this.r, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((CheckoutSummaryViewModel$removeStoreCredit$1) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.f24250a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i == 0) {
                ...
                this.p = 1;
                obj = checkoutSummaryInteractor.f10823a.o(CollectionsKt.Q(str), this);
            ...
            Checkout checkout2 = removeCheckoutCredit.c;
            if (checkout2 != null) {
            ...
            do {
                ...
                if (modalBottomSheetData2 != null) {
                    ...
                    PlainText plainText = new PlainText(removeCheckoutCredit.b);
                    if (removeCheckoutCredit.f10635a) {
                        plainText = null;
                    }
            ...
            companion.getClass();
            analyticsManager.g(new Event(str2, str3) { // from class: au.com.woolworths.analytics.supers.checkout.CheckoutAnalytics$Summary$Action$Companion$removeCreditError$1
...

                {
                    ...
                    spreadBuilder.a(new Pair("event.Label", "Store credit removal failed"));
                ...
                public final String getD() {
                    return "checkout_store_credit_removal_failure";
                }
                ...
                public final boolean equals(Object obj2) {
                    ...
                    return "checkout_store_credit_removal_failure".equals(event.getD()) && Intrinsics.c(this.d, event.getData()) && Intrinsics.c(null, event.getF());
                }
            ...
            do {
                ...
                if (modalBottomSheetData3 != null) {
                    ...
                    modalBottomSheetDataC = ModalBottomSheetDataExtKt.c(modalBottomSheetData3, linkedHashSet3, new ResText(e instanceof NoConnectivityException ? R.string.error_no_network : R.string.checkout_store_credit_remove_server_error_message));
                } else {
