...
final /* synthetic */ class CheckoutSummaryFragment$updateBottomSheet$1$1$1$8$1 extends FunctionReferenceImpl implements Function1<CheckoutStoreCreditItem, Unit> {
    ...
    public final void m(CheckoutStoreCreditItem p0) {
        ...
        companion.getClass();
        analyticsManager.g(new Event(str, str2) { // from class: au.com.woolworths.analytics.supers.checkout.CheckoutAnalytics$Summary$Action$Companion$removeCreditButtonClick$1
...

            {
                ...
                spreadBuilder.a(new Pair("event.Label", "Store credit removed"));
            ...
            public final String getD() {
                return "checkout_store_credit_removed";
            }
            ...
            public final boolean equals(Object obj) {
                ...
                return "checkout_store_credit_removed".equals(event.getD()) && Intrinsics.c(this.d, event.getData()) && Intrinsics.c(null, event.getF());
            }
        ...
        BuildersKt.c(ViewModelKt.a(checkoutSummaryViewModel), null, null, new CheckoutSummaryViewModel$removeStoreCredit$1(checkoutSummaryViewModel, p0, null), 3);
    }
}
