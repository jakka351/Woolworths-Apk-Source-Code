...
abstract class Hilt_IdVerificationActivity extends ComponentActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder s;
    public volatile ActivityComponentManager t;
    public final Object u = new Object();
    public boolean v = false;

    public Hilt_IdVerificationActivity() {
        final IdVerificationActivity idVerificationActivity = (IdVerificationActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.shop.checkout.ui.idverification.Hilt_IdVerificationActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                IdVerificationActivity idVerificationActivity2 = idVerificationActivity;
                if (idVerificationActivity2.v) {
                    return;
                }
                idVerificationActivity2.v = true;
                ((IdVerificationActivity_GeneratedInjector) idVerificationActivity2.t3()).y0(idVerificationActivity2);
            }
        });
    }
