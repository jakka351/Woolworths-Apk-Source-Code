...
public class EpoxyItemDeliveryUnlimitedSignUpInsetBannerBindingImpl extends EpoxyItemDeliveryUnlimitedSignUpInsetBannerBinding {
    ...
    public EpoxyItemDeliveryUnlimitedSignUpInsetBannerBindingImpl(DataBindingComponent dataBindingComponent, View view) {
    ...
    public final boolean G(int i, Object obj) throws Throwable {
        if (35 == i) {
            this.z = (InsetBannerClickListener) obj;
            synchronized (this) {
                this.C |= 1;
            }
            h(35);
    ...
    public final void j() {
        ...
        InsetBannerClickListener insetBannerClickListener = this.z;
        InsetBanner insetBanner = this.y;
        long j2 = 5 & j;
        if ((j & 6) != 0) {
            this.A.L(insetBanner);
        }
        if (j2 != 0) {
            this.A.M(insetBannerClickListener);
        }
        this.A.k();
    }
