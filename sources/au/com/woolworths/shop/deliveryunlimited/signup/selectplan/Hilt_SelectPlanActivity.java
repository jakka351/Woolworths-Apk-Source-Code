...
abstract class Hilt_SelectPlanActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    ...
    public Hilt_SelectPlanActivity() {
        final SelectPlanActivity selectPlanActivity = (SelectPlanActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.shop.deliveryunlimited.signup.selectplan.Hilt_SelectPlanActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                SelectPlanActivity selectPlanActivity2 = selectPlanActivity;
                if (selectPlanActivity2.w) {
                    return;
                }
                selectPlanActivity2.w = true;
                ((SelectPlanActivity_GeneratedInjector) selectPlanActivity2.t3()).K0(selectPlanActivity2);
            }
        });
    }
