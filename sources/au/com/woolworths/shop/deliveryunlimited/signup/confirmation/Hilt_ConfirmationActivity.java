...
abstract class Hilt_ConfirmationActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    ...
    public Hilt_ConfirmationActivity() {
        ...
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.shop.deliveryunlimited.signup.confirmation.Hilt_ConfirmationActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                ConfirmationActivity confirmationActivity2 = confirmationActivity;
                if (confirmationActivity2.w) {
                    return;
                }
                confirmationActivity2.w = true;
                ((ConfirmationActivity_GeneratedInjector) confirmationActivity2.t3()).getClass();
            }
        });
    }
