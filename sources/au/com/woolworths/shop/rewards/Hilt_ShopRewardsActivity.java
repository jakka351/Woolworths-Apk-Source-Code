...
abstract class Hilt_ShopRewardsActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder t;
    public volatile ActivityComponentManager u;
    public final Object v = new Object();
    public boolean w = false;

    public Hilt_ShopRewardsActivity() {
        final ShopRewardsActivity shopRewardsActivity = (ShopRewardsActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.shop.rewards.Hilt_ShopRewardsActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                ShopRewardsActivity shopRewardsActivity2 = shopRewardsActivity;
                if (shopRewardsActivity2.w) {
                    return;
                }
                shopRewardsActivity2.w = true;
                ((ShopRewardsActivity_GeneratedInjector) shopRewardsActivity2.t3()).s(shopRewardsActivity2);
            }
        });
    }
