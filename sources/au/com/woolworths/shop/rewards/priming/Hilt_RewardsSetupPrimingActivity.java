...
abstract class Hilt_RewardsSetupPrimingActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder t;
    public volatile ActivityComponentManager u;
    public final Object v = new Object();
    public boolean w = false;

    public Hilt_RewardsSetupPrimingActivity() {
        final RewardsSetupPrimingActivity rewardsSetupPrimingActivity = (RewardsSetupPrimingActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.shop.rewards.priming.Hilt_RewardsSetupPrimingActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                RewardsSetupPrimingActivity rewardsSetupPrimingActivity2 = rewardsSetupPrimingActivity;
                if (rewardsSetupPrimingActivity2.w) {
                    return;
                }
                rewardsSetupPrimingActivity2.w = true;
                ((RewardsSetupPrimingActivity_GeneratedInjector) rewardsSetupPrimingActivity2.t3()).getClass();
            }
        });
    }
