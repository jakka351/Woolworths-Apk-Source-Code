...
public final class ComposableSingletons$FullWidthContentCardKt$lambda$1925178326$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((((Number) obj2).intValue() & 3) == 2 && composer.c()) {
            ...
            if (objG == Composer.Companion.f1624a) {
                objG = new au.com.woolworths.shop.aem.components.ui.chatentrycard.b(5);
                composer.A(objG);
            }
            composer.l();
            FullWidthContentCardKt.a(orientation, fullWidthContentCardData, (Function1) objG, null, composer, 390, 8);
        }
        return Unit.f24250a;
    }
}
