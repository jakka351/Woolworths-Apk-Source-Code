...
public final class ComposableSingletons$VerticalProductTileContentUiKt$lambda$313216014$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((((Number) obj2).intValue() & 3) == 2 && composer.c()) {
            ...
            VerticalProductTileContentUiKt.a(1772934, KyberEngine.KyberPolyBytes, composer, SizeKt.u(Modifier.Companion.d, 200), new MarketplaceInfo("", new TextWithAltData("Marketplace partner", "Marketplace partner alternative text")), new ProductPriceInfo("", 55, "/4kg", CollectionsKt.Q(new TextWithAltData("4/5kg", "")), new TextWithAltData("$12.50", "Was $12.50"), new TextWithAltData("$5.50", "Save $5.50"), null), "This is the article name it can be quite long and run over a four lines like this example of article name", "", "", ComposableSingletons$VerticalProductTileContentUiKt.f12667a);
        }
        return Unit.f24250a;
    }
}
