...
abstract class Hilt_PromotionActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder t;
    public volatile ActivityComponentManager u;
    public final Object v = new Object();
    public boolean w = false;

    public Hilt_PromotionActivity() {
        final PromotionActivity promotionActivity = (PromotionActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.promotion.banner.ui.Hilt_PromotionActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                PromotionActivity promotionActivity2 = promotionActivity;
                if (promotionActivity2.w) {
                    return;
                }
                promotionActivity2.w = true;
                ((PromotionActivity_GeneratedInjector) promotionActivity2.t3()).getClass();
            }
        });
    }
