...
@StabilityInferred
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/shared/ui/compose/couponbanner/EverydayMarketCouponBannerColors;", "", "shared-ui-compose_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public final /* data */ class EverydayMarketCouponBannerColors {
    ...
    public final boolean equals(Object obj) {
        ...
        return Color.c(this.f10094a, everydayMarketCouponBannerColors.f10094a) && Color.c(this.b, everydayMarketCouponBannerColors.b) && Color.c(this.c, everydayMarketCouponBannerColors.c) && Color.c(this.d, everydayMarketCouponBannerColors.d) && Color.c(this.e, everydayMarketCouponBannerColors.e) && Color.c(this.f, everydayMarketCouponBannerColors.f);
    }

    public final int hashCode() {
        int i = Color.l;
        return Long.hashCode(this.f) + androidx.camera.core.impl.b.b(androidx.camera.core.impl.b.b(androidx.camera.core.impl.b.b(androidx.camera.core.impl.b.b(Long.hashCode(this.f10094a) * 31, 31, this.b), 31, this.c), 31, this.d), 31, this.e);
    }

    public final String toString() {
        String strI = Color.i(this.f10094a);
