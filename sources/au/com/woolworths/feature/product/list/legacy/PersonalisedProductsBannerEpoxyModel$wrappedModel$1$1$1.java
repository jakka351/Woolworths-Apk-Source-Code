...
final /* synthetic */ class PersonalisedProductsBannerEpoxyModel$wrappedModel$1$1$1 extends FunctionReferenceImpl implements Function1<PersonalisedProductsBannerData, Unit> {
    ...
    public final Object invoke(Object obj) {
        ...
        if (actionData != null) {
            if (ProductListViewModel.WhenMappings.b[actionData.getType().ordinal()] == 2) {
                productListViewModel.v.f(new ProductListContract.Actions.LaunchDeeplink(actionData.getAction(), null));
                AnalyticsData analytics = actionData.getAnalytics();
                if (analytics != null) {
                    productListViewModel.g.g(AnalyticsDataKt.a(AnalyticsDataKt.c(analytics, p0.g, false)));
                }
            }
        }
        return Unit.f24250a;
