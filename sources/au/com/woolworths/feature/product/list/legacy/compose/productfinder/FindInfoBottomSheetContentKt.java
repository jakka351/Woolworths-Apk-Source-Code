...
import au.com.woolworths.feature.product.list.compose.productfinder.a;
...
public final class FindInfoBottomSheetContentKt {
    public static final void a(ColumnScope columnScope, final Function0 onCtaClick, Composer composer, int i) {
        ...
        ComposerImpl composerImplV = composer.v(40562694);
        if ((i & 48) == 0) {
        ...
        if ((i2 & 17) == 16 && composerImplV.c()) {
            ...
            CoreThemeKt.c(6, composerImplV, ComposableLambdaKt.c(1666484322, new Function2<Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.product.list.legacy.compose.productfinder.FindInfoBottomSheetContentKt$FindInfoBottomSheetContent$1
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new a(columnScope, onCtaClick, i, 1);
        }
    }
}
