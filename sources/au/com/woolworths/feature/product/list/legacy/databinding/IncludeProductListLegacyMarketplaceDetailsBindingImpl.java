...
public class IncludeProductListLegacyMarketplaceDetailsBindingImpl extends IncludeProductListLegacyMarketplaceDetailsBinding {
    public final TextView A;
    public long B;
    public final ImageView z;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public IncludeProductListLegacyMarketplaceDetailsBindingImpl(DataBindingComponent dataBindingComponent, View view) {
    ...
    @Override // au.com.woolworths.feature.product.list.legacy.databinding.IncludeProductListLegacyMarketplaceDetailsBinding
