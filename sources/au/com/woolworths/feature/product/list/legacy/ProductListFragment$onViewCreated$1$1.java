...
import au.com.woolworths.feature.product.list.legacy.nutrition.NutritionBottomSheetFragment;
...
@DebugMetadata(c = "au.com.woolworths.feature.product.list.legacy.ProductListFragment$onViewCreated$1$1", f = "ProductListFragment.kt", l = {266}, m = "invokeSuspend")
...
final class ProductListFragment$onViewCreated$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* renamed from: au.com.woolworths.feature.product.list.legacy.ProductListFragment$onViewCreated$1$1$1, reason: invalid class name */
    final /* synthetic */ class AnonymousClass1 extends AdaptedFunctionReference implements Function2<ProductListContract.Actions, Continuation<? super Unit>, Object>, SuspendFunction {
        ...
        public final Object invoke(Object obj, Object obj2) {
            ...
            if (actions instanceof ProductListContract.Actions.LaunchProductAddOrReplace) {
                ...
                ProductCard productCard = launchProductAddOrReplace.f5300a;
                ...
                String str = launchProductSearch.f5302a;
                ProductCard productCard2 = launchProductSearch.b;
                switch (productListFragment.R1().d.e.getE().ordinal()) {
                    case 0:
                    case 2:
                    case 3:
                    case 4:
                ...
                if (actions instanceof ProductListContract.Actions.LaunchProductUpdate) {
                    ...
                    ProductCard productCard3 = launchProductUpdate.f5303a;
                    ...
                    ProductCard productCard4 = launchAddToList.f5295a;
                    AddToListBottomSheetFragment.Companion.a(productListFragment.getParentFragmentManager(), null, launchAddToList.b, CollectionsKt.Q(new AddToListProductParameters(productCard4, (String) null, (Float) null, launchAddToList.d, 14)), null, new ProductInfoViewFactory(productCard4), true, launchAddToList.c, launchAddToList.e, 274);
                    ...
                    ProductCard productCard5 = launchAvailabilityMessage.f5296a;
                    ...
                    if (!productListFragment.h2().B.a().isEmpty()) {
                        FragmentProductListLegacyBinding fragmentProductListLegacyBinding = productListFragment.i;
                        ...
                        int iB1 = ((ProductListLayoutManager) layoutManager).b1();
                        productListFragment.u2();
                        ...
                        productListController.requestForcedModelBuild();
                        fragmentProductListLegacyBinding.C.r();
                        epoxyRecyclerView.o0(iB1);
                    }
                    ...
                    final ProductCard productCard6 = displayRestrictedItemPrompt.f5292a;
                    ...
                    if (z) {
                        final int i = 0;
                        negativeButton = title2.setMessage(com.woolworths.R.string.product_age_restricted_item_prompt_message_underage).setPositiveButton(com.woolworths.R.string.ok, new DialogInterface.OnClickListener() { // from class: au.com.woolworths.feature.product.list.legacy.p
                            @Override // android.content.DialogInterface.OnClickListener
                            public final void onClick(DialogInterface dialogInterface, int i2) {
                                switch (i) {
                                    case 0:
                                        productListFragment.Q1().j(ProductListActions.RestrictedItemLoginPromptOk.e, ProductListFragment.p2(productCard6));
                                        break;
                                    case 1:
                                        ...
                                        productListFragment2.Q1().j(ProductListActions.RestrictedItemLoginPromptLogin.e, ProductListFragment.p2(productCard6));
                                        break;
                                    default:
                                        productListFragment.Q1().j(ProductListActions.RestrictedItemLoginPromptCancel.e, ProductListFragment.p2(productCard6));
                                        break;
                                }
                            }
                        });
                        ...
                        final int i2 = 1;
                        AlertDialog.Builder positiveButton = title2.setMessage(com.woolworths.R.string.product_age_restricted_item_prompt_message).setPositiveButton(com.woolworths.R.string.login_action, new DialogInterface.OnClickListener() { // from class: au.com.woolworths.feature.product.list.legacy.p
                            @Override // android.content.DialogInterface.OnClickListener
                        ...
                        final int i3 = 2;
                        negativeButton = positiveButton.setNegativeButton(com.woolworths.R.string.cancel, new DialogInterface.OnClickListener() { // from class: au.com.woolworths.feature.product.list.legacy.p
                            @Override // android.content.DialogInterface.OnClickListener
                            public final void onClick(DialogInterface dialogInterface, int i22) {
                                switch (i3) {
                                    case 0:
                    ...
                    productListFragment.Q1().j(ProductListActions.RestrictedItemLoginPrompt.e, productListFragment.h2().x6());
                } else {
                    ...
                    if (z2) {
                        ...
                        String str2 = launchProductListProductGroup.f5301a;
                        ...
                        if (productListFragment.h2().w6().e.getE() != Activities.ProductList.ProductListType.H) {
                            CharSequence text = productListFragment.getText(com.woolworths.R.string.product_list_no_results_snack_bar_message);
                            Intrinsics.g(text, "getText(...)");
                            productListFragment.I2(text, null, null);
                        }
                    } else if (actions instanceof ProductListContract.Actions.HandleBannerClick) {
                        productListFragment.startActivity(ShopAppDeepLink.a(Screens.u, ((ProductListContract.Actions.HandleBannerClick) actions).f5294a));
                    } else if (actions instanceof ProductListContract.Actions.DisplayPopupMessage) {
                        PopupMessage popupMessage = ((ProductListContract.Actions.DisplayPopupMessage) actions).f5291a;
                        new AlertDialog.Builder(productListFragment.requireContext()).setTitle(popupMessage.d).setMessage(popupMessage.e).setPositiveButton(popupMessage.f, new au.com.woolworths.feature.product.list.q(1)).show();
                        ...
                        EducationBottomSheetFragment.Companion.a(ProductListScreens.e, launchEducationBottomSheet.f5298a, launchEducationBottomSheet.b).show(productListFragment.getParentFragmentManager(), "EducationBottomSheetFragment");
                    } else if (actions instanceof ProductListContract.Actions.LaunchProductVarieties) {
                        String str4 = ((ProductListContract.Actions.LaunchProductVarieties) actions).f5304a;
                        ...
                        String url = ((ProductListContract.Actions.NavigateToLink) actions).f5310a;
                        ...
                        productListFragment.Q1().j(ProductListActions.BoostAllSuccessSnackbarImpression.e, ((ProductListContract.Actions.BoostAllSucceeded) actions).f5289a);
                        String string2 = productListFragment.getString(com.woolworths.R.string.product_boost_all_success);
                        Intrinsics.g(string2, "getString(...)");
                        productListFragment.I2(string2, null, null);
                    } else if (actions instanceof ProductListContract.Actions.BoostAllFailed) {
                        productListFragment.Q1().j(ProductListActions.BoostAllFailSnackbarImpression.e, ((ProductListContract.Actions.BoostAllFailed) actions).f5288a);
                        String string3 = productListFragment.getString(com.woolworths.R.string.product_boost_all_failed);
                        Intrinsics.g(string3, "getString(...)");
                        productListFragment.I2(string3, null, null);
                    } else if (actions instanceof ProductListContract.Actions.LaunchNutritionInfo) {
                        DietaryInfo dietaryInfo = ((ProductListContract.Actions.LaunchNutritionInfo) actions).f5299a;
                        ...
                        VideoAdBottomSheetFragment.Companion.a(((ProductListContract.Actions.LaunchVideoAdBottomSheet) actions).f5306a).show(productListFragment.getParentFragmentManager(), "VideoAdBottomSheetFragment");
                        ...
                        FragmentProductListLegacyBinding fragmentProductListLegacyBinding2 = productListFragment.i;
                        if (fragmentProductListLegacyBinding2 == null) {
                            Intrinsics.p("fragmentProductListBinding");
                            throw null;
                        }
                        View view = fragmentProductListLegacyBinding2.h;
                        ...
                        ListChangeEventKt.b(contextRequireContext, view, resText.getText(contextRequireContext2), displaySnackbarForWatchlist.f5293a, displaySnackbarForWatchlist.c, new t(productListFragment, actions, 2));
                        ...
                        String str5 = launchDeeplink.f5297a;
                        ...
                        productListFragment.I2(((ProductListContract.Actions.ShowTransientEdrOfferBoostError) actions).f5314a, productListFragment.getString(com.woolworths.R.string.dismiss), new au.com.woolworths.android.onesite.deeplink.h(20));
                    } else {
                        if (!(actions instanceof ProductListContract.Actions.OpenOliveChat)) {
                            throw new NoWhenBranchMatchedException();
                        }
                        productListFragment.h2().r.getClass();
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1 flowKt__TransformKt$onEach$$inlined$unsafeTransform$1 = new FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1(new AnonymousClass1(2, productListFragment, ProductListFragment.class, "handleActions", "handleActions(Lau/com/woolworths/feature/product/list/legacy/ProductListContract$Actions;)V", 4), FlowExtKt.a(flow, productListFragment.getViewLifecycleOwner().getD(), Lifecycle.State.h));
            this.p = 1;
