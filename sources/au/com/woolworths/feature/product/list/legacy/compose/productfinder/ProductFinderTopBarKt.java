...
import au.com.woolworths.feature.product.list.legacy.ComposeProductListCallbacks;
...
public final class ProductFinderTopBarKt {
    ...
    public static final ProductFinderTopBarKt$EmptyCallbacks$1 f5348a = new ProductFinderTopBarKt$EmptyCallbacks$1();
    ...
    public static final void a(String str, String str2, boolean z, ComposeProductListCallbacks composeProductListCallbacks, Composer composer, int i) {
        ...
        boolean z3;
        ComposerImpl composerImplV = composer.v(1805553495);
        if ((i & 6) == 0) {
        ...
        if ((i2 & 1171) == 1170 && composerImplV.c()) {
            ...
            AndroidWindowInsets androidWindowInsetsB = WindowInsets_androidKt.b(composerImplV);
            Modifier.Companion companion2 = Modifier.Companion.d;
            Modifier modifierD = WindowInsetsPaddingKt.d(companion2, androidWindowInsetsB);
            ...
            if (composerImplV.O || !Intrinsics.c(composerImplV.G(), Integer.valueOf(i4))) {
                b.B(i4, composerImplV, i4, function26);
            }
            ...
            Modifier modifierD3 = ComposedModifierKt.d(composerImplV, companion2);
            composerImplV.i();
            if (composerImplV.O) {
                composerImplV.K(function0);
            } else {
            ...
            if (composerImplV.O || !Intrinsics.c(composerImplV.G(), Integer.valueOf(i5))) {
                b.B(i5, composerImplV, i5, function26);
            }
            ...
            Modifier modifierD4 = ComposedModifierKt.d(composerImplV, modifierF);
            composerImplV.i();
            if (composerImplV.O) {
                composerImplV.K(function0);
            } else {
            ...
            if (composerImplV.O || !Intrinsics.c(composerImplV.G(), Integer.valueOf(i7))) {
                b.B(i7, composerImplV, i7, function22);
            }
            ...
            if (z) {
                ...
                if (z6 || objG4 == composer$Companion$Empty$1) {
                    objG4 = new a(composeProductListCallbacks2, 19);
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new au.com.woolworths.design.core.ui.component.experimental.pullrefresh.a(str, str2, z, composeProductListCallbacks2, i, 3);
        }
    }
}
