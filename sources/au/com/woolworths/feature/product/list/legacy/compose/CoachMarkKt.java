...
import au.com.woolworths.feature.product.list.compose.f;
import au.com.woolworths.feature.product.list.compose.g;
import au.com.woolworths.feature.product.list.compose.h;
import au.com.woolworths.feature.product.list.compose.i;
import au.com.woolworths.feature.product.list.compose.j;
import au.com.woolworths.feature.product.list.compose.k;
...
@Metadata(d1 = {"\u0000\u000e\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002¨\u0006\u0004²\u0006\u000e\u0010\u0001\u001a\u00020\u00008\n@\nX\u008a\u008e\u0002²\u0006\u000e\u0010\u0003\u001a\u00020\u00028\n@\nX\u008a\u008e\u0002"}, d2 = {"", "tooltipHeight", "Landroidx/compose/ui/geometry/Rect;", "refinedSpotLightRect", "product-list-legacy_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class CoachMarkKt {
    ...
    public static final void a(final Rect spotLightRect, Function0 onDismissRequest, float f, float f2, boolean z, ComposableLambdaImpl composableLambdaImpl, Composer composer, int i) {
        ...
        ComposerImpl composerImplV = composer.v(316758226);
        ...
        if ((599187 & i2) == 599186 && composerImplV.c()) {
            ...
            if (z3 || objG2 == composer$Companion$Empty$1) {
                z2 = z;
                objG2 = new h(z2, spotLightRect, mutableState, 1);
            ...
            PopupPositionProvider popupPositionProvider = new PopupPositionProvider() { // from class: au.com.woolworths.feature.product.list.legacy.compose.CoachMarkKt$CoachMark$2
            ...
            AndroidPopup_androidKt.a(popupPositionProvider, onDismissRequest, popupProperties, ComposableLambdaKt.c(1502305140, new Function2<Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.product.list.legacy.compose.CoachMarkKt$CoachMark$3
                {
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new i(spotLightRect, onDismissRequest, f, f3, z2, composableLambdaImpl2, i, 1);
        }
    }

    public static final void b(float f, int i, int i2, Composer composer) {
        ComposerImpl composerImplV = composer.v(1868879665);
    ...
    public static final void c(Rect rect, float f, float f2, Modifier modifier, Composer composer, int i) {
        ...
        RecomposeScopeImpl recomposeScopeImplX = composerImplV.X();
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new k(rect, f, f2, modifier, i, 1);
        }
    }
