...
public final class FilterSortItemKt {
    public static final void a(final ProductListOptionsSortOptionItem item, Function0 onGetVisibleSortOptions, Function1 onSortOptionSelected, Composer composer, int i) {
        ...
        ComposerImpl composerImplV = composer.v(-1442928805);
        ...
        if ((i2 & 147) == 146 && composerImplV.c()) {
            ...
            if (z) {
                composerImplV.o(2035961473);
                Modifier modifierA = AspectRatioKt.a(companion, 3.8f);
                boolean z2 = ((ProductListOptionsSortOptionItem.SortOptionItem) item).f5384a.g;
                composerImplV.o(-1633490746);
                boolean z3 = ((i2 & 896) == 256) | ((i2 & 14) == 4);
                Object objG = composerImplV.G();
                if (z3 || objG == Composer.Companion.f1624a) {
                    objG = new androidx.navigation.compose.a(17, onSortOptionSelected, item);
                    composerImplV.A(objG);
                }
                composerImplV.V(false);
                FilterChipKt.a(true, z2, (Function0) objG, modifierA, null, 0L, 0L, null, null, null, ComposableLambdaKt.c(1290693858, new Function3<RowScope, Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.product.list.legacy.compose.filter.FilterSortItemKt$FilterSortItem$2
                    ...
                    public final Object invoke(Object obj, Object obj2, Object obj3) {
                        ...
                        if ((iIntValue & 17) == 16 && composer3.c()) {
                            ...
                            SortOption sortOption = ((ProductListOptionsSortOptionItem.SortOptionItem) item).f5384a;
                            TextKt.b(sortOption.e, null, 0L, 0L, null, 0L, null, null, 0L, 0, false, 0, 0, null, WxTheme.b(composer3).o, composer3, 0, 0, 65534);
                            String str = sortOption.f;
                            composer3.o(-714353494);
                            if (str == null) {
                                composer2 = composer3;
                            } else {
                                composer2 = composer3;
                                TextKt.b(sortOption.f, null, 0L, 0L, null, 0L, null, null, 0L, 0, false, 0, 0, null, WxTheme.b(composer3).r, composer2, 0, 0, 65534);
                            }
                            composer2.l();
                            composer2.f();
                        }
                ...
                if (!(item instanceof ProductListOptionsSortOptionItem.SortOptionsToggleItem)) {
                    throw au.com.woolworths.android.onesite.a.w(619863864, composerImplV, false);
                }
                composerImplV.o(2036980009);
                FilterChipKt.a(true, false, onGetVisibleSortOptions, AspectRatioKt.a(companion, 3.8f), null, 0L, 0L, null, null, null, ComposableLambdaKt.c(267045657, new Function3<RowScope, Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.product.list.legacy.compose.filter.FilterSortItemKt$FilterSortItem$3
                    @Override // kotlin.jvm.functions.Function3
                    public final Object invoke(Object obj, Object obj2, Object obj3) {
                        RowScope FilterChip = (RowScope) obj;
                        ...
                        if ((iIntValue & 17) == 16 && composer2.c()) {
                            ...
                            Modifier modifierE = SizeKt.e(Modifier.Companion.d, 1.0f);
                            TextKt.b(StringResources_androidKt.c(composer2, ((ProductListOptionsSortOptionItem.SortOptionsToggleItem) item).f5385a), modifierE, WxTheme.a(composer2).h(), 0L, null, 0L, null, new TextAlign(3), 0L, 0, false, 0, 0, null, WxTheme.b(composer2).o, composer2, 48, 0, 65016);
                        }
                        return Unit.f24250a;
                    }
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new androidx.lifecycle.compose.c(item, onGetVisibleSortOptions, onSortOptionSelected, i, 23);
        }
    }
}
