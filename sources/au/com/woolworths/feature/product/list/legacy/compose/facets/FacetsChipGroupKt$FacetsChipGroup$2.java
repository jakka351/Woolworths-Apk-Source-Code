...
import au.com.woolworths.design.wx.component.topbar.a;
...
@DebugMetadata(c = "au.com.woolworths.feature.product.list.legacy.compose.facets.FacetsChipGroupKt$FacetsChipGroup$2", f = "FacetsChipGroup.kt", l = {93}, m = "invokeSuspend")
...
final class FacetsChipGroupKt$FacetsChipGroup$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            Flow flowR = FlowKt.r(SnapshotStateKt.m(new a(this.q, 2)));
            final Ref.IntRef intRef = this.r;
            final Function0 function0 = this.s;
            FlowCollector flowCollector = new FlowCollector() { // from class: au.com.woolworths.feature.product.list.legacy.compose.facets.FacetsChipGroupKt$FacetsChipGroup$2.2
