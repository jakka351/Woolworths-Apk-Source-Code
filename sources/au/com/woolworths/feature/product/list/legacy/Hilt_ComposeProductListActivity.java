...
public abstract class Hilt_ComposeProductListActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    ...
    public Hilt_ComposeProductListActivity() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.product.list.legacy.Hilt_ComposeProductListActivity.1
            ...
            public final void a(ComponentActivity componentActivity) {
                ...
                ((ComposeProductListActivity_GeneratedInjector) hilt_ComposeProductListActivity.t3()).d((ComposeProductListActivity) hilt_ComposeProductListActivity);
            }
        });
    }
