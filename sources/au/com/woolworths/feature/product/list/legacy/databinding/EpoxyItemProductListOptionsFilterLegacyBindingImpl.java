...
public class EpoxyItemProductListOptionsFilterLegacyBindingImpl extends EpoxyItemProductListOptionsFilterLegacyBinding implements OnClickListener.Listener {
    public static final ViewDataBinding.IncludedLayouts F;
    public final ConstraintLayout B;
    public final IncludeCircledCountLegacyBinding C;
    ...
    static {
        ...
        F = includedLayouts;
        includedLayouts.a(0, new int[]{2}, new int[]{R.layout.include_circled_count_legacy}, new String[]{"include_circled_count_legacy"});
    }

    /* JADX WARN: Illegal instructions before constructor call */
    public EpoxyItemProductListOptionsFilterLegacyBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        ...
        IncludeCircledCountLegacyBinding includeCircledCountLegacyBinding = (IncludeCircledCountLegacyBinding) objArrT[2];
        this.C = includeCircledCountLegacyBinding;
    ...
    public final void a(int i) {
        ...
        filterOptionsClickListener.I(filterOptionItem.f5379a);
    }
