...
@DebugMetadata(c = "au.com.woolworths.feature.product.list.legacy.ComposeProductListActivity$initActionsCollection$2", f = "ComposeProductListActivity.kt", l = {347}, m = "invokeSuspend")
...
final class ComposeProductListActivity$initActionsCollection$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* renamed from: au.com.woolworths.feature.product.list.legacy.ComposeProductListActivity$initActionsCollection$2$1, reason: invalid class name */
    final /* synthetic */ class AnonymousClass1 extends AdaptedFunctionReference implements Function2<ProductListContract.ProductListActivityActions, Continuation<? super Unit>, Object>, SuspendFunction {
        ...
        public final Object invoke(Object obj, Object obj2) throws NumberFormatException {
            ...
            if (productListActivityActions instanceof ProductListContract.ProductListActivityActions.LaunchProductListOptions) {
                ...
                composeProductListActivity.startActivity(Activities.ProductAvailabilityActivity.f4502a.b(((ProductListContract.ProductListActivityActions.LaunchProductAvailability) productListActivityActions).f5318a));
            }
            return Unit.f24250a;
        }
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1 flowKt__TransformKt$onEach$$inlined$unsafeTransform$1 = new FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1(new AnonymousClass1(2, composeProductListActivity, ComposeProductListActivity.class, "handleProductListActions", "handleProductListActions(Lau/com/woolworths/feature/product/list/legacy/ProductListContract$ProductListActivityActions;)V", 4), FlowExtKt.a(composeProductListActivity.S4().y, composeProductListActivity.getD(), Lifecycle.State.h));
            this.p = 1;
