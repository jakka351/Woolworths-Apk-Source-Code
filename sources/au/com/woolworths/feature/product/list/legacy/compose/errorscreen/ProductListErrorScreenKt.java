...
public final class ProductListErrorScreenKt {
    public static final void a(ProductListZeroResults.ProductListFullScreenError data, Function2 onClearFiltersClicked, Modifier modifier, Composer composer, int i) {
        int i2;
        boolean z;
        boolean z2;
        Intrinsics.h(data, "data");
        Intrinsics.h(onClearFiltersClicked, "onClearFiltersClicked");
        ComposerImpl composerImplV = composer.v(-362247692);
        if ((i & 6) == 0) {
        ...
        if ((i & 48) == 0) {
            i2 |= composerImplV.I(onClearFiltersClicked) ? 32 : 16;
        }
        ...
        if ((i2 & 147) == 146 && composerImplV.c()) {
            ...
            SingletonAsyncImageKt.a(data.f5367a, null, SizeKt.e(companion, 1.0f), null, ContentScale.Companion.d, composerImplV, 1573296, 1976);
            String str = data.b;
            if (str == null) {
                str = "";
            }
            ...
            LinkData linkData = data.d;
            composerImplV.o(-438228535);
            if (linkData == null) {
                z = false;
                z2 = true;
            } else {
                ...
                boolean zI = ((i4 & 112) == 32) | composerImplV.I(linkData) | composerImplV.I(data);
                Object objG = composerImplV.G();
                if (zI || objG == Composer.Companion.f1624a) {
                    objG = new c(4, onClearFiltersClicked, linkData, data);
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new androidx.lifecycle.compose.c(data, onClearFiltersClicked, modifier, i, 21);
        }
    }
}
