...
public final class FilterChipCoachMarkKt {
    public static final void a(String title, String message, Function0 onButtonClick, Composer composer, int i) {
        ...
        ComposerImpl composerImplV = composer.v(968104839);
        ...
        if ((i2 & 147) == 146 && composerImplV.c()) {
            ...
            TertiaryButtonKt.a(StringResources_androidKt.c(composerImplV, R.string.best_value_chip_coach_mark_button_text), onButtonClick, TestTagKt.a(companion, "filterChipCoachMarkActionButton"), false, false, null, null, composerImplV, (i4 & 112) | KyberEngine.KyberPolyBytes, 120);
            composerImplV.V(true);
            composerImplV.V(true);
        }
        RecomposeScopeImpl recomposeScopeImplX = composerImplV.X();
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new l(title, message, onButtonClick, i, 1);
        }
    }
}
