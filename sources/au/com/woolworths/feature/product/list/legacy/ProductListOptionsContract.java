...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0004\bf\u0018\u00002\u00020\u0001:\u0003\u0002\u0003\u0004ø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\u0005À\u0006\u0001"}, d2 = {"Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract;", "", "ViewState", "Actions", "FilterOptionsActions", "product-list-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes3.dex */
public interface ProductListOptionsContract {

    @StabilityInferred
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b7\u0018\u00002\u00020\u0001:\u0004\u0002\u0003\u0004\u0005\u0082\u0001\u0004\u0006\u0007\b\t¨\u0006\n"}, d2 = {"Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$Actions;", "", "SeeResults", "ShowMessage", "LaunchFilterOptions", "LaunchMarketplaceHowItWorks", "Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$Actions$LaunchFilterOptions;", "Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$Actions$LaunchMarketplaceHowItWorks;", "Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$Actions$SeeResults;", "Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$Actions$ShowMessage;", "product-list-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static abstract class Actions {

        @StabilityInferred
        @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$Actions$LaunchFilterOptions;", "Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$Actions;", "product-list-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
        public static final /* data */ class LaunchFilterOptions extends Actions {
            ...
            public final boolean equals(Object obj) {
                ...
                return (obj instanceof LaunchFilterOptions) && Intrinsics.c(this.f5330a, ((LaunchFilterOptions) obj).f5330a);
            }
            ...
            public final String toString() {
                return YU.a.h("LaunchFilterOptions(filterId=", this.f5330a, ")");
            }
        }

        @StabilityInferred
        @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$Actions$LaunchMarketplaceHowItWorks;", "Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$Actions;", "product-list-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
        public static final /* data */ class LaunchMarketplaceHowItWorks extends Actions {

            /* renamed from: a, reason: collision with root package name */
            public final InfoSection f5331a;

            public LaunchMarketplaceHowItWorks(InfoSection infoSection) {
                Intrinsics.h(infoSection, "infoSection");
                this.f5331a = infoSection;
            }
            ...
            public final boolean equals(Object obj) {
                ...
                return (obj instanceof LaunchMarketplaceHowItWorks) && Intrinsics.c(this.f5331a, ((LaunchMarketplaceHowItWorks) obj).f5331a);
            }
            ...
            public final String toString() {
                return "LaunchMarketplaceHowItWorks(infoSection=" + this.f5331a + ")";
            }
        }

        @StabilityInferred
        @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$Actions$SeeResults;", "Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$Actions;", "product-list-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
        public static final /* data */ class SeeResults extends Actions {

            /* renamed from: a, reason: collision with root package name */
            public final ProductsDisplayMode f5332a;

            public SeeResults(ProductsDisplayMode productsDisplayMode) {
                this.f5332a = productsDisplayMode;
            }
            ...
            public final boolean equals(Object obj) {
                ...
                return (obj instanceof SeeResults) && this.f5332a == ((SeeResults) obj).f5332a;
            }
            ...
            public final String toString() {
                return "SeeResults(displayMode=" + this.f5332a + ")";
            }
        }

        @StabilityInferred
        @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$Actions$ShowMessage;", "Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$Actions;", "product-list-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
        public static final /* data */ class ShowMessage extends Actions {

            /* renamed from: a, reason: collision with root package name */
            public final ResText f5333a;
            ...
            public final boolean equals(Object obj) {
                ...
                return (obj instanceof ShowMessage) && Intrinsics.c(this.f5333a, ((ShowMessage) obj).f5333a);
            }
            ...
            public final String toString() {
                return "ShowMessage(messageText=" + this.f5333a + ")";
            }
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\b7\u0018\u00002\u00020\u0001:\u0001\u0002\u0082\u0001\u0001\u0003¨\u0006\u0004"}, d2 = {"Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$FilterOptionsActions;", "", "OpenUrl", "Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$FilterOptionsActions$OpenUrl;", "product-list-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static abstract class FilterOptionsActions {

        @StabilityInferred
        @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$FilterOptionsActions$OpenUrl;", "Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$FilterOptionsActions;", "product-list-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
        public static final /* data */ class OpenUrl extends FilterOptionsActions {
            ...
            public final boolean equals(Object obj) {
                ...
                return (obj instanceof OpenUrl) && Intrinsics.c(this.f5334a, ((OpenUrl) obj).f5334a);
            }
            ...
            public final String toString() {
                return YU.a.h("OpenUrl(url=", this.f5334a, ")");
            }
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/feature/product/list/legacy/ProductListOptionsContract$ViewState;", "", "product-list-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class ViewState {
        ...
        public final boolean equals(Object obj) {
            ...
            return this.f5335a == viewState.f5335a && this.b == viewState.b && Intrinsics.c(this.c, viewState.c) && Intrinsics.c(this.d, viewState.d) && Intrinsics.c(this.e, viewState.e) && Intrinsics.c(this.f, viewState.f) && this.g == viewState.g && this.h == viewState.h && this.i == viewState.i && this.j == viewState.j;
        }

        public final int hashCode() {
            int iHashCode = (this.c.hashCode() + ((this.b.hashCode() + (Boolean.hashCode(this.f5335a) * 31)) * 31)) * 31;
            String str = this.d;
