...
@Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\b\u0086\u0081\u0002\u0018\u00002\u00020\u00012\b\u0012\u0004\u0012\u00020\u00000\u0002¨\u0006\u0003"}, d2 = {"Lau/com/woolworths/feature/product/list/legacy/analytics/ProductListOptionsFiltersActions;", "Lau/com/woolworths/android/onesite/analytics/Action;", "", "product-list-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public abstract class ProductListOptionsFiltersActions implements Action {
    ...
    static {
        ProductListOptionsFiltersActions productListOptionsFiltersActions = new ProductListOptionsFiltersActions() { // from class: au.com.woolworths.feature.product.list.legacy.analytics.ProductListOptionsFiltersActions.CLEAR_CLICK
        ...
        ProductListOptionsFiltersActions productListOptionsFiltersActions2 = new ProductListOptionsFiltersActions() { // from class: au.com.woolworths.feature.product.list.legacy.analytics.ProductListOptionsFiltersActions.DIETARY_BANNER_IMPRESSION
        ...
        ProductListOptionsFiltersActions productListOptionsFiltersActions3 = new ProductListOptionsFiltersActions() { // from class: au.com.woolworths.feature.product.list.legacy.analytics.ProductListOptionsFiltersActions.DIETARY_BANNER_FIND_OUT_MORE_CLICK
            public final Category n = Category.m;
        ...
        ProductListOptionsFiltersActions productListOptionsFiltersActions4 = new ProductListOptionsFiltersActions() { // from class: au.com.woolworths.feature.product.list.legacy.analytics.ProductListOptionsFiltersActions.FILTER_CHECKED
        ...
        ProductListOptionsFiltersActions productListOptionsFiltersActions5 = new ProductListOptionsFiltersActions() { // from class: au.com.woolworths.feature.product.list.legacy.analytics.ProductListOptionsFiltersActions.FILTER_UNCHECKED
        ...
        ProductListOptionsFiltersActions productListOptionsFiltersActions6 = new ProductListOptionsFiltersActions() { // from class: au.com.woolworths.feature.product.list.legacy.analytics.ProductListOptionsFiltersActions.SEE_RESULTS_CLICK
            public final Category n = Category.m;
        ...
        ProductListOptionsFiltersActions productListOptionsFiltersActions7 = new ProductListOptionsFiltersActions() { // from class: au.com.woolworths.feature.product.list.legacy.analytics.ProductListOptionsFiltersActions.SELECT_ALL_CLICK
            public final Category n = Category.m;
