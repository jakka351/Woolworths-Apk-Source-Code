...
public final class ProductListOptionsContentSkeletonKt {
    public static final void a(ProductListOptionsContract.ViewState viewState, Function0 onSeeResultButtonClick, ComposableLambdaImpl composableLambdaImpl, Composer composer, int i) {
        ...
        boolean z = viewState.f5335a;
        Intrinsics.h(onSeeResultButtonClick, "onSeeResultButtonClick");
        ComposerImpl composerImplV = composer.v(2084096683);
        ...
        if ((i2 & 147) == 146 && composerImplV.c()) {
            ...
            StatefulButtonKt.b(strA, strA, SizeKt.e(PaddingKt.j(companion, BitmapDescriptorFactory.HUE_RED, f, BitmapDescriptorFactory.HUE_RED, WindowInsetsKt.d(WindowInsets_androidKt.a(composerImplV), composerImplV).getD(), 5), 1.0f), z ? StatefulButtonState.e : StatefulButtonState.d, 0L, onSeeResultButtonClick, composerImplV, (i2 << 12) & 458752, 16);
            composerImplV.V(true);
            composerImplV.o(365474449);
            if (z) {
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new androidx.lifecycle.compose.c(viewState, onSeeResultButtonClick, function3, i, 24);
        }
    }
}
