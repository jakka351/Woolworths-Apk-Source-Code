...
public class FragmentProductMainFilterLegacyBindingImpl extends FragmentProductMainFilterLegacyBinding implements StatefulButtonClickHandler.Listener, OnClickListener.Listener {
    ...
    public FragmentProductMainFilterLegacyBindingImpl(DataBindingComponent dataBindingComponent, View view) {
    ...
    @Override // au.com.woolworths.feature.product.list.legacy.databinding.FragmentProductMainFilterLegacyBinding
    ...
    public final void a(int i) {
        ...
        if (productListOptionsViewModel != null) {
            productListOptionsViewModel.E6();
        }
    }
    ...
    public final void b(int i) {
        ProductListOptionsViewModel productListOptionsViewModel = this.D;
        if (productListOptionsViewModel != null) {
            productListOptionsViewModel.F6(SeeResultsClickSource.e);
        }
    }
