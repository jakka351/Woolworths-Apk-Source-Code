...
public final class FilterCardItemKt {
    public static final void a(final Function0 onCardDismissed, Composer composer, int i) {
        ...
        ComposerImpl composerImplV = composer.v(91845873);
        if ((i & 6) == 0) {
        ...
        if ((i2 & 3) == 2 && composerImplV.c()) {
            ...
            CardKt.a(PaddingKt.h(Modifier.Companion.d, BitmapDescriptorFactory.HUE_RED, 4, 1), null, 0L, 0L, null, BitmapDescriptorFactory.HUE_RED, ComposableLambdaKt.c(-1698205612, new Function2<Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.product.list.legacy.compose.filter.FilterCardItemKt$FilterCardItem$1
                ...
                public final Object invoke(Object obj, Object obj2) {
                    ...
                    if ((((Number) obj2).intValue() & 3) == 2 && composer2.c()) {
                        ...
                        FilterHighlightCard filterHighlightCard = FilterHighlightCard.d;
                        Text spannedText = filterHighlightCard.getSpannedText();
                        composer2.o(77095599);
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new d(i, 1, onCardDismissed);
        }
    }
}
