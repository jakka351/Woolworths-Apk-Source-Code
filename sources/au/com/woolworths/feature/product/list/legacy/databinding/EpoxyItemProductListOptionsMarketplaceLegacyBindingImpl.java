...
public class EpoxyItemProductListOptionsMarketplaceLegacyBindingImpl extends EpoxyItemProductListOptionsMarketplaceLegacyBinding {
    ...
    public final void j() {
        ...
        if (j2 == 0 || productFilterSwitch == null) {
            ...
            str = productFilterSwitch.d;
            str2 = productFilterSwitch.f;
        }
        if (j2 != 0) {
            ImageView imageView = this.B;
            d.z(imageView, R.drawable.ic_everyday_market_logo_small, imageView, str2, null);
