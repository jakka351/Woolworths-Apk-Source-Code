...
import au.com.woolworths.feature.product.list.compose.facets.a;
import au.com.woolworths.feature.product.list.compose.facets.b;
import au.com.woolworths.feature.product.list.legacy.data.ChipText;
...
public final class FacetsChipGroupKt {
    public static final void a(int i, Composer composer, List list, Function0 onFacetScroll, Function1 onFacetsChipClick, boolean z) {
        ...
        ComposerImpl composerImplV = composer.v(67289872);
        if ((i & 6) == 0) {
        ...
        if ((i & KyberEngine.KyberPolyBytes) == 0) {
            i3 |= composerImplV.I(onFacetsChipClick) ? 256 : 128;
        }
        if ((i & 3072) == 0) {
            i3 |= composerImplV.I(onFacetScroll) ? 2048 : 1024;
        }
        if ((i3 & 1171) == 1170 && composerImplV.c()) {
            ...
            boolean zI = ((i3 & 896) == 256) | ((i3 & 14) == 4) | composerImplV.I(list);
            Object objG = composerImplV.G();
            if (zI || objG == Composer.Companion.f1624a) {
                objG = new a(list, z, onFacetsChipClick, 1);
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new b(z, list, onFacetsChipClick, onFacetScroll, i, 1);
        }
    }
