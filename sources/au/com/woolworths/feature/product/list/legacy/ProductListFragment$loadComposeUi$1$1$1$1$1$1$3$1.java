...
final /* synthetic */ class ProductListFragment$loadComposeUi$1$1$1$1$1$1$3$1 extends FunctionReferenceImpl implements Function0<Unit> {
    ...
    public final Object invoke() {
        ...
        productListViewModel.g.j(ProductListActions.FilterClick.e, productListViewModel.x6());
        ProductListContract.ViewState viewState = (ProductListContract.ViewState) productListViewModel.F.e();
        if (viewState != null && viewState.e) {
            androidx.constraintlayout.core.state.a.v(productListInteractor.f5328a.b, "has_dot_interaction", true);
            MutableStateFlow mutableStateFlow = productListInteractor.n;
            do {
                value = mutableStateFlow.getValue();
                productListFlow = (ProductListContract.ProductListFlow) value;
            } while (!mutableStateFlow.d(value, ProductListContract.ProductListFlow.a(productListFlow, null, null, null, null, null, new ProductListContract.ProductListFilterState(productListFlow.f.f5321a, false), null, 95)));
        }
        ...
        if (!productListInteractor.l.isEmpty() && productsListRepository.b.getInt("filter_card_count", 0) <= 3) {
            SharedPreferences sharedPreferences = productListInteractor.f5328a.b;
            SharedPreferences.Editor editorEdit = sharedPreferences.edit();
            editorEdit.putInt("filter_card_count", sharedPreferences.getInt("filter_card_count", 0) + 1);
            editorEdit.apply();
        }
        productListViewModel.x.f(new ProductListContract.ProductListActivityActions.LaunchProductListOptions(productListViewModel.w6()));
        return Unit.f24250a;
    }
}
