...
@Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\b\u0086\u0081\u0002\u0018\u00002\u00020\u00012\b\u0012\u0004\u0012\u00020\u00000\u0002¨\u0006\u0003"}, d2 = {"Lau/com/woolworths/feature/product/list/analytics/ProductListScreens;", "Lau/com/woolworths/android/onesite/analytics/Screen;", "", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public abstract class ProductListScreens implements Screen {
    ...
    static {
        ProductListScreens productListScreens = new ProductListScreens() { // from class: au.com.woolworths.feature.product.list.analytics.ProductListScreens.PRODUCT_CHILD_FILTER
        ...
        ProductListScreens productListScreens2 = new ProductListScreens() { // from class: au.com.woolworths.feature.product.list.analytics.ProductListScreens.PRODUCT_LIST
            @Override // au.com.woolworths.android.onesite.analytics.Screen
            /* renamed from: a */
            public final String getD() {
                return "Products";
        ...
        ProductListScreens productListScreens3 = new ProductListScreens() { // from class: au.com.woolworths.feature.product.list.analytics.ProductListScreens.PRODUCT_LIST_FROM_RECIPES
            @Override // au.com.woolworths.android.onesite.analytics.Screen
            /* renamed from: a */
            public final String getD() {
                return "Recipes";
        ...
        ProductListScreens productListScreens4 = new ProductListScreens() { // from class: au.com.woolworths.feature.product.list.analytics.ProductListScreens.PRODUCT_LIST_OPTIONS
            @Override // au.com.woolworths.android.onesite.analytics.Screen
            /* renamed from: a */
            public final String getD() {
                return "Products";
        ...
        ProductListScreens productListScreens5 = new ProductListScreens() { // from class: au.com.woolworths.feature.product.list.analytics.ProductListScreens.ZERO_RESULTS
            @Override // au.com.woolworths.android.onesite.analytics.Screen
            /* renamed from: a */
            public final String getD() {
                return "Products";
