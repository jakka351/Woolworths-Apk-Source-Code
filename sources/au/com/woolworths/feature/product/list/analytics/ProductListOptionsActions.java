...
@Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\b\u0086\u0081\u0002\u0018\u00002\u00020\u00012\b\u0012\u0004\u0012\u00020\u00000\u0002¨\u0006\u0003"}, d2 = {"Lau/com/woolworths/feature/product/list/analytics/ProductListOptionsActions;", "Lau/com/woolworths/android/onesite/analytics/Action;", "", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public abstract class ProductListOptionsActions implements Action {
    ...
    static {
        ProductListOptionsActions productListOptionsActions = new ProductListOptionsActions() { // from class: au.com.woolworths.feature.product.list.analytics.ProductListOptionsActions.CLOSE_FILTERS
        ...
        ProductListOptionsActions productListOptionsActions2 = new ProductListOptionsActions() { // from class: au.com.woolworths.feature.product.list.analytics.ProductListOptionsActions.FILTER_SCREEN_IMPRESSION
        ...
        ProductListOptionsActions productListOptionsActions3 = new ProductListOptionsActions() { // from class: au.com.woolworths.feature.product.list.analytics.ProductListOptionsActions.MARKETPLACE_SWITCH_CHECK_OFF
        ...
        ProductListOptionsActions productListOptionsActions4 = new ProductListOptionsActions() { // from class: au.com.woolworths.feature.product.list.analytics.ProductListOptionsActions.MARKETPLACE_SWITCH_CHECK_ON
        ...
        ProductListOptionsActions productListOptionsActions5 = new ProductListOptionsActions() { // from class: au.com.woolworths.feature.product.list.analytics.ProductListOptionsActions.MARKETPLACE_SWITCH_CTA_CLICK
            public final Category o = Category.m;
        ...
        ProductListOptionsActions productListOptionsActions6 = new ProductListOptionsActions() { // from class: au.com.woolworths.feature.product.list.analytics.ProductListOptionsActions.RESET_FILTER_CLICK
            public final Category o = Category.m;
        ...
        ProductListOptionsActions productListOptionsActions7 = new ProductListOptionsActions() { // from class: au.com.woolworths.feature.product.list.analytics.ProductListOptionsActions.SEE_RESULTS_CLICK
            public final Category o = Category.m;
        ...
        ProductListOptionsActions productListOptionsActions8 = new ProductListOptionsActions() { // from class: au.com.woolworths.feature.product.list.analytics.ProductListOptionsActions.UNABLE_TO_APPLY_FILTERS_ERROR
