...
@DebugMetadata(c = "au.com.woolworths.feature.product.list.ProductListOptionsViewModel$applyOptionsAndRefresh$1", f = "ProductListOptionsViewModel.kt", l = {915}, m = "invokeSuspend")
...
final class ProductListOptionsViewModel$applyOptionsAndRefresh$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            Activities.ProductList.ExtraProductListSource extraProductListSourceV6 = productListOptionsViewModel.v6();
            this.p = 1;
            obj = productListOptionsViewModel.t6(extraProductListSourceV6, this);
        ...
        if (!((Boolean) obj).booleanValue()) {
            productListOptionsViewModel.f.E(this.r);
        }
        return Unit.f24250a;
    }
}
