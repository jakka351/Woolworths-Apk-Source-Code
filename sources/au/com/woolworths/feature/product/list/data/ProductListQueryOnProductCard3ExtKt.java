...
@Metadata(d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u001a\n\u0010\u0000\u001a\u00020\u0001*\u00020\u0002¨\u0006\u0003"}, d2 = {"toUiModel", "Lau/com/woolworths/product/models/ProductCard;", "Lcom/woolworths/product/list/ProductListQuery$OnProductCard3;", "product-list_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes3.dex */
public final class ProductListQueryOnProductCard3ExtKt {
    @NotNull
    public static final ProductCard toUiModel(@NotNull ProductListQuery.OnProductCard3 onProductCard3) {
        List arrayList;
        List arrayList2;
        String str;
        List arrayList3;
        Intrinsics.h(onProductCard3, "<this>");
        String str2 = onProductCard3.getProductCard().f8949a;
        String str3 = onProductCard3.getProductCard().b;
        String str4 = onProductCard3.getProductCard().e;
        String str5 = onProductCard3.getProductCard().j;
        Integer num = onProductCard3.getProductCard().h;
        String str6 = onProductCard3.getProductCard().i;
        String str7 = onProductCard3.getProductCard().l;
        boolean z = onProductCard3.getProductCard().f;
        boolean z2 = onProductCard3.getProductCard().c;
        String str8 = onProductCard3.getProductCard().m;
        String str9 = onProductCard3.getProductCard().n;
        ProductCard.Trolley trolley = onProductCard3.getProductCard().p;
        ProductTrolleyData uiModel = trolley != null ? ProductCardKt.toUiModel(trolley) : null;
        List list = onProductCard3.getProductCard().q;
        if (list != null) {
            List list2 = list;
        ...
        ProductShoppingList uiModel2 = ProductCardListExtKt.toUiModel(onProductCard3.getProductCard().r);
        ProductCard.InStoreDetails inStoreDetails = onProductCard3.getProductCard().s;
        InstoreDetailsData uiModel3 = inStoreDetails != null ? ProductCardInStoreDetailsExtKt.toUiModel(inStoreDetails) : null;
        PurchaseRestriction purchaseRestriction = onProductCard3.getProductCard().d;
        ...
        List<ProductCard.InlineLabel> list5 = onProductCard3.getProductCard().o;
        if (list5 != null) {
        ...
        ProductCard.PromotionInfo promotionInfo = onProductCard3.getProductCard().k;
        PromotionInfo uiModel6 = promotionInfo != null ? ProductCardPromotionInfoExtKt.toUiModel(promotionInfo) : null;
        String str10 = onProductCard3.getProductCard().u;
        String str11 = onProductCard3.getProductCard().v;
        ProductCard.Marketplace marketplace = onProductCard3.getProductCard().w;
        ProductListMarketplace uiModel7 = marketplace != null ? ProductCardMarketplaceExtKt.toUiModel(marketplace) : null;
        ProductCard.RewardsOfferInfo rewardsOfferInfo = onProductCard3.getProductCard().x;
        RewardsOfferInfo uiModel8 = rewardsOfferInfo != null ? ProductCardRewardsOfferInfoExtKt.toUiModel(rewardsOfferInfo) : null;
        String str12 = onProductCard3.getProductCard().y;
        ProductCard.TagLabel tagLabel = onProductCard3.getProductCard().z;
        TagLabel uiModel9 = tagLabel != null ? ProductCardTagLabelExtKt.toUiModel(tagLabel) : null;
        ProductCard.InStoreAvailabilityInfo inStoreAvailabilityInfo = onProductCard3.getProductCard().g;
        ...
        ProductCard.ProductVarieties productVarieties = onProductCard3.getProductCard().A;
        ProductVarieties uiModel11 = productVarieties != null ? ProductCardProductVarietiesExtKt.toUiModel(productVarieties) : null;
        List list6 = onProductCard3.getProductCard().B;
        if (list6 != null) {
            List list7 = list6;
            str = str2;
