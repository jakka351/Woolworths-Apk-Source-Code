...
@Metadata(d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u001a\n\u0010\u0000\u001a\u00020\u0001*\u00020\u0002¨\u0006\u0003"}, d2 = {"toUiModel", "Lau/com/woolworths/product/models/ProductCard;", "Lau/com/woolworths/shop/lists/data/remote/SuggestedProductListQuery$Product;", "product-list_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes3.dex */
public final class SuggestedProductListQueryProductExtKt {
    @NotNull
    public static final ProductCard toUiModel(@NotNull SuggestedProductListQuery.Product product) {
        List arrayList;
        List arrayList2;
        String str;
        List arrayList3;
        Intrinsics.h(product, "<this>");
        String str2 = product.getProductCard().f8949a;
        String str3 = product.getProductCard().b;
        String str4 = product.getProductCard().e;
        String str5 = product.getProductCard().j;
        Integer num = product.getProductCard().h;
        String str6 = product.getProductCard().i;
        String str7 = product.getProductCard().l;
        boolean z = product.getProductCard().f;
        boolean z2 = product.getProductCard().c;
        String str8 = product.getProductCard().m;
        String str9 = product.getProductCard().n;
        ProductCard.Trolley trolley = product.getProductCard().p;
        ProductTrolleyData uiModel = trolley != null ? ProductCardKt.toUiModel(trolley) : null;
        List list = product.getProductCard().q;
        if (list != null) {
            List list2 = list;
        ...
        ProductShoppingList uiModel2 = ProductCardListExtKt.toUiModel(product.getProductCard().r);
        ...
        String str10 = product.getProductCard().u;
        String str11 = product.getProductCard().v;
        ...
        String str12 = product.getProductCard().y;
        ...
        List list6 = product.getProductCard().B;
        if (list6 != null) {
            List list7 = list6;
            str = str2;
        ...
        boolean z3 = product.getProductCard().C;
