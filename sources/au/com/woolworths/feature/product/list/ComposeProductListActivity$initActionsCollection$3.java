...
@DebugMetadata(c = "au.com.woolworths.feature.product.list.ComposeProductListActivity$initActionsCollection$3", f = "ComposeProductListActivity.kt", l = {370}, m = "invokeSuspend")
...
final class ComposeProductListActivity$initActionsCollection$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* renamed from: au.com.woolworths.feature.product.list.ComposeProductListActivity$initActionsCollection$3$1, reason: invalid class name */
    final /* synthetic */ class AnonymousClass1 extends AdaptedFunctionReference implements Function2<ProductListOptionsContract.Actions, Continuation<? super Unit>, Object>, SuspendFunction {
        ...
        public final Object invoke(Object obj, Object obj2) {
            ...
            if (actions instanceof ProductListOptionsContract.Actions.LaunchFilterOptions) {
                String filterId = ((ProductListOptionsContract.Actions.LaunchFilterOptions) actions).f5253a;
                ...
                bundle.putParcelable("EXTRA_PRODUCT_LIST_OPTIONS_FILTER", new ProductListOptionsFilterFragment.Companion.Extras(filterId));
                productListOptionsFilterFragment.setArguments(bundle);
                fragmentTransactionE.j(com.woolworths.R.id.fragment_container, productListOptionsFilterFragment, null);
                ...
                composeProductListActivity.S4().I6(((ProductListOptionsContract.Actions.SeeResults) actions).f5255a, true);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1 flowKt__TransformKt$onEach$$inlined$unsafeTransform$1 = new FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1(new AnonymousClass1(2, composeProductListActivity, ComposeProductListActivity.class, "handleProductListOptionsActions", "handleProductListOptionsActions(Lau/com/woolworths/feature/product/list/ProductListOptionsContract$Actions;)V", 4), FlowExtKt.a(((ProductListOptionsViewModel) composeProductListActivity.C.getD()).n, composeProductListActivity.getD(), Lifecycle.State.h));
            this.p = 1;
