...
abstract class Hilt_ProductListActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    ...
    public Hilt_ProductListActivity() {
        ...
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.product.list.v2.Hilt_ProductListActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                ProductListActivity productListActivity2 = productListActivity;
                if (productListActivity2.w) {
                    return;
                }
                productListActivity2.w = true;
                ((ProductListActivity_GeneratedInjector) productListActivity2.t3()).a0(productListActivity2);
            }
        });
    }
