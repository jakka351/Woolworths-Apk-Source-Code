...
public abstract class FragmentProductMainFilterBinding extends ViewDataBinding {
    ...
    public FragmentProductMainFilterBinding(DataBindingComponent dataBindingComponent, View view, FrameLayout frameLayout, EpoxyRecyclerView epoxyRecyclerView, FrameLayout frameLayout2, StatefulButton statefulButton, Toolbar toolbar) {
