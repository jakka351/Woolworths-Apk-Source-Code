...
public class EpoxyItemFilterHighlightCardBindingImpl extends EpoxyItemFilterHighlightCardBinding implements OnClickListener.Listener {
    ...
    public EpoxyItemFilterHighlightCardBindingImpl(DataBindingComponent dataBindingComponent, View view) {
    ...
    public final void j() {
        ...
        if ((j & 2) != 0) {
            ...
            TextViewBindingsKt.c(this.z, FilterHighlightCard.TITLE, false);
        }
    }
