...
public class FragmentProductListOptionsFilterBindingImpl extends FragmentProductListOptionsFilterBinding implements OnClickListener.Listener, StatefulButtonClickHandler.Listener {
    ...
    public FragmentProductListOptionsFilterBindingImpl(DataBindingComponent dataBindingComponent, View view) {
    ...
    @Override // au.com.woolworths.feature.product.list.databinding.FragmentProductListOptionsFilterBinding
    ...
    public final void a(int i) {
        ...
        if (i != 1) {
            if (i == 2 && (productListOptionsViewModel = this.F) != null) {
                productListOptionsViewModel.F6();
                return;
            }
            return;
        }
        ...
        if (productListOptionsViewModel2 != null) {
            productListOptionsViewModel2.C6();
        }
    }
    ...
    public final void b(int i) {
        ...
        if (productListOptionsViewModel != null) {
            productListOptionsViewModel.E6(SeeResultsClickSource.f);
        }
    }
