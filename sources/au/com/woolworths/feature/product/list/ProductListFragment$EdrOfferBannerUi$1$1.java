...
final /* synthetic */ class ProductListFragment$EdrOfferBannerUi$1$1 extends FunctionReferenceImpl implements Function1<EdrOfferBannerData, Unit> {
    ...
    public final Object invoke(Object obj) {
        ...
        if (actionData != null) {
            if (ProductListViewModel.WhenMappings.b[actionData.getType().ordinal()] == 1) {
                productListViewModel.y.f(new ProductListContract.Actions.LaunchDeeplink(actionData.getAction(), analyticsData != null ? analyticsData.getExtraContent() : null));
                AnalyticsData analytics = actionData.getAnalytics();
                if (analytics != null) {
                    productListViewModel.h.g(AnalyticsDataKt.a(AnalyticsDataKt.c(AnalyticsDataKt.c(analytics, p0.j, false), analyticsData, false)));
                }
            }
        }
        return Unit.f24250a;
