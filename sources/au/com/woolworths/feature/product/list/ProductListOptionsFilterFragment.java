...
import au.com.woolworths.feature.product.list.databinding.FragmentProductListOptionsFilterBinding;
...
@StabilityInferred
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0001\u0018\u00002\u00020\u0001:\u0001\u0004B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0005"}, d2 = {"Lau/com/woolworths/feature/product/list/ProductListOptionsFilterFragment;", "Landroidx/fragment/app/Fragment;", "<init>", "()V", "Companion", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
@AndroidEntryPoint
@SourceDebugExtension
/* loaded from: classes3.dex */
public final class ProductListOptionsFilterFragment extends Hilt_ProductListOptionsFilterFragment {
    public FragmentProductListOptionsFilterBinding i;
    public final ViewModelLazy j = new ViewModelLazy(Reflection.f24268a.b(ProductListOptionsViewModel.class), new Function0<ViewModelStore>() { // from class: au.com.woolworths.feature.product.list.ProductListOptionsFilterFragment$special$$inlined$activityViewModels$default$1
        {
            super(0);
        }
    ...
    }, new Function0<ViewModelProvider.Factory>() { // from class: au.com.woolworths.feature.product.list.ProductListOptionsFilterFragment$special$$inlined$activityViewModels$default$3
        {
            super(0);
        }
    ...
    }, new Function0<CreationExtras>() { // from class: au.com.woolworths.feature.product.list.ProductListOptionsFilterFragment$special$$inlined$activityViewModels$default$2
        {
            super(0);
        }
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001:\u0001\u0005R\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004¨\u0006\u0006"}, d2 = {"Lau/com/woolworths/feature/product/list/ProductListOptionsFilterFragment$Companion;", "", "", "EXTRA_PRODUCT_LIST_OPTIONS_FILTER", "Ljava/lang/String;", "Extras", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {

        @StabilityInferred
        @Parcelize
        @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/feature/product/list/ProductListOptionsFilterFragment$Companion$Extras;", "Landroid/os/Parcelable;", "product-list_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    @DebugMetadata(c = "au.com.woolworths.feature.product.list.ProductListOptionsFilterFragment$onViewCreated$1", f = "ProductListOptionsFilterFragment.kt", l = {122}, m = "invokeSuspend")
    /* renamed from: au.com.woolworths.feature.product.list.ProductListOptionsFilterFragment$onViewCreated$1, reason: invalid class name */
    final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        public int p;

        @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
        /* renamed from: au.com.woolworths.feature.product.list.ProductListOptionsFilterFragment$onViewCreated$1$1, reason: invalid class name and collision with other inner class name */
        final /* synthetic */ class C01021 extends AdaptedFunctionReference implements Function2<ProductListOptionsContract.FilterOptionsActions, Continuation<? super Unit>, Object>, SuspendFunction {
            ...
            public final Object invoke(Object obj, Object obj2) {
                ...
                ContextExtKt.e(contextRequireContext, ((ProductListOptionsContract.FilterOptionsActions.OpenUrl) filterOptionsActions).f5257a);
                return Unit.f24250a;
            }
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1 flowKt__TransformKt$onEach$$inlined$unsafeTransform$1 = new FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1(new C01021(2, productListOptionsFilterFragment, ProductListOptionsFilterFragment.class, "handleFilterActions", "handleFilterActions(Lau/com/woolworths/feature/product/list/ProductListOptionsContract$FilterOptionsActions;)V", 4), FlowExtKt.a(productListOptionsFilterFragment.I1().l, productListOptionsFilterFragment.getViewLifecycleOwner().getD(), Lifecycle.State.h));
                this.p = 1;
    ...
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "au.com.woolworths.feature.product.list.ProductListOptionsFilterFragment$onViewCreated$2", f = "ProductListOptionsFilterFragment.kt", l = {129}, m = "invokeSuspend")
    /* renamed from: au.com.woolworths.feature.product.list.ProductListOptionsFilterFragment$onViewCreated$2, reason: invalid class name */
    final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        public int p;

        @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
        /* renamed from: au.com.woolworths.feature.product.list.ProductListOptionsFilterFragment$onViewCreated$2$1, reason: invalid class name */
        final /* synthetic */ class AnonymousClass1 extends AdaptedFunctionReference implements Function2<ProductListOptionsContract.Actions, Continuation<? super Unit>, Object>, SuspendFunction {
            ...
            public final Object invoke(Object obj, Object obj2) {
                ...
                if (actions instanceof ProductListOptionsContract.Actions.ShowMessage) {
                    ...
                    FragmentProductListOptionsFilterBinding fragmentProductListOptionsFilterBinding = productListOptionsFilterFragment.i;
                    if (fragmentProductListOptionsFilterBinding == null) {
                        Intrinsics.p("fragmentBinding");
                        throw null;
                    }
                    snackbarJ.f(fragmentProductListOptionsFilterBinding.y);
                    snackbarJ.l();
                } else {
                    productListOptionsFilterFragment.getClass();
                }
    ...
    public final View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (featureToggleManager.c(BaseShopAppFeature.o0)) {
            ...
            composeView.setContent(new ComposableLambdaImpl(new Function2<Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.product.list.ProductListOptionsFilterFragment$onCreateView$1$1
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    ...
                    if ((((Number) obj2).intValue() & 3) == 2 && composer.c()) {
                        ...
                        ThemeKt.b(6, composer, ComposableLambdaKt.c(-1361179551, new Function2<Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.product.list.ProductListOptionsFilterFragment$onCreateView$1$1.1
                            @Override // kotlin.jvm.functions.Function2
                            public final Object invoke(Object obj3, Object obj4) {
                                ...
                                if ((((Number) obj4).intValue() & 3) == 2 && composer2.c()) {
                                    ...
                                    if (zI || objG == Composer.Companion.f1624a) {
                                        objG = new i(productListOptionsFilterFragment2, 2);
                                        composer2.A(objG);
                                    }
                                    composer2.l();
        ...
        int i = FragmentProductListOptionsFilterBinding.G;
        androidx.databinding.DataBinderMapperImpl dataBinderMapperImpl = DataBindingUtil.f2545a;
        FragmentProductListOptionsFilterBinding fragmentProductListOptionsFilterBinding = (FragmentProductListOptionsFilterBinding) ViewDataBinding.q(inflater, com.woolworths.R.layout.fragment_product_list_options_filter, null, false, null);
        this.i = fragmentProductListOptionsFilterBinding;
        if (fragmentProductListOptionsFilterBinding == null) {
            Intrinsics.p("fragmentBinding");
            throw null;
        }
        fragmentProductListOptionsFilterBinding.D(this);
        FragmentProductListOptionsFilterBinding fragmentProductListOptionsFilterBinding2 = this.i;
        if (fragmentProductListOptionsFilterBinding2 == null) {
            Intrinsics.p("fragmentBinding");
            throw null;
        }
        View view = fragmentProductListOptionsFilterBinding2.h;
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        FragmentProductListOptionsFilterBinding fragmentProductListOptionsFilterBinding = this.i;
        if (fragmentProductListOptionsFilterBinding == null) {
            Intrinsics.p("fragmentBinding");
            throw null;
        }
        fragmentProductListOptionsFilterBinding.L(I1());
        ...
        fragmentProductListOptionsFilterBinding2.B.setController(productListOptionsFilterController);
        FragmentProductListOptionsFilterBinding fragmentProductListOptionsFilterBinding3 = this.i;
        if (fragmentProductListOptionsFilterBinding3 == null) {
            Intrinsics.p("fragmentBinding");
            throw null;
        }
        fragmentProductListOptionsFilterBinding3.E.setNavigationOnClickListener(new z(this, 0));
