...
final class ProductListSkeletonUiKt$ProductListSkeletonUiDisplayGrid$1$1$1 implements Function4<LazyGridItemScope, Integer, Composer, Integer, Unit> {
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3, Object obj4) {
        ...
        if ((iIntValue2 & 145) == 144 && composer.c()) {
            ...
            float f3 = 10;
            float f4 = 2;
            BoxKt.a(BackgroundKt.b(ClipKt.a(SizeKt.g(SizeKt.e(PaddingKt.j(companion, f2, f, f2, BitmapDescriptorFactory.HUE_RED, 8), 1.0f), f3), RoundedCornerShapeKt.b(f4)), CoreTheme.b(composer).e.f4848a.d, rectangleShapeKt$RectangleShape$1), composer, 0);
            float f5 = 36;
            BoxKt.a(BackgroundKt.b(ClipKt.a(SizeKt.g(SizeKt.e(PaddingKt.j(companion, f5, f, f5, BitmapDescriptorFactory.HUE_RED, 8), 1.0f), f3), RoundedCornerShapeKt.b(f4)), CoreTheme.b(composer).e.f4848a.d, rectangleShapeKt$RectangleShape$1), composer, 0);
            BoxKt.a(BackgroundKt.b(ClipKt.a(SizeKt.r(PaddingKt.j(companion, BitmapDescriptorFactory.HUE_RED, 12, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 13), 70, f5), RoundedCornerShapeKt.b(f4)), CoreTheme.b(composer).e.f4848a.d, rectangleShapeKt$RectangleShape$1), composer, 0);
            float f6 = 8;
            BoxKt.a(BackgroundKt.b(ClipKt.a(SizeKt.g(SizeKt.e(PaddingKt.i(companion, f6, 50, f6, 20), 1.0f), f5), RoundedCornerShapeKt.b(4)), CoreTheme.b(composer).e.f4848a.d, rectangleShapeKt$RectangleShape$1), composer, 0);
            composer.o(1326482141);
            if (iIntValue != 6) {
                DividerKt.a(BitmapDescriptorFactory.HUE_RED, 0, 5, CoreTheme.b(composer).e.b.e, composer, null);
            }
            composer.l();
            composer.f();
            composer.o(1305111474);
            if ((iIntValue + 1) % 2 != 0) {
