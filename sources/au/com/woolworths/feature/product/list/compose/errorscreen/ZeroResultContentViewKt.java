...
import au.com.woolworths.feature.product.list.data.ZeroResultProductCategories;
...
public final class ZeroResultContentViewKt {
    public static final void a(int i, Composer composer, Function1 onBannerClick) {
        ...
        ComposerImpl composerImplV = composer.v(-1848289828);
        ...
        if ((i2 & 3) == 2 && composerImplV.c()) {
            ...
            if (zN || objG == Composer.Companion.f1624a) {
                objG = new b(onBannerClick, strC, 0);
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new c(i, 0, onBannerClick);
        }
    }
    ...
    public static final void b(final ZeroResultPageData data, final boolean z, final ProductClickListener productClickListener, final Function1 onBrowseAllAislesClick, final Function1 onProductCategoryTileClick, Function0 onZeroResultVisible, final Function1 onZeroResultHorizontalListVisible, boolean z2, final Function1 onChatEntryBannerClicked, Modifier modifier, Composer composer, int i, int i2) {
        ...
        ComposerImpl composerImplV = composer.v(419441780);
        if ((i & 6) == 0) {
        ...
        if ((i3 & 306783379) == 306783378 && composerImplV.c()) {
            ...
            if (z5 || objG == composer$Companion$Empty$1) {
                objG = new j(1, onZeroResultVisible);
                composerImplV.A(objG);
            }
            composerImplV.V(false);
            ...
            if (zI || objG2 == composer$Companion$Empty$1) {
                final boolean z6 = z3;
                modifier2 = modifier4;
                Function1 function1 = new Function1() { // from class: au.com.woolworths.feature.product.list.compose.errorscreen.d
                    ...
                    public final Object invoke(Object obj) {
                        ...
                        final String title = zeroResultPageData.getTitle();
                        if (title != null) {
                            LazyVerticalGrid.f(new c0(13), new ComposableLambdaImpl(new Function3<LazyGridItemScope, Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.product.list.compose.errorscreen.ZeroResultContentViewKt$ZeroResultContentView$2$1$1$2
                                ...
                                public final Object invoke(Object obj2, Object obj3, Object obj4) {
                                    ...
                                    if ((iIntValue & 17) == 16 && composer2.c()) {
                                        ...
                                        try {
                                            builder.e(str);
                                            builder.i(iL);
                                            String searchTerm = zeroResultPageData.getSearchTerm();
                                            if (searchTerm != null) {
                        ...
                        final String message = zeroResultPageData.getMessage();
                        final boolean z9 = z6;
                        if (message != null) {
                            LazyVerticalGrid.f(new c0(14), new ComposableLambdaImpl(new Function3<LazyGridItemScope, Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.product.list.compose.errorscreen.ZeroResultContentViewKt$ZeroResultContentView$2$1$2$2
                                @Override // kotlin.jvm.functions.Function3
                                public final Object invoke(Object obj2, Object obj3, Object obj4) {
                                    LazyGridItemScope item = (LazyGridItemScope) obj2;
                                    Composer composer2 = (Composer) obj3;
                                    ...
                                    if ((iIntValue & 17) == 16 && composer2.c()) {
                                        ...
                                        float f = 16;
                                        TextKt.a(message, CoreTheme.f(composer2).f5120a.f5121a.f5122a, PaddingKt.j(PaddingKt.h(BackgroundKt.b(Modifier.Companion.d, CoreTheme.b(composer2).e.f4848a.c, RectangleShapeKt.f1779a), f, BitmapDescriptorFactory.HUE_RED, 2), BitmapDescriptorFactory.HUE_RED, f, BitmapDescriptorFactory.HUE_RED, (z7 && z9) ? f : 24, 5), CoreTheme.b(composer2).e.d.b, null, 0, 0, false, 0, null, composer2, 0, 1008);
                                    }
                                    return Unit.f24250a;
                                }
                            }, true, 1772488361));
                        }
                        List<Object> items2 = zeroResultPageData.getItems();
                        ...
                        if ((z7 || z8) && z9) {
                            ...
                            LazyVerticalGrid.f(c0Var, new ComposableLambdaImpl(new Function3<LazyGridItemScope, Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.product.list.compose.errorscreen.ZeroResultContentViewKt$ZeroResultContentView$2$1$4
                                @Override // kotlin.jvm.functions.Function3
                                public final Object invoke(Object obj2, Object obj3, Object obj4) {
                                    LazyGridItemScope item = (LazyGridItemScope) obj2;
                                    Composer composer2 = (Composer) obj3;
                        ...
                        final int i5 = 0;
                        for (Object obj2 : zeroResultPageData.getItems()) {
                            int i6 = i5 + 1;
                            if (i5 < 0) {
                                CollectionsKt.z0();
                                throw null;
                            ...
                            if (obj2 instanceof ZeroResultProductCategories) {
                                ...
                                final String zeroResultProductCategoriesTitle = zeroResultProductCategories.getZeroResultProductCategoriesTitle();
                                if (zeroResultProductCategoriesTitle != null) {
                                    LazyVerticalGrid.f(new c0(16), new ComposableLambdaImpl(new Function3<LazyGridItemScope, Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.product.list.compose.errorscreen.ZeroResultContentViewKt$ZeroResultContentView$2$1$5$1$2
                                        @Override // kotlin.jvm.functions.Function3
                                        public final Object invoke(Object obj3, Object obj4, Object obj5) {
                                            ...
                                            if ((iIntValue & 17) == 16 && composer2.c()) {
                                                ...
                                                TextKt.a(zeroResultProductCategoriesTitle, CoreTheme.f(composer2).d.c.b, PaddingKt.h(PaddingKt.j(BackgroundKt.b(SizeKt.e(Modifier.Companion.d, 1.0f), CoreTheme.b(composer2).e.f4848a.c, RectangleShapeKt.f1779a), BitmapDescriptorFactory.HUE_RED, 8, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 13), 16, BitmapDescriptorFactory.HUE_RED, 2), CoreTheme.b(composer2).e.d.d, null, 0, 0, false, 0, null, composer2, 0, 1008);
                                            }
                                            return Unit.f24250a;
                                        }
                                    }, true, 523549833));
                                }
                                int size = zeroResultProductCategories.getZeroResultProductCategoriesItems().size();
                                final Function1 function13 = onProductCategoryTileClick;
                                LazyGridScope.h(LazyVerticalGrid, size, null, null, null, new ComposableLambdaImpl(new Function4<LazyGridItemScope, Integer, Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.product.list.compose.errorscreen.ZeroResultContentViewKt$ZeroResultContentView$2$1$5$2
                                    @Override // kotlin.jvm.functions.Function4
                                    public final Object invoke(Object obj3, Object obj4, Object obj5, Object obj6) {
                                        LazyGridItemScope items3 = (LazyGridItemScope) obj3;
                                        int iIntValue = ((Number) obj4).intValue();
                                        Composer composer2 = (Composer) obj5;
                                        int iIntValue2 = ((Number) obj6).intValue();
                                        Intrinsics.h(items3, "$this$items");
                                        if ((iIntValue2 & 48) == 0) {
                                        ...
                                        if ((iIntValue2 & 145) == 144 && composer2.c()) {
                                            ...
                                            ProductCategoryTileData productCategoryTileData = zeroResultProductCategories.getZeroResultProductCategoriesItems().get(iIntValue);
                                            int i7 = iIntValue % 2;
                                            ...
                                            if (zN || objG3 == Composer.Companion.f1624a) {
                                                objG3 = new au.com.woolworths.design.wx.component.searchbar.a(3, function14);
                                                composer2.A(objG3);
                                            }
                                            composer2.l();
                                ...
                                LazyVerticalGrid.f(c0Var2, new ComposableLambdaImpl(new Function3<LazyGridItemScope, Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.product.list.compose.errorscreen.ZeroResultContentViewKt$ZeroResultContentView$2$1$5$4
                                    @Override // kotlin.jvm.functions.Function3
                                    public final Object invoke(Object obj3, Object obj4, Object obj5) {
                                        LazyGridItemScope item = (LazyGridItemScope) obj3;
                                        Composer composer2 = (Composer) obj4;
                                        ...
                                        if ((iIntValue & 17) == 16 && composer2.c()) {
                                            ...
                                            Object objG3 = composer2.G();
                                            if (zN || objG3 == Composer.Companion.f1624a) {
                                                objG3 = new f(function15, context, 0);
                                                composer2.A(objG3);
                                            }
                                            composer2.l();
                                ...
                                LazyVerticalGrid.f(c0Var3, new ComposableLambdaImpl(new Function3<LazyGridItemScope, Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.product.list.compose.errorscreen.ZeroResultContentViewKt$ZeroResultContentView$2$1$5$6
                                    @Override // kotlin.jvm.functions.Function3
                                    public final Object invoke(Object obj3, Object obj4, Object obj5) {
                                        LazyGridItemScope item = (LazyGridItemScope) obj3;
                                        Composer composer2 = (Composer) obj4;
                                        ...
                                        if (zI2 || objG3 == Composer.Companion.f1624a) {
                                            objG3 = new g(function16, horizontalListData2, 0);
                                            composer2.A(objG3);
                                        }
                                        composer2.l();
                                        EffectsKt.c(unit, (Function1) objG3, composer2);
                                        HorizontalListKt.a(i5, horizontalListData2, z10, EmptyList.d, null, null, null, null, null, productClickListener2, lazyListState, modifier5, false, null, false, null, null, composer2, 115043392 | (ProductId.$stable << 9), 126976);
                                        return unit;
                                    }
                                }, true, 930027658));
                            }
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new e(data, z, productClickListener, onBrowseAllAislesClick, onProductCategoryTileClick, onZeroResultVisible, onZeroResultHorizontalListVisible, z2, onChatEntryBannerClicked, modifier2, i, i2, 0);
        }
    }
}
