...
public final class DisplayModeItemKt {
    public static final void a(final ProductsDisplayMode item, boolean z, Function1 onDisplayModeClicked, Composer composer, int i) {
        ...
        ComposerImpl composerImplV = composer.v(787561106);
        if ((i & 6) == 0) {
        ...
        if ((i2 & 147) == 146 && composerImplV.c()) {
            ...
            if (z3 || objG == Composer.Companion.f1624a) {
                objG = new androidx.navigation.compose.a(8, onDisplayModeClicked, item);
                composerImplV.A(objG);
            }
            composerImplV.V(false);
            composerImpl = composerImplV;
            FilterChipKt.a(true, z2, (Function0) objG, modifierA, null, 0L, 0L, null, null, null, ComposableLambdaKt.c(-1306723695, new Function3<RowScope, Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.product.list.compose.filter.DisplayModeItemKt$DisplayModeItem$2
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new b(item, z, onDisplayModeClicked, i, 0);
        }
    }
}
