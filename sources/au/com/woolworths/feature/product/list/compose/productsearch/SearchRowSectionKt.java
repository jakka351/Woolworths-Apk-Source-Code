...
public final class SearchRowSectionKt {
    public static final void a(Modifier modifier, Composer composer, int i) {
        Modifier modifier2;
        ComposerImpl composerImplV = composer.v(569348506);
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new au.com.woolworths.compose.utils.layout.a(i, 1, modifier2);
        }
    }
    ...
    */
    ...
    public static final void c(int i, Composer composer, Modifier modifier, String str) {
        ...
        if ((i2 & 19) == 18 && composerImplV.c()) {
            ...
            if (z || objG == Composer.Companion.f1624a) {
                objG = new androidx.navigation.fragment.d(str, 8);
        ...
        RecomposeScopeImpl recomposeScopeImplX = composerImplV.X();
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new au.com.woolworths.design.core.ui.component.experimental.badge.a(str, modifier2, i, 3);
        }
    }
    ...
    public static final void d(Function0 onScanBarcodeClicked, Function0 onBuyAgainClicked, Function0 onOliveClicked, Function1 shouldDisplaySearchTile, Modifier modifier, Composer composer, int i) {
        ...
        ComposerImpl composerImplV = composer.v(-130220605);
        if (((i | 24576) & 9363) == 9362 && composerImplV.c()) {
            composerImplV.j();
            modifier2 = modifier;
        } else {
            ...
            composerImplV.o(-1557543976);
            if (((Boolean) shouldDisplaySearchTile.invoke(SearchTile.f)).booleanValue()) {
                b(onScanBarcodeClicked, StringResources_androidKt.c(composerImplV, R.string.olive_voice_scan_barcode_tile_title), "scan a barcode", ComposableSingletons$SearchRowSectionKt.f5271a, ComposableSingletons$SearchRowSectionKt.b, false, composerImplV, 224646, 64);
            }
            composerImplV.V(false);
            composerImplV.o(-1557516570);
            if (((Boolean) shouldDisplaySearchTile.invoke(SearchTile.g)).booleanValue()) {
                b(onBuyAgainClicked, StringResources_androidKt.c(composerImplV, R.string.buy_again_entry_point_title), "buy again", ComposableSingletons$SearchRowSectionKt.c, ComposableSingletons$SearchRowSectionKt.d, false, composerImplV, 224646, 64);
            }
            composerImplV.V(false);
            composerImplV.o(-1557489347);
            if (((Boolean) shouldDisplaySearchTile.invoke(SearchTile.h)).booleanValue()) {
                b(onOliveClicked, StringResources_androidKt.c(composerImplV, R.string.ask_olive_entry_point_title), "ask olive", ComposableSingletons$SearchRowSectionKt.e, ComposableSingletons$SearchRowSectionKt.f, true, composerImplV, 1797510, 0);
            }
            composerImplV.V(false);
        ...
        RecomposeScopeImpl recomposeScopeImplX = composerImplV.X();
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new g(onScanBarcodeClicked, onBuyAgainClicked, onOliveClicked, shouldDisplaySearchTile, modifier2, i, 1);
        }
    }
}
