...
import au.com.woolworths.feature.product.list.compose.filter.FilterTextWithCountKt;
...
public final class ProductListOptionsChildFilterKt {
    public static final void a(FilterMenuItem filterMenuItem, Function1 onFilterOptionClicked, Function2 onFilterCheckboxStateChanged, Composer composer, int i) {
        ...
        ComposerImpl composerImplV = composer.v(383844905);
        ...
        if ((i2 & 147) == 146 && composerImplV.c()) {
            ...
            if (zI || objG == composer$Companion$Empty$1) {
                objG = new f(9, (Object) filterMenuItem, onFilterOptionClicked);
            ...
            if (zI2 || objG2 == composer$Companion$Empty$1) {
                objG2 = new androidx.navigation.compose.a(11, onFilterCheckboxStateChanged, filterMenuItem);
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new c(i, 20, filterMenuItem, onFilterCheckboxStateChanged, onFilterOptionClicked);
        }
    }
}
