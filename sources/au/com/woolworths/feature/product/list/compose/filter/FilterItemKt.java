...
public final class FilterItemKt {
    public static final void a(ProductListOptionsItem.FilterOptionItem filterOptionItem, Function1 onFilterItemClicked, Composer composer, int i) {
        ...
        ComposerImpl composerImplV = composer.v(768777705);
        ...
        if ((i2 & 19) == 18 && composerImplV.c()) {
            ...
            if (z || objG == Composer.Companion.f1624a) {
                objG = new androidx.navigation.compose.a(9, onFilterItemClicked, filterOptionItem);
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new au.com.woolworths.design.core.ui.component.stable.snackbar.b(filterOptionItem, i, 6, onFilterItemClicked);
        }
    }
}
