    ...
    public final Object invoke(Object obj) {
        ...
        switch (i) {
            case 0:
                ...
                Flow productListViewStateFlow = FlowLiveDataConversions.a(composeProductListActivity.S4().C);
                Flow productListActionsFlow = composeProductListActivity.S4().z;
                ...
                composeProductListActivityViewModelQ4.h = BuildersKt.c(ViewModelKt.a(composeProductListActivityViewModelQ4), null, null, new ComposeProductListActivityViewModel$startSuccessSearchResultCollection$1(2, null), 3);
            ...
            case 1:
                ...
                if (!((ComposeProductListActivityContract.ViewState) composeProductListActivity.Q4().k.getValue()).e) {
                    composeProductListActivity.Q4().l.f(ComposeProductListActivityContract.Action.NavigateUp.f5206a);
                    break;
                } else {
                    composeProductListActivity.Q4();
            ...
            case 2:
                ...
                ((OliveVoiceViewModel) composeProductListActivity.D.getD()).r6(it);
                break;
            default:
                ...
                composeProductListActivity.S4().G6(extras);
