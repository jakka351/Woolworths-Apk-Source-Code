...
@DebugMetadata(c = "au.com.woolworths.feature.product.list.ComposeProductListActivity$initActionsCollection$1", f = "ComposeProductListActivity.kt", l = {356}, m = "invokeSuspend")
...
final class ComposeProductListActivity$initActionsCollection$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* renamed from: au.com.woolworths.feature.product.list.ComposeProductListActivity$initActionsCollection$1$1, reason: invalid class name */
    final /* synthetic */ class AnonymousClass1 extends AdaptedFunctionReference implements Function2<ComposeProductListActivityContract.Action, Continuation<? super Unit>, Object>, SuspendFunction {
        ...
        public final Object invoke(Object obj, Object obj2) {
            ...
            if (Intrinsics.c(action, ComposeProductListActivityContract.Action.NavigateUp.f5206a)) {
                composeProductListActivity.finish();
            } else {
                if (!Intrinsics.c(action, ComposeProductListActivityContract.Action.LaunchSearch.f5205a)) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1 flowKt__TransformKt$onEach$$inlined$unsafeTransform$1 = new FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1(new AnonymousClass1(2, composeProductListActivity, ComposeProductListActivity.class, "handleActivityActions", "handleActivityActions(Lau/com/woolworths/feature/product/list/ComposeProductListActivityContract$Action;)V", 4), FlowExtKt.a(composeProductListActivity.Q4().m, composeProductListActivity.getD(), Lifecycle.State.h));
            this.p = 1;
