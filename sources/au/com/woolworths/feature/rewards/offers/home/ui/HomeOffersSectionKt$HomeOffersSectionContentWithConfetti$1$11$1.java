...
final /* synthetic */ class HomeOffersSectionKt$HomeOffersSectionContentWithConfetti$1$11$1 extends FunctionReferenceImpl implements Function1<Boolean, Unit> {
    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Object obj) {
        boolean zBooleanValue = ((Boolean) obj).booleanValue();
        RewardsOffersHomeViewModel rewardsOffersHomeViewModel = (RewardsOffersHomeViewModel) this.receiver;
        if (!rewardsOffersHomeViewModel.x && zBooleanValue) {
            rewardsOffersHomeViewModel.x = true;
            rewardsOffersHomeViewModel.p.c(RewardsPointsActionData.k);
        }
        return Unit.f24250a;
    }
}
