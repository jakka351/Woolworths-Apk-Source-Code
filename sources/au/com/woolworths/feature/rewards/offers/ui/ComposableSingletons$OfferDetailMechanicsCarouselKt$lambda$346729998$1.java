...
public final class ComposableSingletons$OfferDetailMechanicsCarouselKt$lambda$346729998$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((((Number) obj2).intValue() & 3) == 2 && composer.c()) {
            ...
            OfferDetailMechanicsCarouselKt.a(new RewardsOfferMechanics("2023-01-01T00:00:00Z", RewardsOfferMechanicsSeparatorIcon.ARROW, 0, CollectionsKt.R(new RewardsOfferMechanicItem(RewardsCalendarIcon.CALENDAR_1_DISABLED, "Special Offer Day", "Special offer available today!", "Offer Day"), new RewardsOfferMechanicItem(RewardsCalendarIcon.CALENDAR_2_DISABLED, "Double Points", "Earn double points on purchases!", "Double Points"))), null, composer, 0);
        }
        return Unit.f24250a;
    }
}
