...
@StabilityInferred
@Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b7\u0018\u00002\u00020\u0001:\u0002\u0002\u0003\u0082\u0001\u0002\u0004\u0005¨\u0006\u0006"}, d2 = {"Lau/com/woolworths/feature/rewards/everydayextras/signup/data/onboarding/EverydayExtrasSubscribeFooterItem;", "Landroid/os/Parcelable;", "Button", "SubscribeContentCta", "Lau/com/woolworths/feature/rewards/everydayextras/signup/data/onboarding/EverydayExtrasSubscribeFooterItem$Button;", "Lau/com/woolworths/feature/rewards/everydayextras/signup/data/onboarding/EverydayExtrasSubscribeFooterItem$SubscribeContentCta;", "everyday-extras-sign-up_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes3.dex */
public abstract class EverydayExtrasSubscribeFooterItem implements Parcelable {

    @StabilityInferred
    @Parcelize
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u00012\u00020\u00022\u00020\u0003¨\u0006\u0004"}, d2 = {"Lau/com/woolworths/feature/rewards/everydayextras/signup/data/onboarding/EverydayExtrasSubscribeFooterItem$Button;", "Lau/com/woolworths/feature/rewards/everydayextras/signup/data/onboarding/EverydayExtrasSubscribeFooterItem;", "Lau/com/woolworths/feature/rewards/everydayextras/signup/data/shared/EverydayExtrasButtonInterface;", "Landroid/os/Parcelable;", "everyday-extras-sign-up_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Button extends EverydayExtrasSubscribeFooterItem implements EverydayExtrasButtonInterface, Parcelable {
    ...
    @StabilityInferred
    @Parcelize
    @Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u00012\u00020\u0002¨\u0006\u0003"}, d2 = {"Lau/com/woolworths/feature/rewards/everydayextras/signup/data/onboarding/EverydayExtrasSubscribeFooterItem$SubscribeContentCta;", "Lau/com/woolworths/feature/rewards/everydayextras/signup/data/onboarding/EverydayExtrasSubscribeFooterItem;", "Landroid/os/Parcelable;", "everyday-extras-sign-up_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class SubscribeContentCta extends EverydayExtrasSubscribeFooterItem implements Parcelable {

        @NotNull
        public static final Parcelable.Creator<SubscribeContentCta> CREATOR = new Creator();
        public final ContentCta d;

        @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
        public static final class Creator implements Parcelable.Creator<SubscribeContentCta> {
            @Override // android.os.Parcelable.Creator
            public final SubscribeContentCta createFromParcel(Parcel parcel) {
                Intrinsics.h(parcel, "parcel");
                return new SubscribeContentCta((ContentCta) parcel.readParcelable(SubscribeContentCta.class.getClassLoader()));
            }

            @Override // android.os.Parcelable.Creator
            public final SubscribeContentCta[] newArray(int i) {
                return new SubscribeContentCta[i];
            }
        }

        public SubscribeContentCta(ContentCta contentCta) {
            this.d = contentCta;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof SubscribeContentCta) && Intrinsics.c(this.d, ((SubscribeContentCta) obj).d);
        }
        ...
        public final int hashCode() {
            ...
            return contentCta.hashCode();
        }

        public final String toString() {
            return "SubscribeContentCta(contentCta=" + this.d + ")";
        }
