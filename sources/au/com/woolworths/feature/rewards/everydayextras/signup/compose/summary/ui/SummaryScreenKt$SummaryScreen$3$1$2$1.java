...
final /* synthetic */ class SummaryScreenKt$SummaryScreen$3$1$2$1 extends FunctionReferenceImpl implements Function0<Unit> {
    @Override // kotlin.jvm.functions.Function0
    public final Object invoke() {
        ((EverydayExtraSummaryViewModel) this.receiver).n.f(EverydayExtraSummaryContract.Action.ScanCard.f6124a);
        return Unit.f24250a;
    }
}
