...
final class LandingScreenKt$PreviewContentUi_Accessibility$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if (objG == composer$Companion$Empty$1) {
            objG = new au.com.woolworths.feature.rewards.account.closeaccount.ui.d(19);
            composer.A(objG);
        }
        ...
        if (objE2 == composer$Companion$Empty$1) {
            objE2 = new au.com.woolworths.feature.rewards.account.closeaccount.ui.d(20);
            composer.A(objE2);
        }
        ...
        if (objE3 == composer$Companion$Empty$1) {
            objE3 = new au.com.woolworths.feature.rewards.account.closeaccount.ui.d(21);
            composer.A(objE3);
        }
        ...
        if (objE5 == composer$Companion$Empty$1) {
            objE5 = new au.com.woolworths.feature.rewards.account.closeaccount.ui.d(22);
            composer.A(objE5);
        }
        composer.l();
        LandingScreenKt.b(true, null, null, function1, function0, function12, function13, function2, (Function1) objE5, composer, 115043718);
        throw null;
    }
}
