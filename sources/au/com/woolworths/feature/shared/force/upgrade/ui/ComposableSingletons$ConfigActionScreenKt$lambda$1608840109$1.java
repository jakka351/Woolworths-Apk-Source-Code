...
public final class ComposableSingletons$ConfigActionScreenKt$lambda$1608840109$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((((Number) obj2).intValue() & 3) == 2 && composer.c()) {
            ...
            ConfigActionContract.ViewState.FullScreenContent fullScreenContent = new ConfigActionContract.ViewState.FullScreenContent(new UpdateFullScreenType.OsForceUpdate("Update", "To continue to access the Woolworths app you need the latest Android version. Please update today.", "Update", "Show card"));
