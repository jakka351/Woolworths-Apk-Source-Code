...
final /* synthetic */ class ConfigActionActivity$setViewContent$1$1$4$1 extends FunctionReferenceImpl implements Function2<Boolean, String, Unit> {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if (zBooleanValue) {
            ...
            ForceUpgradeAnalytics.ForceUpgradeOsScreen.Action action = new ForceUpgradeAnalytics.ForceUpgradeOsScreen(str).f;
            action.getClass();
            configActionViewModelP4.f.g(new ForceUpgradeAnalytics$ForceUpgradeOsScreen$Action$buttonClick$1(action, p1));
        } else {
            ConfigActionViewModel configActionViewModelP42 = configActionActivity.P4();
            ForceUpgradeAnalytics.SoftUpgradeOsDialog.Action action2 = new ForceUpgradeAnalytics.SoftUpgradeOsDialog(str).f;
            action2.getClass();
            configActionViewModelP42.f.g(new ForceUpgradeAnalytics$SoftUpgradeOsDialog$Action$buttonClick$1(action2, p1));
        }
        ContextExtKt.i(configActionActivity);
