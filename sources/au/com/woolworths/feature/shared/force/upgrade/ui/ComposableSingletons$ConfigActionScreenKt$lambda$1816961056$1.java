...
public final class ComposableSingletons$ConfigActionScreenKt$lambda$1816961056$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((((Number) obj2).intValue() & 3) == 2 && composer.c()) {
            ...
            ConfigActionContract.ViewState.Content content = new ConfigActionContract.ViewState.Content(new UpdateDialogType.OsForceUpdate("Update", "To continue to access the Woolworths app you need the latest Android version. Please update today.", "Update"));
