...
abstract class Hilt_FeedbackFormActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    ...
    public Hilt_FeedbackFormActivity() {
        ...
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shared.feedback.ui.Hilt_FeedbackFormActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                FeedbackFormActivity feedbackFormActivity2 = feedbackFormActivity;
                if (feedbackFormActivity2.w) {
                    return;
                }
                feedbackFormActivity2.w = true;
                ((FeedbackFormActivity_GeneratedInjector) feedbackFormActivity2.t3()).T(feedbackFormActivity2);
            }
        });
    }
