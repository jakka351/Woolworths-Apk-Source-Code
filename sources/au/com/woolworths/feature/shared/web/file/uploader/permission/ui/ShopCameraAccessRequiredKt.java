...
public final class ShopCameraAccessRequiredKt {
    public static final void a(final Function0 onBackClick, final Function0 onEnablePermissionClick, Composer composer, int i) {
        ...
        ComposerImpl composerImplV = composer.v(-2044845019);
        if ((i & 6) == 0) {
        ...
        if ((i2 & 19) == 18 && composerImplV.c()) {
            ...
            SurfaceKt.a(null, null, 0L, 0L, null, BitmapDescriptorFactory.HUE_RED, ComposableLambdaKt.c(-472681119, new Function2<Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.shared.web.file.uploader.permission.ui.ShopCameraAccessRequiredKt$ShopCameraAccessRequired$1
                ...
                public final Object invoke(Object obj, Object obj2) {
                    ...
                    if ((((Number) obj2).intValue() & 3) == 2 && composer2.c()) {
                        ...
                        TopNavBarKt.b(StringResources_androidKt.c(composer2, R.string.chat_camera_permission_screen_title), null, null, null, 0L, j, 0L, null, 0, ComposableLambdaKt.c(-771786502, new Function2<Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.shared.web.file.uploader.permission.ui.ShopCameraAccessRequiredKt$ShopCameraAccessRequired$1$1$1
                            @Override // kotlin.jvm.functions.Function2
                        ...
                        ImageKt.a(PainterResources_androidKt.a(R.drawable.ic_camera_off, 0, composer2), null, AspectRatioKt.a(SizeKt.e(PaddingKt.h(companion, 48, BitmapDescriptorFactory.HUE_RED, 2), 1.0f), 1.0f), Alignment.Companion.e, ContentScale.Companion.b, BitmapDescriptorFactory.HUE_RED, null, composer2, 28080, 96);
                        TextKt.b(StringResources_androidKt.c(composer2, R.string.chat_camera_permission_screen_subtitle), null, 0L, 0L, null, 0L, null, new TextAlign(3), 0L, 0, false, 0, 0, null, WxTheme.b(composer2).w, composer2, 0, 0, 65022);
                        TextKt.b(StringResources_androidKt.c(composer2, R.string.chat_camera_permission_screen_body_shop), PaddingKt.f(companion, f), 0L, 0L, null, 0L, null, new TextAlign(3), 0L, 0, false, 0, 0, null, WxTheme.b(composer2).z, composer2, 48, 0, 65020);
                        ...
                        PrimaryButtonKt.a(upperCase, onEnablePermissionClick, modifierF, false, false, null, null, null, null, composer2, KyberEngine.KyberPolyBytes, 1016);
                        composer2.f();
                        composer2.f();
                    }
                    return Unit.f24250a;
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new a(onBackClick, onEnablePermissionClick, i, 1);
        }
    }
}
