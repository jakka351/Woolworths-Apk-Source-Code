...
abstract class Hilt_BrandedShopActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder t;
    public volatile ActivityComponentManager u;
    public final Object v = new Object();
    public boolean w = false;

    public Hilt_BrandedShopActivity() {
        final BrandedShopActivity brandedShopActivity = (BrandedShopActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.brandedshop.Hilt_BrandedShopActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                BrandedShopActivity brandedShopActivity2 = brandedShopActivity;
                if (brandedShopActivity2.w) {
                    return;
                }
                brandedShopActivity2.w = true;
                ((BrandedShopActivity_GeneratedInjector) brandedShopActivity2.t3()).z(brandedShopActivity2);
            }
        });
    }
