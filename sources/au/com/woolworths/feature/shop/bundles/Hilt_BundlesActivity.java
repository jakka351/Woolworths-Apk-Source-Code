...
abstract class Hilt_BundlesActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder t;
    public volatile ActivityComponentManager u;
    public final Object v = new Object();
    public boolean w = false;

    public Hilt_BundlesActivity() {
        final BundlesActivity bundlesActivity = (BundlesActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.bundles.Hilt_BundlesActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                BundlesActivity bundlesActivity2 = bundlesActivity;
                if (bundlesActivity2.w) {
                    return;
                }
                bundlesActivity2.w = true;
                ((BundlesActivity_GeneratedInjector) bundlesActivity2.t3()).m(bundlesActivity2);
            }
        });
    }
