package au.com.woolworths.feature.shop.editorder;
...
public class DataBinderMapperImpl extends DataBinderMapper {
    ...
    public static final SparseIntArray f7054a;
    ...
    public static class InnerLayoutIdLookup {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final HashMap f7055a;

        static {
            HashMap map = new HashMap(1);
            f7055a = map;
            map.put("layout/activity_edit_order_error_0", Integer.valueOf(com.woolworths.R.layout.activity_edit_order_error));
        }
    }

    static {
        SparseIntArray sparseIntArray = new SparseIntArray(1);
        f7054a = sparseIntArray;
        sparseIntArray.put(com.woolworths.R.layout.activity_edit_order_error, 1);
    }
    ...
    public final ViewDataBinding b(DataBindingComponent dataBindingComponent, View view, int i) {
        ...
        if ("layout/activity_edit_order_error_0".equals(tag)) {
            return new ActivityEditOrderErrorBindingImpl(dataBindingComponent, view);
        }
        throw new IllegalArgumentException(b.m(tag, "The tag for activity_edit_order_error is invalid. Received: "));
    }

    @Override // androidx.databinding.DataBinderMapper
    public final ViewDataBinding c(DataBindingComponent dataBindingComponent, View[] viewArr, int i) {
        if (viewArr.length != 0 && f7054a.get(i) > 0 && viewArr[0].getTag() == null) {
            throw new RuntimeException("view must have a tag");
        }
        return null;
    }
    ...
    public final int d(String str) {
        Integer num = (Integer) InnerLayoutIdLookup.f7055a.get(str);
        if (num == null) {
            return 0;
        }
        return num.intValue();
