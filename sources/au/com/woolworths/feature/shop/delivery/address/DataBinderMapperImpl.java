...
public class DataBinderMapperImpl extends DataBinderMapper {
    ...
    public static final SparseIntArray f7043a;

    public static class InnerBrLookup {
        static {
            SparseArray sparseArrayB = au.com.woolworths.android.onesite.a.b(44, 0, 1, "_all", "actionState");
    ...
    public static class InnerLayoutIdLookup {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final HashMap f7044a;

        static {
            HashMap map = new HashMap(1);
            f7044a = map;
            map.put("layout/activity_add_delivery_address_manually_0", Integer.valueOf(com.woolworths.R.layout.activity_add_delivery_address_manually));
        }
    }

    static {
        SparseIntArray sparseIntArray = new SparseIntArray(1);
        f7043a = sparseIntArray;
        sparseIntArray.put(com.woolworths.R.layout.activity_add_delivery_address_manually, 1);
    }
    ...
    public final ViewDataBinding b(DataBindingComponent dataBindingComponent, View view, int i) {
        ...
        if ("layout/activity_add_delivery_address_manually_0".equals(tag)) {
            return new ActivityAddDeliveryAddressManuallyBindingImpl(dataBindingComponent, view);
        }
        throw new IllegalArgumentException(b.m(tag, "The tag for activity_add_delivery_address_manually is invalid. Received: "));
    }

    @Override // androidx.databinding.DataBinderMapper
    public final ViewDataBinding c(DataBindingComponent dataBindingComponent, View[] viewArr, int i) {
        if (viewArr.length != 0 && f7043a.get(i) > 0 && viewArr[0].getTag() == null) {
            throw new RuntimeException("view must have a tag");
        }
        return null;
    }
    ...
    public final int d(String str) {
        Integer num = (Integer) InnerLayoutIdLookup.f7044a.get(str);
        if (num == null) {
            return 0;
        }
        return num.intValue();
