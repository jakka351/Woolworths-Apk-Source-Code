...
abstract class Hilt_FullPageVideoPlayerActivity extends ComponentActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder s;
    public volatile ActivityComponentManager t;
    public final Object u = new Object();
    public boolean v = false;

    public Hilt_FullPageVideoPlayerActivity() {
        final FullPageVideoPlayerActivity fullPageVideoPlayerActivity = (FullPageVideoPlayerActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.video.Hilt_FullPageVideoPlayerActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                FullPageVideoPlayerActivity fullPageVideoPlayerActivity2 = fullPageVideoPlayerActivity;
                if (fullPageVideoPlayerActivity2.v) {
                    return;
                }
                fullPageVideoPlayerActivity2.v = true;
                ((FullPageVideoPlayerActivity_GeneratedInjector) fullPageVideoPlayerActivity2.t3()).getClass();
            }
        });
    }
