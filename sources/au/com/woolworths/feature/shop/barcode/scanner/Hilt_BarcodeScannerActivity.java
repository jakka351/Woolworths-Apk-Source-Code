...
abstract class Hilt_BarcodeScannerActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder t;
    public volatile ActivityComponentManager u;
    public final Object v = new Object();
    public boolean w = false;

    public Hilt_BarcodeScannerActivity() {
        final BarcodeScannerActivity barcodeScannerActivity = (BarcodeScannerActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.barcode.scanner.Hilt_BarcodeScannerActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                BarcodeScannerActivity barcodeScannerActivity2 = barcodeScannerActivity;
                if (barcodeScannerActivity2.w) {
                    return;
                }
                barcodeScannerActivity2.w = true;
                ((BarcodeScannerActivity_GeneratedInjector) barcodeScannerActivity2.t3()).c0(barcodeScannerActivity2);
            }
        });
    }
