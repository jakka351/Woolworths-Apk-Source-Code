...
abstract class Hilt_AccountDetailsActivity extends ComponentActivity implements GeneratedComponentManagerHolder {
    ...
    public Hilt_AccountDetailsActivity() {
        ...
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.account.ui.details.Hilt_AccountDetailsActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                AccountDetailsActivity accountDetailsActivity2 = accountDetailsActivity;
                if (accountDetailsActivity2.v) {
                    return;
                }
                accountDetailsActivity2.v = true;
                ((AccountDetailsActivity_GeneratedInjector) accountDetailsActivity2.t3()).getClass();
            }
        });
    }
