...
public class ItemHorizontalSelectorBindingModel_ extends DataBindingEpoxyModel implements GeneratedModel<DataBindingEpoxyModel.DataBindingHolder>, ItemHorizontalSelectorBindingModelBuilder {
    ...
    public final void J(ViewDataBinding viewDataBinding) {
        ...
        if (!viewDataBinding.G(37, null)) {
            throw new IllegalStateException("The attribute clickListener was defined in your data binding model (com.airbnb.epoxy.DataBindingEpoxyModel) but a data variable of that name was not found in the layout.");
        }
        if (!viewDataBinding.G(150, null)) {
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof ItemHorizontalSelectorBindingModel_) && super.equals(obj);
    }
    ...
    public final String toString() {
        return "ItemHorizontalSelectorBindingModel_{index=null, viewListener=null, clickListener=null, label=null, itemWidthRes=0}" + super.toString();
    }
