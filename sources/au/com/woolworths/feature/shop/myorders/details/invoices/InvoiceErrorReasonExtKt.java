...
public final class InvoiceErrorReasonExtKt {

    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    public /* synthetic */ class WhenMappings {
        static {
            int[] iArr = new int[InvoiceErrorReason.values().length];
            try {
                iArr[0] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                InvoiceErrorReason.Companion companion = InvoiceErrorReason.e;
                iArr[1] = 2;
