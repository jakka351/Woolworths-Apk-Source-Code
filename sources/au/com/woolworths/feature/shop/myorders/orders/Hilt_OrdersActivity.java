...
public abstract class Hilt_OrdersActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    ...
    public Hilt_OrdersActivity() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.myorders.orders.Hilt_OrdersActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                Hilt_OrdersActivity hilt_OrdersActivity = Hilt_OrdersActivity.this;
                if (hilt_OrdersActivity.w) {
                    return;
                }
                hilt_OrdersActivity.w = true;
                ((OrdersActivity_GeneratedInjector) hilt_OrdersActivity.t3()).j((OrdersActivity) hilt_OrdersActivity);
            }
        });
    }
