...
abstract class Hilt_WebLinkActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder t;
    public volatile ActivityComponentManager u;
    public final Object v = new Object();
    public boolean w = false;

    public Hilt_WebLinkActivity() {
        final WebLinkActivity webLinkActivity = (WebLinkActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.weblink.Hilt_WebLinkActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                WebLinkActivity webLinkActivity2 = webLinkActivity;
                if (webLinkActivity2.w) {
                    return;
                }
                webLinkActivity2.w = true;
                ((WebLinkActivity_GeneratedInjector) webLinkActivity2.t3()).a1(webLinkActivity2);
            }
        });
    }
