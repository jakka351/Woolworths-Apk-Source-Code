...
public final class AnalyticsExtraContentExtKt {
    public static final AnalyticsExtraContent a(Analytics.ExtraContent extraContent) {
        List arrayList;
        Intrinsics.h(extraContent, "<this>");
        String str = extraContent.f20222a;
