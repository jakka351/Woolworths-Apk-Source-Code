...
@Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0007\n\u0002\b\u0002¨\u0006\u0004²\u0006\u000e\u0010\u0001\u001a\u0004\u0018\u00010\u00008\nX\u008a\u0084\u0002²\u0006\f\u0010\u0003\u001a\u00020\u00028\nX\u008a\u0084\u0002"}, d2 = {"Lcom/airbnb/lottie/LottieComposition;", "composition", "", "progress", "wpay_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
...
public final class WappleLoadingScreenKt {
    public static final void a(int i, int i2, Composer composer, Modifier modifier) {
        ...
        ComposerImpl composerImplV = composer.v(1540211827);
        int i4 = i2 & 1;
        if (i4 != 0) {
            i3 = i | 6;
            modifier2 = modifier;
        ...
        if ((i3 & 3) == 2 && composerImplV.c()) {
            ...
            Modifier modifierB = BackgroundKt.b(modifier3.x0(SizeKt.c), Color.b(Color.b, 0.4f), RectangleShapeKt.f1779a);
            composerImplV.o(1849434622);
            ...
            if (zN || objG3 == composer$Companion$Empty$1) {
                objG3 = new au.com.woolworths.feature.product.list.compose.filter.h(lottieAnimatableA, 8);
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new au.com.woolworths.feature.shop.recipes.details.ui.a(modifier2, i, i2, 1);
        }
    }
}
