...
public final class DeviceNotSupportedDialogKt {
    public static final void a(int i, Composer composer, Modifier modifier, final Function0 onDismissAction, Function0 onDialogImpression) {
        ...
        ComposerImpl composerImplV = composer.v(-297525412);
        if ((i & 6) == 0) {
        ...
        if ((i3 & 147) == 146 && composerImplV.c()) {
            ...
            if (z || objG == Composer.Companion.f1624a) {
                objG = new DeviceNotSupportedDialogKt$DeviceNotSupportedDialog$1$1(onDialogImpression, null);
                composerImplV.A(objG);
            }
            composerImplV.V(false);
            EffectsKt.e(composerImplV, Unit.f24250a, (Function2) objG);
            CoreThemeKt.c(6, composerImplV, ComposableLambdaKt.c(-1076360320, new Function2<Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.shop.instore.navigation.map.ui.dialog.DeviceNotSupportedDialogKt$DeviceNotSupportedDialog$2
                ...
                public final Object invoke(Object obj, Object obj2) {
                    ...
                    if ((((Number) obj2).intValue() & 3) == 2 && composer2.c()) {
                        ...
                        String strC = StringResources_androidKt.c(composer2, R.string.device_not_supported_title);
                        String strC2 = StringResources_androidKt.c(composer2, R.string.device_not_supported_text);
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new a(onDismissAction, modifier2, onDialogImpression, i, 1);
        }
    }
}
