...
public abstract class Hilt_SignUpActivity extends ComponentActivity implements GeneratedComponentManagerHolder {
    ...
    public Hilt_SignUpActivity() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.signup.Hilt_SignUpActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                Hilt_SignUpActivity hilt_SignUpActivity = Hilt_SignUpActivity.this;
                if (hilt_SignUpActivity.v) {
                    return;
                }
                hilt_SignUpActivity.v = true;
                ((SignUpActivity_GeneratedInjector) hilt_SignUpActivity.t3()).x((SignUpActivity) hilt_SignUpActivity);
            }
        });
    }
