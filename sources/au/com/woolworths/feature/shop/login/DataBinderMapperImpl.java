...
public class DataBinderMapperImpl extends DataBinderMapper {
    ...
    public static final SparseIntArray f7443a;

    public static class InnerBrLookup {
        static {
            SparseArray sparseArrayB = au.com.woolworths.android.onesite.a.b(99, 0, 1, "_all", "actionState");
    ...
    public static class InnerLayoutIdLookup {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final HashMap f7444a;

        static {
            HashMap map = new HashMap(1);
            f7444a = map;
            map.put("layout/fragment_guest_login_0", Integer.valueOf(com.woolworths.R.layout.fragment_guest_login));
        }
    }
    ...
    static {
        ...
        sparseIntArray.put(com.woolworths.R.layout.fragment_guest_login, 1);
    }
    ...
    public final ViewDataBinding b(DataBindingComponent dataBindingComponent, View view, int i) {
        ...
        throw new IllegalArgumentException(androidx.camera.core.impl.b.m(tag, "The tag for fragment_guest_login is invalid. Received: "));
    }

    @Override // androidx.databinding.DataBinderMapper
    public final ViewDataBinding c(DataBindingComponent dataBindingComponent, View[] viewArr, int i) {
        if (viewArr.length != 0 && f7443a.get(i) > 0 && viewArr[0].getTag() == null) {
            throw new RuntimeException("view must have a tag");
        }
        return null;
    }
    ...
    public final int d(String str) {
        Integer num = (Integer) InnerLayoutIdLookup.f7444a.get(str);
        if (num == null) {
            return 0;
        }
        return num.intValue();
