...
abstract class Hilt_ProductAvailabilityActivity extends ComponentActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder s;
    public volatile ActivityComponentManager t;
    public final Object u = new Object();
    public boolean v = false;

    public Hilt_ProductAvailabilityActivity() {
        final ProductAvailabilityActivity productAvailabilityActivity = (ProductAvailabilityActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.product.availability.Hilt_ProductAvailabilityActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                ProductAvailabilityActivity productAvailabilityActivity2 = productAvailabilityActivity;
                if (productAvailabilityActivity2.v) {
                    return;
                }
                productAvailabilityActivity2.v = true;
                ((ProductAvailabilityActivity_GeneratedInjector) productAvailabilityActivity2.t3()).getClass();
            }
        });
    }
