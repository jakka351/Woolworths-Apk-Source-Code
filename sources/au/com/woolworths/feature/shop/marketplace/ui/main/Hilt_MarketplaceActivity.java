...
abstract class Hilt_MarketplaceActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder t;
    public volatile ActivityComponentManager u;
    public final Object v = new Object();
    public boolean w = false;

    public Hilt_MarketplaceActivity() {
        final MarketplaceActivity marketplaceActivity = (MarketplaceActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.marketplace.ui.main.Hilt_MarketplaceActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                MarketplaceActivity marketplaceActivity2 = marketplaceActivity;
                if (marketplaceActivity2.w) {
                    return;
                }
                marketplaceActivity2.w = true;
                ((MarketplaceActivity_GeneratedInjector) marketplaceActivity2.t3()).J0(marketplaceActivity2);
            }
        });
    }
