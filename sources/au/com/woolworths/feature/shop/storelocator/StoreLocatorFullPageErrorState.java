...
@Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\b\u0086\u0081\u0002\u0018\u00002\u00020\u00012\b\u0012\u0004\u0012\u00020\u00000\u0002¨\u0006\u0003"}, d2 = {"Lau/com/woolworths/feature/shop/storelocator/StoreLocatorFullPageErrorState;", "Lau/com/woolworths/android/onesite/common/FullPageErrorCause;", "", "storelocator_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public abstract class StoreLocatorFullPageErrorState implements FullPageErrorCause {
    ...
    static {
        StoreLocatorFullPageErrorState storeLocatorFullPageErrorState = new StoreLocatorFullPageErrorState() { // from class: au.com.woolworths.feature.shop.storelocator.StoreLocatorFullPageErrorState.DEVICE_LOCATION_DISABLED
        ...
        StoreLocatorFullPageErrorState storeLocatorFullPageErrorState2 = new StoreLocatorFullPageErrorState() { // from class: au.com.woolworths.feature.shop.storelocator.StoreLocatorFullPageErrorState.NETWORK_ERROR
            @Override // au.com.woolworths.android.onesite.common.FullPageErrorCause
            public final int getDrawableRes() {
        ...
        StoreLocatorFullPageErrorState storeLocatorFullPageErrorState3 = new StoreLocatorFullPageErrorState() { // from class: au.com.woolworths.feature.shop.storelocator.StoreLocatorFullPageErrorState.NO_LOCATION_PERMISSION
            @Override // au.com.woolworths.android.onesite.common.FullPageErrorCause
            public final int getDrawableRes() {
                return com.woolworths.R.drawable.pickup_location;
            }
        ...
        StoreLocatorFullPageErrorState storeLocatorFullPageErrorState4 = new StoreLocatorFullPageErrorState() { // from class: au.com.woolworths.feature.shop.storelocator.StoreLocatorFullPageErrorState.NO_LOCATION_PERMISSION_PERMANENT
            @Override // au.com.woolworths.android.onesite.common.FullPageErrorCause
            public final int getDrawableRes() {
                return com.woolworths.R.drawable.pickup_location;
            }
        ...
        StoreLocatorFullPageErrorState storeLocatorFullPageErrorState5 = new StoreLocatorFullPageErrorState() { // from class: au.com.woolworths.feature.shop.storelocator.StoreLocatorFullPageErrorState.SERVER_ERROR
            @Override // au.com.woolworths.android.onesite.common.FullPageErrorCause
            public final int getDrawableRes() {
        ...
        StoreLocatorFullPageErrorState storeLocatorFullPageErrorState6 = new StoreLocatorFullPageErrorState() { // from class: au.com.woolworths.feature.shop.storelocator.StoreLocatorFullPageErrorState.NO_RESULT_FOUND
            @Override // au.com.woolworths.android.onesite.common.FullPageErrorCause
            public final int getDrawableRes() {
