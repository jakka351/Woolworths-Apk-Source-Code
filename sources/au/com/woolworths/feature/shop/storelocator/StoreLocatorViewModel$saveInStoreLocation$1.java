...
@DebugMetadata(c = "au.com.woolworths.feature.shop.storelocator.StoreLocatorViewModel$saveInStoreLocation$1", f = "StoreLocatorViewModel.kt", l = {100}, m = "invokeSuspend")
...
final class StoreLocatorViewModel$saveInStoreLocation$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public StoreLocatorViewModel$saveInStoreLocation$1(StoreLocatorViewModel storeLocatorViewModel, Store store, Continuation continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i == 0) {
                ResultKt.b(obj);
                StoreLocatorInteractorImpl storeLocatorInteractorImpl = storeLocatorViewModel.e;
                Store store = this.r;
                this.p = 1;
                if (storeLocatorInteractorImpl.a(store, this) == coroutineSingletons) {
            ...
            sharedFlowImpl.f(StoreLocatorContract.Actions.CompleteSetStoreLocation.f8119a);
