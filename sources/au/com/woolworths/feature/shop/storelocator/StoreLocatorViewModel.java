...
import au.com.woolworths.feature.shop.storelocator.analytics.adobe.data.StoreSearchData;
...
@StabilityInferred
@HiltViewModel
@Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0001\u0018\u00002\u00020\u00012\u00020\u00022\u00020\u0003:\u0001\u0004¨\u0006\u0005"}, d2 = {"Lau/com/woolworths/feature/shop/storelocator/StoreLocatorViewModel;", "Landroidx/lifecycle/ViewModel;", "Lau/com/woolworths/feature/shop/storelocator/StoreLocatorEventHandler;", "Lau/com/woolworths/android/onesite/common/FullPageErrorStateClickHandler;", "Companion", "storelocator_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
...
public final class StoreLocatorViewModel extends ViewModel implements StoreLocatorEventHandler, FullPageErrorStateClickHandler {
    public final StoreLocatorInteractorImpl e;
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\b\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, d2 = {"Lau/com/woolworths/feature/shop/storelocator/StoreLocatorViewModel$Companion;", "", "", "MINIMUM_SEARCH_THRESHOLD", "I", "storelocator_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public StoreLocatorViewModel(StoreLocatorInteractorImpl storeLocatorInteractorImpl, LocationInteractor locationInteractor, LegacyShopAnalyticsManager analyticsManager, NetworkExceptions networkExceptions) {
        Intrinsics.h(locationInteractor, "locationInteractor");
        Intrinsics.h(analyticsManager, "analyticsManager");
        Intrinsics.h(networkExceptions, "networkExceptions");
        this.e = storeLocatorInteractorImpl;
    ...
    public static void t6(StoreLocatorViewModel storeLocatorViewModel, MutableLiveData mutableLiveData, boolean z, StoreLocatorContract.StoreListDisplayMode storeListDisplayMode, List list, StoreLocatorFullPageErrorState storeLocatorFullPageErrorState, int i) {
        ...
        if ((i & 1) != 0) {
            ...
            z = viewState2 != null ? viewState2.f8127a : false;
        }
        boolean z2 = z;
        if ((i & 2) != 0) {
    ...
    public final void onSecondaryActionClicked() {
        ...
        int i = storeLocatorFullPageErrorState2 == null ? -1 : WhenMappings.f8130a[storeLocatorFullPageErrorState2.ordinal()];
        SharedFlowImpl sharedFlowImpl = this.k;
        if (i == 1) {
            sharedFlowImpl.f(StoreLocatorContract.Actions.ShowPermissionsDialog.f8123a);
            return;
        }
        if (i == 2) {
            sharedFlowImpl.f(StoreLocatorContract.Actions.GoToSettings.f8120a);
            return;
        }
        if (i == 3) {
            sharedFlowImpl.f(StoreLocatorContract.Actions.TurnOnDeviceLocation.f8125a);
            return;
        }
        if (i == 4) {
            r6();
    ...
    public final void s6(String str) {
        ...
        BuildersKt.c(ViewModelKt.a(this), null, null, new StoreLocatorViewModel$searchLocations$1(this, str, null), 3);
    }

    @Override // au.com.woolworths.feature.shop.storelocator.StoreLocatorEventHandler
