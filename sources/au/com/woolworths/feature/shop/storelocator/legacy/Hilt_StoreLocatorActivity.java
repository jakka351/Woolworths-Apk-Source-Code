...
abstract class Hilt_StoreLocatorActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder t;
    public volatile ActivityComponentManager u;
    public final Object v = new Object();
    public boolean w = false;

    public Hilt_StoreLocatorActivity() {
        final StoreLocatorActivity storeLocatorActivity = (StoreLocatorActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.storelocator.legacy.Hilt_StoreLocatorActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                StoreLocatorActivity storeLocatorActivity2 = storeLocatorActivity;
                if (storeLocatorActivity2.w) {
                    return;
                }
                storeLocatorActivity2.w = true;
                ((StoreLocatorActivity_GeneratedInjector) storeLocatorActivity2.t3()).J(storeLocatorActivity2);
            }
        });
    }
