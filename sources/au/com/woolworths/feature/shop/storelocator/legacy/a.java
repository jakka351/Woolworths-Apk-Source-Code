    ...
    public final Object invoke(Object obj) {
        ...
        switch (i2) {
            case 0:
                ...
                legacyActivityStoreLocatorBinding.G.b(i, true);
                ...
                if (storeLocatorEpoxyController2 != null) {
                    storeLocatorEpoxyController2.addModelBuildListener(new OnModelBuildFinishedListener() { // from class: au.com.woolworths.feature.shop.storelocator.legacy.e
                        @Override // com.airbnb.epoxy.OnModelBuildFinishedListener
                        public final void a(DiffResult it) {
                            int i4 = StoreLocatorActivity.J;
                            Intrinsics.h(it, "it");
                            LegacyActivityStoreLocatorBinding legacyActivityStoreLocatorBinding2 = storeLocatorActivity.C;
                            if (legacyActivityStoreLocatorBinding2 != null) {
                                legacyActivityStoreLocatorBinding2.z.o0(0);
                            } else {
                                Intrinsics.p("binding");
                                throw null;
                            }
            ...
            default:
                ...
                googleMap.clear();
                if (!mapState.f8163a.isEmpty()) {
                    LatLngBounds.Builder builder = LatLngBounds.builder();
                    Intrinsics.g(builder, "builder(...)");
                    for (Store store : mapState.f8163a) {
