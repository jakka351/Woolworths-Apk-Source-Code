...
public abstract class LegacyActivityStoreLocatorBinding extends ViewDataBinding {
    ...
    public LegacyActivityStoreLocatorBinding(DataBindingComponent dataBindingComponent, View view, IncludeGenericErrorStateBinding includeGenericErrorStateBinding, EpoxyRecyclerView epoxyRecyclerView, Button button, ContentLoadingProgressBar contentLoadingProgressBar, FragmentContainerView fragmentContainerView, Button button2, SearchView searchView, SwipeRefreshLayout swipeRefreshLayout, MaterialButtonToggleGroup materialButtonToggleGroup, Toolbar toolbar) {
