...
import au.com.woolworths.feature.shop.storelocator.details.d;
import au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.StoreDetailsContract;
import au.com.woolworths.feature.shop.storelocator.legacy.pickup.models.StoreExtKt;
...
@Metadata(d1 = {"\u0000\b\n\u0002\u0018\u0002\n\u0002\b\u0002¨\u0006\u0002²\u0006\u0010\u0010\u0001\u001a\u0004\u0018\u00010\u00008\n@\nX\u008a\u008e\u0002"}, d2 = {"Lau/com/woolworths/feature/shop/storelocator/legacy/pickup/details/StoreDetailsContract$ViewState;", "mutableViewState", "storelocator-legacy_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
@SourceDebugExtension
/* loaded from: classes3.dex */
public final class StoreDetailsScreenKt {

    /* renamed from: a, reason: collision with root package name */
    public static final /* synthetic */ int f8201a = 0;
    ...
    public static final void a(int i, int i2, Composer composer, Modifier modifier, String str, String str2, Function0 function0) {
        ComposerImpl composerImplV = composer.v(650214317);
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new au.com.woolworths.feature.shop.storelocator.details.a(i, i2, 1, modifier, str, str2, function0);
        }
    }
    ...
    public static final void b(final StoreDetailsContract.ViewState viewState, Composer composer, int i) {
        int i2;
        Object next;
        boolean zC;
        boolean zC2;
        ...
        ComposerImpl composerImplV = composer.v(-2002756653);
        if ((i & 6) == 0) {
        ...
        if ((i2 & 3) == 2 && composerImplV.c()) {
            ...
            final Store store2 = viewState.b;
            Store store3 = viewState.b;
            ...
            if (store2 != null) {
                ...
                composerImplV.o(-503787607);
                Object obj = Composer.Companion.f1624a;
                if (str3 == null) {
                    r14 = 0;
                } else {
                    if (str != null) {
                        zC = Intrinsics.c(store3 != null ? StoreExtKt.b(store3) : null, str);
                    } else {
                        zC = false;
                    }
                    if (zC) {
                        ...
                        if (str != null) {
                            zC2 = Intrinsics.c(store3 != null ? StoreExtKt.a(store3) : null, str);
                        } else {
                            zC2 = false;
                        }
                        if (zC2) {
                            ...
                            if (str2 != null) {
                                zC3 = Intrinsics.c(store2 != null ? StoreExtKt.b(store2) : null, str2);
                            } else {
                                zC3 = false;
                            }
                    ...
                    boolean zI = composerImplV.I(store2) | composerImplV.I(viewState);
                    Object objG = composerImplV.G();
                    if (zI || objG == obj) {
                        final int i3 = 0;
                        objG = new Function0() { // from class: au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.a
                            ...
                            public final Object invoke() {
                                ...
                                switch (i4) {
                                    case 0:
                                        int i5 = StoreDetailsScreenKt.f8201a;
                                        String strB = StoreExtKt.b(store4);
                                        if (strB != null) {
                                            Function1 function1 = viewState2.h;
                                            String strC = StoreExtKt.c(store4);
                                            function1.invoke(new StoreDetailsContract.ViewModelAction.PickUpAddressSelected(strB, strC != null ? strC : ""));
                                            break;
                                        }
                                        break;
                                    default:
                                        int i6 = StoreDetailsScreenKt.f8201a;
                                        String strA = StoreExtKt.a(store4);
                                        if (strA != null) {
                                            Function1 function12 = viewState2.h;
                                            String strC2 = StoreExtKt.c(store4);
                ...
                composerImplV.o(-503765219);
                if (str4 != null) {
                    if (str != null) {
                        zC5 = Intrinsics.c(store3 != null ? StoreExtKt.a(store3) : null, str);
                    } else {
                        zC5 = r14;
                    }
                    if (zC5) {
                        ...
                        if (str != null) {
                            zC6 = Intrinsics.c(store3 != null ? StoreExtKt.b(store3) : null, str);
                        } else {
                            zC6 = r14;
                        }
                        if (zC6) {
                            ...
                            if (str2 != null) {
                                zC7 = Intrinsics.c(store2 != null ? StoreExtKt.a(store2) : null, str2);
                            } else {
                                zC7 = r14;
                            }
                    ...
                    composerImplV.o(-1633490746);
                    boolean zI2 = composerImplV.I(store2) | composerImplV.I(viewState);
                    Object objG2 = composerImplV.G();
                    if (zI2 || objG2 == obj) {
                        final int i4 = 1;
                        objG2 = new Function0() { // from class: au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.a
                            @Override // kotlin.jvm.functions.Function0
                            public final Object invoke() {
                                int i42 = i4;
                                Unit unit = Unit.f24250a;
                ...
                if (str5 != null) {
                    zC4 = Intrinsics.c(store2 != null ? store2.d : null, str5);
                } else {
                    zC4 = r14;
                }
                if (zC4) {
                    composerImplV.o(491234369);
                    f(composerImplV, r14);
                    composerImplV.V(r14);
                } else {
                    composerImplV.o(491299779);
                    if (!viewState.g && (store = store2.p) != null) {
        ...
        RecomposeScopeImpl recomposeScopeImplX = composerImplV.X();
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new au.com.woolworths.design.core.ui.foundation.a(i, 3, viewState);
        }
    }

    public static final void c(StoreDetailsContract.ViewState viewState, Composer composer, int i) {
        ComposerImpl composerImplV = composer.v(690175246);
        if ((((composerImplV.I(viewState) ? 4 : 2) | i) & 3) == 2 && composerImplV.c()) {
            ...
            if (zI || objG == Composer.Companion.f1624a) {
                objG = new au.com.woolworths.feature.shop.myorders.details.infomodal.a(viewState, 15);
                composerImplV.A(objG);
            }
            composerImplV.V(false);
            TertiaryButtonKt.b((Function0) objG, null, false, null, ComposableSingletons$StoreDetailsScreenKt.f8191a, composerImplV, 24576, 14);
            composerImplV.V(true);
        }
        RecomposeScopeImpl recomposeScopeImplX = composerImplV.X();
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new b(viewState, i, 0);
        }
    }

    public static final void d(List list, Modifier modifier, Composer composer, int i) {
        ComposerImpl composerImplV = composer.v(583354248);
        ...
        RecomposeScopeImpl recomposeScopeImplX = composerImplV.X();
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new i(list, modifier, i, 3);
        }
    }
    ...
    public static final void e(StoreDetailsContract.ViewState viewState, Modifier modifier, Composer composer, int i) {
        String strH;
        boolean z;
        ComposerImpl composerImplV = composer.v(234057344);
        int i2 = (composerImplV.I(viewState) ? 4 : 2) | i;
        if ((i2 & 19) == 18 && composerImplV.c()) {
            composerImplV.j();
        } else {
            Modifier modifierA = TestTagKt.a(modifier, "store_details_header");
            ...
            composerImplV.o(74417755);
            if (store == null) {
                z = false;
            } else {
                Modifier.Companion companion = Modifier.Companion.d;
                float f = 16;
                ImageKt.a(PainterResources_androidKt.a(R.drawable.wapple_store_details, 0, composerImplV), null, PaddingKt.f(TestTagKt.a(companion, "woolworths_logo"), f), null, null, BitmapDescriptorFactory.HUE_RED, null, composerImplV, 432, 120);
        ...
        RecomposeScopeImpl recomposeScopeImplX = composerImplV.X();
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new au.com.woolworths.feature.shared.receipt.details.compose.a(viewState, i, 29, modifier);
        }
    }

    public static final void f(Composer composer, int i) {
        ComposerImpl composerImplV = composer.v(-1188659554);
        ...
        RecomposeScopeImpl recomposeScopeImplX = composerImplV.X();
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new au.com.woolworths.feature.shop.modeselector.ui.b(i, 22);
        }
    }

    public static final void g(StoreDetailsContract.ViewState viewState, StoreLocatorResult.Store store, Modifier modifier, Composer composer, int i) {
        int i2;
        Modifier modifier2;
        ComposerImpl composerImplV = composer.v(1861208527);
        if ((i & 6) == 0) {
            i2 = (composerImplV.I(viewState) ? 4 : 2) | i;
        } else {
            i2 = i;
        ...
        RecomposeScopeImpl recomposeScopeImplX = composerImplV.X();
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new au.com.woolworths.feature.rewards.everydayextras.signup.compose.landing.ui.c(viewState, store, modifier, i, 29);
        }
    }

    public static final void h(Composer composer, int i) {
        ComposerImpl composerImplV = composer.v(-313201662);
        if (i == 0 && composerImplV.c()) {
            composerImplV.j();
        } else {
        ...
        RecomposeScopeImpl recomposeScopeImplX = composerImplV.X();
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new au.com.woolworths.feature.shop.modeselector.ui.b(i, 23);
        }
    }
    ...
    */
    public static final void i(au.com.woolworths.foundation.shop.storelocator.pickup.models.Store r30, androidx.compose.ui.Modifier r31, androidx.compose.runtime.Composer r32, int r33) {
        /*
            Method dump skipped, instructions count: 414
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.StoreDetailsScreenKt.i(au.com.woolworths.foundation.shop.storelocator.pickup.models.Store, androidx.compose.ui.Modifier, androidx.compose.runtime.Composer, int):void");
    }
    ...
    public static final void j(String str, StatefulButtonState statefulButtonState, Function0 function0, Modifier modifier, Composer composer, int i) {
        Modifier modifier2;
        ComposerImpl composerImplV = composer.v(384446350);
        ...
        RecomposeScopeImpl recomposeScopeImplX = composerImplV.X();
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new d(str, statefulButtonState, function0, modifier2, i, 1);
        }
    }
    ...
    public static final void k(final StoreDetailsContract.ViewState viewState, final Function0 onNavigateUp, Composer composer, int i) {
        ...
        ComposerImpl composerImplV = composer.v(1105397927);
        int i2 = (composerImplV.I(viewState) ? 4 : 2) | i;
        if ((i & 48) == 0) {
        ...
        if ((i2 & 19) == 18 && composerImplV.c()) {
            ...
            composerImpl = composerImplV;
            au.com.woolworths.design.wx.component.ScaffoldKt.a(SizeKt.c, scaffoldStateD, ComposableLambdaKt.c(1116169026, new Function2<Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.StoreDetailsScreenKt$StoreDetailsScreen$1
                ...
                public final Object invoke(Object obj, Object obj2) {
                    ...
                    if ((((Number) obj2).intValue() & 3) == 2 && composer2.c()) {
                        ...
                        TopNavBarKt.b(StringResources_androidKt.c(composer2, R.string.store_details_screen_title), null, null, null, 0L, 0L, 0L, null, 2, ComposableLambdaKt.c(1793052241, new Function2<Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.StoreDetailsScreenKt$StoreDetailsScreen$1.1
                            @Override // kotlin.jvm.functions.Function2
            ...
            }, composerImplV), null, null, 0, 0L, 0L, null, null, ComposableLambdaKt.c(859074832, new Function3<PaddingValues, Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.StoreDetailsScreenKt$StoreDetailsScreen$2
                ...
                public final Object invoke(Object obj, Object obj2, Object obj3) {
                    ...
                    if ((iIntValue & 17) == 16 && composer2.c()) {
                        ...
                        StoreDetailsContract.ViewState viewState2 = viewState;
                        int iOrdinal = viewState2.f8200a.ordinal();
                        if (iOrdinal == 0) {
                            composer2.o(937195707);
                            StoreDetailsScreenKt.h(composer2, 0);
                            composer2.l();
                        } else if (iOrdinal == 1) {
                            composer2.o(937198121);
                            StoreDetailsScreenKt.l(viewState2, composer2, 0);
                            composer2.l();
                        } else {
                            if (iOrdinal != 2) {
                                throw au.com.woolworths.android.onesite.a.x(composer2, 937193304);
                            }
                            composer2.o(937200610);
                            StoreDetailsScreenKt.c(viewState2, composer2, 0);
                            composer2.l();
                        }
                        Integer num = viewState2.e;
                        composer2.o(937203055);
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new h(viewState, i, 17, onNavigateUp);
        }
    }
    ...
    public static final void l(final StoreDetailsContract.ViewState viewState, Composer composer, int i) {
        ...
        ComposerImpl composerImplV = composer.v(-713602685);
        ...
        if ((i3 & 3) == 2 && composerImplV.c()) {
            ...
            Modifier.Companion companion = Modifier.Companion.d;
            Modifier modifierA = WindowInsetsPadding_androidKt.a(ScrollKt.b(SizeKt.e(companion, 1.0f), ScrollKt.a(composerImplV), true));
            ColumnMeasurePolicy columnMeasurePolicyA = ColumnKt.a(Arrangement.c, Alignment.Companion.n, composerImplV, 48);
            int i4 = composerImplV.P;
            PersistentCompositionLocalMap persistentCompositionLocalMapQ = composerImplV.Q();
            Modifier modifierD = ComposedModifierKt.d(composerImplV, modifierA);
            ...
            composerImplV.o(958037030);
            if (list2 != null) {
                m(list2, PaddingKt.f(TestTagKt.a(companion, "store_details_trading_hours"), f), composerImplV, 48);
            }
            composerImplV.V(false);
            ...
            composerImpl3.o(958050356);
            Object obj2 = Composer.Companion.f1624a;
            if (str == null) {
                obj = obj2;
                i2 = -1633490746;
            } else {
                Modifier modifierF = PaddingKt.f(TestTagKt.a(companion, "store_details_phone"), f);
                ...
                if (zI || objG == obj2) {
                    final int i5 = 0;
                    objG = new Function0() { // from class: au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.c
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            int i6 = i5;
                            Unit unit = Unit.f24250a;
            ...
            composerImpl3.o(958066430);
            if (str2 == null) {
                composerImpl = composerImpl3;
            } else {
                Modifier modifierF2 = PaddingKt.f(TestTagKt.a(companion, "store_details_address"), f);
                ...
                if (zI2 || objG2 == obj) {
                    final int i6 = 1;
                    objG2 = new Function0() { // from class: au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.c
                        @Override // kotlin.jvm.functions.Function0
                        public final Object invoke() {
                            int i62 = i6;
                            Unit unit = Unit.f24250a;
            ...
            composerImpl.o(958083273);
            if (list != null) {
                d(list, SizeKt.e(PaddingKt.f(TestTagKt.a(companion, "store_details_facilities"), f), 1.0f), composerImpl, 48);
            }
            composerImpl.V(false);
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new b(viewState, i, 1);
        }
    }

    public static final void m(List list, Modifier modifier, Composer composer, int i) {
        ComposerImpl composerImpl;
        ComposerImpl composerImplV = composer.v(-258745483);
        if ((((composerImplV.I(list) ? 4 : 2) | i) & 19) == 18 && composerImplV.c()) {
            composerImplV.j();
            composerImpl = composerImplV;
        } else {
        ...
        RecomposeScopeImpl recomposeScopeImplX = composerImpl.X();
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new i(list, modifier, i, 4);
        }
    }
}
