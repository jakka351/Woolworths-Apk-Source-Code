...
abstract class Hilt_StoreDetailsActivity extends ComponentActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder s;
    public volatile ActivityComponentManager t;
    public final Object u = new Object();
    public boolean v = false;

    public Hilt_StoreDetailsActivity() {
        final StoreDetailsActivity storeDetailsActivity = (StoreDetailsActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.Hilt_StoreDetailsActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                StoreDetailsActivity storeDetailsActivity2 = storeDetailsActivity;
                if (storeDetailsActivity2.v) {
                    return;
                }
                storeDetailsActivity2.v = true;
                ((StoreDetailsActivity_GeneratedInjector) storeDetailsActivity2.t3()).D(storeDetailsActivity2);
            }
        });
    }
