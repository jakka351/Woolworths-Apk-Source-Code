...
@StabilityInferred
@Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0001\u0018\u00002\u00020\u0001:\u0001\u0004B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0007²\u0006\f\u0010\u0006\u001a\u00020\u00058\nX\u008a\u0084\u0002"}, d2 = {"Lau/com/woolworths/feature/shop/storelocator/legacy/pickup/details/StoreDetailsActivity;", "Landroidx/activity/ComponentActivity;", "<init>", "()V", "Companion", "Lau/com/woolworths/feature/shop/storelocator/legacy/pickup/details/StoreDetailsContract$ViewState;", "viewState", "storelocator-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
@SuppressLint
@AndroidEntryPoint
...
public final class StoreDetailsActivity extends Hilt_StoreDetailsActivity {
    ...
    public final ViewModelLazy x = new ViewModelLazy(Reflection.f24268a.b(StoreDetailsViewModel.class), new Function0<ViewModelStore>() { // from class: au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.StoreDetailsActivity$special$$inlined$assistedViewModels$1
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            return this.d.getViewModelStore();
        }
    }, new Function0<ViewModelProvider.Factory>() { // from class: au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.StoreDetailsActivity$special$$inlined$assistedViewModels$2
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            return this.d.getDefaultViewModelProviderFactory();
        }
    }, new Function0<CreationExtras>() { // from class: au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.StoreDetailsActivity$special$$inlined$assistedViewModels$3
        @Override // kotlin.jvm.functions.Function0
        public final Object invoke() {
            CreationExtras defaultViewModelCreationExtras = this.d.getDefaultViewModelCreationExtras();
            final StoreDetailsActivity storeDetailsActivity = this;
            return HiltViewModelExtensions.a(defaultViewModelCreationExtras, new Function1<StoreDetailsViewModel.Factory, ViewModel>() { // from class: au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.StoreDetailsActivity$special$$inlined$assistedViewModels$3.1
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    Bundle extras;
                    Activities.StoreDetailsLegacy.Extras extras2;
                    ...
                    if (intent == null || (extras = intent.getExtras()) == null || (extras2 = (Activities.StoreDetailsLegacy.Extras) extras.getParcelable("EXTRA_STORE_DETAILS_DATA")) == null) {
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001:\u0001\bR\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0006\u001a\u00020\u00058\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0006\u0010\u0007¨\u0006\t"}, d2 = {"Lau/com/woolworths/feature/shop/storelocator/legacy/pickup/details/StoreDetailsActivity$Companion;", "", "", "EXTRA_STORE", "Ljava/lang/String;", "", "REQUEST_CODE", "I", "Extras", "storelocator-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {

        @StabilityInferred
        @Parcelize
        @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/feature/shop/storelocator/legacy/pickup/details/StoreDetailsActivity$Companion$Extras;", "Landroid/os/Parcelable;", "storelocator-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
        ...
        public static void a(Activity activity, Store store, ActivityOptionsCompat activityOptionsCompat) {
            Intrinsics.h(store, "store");
            activity.startActivityForResult(Activities.StoreDetailsLegacy.f4546a.b(store, true, false), 202109, activityOptionsCompat.c());
        }
    }

    @Metadata(d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n"}, d2 = {"<anonymous>", "", "it", "Lau/com/woolworths/feature/shop/storelocator/legacy/pickup/details/StoreDetailsContract$ViewState;"}, k = 3, mv = {2, 1, 0}, xi = 48)
    @DebugMetadata(c = "au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.StoreDetailsActivity$onCreate$1", f = "StoreDetailsActivity.kt", l = {}, m = "invokeSuspend")
    /* renamed from: au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.StoreDetailsActivity$onCreate$1, reason: invalid class name */
    final class AnonymousClass1 extends SuspendLambda implements Function2<StoreDetailsContract.ViewState, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (viewAction != null) {
                ...
                if (z) {
                    String str = ((StoreDetailsContract.ViewAction.CallContactNumber) viewAction).f8193a;
                    int i = StoreDetailsActivity.y;
                    ...
                    String str2 = ((StoreDetailsContract.ViewAction.ShowLocationInMap) viewAction).f8196a;
                    ...
                    StoreLocatorResult.Store store = ((StoreDetailsContract.ViewAction.ShopInStoreSelected) viewAction).f8195a;
                    ...
                    if (!viewAction.equals(StoreDetailsContract.ViewAction.FinishSetUpPickUpLocator.f8194a)) {
    ...
    @Override // au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.Hilt_StoreDetailsActivity, androidx.activity.ComponentActivity, androidx.core.app.ComponentActivity, android.app.Activity
    public final void onCreate(Bundle bundle) {
        ...
        boolean z = extraLocationDetailsSource instanceof Activities.StoreDetailsLegacy.ExtrasByData;
        ViewModelLazy viewModelLazy = this.x;
        if (z) {
            StoreDetailsViewModel storeDetailsViewModel = (StoreDetailsViewModel) viewModelLazy.getD();
            Activities.StoreDetails.ExtraLocationDetailsData extraLocationDetailsData = ((Activities.StoreDetailsLegacy.ExtrasByData) extraLocationDetailsSource).d;
        ...
        } else if (extraLocationDetailsSource instanceof Activities.StoreDetailsLegacy.ExtrasByStoreNumber) {
            ((StoreDetailsViewModel) viewModelLazy.getD()).r6(((Activities.StoreDetailsLegacy.ExtrasByStoreNumber) extraLocationDetailsSource).d);
        }
        ...
        ComponentActivityKt.a(this, new ComposableLambdaImpl(new Function2<Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.StoreDetailsActivity.onCreate.2
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                ...
                if ((((Number) obj2).intValue() & 3) == 2 && composer.c()) {
                    ...
                    ThemeKt.b(6, composer, ComposableLambdaKt.c(-69500239, new Function2<Composer, Integer, Unit>() { // from class: au.com.woolworths.feature.shop.storelocator.legacy.pickup.details.StoreDetailsActivity.onCreate.2.1
                        @Override // kotlin.jvm.functions.Function2
