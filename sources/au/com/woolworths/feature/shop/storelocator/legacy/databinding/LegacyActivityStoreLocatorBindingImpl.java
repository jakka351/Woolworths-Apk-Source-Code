...
import au.com.woolworths.feature.shop.storelocator.legacy.generated.callback.OnClickListener;
import au.com.woolworths.feature.shop.storelocator.legacy.generated.callback.OnQueryTextChange1;
import au.com.woolworths.feature.shop.storelocator.legacy.generated.callback.OnQueryTextSubmit1;
import au.com.woolworths.feature.shop.storelocator.legacy.generated.callback.OnRefreshListener;
import com.airbnb.epoxy.EpoxyRecyclerView;
import com.google.android.material.button.MaterialButtonToggleGroup;
import com.woolworths.R;

/* loaded from: classes3.dex */
public class LegacyActivityStoreLocatorBindingImpl extends LegacyActivityStoreLocatorBinding implements OnClickListener.Listener, OnQueryTextSubmit1.Listener, OnRefreshListener.Listener, OnQueryTextChange1.Listener {
    public static final ViewDataBinding.IncludedLayouts P;
    public static final SparseIntArray Q;
    public final OnClickListener J;
    public final OnQueryTextSubmit1 K;
    public final OnRefreshListener L;
    public final OnClickListener M;
    public final OnQueryTextChange1 N;
    public long O;
    ...
    public LegacyActivityStoreLocatorBindingImpl(DataBindingComponent dataBindingComponent, View view) {
        ...
        this.K = new OnQueryTextSubmit1(this);
        this.L = new OnRefreshListener(this);
        this.M = new OnClickListener(this, 3);
        this.N = new OnQueryTextChange1(this);
        r();
    }
    ...
    @Override // au.com.woolworths.feature.shop.storelocator.legacy.databinding.LegacyActivityStoreLocatorBinding
    ...
    public final void j() {
        ...
        if (j2 != 0) {
            ...
            z = viewState != null && viewState.f8164a && viewState.c.isEmpty() && viewState.d.isEmpty();
            z2 = viewState != null && viewState.b == StoreLocatorContract.StoreListDisplayMode.e && viewState.e == null;
            z3 = (viewState == null || !viewState.f8164a || (viewState.c.isEmpty() && viewState.d.isEmpty())) ? false : true;
