...
/* renamed from: au.com.woolworths.feature.shop.modeselector.ui.ComposableSingletons$ShoppingModeOptionKt$lambda$-1494590579$1, reason: invalid class name */
/* loaded from: classes3.dex */
public final class ComposableSingletons$ShoppingModeOptionKt$lambda$1494590579$1 implements Function2<Composer, Integer, Unit> {
    public static final ComposableSingletons$ShoppingModeOptionKt$lambda$1494590579$1 d = new ComposableSingletons$ShoppingModeOptionKt$lambda$1494590579$1();
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((((Number) obj2).intValue() & 3) == 2 && composer.c()) {
            ...
            List<Item> list = shoppingModeSelectorOptionsSection.b;
            ArrayList arrayList = new ArrayList(CollectionsKt.s(list, 10));
            for (Item item : list) {
                ShoppingModeSelectorOptionStateApiData shoppingModeSelectorOptionStateApiData = ShoppingModeSelectorOptionStateApiData.d;
                arrayList.add(Item.a(item, 253));
            }
            ...
            if (objG == composer$Companion$Empty$1) {
                objG = new au.com.woolworths.feature.shop.marketplace.ui.facet.a(23);
                composer.A(objG);
            }
