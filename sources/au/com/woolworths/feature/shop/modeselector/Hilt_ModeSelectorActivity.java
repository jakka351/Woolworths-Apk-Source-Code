...
abstract class Hilt_ModeSelectorActivity extends ComponentActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder s;
    public volatile ActivityComponentManager t;
    public final Object u = new Object();
    public boolean v = false;

    public Hilt_ModeSelectorActivity() {
        final ModeSelectorActivity modeSelectorActivity = (ModeSelectorActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.modeselector.Hilt_ModeSelectorActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                ModeSelectorActivity modeSelectorActivity2 = modeSelectorActivity;
                if (modeSelectorActivity2.v) {
                    return;
                }
                modeSelectorActivity2.v = true;
                ((ModeSelectorActivity_GeneratedInjector) modeSelectorActivity2.t3()).getClass();
            }
        });
    }
