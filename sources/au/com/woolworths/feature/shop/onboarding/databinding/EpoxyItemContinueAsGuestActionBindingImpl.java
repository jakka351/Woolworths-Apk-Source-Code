...
public class EpoxyItemContinueAsGuestActionBindingImpl extends EpoxyItemContinueAsGuestActionBinding implements OnClickListener.Listener {
    public final OnClickListener A;
    public long B;

    public EpoxyItemContinueAsGuestActionBindingImpl(DataBindingComponent dataBindingComponent, View view) {
