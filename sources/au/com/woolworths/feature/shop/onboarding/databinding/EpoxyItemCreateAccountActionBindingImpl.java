...
public class EpoxyItemCreateAccountActionBindingImpl extends EpoxyItemCreateAccountActionBinding implements OnClickListener.Listener {
    public final OnClickListener A;
    public long B;

    public EpoxyItemCreateAccountActionBindingImpl(DataBindingComponent dataBindingComponent, View view) {
