...
public abstract class Hilt_OnboardingActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    ...
    public Hilt_OnboardingActivity() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.onboarding.Hilt_OnboardingActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                Hilt_OnboardingActivity hilt_OnboardingActivity = Hilt_OnboardingActivity.this;
                if (hilt_OnboardingActivity.w) {
                    return;
                }
                hilt_OnboardingActivity.w = true;
                ((OnboardingActivity_GeneratedInjector) hilt_OnboardingActivity.t3()).c((OnboardingActivity) hilt_OnboardingActivity);
            }
        });
    }
