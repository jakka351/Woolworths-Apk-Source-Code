...
abstract class Hilt_OnboardingSduiActivity extends ComponentActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder s;
    public volatile ActivityComponentManager t;
    public final Object u = new Object();
    public boolean v = false;

    public Hilt_OnboardingSduiActivity() {
        final OnboardingSduiActivity onboardingSduiActivity = (OnboardingSduiActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.onboarding.sdui.Hilt_OnboardingSduiActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                OnboardingSduiActivity onboardingSduiActivity2 = onboardingSduiActivity;
                if (onboardingSduiActivity2.v) {
                    return;
                }
                onboardingSduiActivity2.v = true;
                ((OnboardingSduiActivity_GeneratedInjector) onboardingSduiActivity2.t3()).q0(onboardingSduiActivity2);
            }
        });
    }
