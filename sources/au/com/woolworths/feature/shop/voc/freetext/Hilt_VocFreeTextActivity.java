...
abstract class Hilt_VocFreeTextActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder t;
    public volatile ActivityComponentManager u;
    public final Object v = new Object();
    public boolean w = false;

    public Hilt_VocFreeTextActivity() {
        final VocFreeTextActivity vocFreeTextActivity = (VocFreeTextActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.voc.freetext.Hilt_VocFreeTextActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                VocFreeTextActivity vocFreeTextActivity2 = vocFreeTextActivity;
                if (vocFreeTextActivity2.w) {
                    return;
                }
                vocFreeTextActivity2.w = true;
                ((VocFreeTextActivity_GeneratedInjector) vocFreeTextActivity2.t3()).e(vocFreeTextActivity2);
            }
        });
    }
