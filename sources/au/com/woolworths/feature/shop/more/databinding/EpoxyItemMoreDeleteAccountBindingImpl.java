...
public class EpoxyItemMoreDeleteAccountBindingImpl extends EpoxyItemMoreDeleteAccountBinding implements OnClickListener.Listener {
    public final ConstraintLayout B;
    public final OnClickListener C;
    public long D;

    /* JADX WARN: Illegal instructions before constructor call */
    public EpoxyItemMoreDeleteAccountBindingImpl(DataBindingComponent dataBindingComponent, View view) {
    ...
    public final void a(int i) {
        ...
        if (moreViewModel != null) {
            moreViewModel.f.c(MoreActions.s);
            moreViewModel.v.f(MoreContract.Actions.LaunchDeleteAccount.f7559a);
        }
    }
    ...
    public final void j() {
        ...
        MoreDeleteAccount moreDeleteAccount = this.z;
        long j2 = 5 & j;
        String title = (j2 == 0 || moreDeleteAccount == null) ? null : moreDeleteAccount.getTitle();
        if (j2 != 0) {
