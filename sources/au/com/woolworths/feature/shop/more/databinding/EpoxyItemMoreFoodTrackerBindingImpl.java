...
public class EpoxyItemMoreFoodTrackerBindingImpl extends EpoxyItemMoreFoodTrackerBinding implements OnClickListener.Listener {
    public final ConstraintLayout B;
    public final OnClickListener C;
    public long D;

    /* JADX WARN: Illegal instructions before constructor call */
    public EpoxyItemMoreFoodTrackerBindingImpl(DataBindingComponent dataBindingComponent, View view) {
    ...
    public final void a(int i) {
        String url;
        MoreFoodTracker moreFoodTracker = this.z;
        MoreViewModel moreViewModel = this.A;
        if (moreViewModel == null || moreFoodTracker == null || (url = moreFoodTracker.getUrl()) == null) {
            return;
        }
        moreViewModel.f.c(MoreActions.k);
    ...
    public final void j() {
        ...
        MoreFoodTracker moreFoodTracker = this.z;
        long j2 = 5 & j;
        String title = (j2 == 0 || moreFoodTracker == null) ? null : moreFoodTracker.getTitle();
        if (j2 != 0) {
