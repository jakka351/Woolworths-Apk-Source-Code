...
public class EpoxyItemMoreAppVersionBindingImpl extends EpoxyItemMoreAppVersionBinding {
    ...
    static {
        ...
        B = sparseIntArray;
        sparseIntArray.put(R.id.wapple_grey_image_view, 2);
    }
    ...
    public final void j() {
        ...
        if (j2 != 0) {
            ...
            ResWithArgText resWithArgText = moreData != null ? moreData.f : null;
            if (resWithArgText != null) {
                text = resWithArgText.getText(this.h.getContext());
            }
        }
        if (j2 != 0) {
