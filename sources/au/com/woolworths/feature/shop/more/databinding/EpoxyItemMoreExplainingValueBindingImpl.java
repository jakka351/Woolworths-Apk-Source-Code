...
public class EpoxyItemMoreExplainingValueBindingImpl extends EpoxyItemMoreExplainingValueBinding implements OnClickListener.Listener {
    public final ConstraintLayout B;
    public final OnClickListener C;
    public long D;

    /* JADX WARN: Illegal instructions before constructor call */
    public EpoxyItemMoreExplainingValueBindingImpl(DataBindingComponent dataBindingComponent, View view) {
    ...
    public final boolean G(int i, Object obj) throws Throwable {
        if (147 == i) {
            this.z = (MoreExplainingValue) obj;
            synchronized (this) {
                this.D |= 1;
            }
            h(147);
    ...
    public final void a(int i) {
        String url;
        MoreExplainingValue moreExplainingValue = this.z;
        MoreViewModel moreViewModel = this.A;
        if (moreViewModel == null || moreExplainingValue == null || (url = moreExplainingValue.getUrl()) == null) {
            return;
        }
        moreViewModel.f.c(MoreActions.j);
    ...
    public final void j() {
        ...
        MoreExplainingValue moreExplainingValue = this.z;
        long j2 = 5 & j;
        String title = (j2 == 0 || moreExplainingValue == null) ? null : moreExplainingValue.getTitle();
        if (j2 != 0) {
