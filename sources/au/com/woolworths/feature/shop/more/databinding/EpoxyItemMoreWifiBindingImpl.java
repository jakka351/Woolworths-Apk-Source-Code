...
public class EpoxyItemMoreWifiBindingImpl extends EpoxyItemMoreWifiBinding implements OnClickListener.Listener {
    public final ConstraintLayout B;
    public final OnClickListener C;
    public long D;

    /* JADX WARN: Illegal instructions before constructor call */
    public EpoxyItemMoreWifiBindingImpl(DataBindingComponent dataBindingComponent, View view) {
    ...
    public final void a(int i) {
        ...
        if (moreViewModel != null) {
            moreViewModel.f.c(MoreActions.n);
            moreViewModel.v.f(MoreContract.Actions.LaunchInstoreWifi.f7564a);
        }
    }
    ...
    public final void j() {
        ...
        MoreCiscoWiFi moreCiscoWiFi = this.z;
        long j2 = 5 & j;
        String title = (j2 == 0 || moreCiscoWiFi == null) ? null : moreCiscoWiFi.getTitle();
        if (j2 != 0) {
