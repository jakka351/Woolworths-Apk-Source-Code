...
public class EpoxyItemMoreReceiptPreferencesBindingImpl extends EpoxyItemMoreReceiptPreferencesBinding implements OnClickListener.Listener {
    public final ConstraintLayout B;
    public final OnClickListener C;
    public long D;

    /* JADX WARN: Illegal instructions before constructor call */
    public EpoxyItemMoreReceiptPreferencesBindingImpl(DataBindingComponent dataBindingComponent, View view) {
    ...
    public final boolean G(int i, Object obj) throws Throwable {
        if (147 == i) {
            this.z = (MoreReceiptPreferences) obj;
            synchronized (this) {
                this.D |= 1;
            }
            h(147);
    ...
    public final void a(int i) {
        String url;
        MoreReceiptPreferences moreReceiptPreferences = this.z;
        MoreViewModel moreViewModel = this.A;
        if (moreViewModel == null || moreReceiptPreferences == null || (url = moreReceiptPreferences.getUrl()) == null) {
            return;
        }
        moreViewModel.f.c(MoreActions.q);
    ...
    public final void j() {
        ...
        MoreReceiptPreferences moreReceiptPreferences = this.z;
        long j2 = 5 & j;
        String title = (j2 == 0 || moreReceiptPreferences == null) ? null : moreReceiptPreferences.getTitle();
        if (j2 != 0) {
