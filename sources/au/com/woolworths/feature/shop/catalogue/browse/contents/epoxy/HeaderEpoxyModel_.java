...
import au.com.woolworths.feature.shop.catalogue.browse.contents.epoxy.HeaderEpoxyModel;
...
public class HeaderEpoxyModel_ extends HeaderEpoxyModel implements GeneratedModel<HeaderEpoxyModel.Holder>, HeaderEpoxyModelBuilder {
    ...
    public final HeaderEpoxyModel_ K() {
        super.p("header");
        return this;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        String str = this.n;
        String str2 = ((HeaderEpoxyModel_) obj).n;
    ...
    public final String toString() {
        return "HeaderEpoxyModel_{image=" + this.n + "}" + super.toString();
    }
