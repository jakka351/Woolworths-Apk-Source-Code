...
public /* synthetic */ class CatalogueHomeActivity$selectInitialStore$1 implements ActivityResultCallback, FunctionAdapter {
    public final /* synthetic */ CatalogueHomeActivity d;

    public CatalogueHomeActivity$selectInitialStore$1(CatalogueHomeActivity catalogueHomeActivity) {
    ...
    public final void a(Object obj) {
        ...
        int i2 = p0.f6780a;
        CatalogueHomeActivity catalogueHomeActivity = this.d;
        if (i2 != -1) {
            catalogueHomeActivity.finish();
            return;
        }
    ...
    public final Function b() {
        return new FunctionReferenceImpl(1, this.d, CatalogueHomeActivity.class, "handleSelectInitialStore", "handleSelectInitialStore(Lau/com/woolworths/feature/shop/catalogue/CatalogueStoreSelectionResult;)V", 0);
    }
