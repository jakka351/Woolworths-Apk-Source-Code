...
public final class CatalogueListingQueryCatalogueListingExtKt {
    public static final CategoryListing a(CatalogueListingQuery.CatalogueListing catalogueListing) {
        Iterator it;
        ...
        Intrinsics.h(catalogueListing, "<this>");
        CatalogueListingQuery.Header header = catalogueListing.f21672a;
        ListingHeader listingHeader = header != null ? new ListingHeader(header.f21674a, header.b, header.c) : null;
        ArrayList arrayList4 = catalogueListing.b;
        ArrayList arrayList5 = new ArrayList();
        Iterator it2 = arrayList4.iterator();
        while (it2.hasNext()) {
            CatalogueListingQuery.OnProductCard onProductCard = ((CatalogueListingQuery.Item) it2.next()).b;
        ...
        return new CategoryListing(listingHeader, arrayList5);
    }
}
