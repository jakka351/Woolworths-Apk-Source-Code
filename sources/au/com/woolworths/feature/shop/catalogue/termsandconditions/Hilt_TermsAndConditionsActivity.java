...
abstract class Hilt_TermsAndConditionsActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    ...
    public Hilt_TermsAndConditionsActivity() {
        ...
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.catalogue.termsandconditions.Hilt_TermsAndConditionsActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                TermsAndConditionsActivity termsAndConditionsActivity2 = termsAndConditionsActivity;
                if (termsAndConditionsActivity2.w) {
                    return;
                }
                termsAndConditionsActivity2.w = true;
                ((TermsAndConditionsActivity_GeneratedInjector) termsAndConditionsActivity2.t3()).getClass();
            }
        });
    }
