...
@DebugMetadata(c = "au.com.woolworths.feature.shop.recipes.recipes.RecipesInteractor$fetchRecipeListBySourceAndTags$1", f = "RecipesInteractor.kt", l = {40, 50, 57}, m = "invokeSuspend")
/* loaded from: classes3.dex */
final class RecipesInteractor$fetchRecipeListBySourceAndTags$1 extends SuspendLambda implements Function3<Integer, Integer, Continuation<? super NumericPageData<Object>>, Object> {
    public int p;
    ...
    public RecipesInteractor$fetchRecipeListBySourceAndTags$1(RecipesInteractor recipesInteractor, List list, String str, Continuation continuation) {
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        List list = this.s;
        String str = this.t;
        RecipesInteractor$fetchRecipeListBySourceAndTags$1 recipesInteractor$fetchRecipeListBySourceAndTags$1 = new RecipesInteractor$fetchRecipeListBySourceAndTags$1(this.r, list, str, (Continuation) obj3);
        recipesInteractor$fetchRecipeListBySourceAndTags$1.q = (Integer) obj;
        return recipesInteractor$fetchRecipeListBySourceAndTags$1.invokeSuspend(Unit.f24250a);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Exception {
        ...
        if (i == 0) {
            ...
            this.p = 1;
            objA = recipesRepository.a(this.s, num, this.t, null, collectionModeW, this);
