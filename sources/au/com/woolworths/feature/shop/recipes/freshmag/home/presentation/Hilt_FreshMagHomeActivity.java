...
abstract class Hilt_FreshMagHomeActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder t;
    public volatile ActivityComponentManager u;
    public final Object v = new Object();
    public boolean w = false;

    public Hilt_FreshMagHomeActivity() {
        final FreshMagHomeActivity freshMagHomeActivity = (FreshMagHomeActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.recipes.freshmag.home.presentation.Hilt_FreshMagHomeActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                FreshMagHomeActivity freshMagHomeActivity2 = freshMagHomeActivity;
                if (freshMagHomeActivity2.w) {
                    return;
                }
                freshMagHomeActivity2.w = true;
                ((FreshMagHomeActivity_GeneratedInjector) freshMagHomeActivity2.t3()).L(freshMagHomeActivity2);
            }
        });
    }
