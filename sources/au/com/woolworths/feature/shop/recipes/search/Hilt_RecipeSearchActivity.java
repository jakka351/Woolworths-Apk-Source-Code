...
abstract class Hilt_RecipeSearchActivity extends ComponentActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder s;
    public volatile ActivityComponentManager t;
    public final Object u = new Object();
    public boolean v = false;

    public Hilt_RecipeSearchActivity() {
        final RecipeSearchActivity recipeSearchActivity = (RecipeSearchActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.feature.shop.recipes.search.Hilt_RecipeSearchActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                RecipeSearchActivity recipeSearchActivity2 = recipeSearchActivity;
                if (recipeSearchActivity2.v) {
                    return;
                }
                recipeSearchActivity2.v = true;
                ((RecipeSearchActivity_GeneratedInjector) recipeSearchActivity2.t3()).getClass();
            }
        });
    }
