...
public final class ComposableSingletons$LandingPageScreenUiKt$lambda$1939342258$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((((Number) obj2).intValue() & 3) == 2 && composer.c()) {
            ...
            DynamicPageContract.ViewState viewState = new DynamicPageContract.ViewState(null, DynamicPageErrorState.e, 21);
            composer.o(1849434622);
            Object objG = composer.G();
            Composer$Companion$Empty$1 composer$Companion$Empty$1 = Composer.Companion.f1624a;
            if (objG == composer$Companion$Empty$1) {
                objG = new androidx.navigation.compose.h(15, (byte) 0);
                composer.A(objG);
            }
