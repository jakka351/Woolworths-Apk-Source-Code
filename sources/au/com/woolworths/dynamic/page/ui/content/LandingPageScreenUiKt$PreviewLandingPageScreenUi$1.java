...
final class LandingPageScreenUiKt$PreviewLandingPageScreenUi$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((((Number) obj2).intValue() & 3) == 2 && composer.c()) {
            ...
            composer.l();
            DynamicPageContract.ViewState viewState = new DynamicPageContract.ViewState((DynamicPageFeedData) ((MutableState) objG).getD(), null, 25);
            composer.o(1849434622);
            Object objG2 = composer.G();
            if (objG2 == composer$Companion$Empty$1) {
                objG2 = new androidx.navigation.compose.h(21, (byte) 0);
                composer.A(objG2);
            }
