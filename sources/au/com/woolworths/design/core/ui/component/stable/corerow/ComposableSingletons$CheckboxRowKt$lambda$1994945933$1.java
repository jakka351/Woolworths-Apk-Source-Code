...
public final class ComposableSingletons$CheckboxRowKt$lambda$1994945933$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((((Number) obj2).intValue() & 3) == 2 && composer.c()) {
            ...
            if (objG == Composer.Companion.f1624a) {
                objG = new au.com.woolworths.android.onesite.repository.b(28);
                composer.A(objG);
            }
            composer.l();
            CheckboxRowKt.a("Title", checkBoxState, (Function1) objG, null, false, null, "Overline", null, localImage, text, dividerType, composer, 1573302, 6, 184);
        }
        return Unit.f24250a;
    }
}
