...
public final class ComposableSingletons$CoachMarkKt$lambda$1402417217$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((((Number) obj2).intValue() & 3) == 2 && composer.c()) {
            ...
            CoachMarkState coachMarkState = new CoachMarkState(true, new Rect(100.0f, 200.0f, 300.0f, 300.0f));
            ...
            composer.l();
            CoachMarkKt.a(coachMarkState, (Function0) objG, BitmapDescriptorFactory.HUE_RED, 20, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, ComposableSingletons$CoachMarkKt.b, composer, 100666416, 244);
            composer.f();
        }
        return Unit.f24250a;
    }
