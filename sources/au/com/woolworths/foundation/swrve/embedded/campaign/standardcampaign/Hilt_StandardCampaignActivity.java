...
abstract class Hilt_StandardCampaignActivity extends ComponentActivity implements GeneratedComponentManagerHolder {
    public SavedStateHandleHolder s;
    public volatile ActivityComponentManager t;
    public final Object u = new Object();
    public boolean v = false;

    public Hilt_StandardCampaignActivity() {
        final StandardCampaignActivity standardCampaignActivity = (StandardCampaignActivity) this;
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: au.com.woolworths.foundation.swrve.embedded.campaign.standardcampaign.Hilt_StandardCampaignActivity.1
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void a(ComponentActivity componentActivity) {
                StandardCampaignActivity standardCampaignActivity2 = standardCampaignActivity;
                if (standardCampaignActivity2.v) {
                    return;
                }
                standardCampaignActivity2.v = true;
                ((StandardCampaignActivity_GeneratedInjector) standardCampaignActivity2.t3()).i0(standardCampaignActivity2);
            }
        });
    }
