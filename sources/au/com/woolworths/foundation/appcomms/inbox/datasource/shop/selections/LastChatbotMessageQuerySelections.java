...
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\bÀ\u0002\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lau/com/woolworths/foundation/appcomms/inbox/datasource/shop/selections/LastChatbotMessageQuerySelections;", "", "inbox-datasource-shop"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes4.dex */
public final class LastChatbotMessageQuerySelections {

    /* renamed from: a, reason: collision with root package name */
    public static final List f8472a;
    public static final List b;

    static {
        CompiledField compiledFieldC = new CompiledField.Builder("__typename", CompiledGraphQL.b(GraphQLString.f11443a)).c();
        CompiledFragment.Builder builder = new CompiledFragment.Builder("LastChatbotMsg", CollectionsKt.Q("LastChatbotMsg"));
        builder.b(LastChatbotMessageSelections.f8470a);
        List listR = CollectionsKt.R(compiledFieldC, builder.a());
        f8472a = listR;
        CompiledField.Builder builder2 = new CompiledField.Builder("lastChatbotMsg", CompiledGraphQL.b(LastChatbotMsg.f11512a));
