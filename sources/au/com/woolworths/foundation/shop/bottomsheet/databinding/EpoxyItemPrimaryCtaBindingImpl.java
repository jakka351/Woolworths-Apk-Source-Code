...
public class EpoxyItemPrimaryCtaBindingImpl extends EpoxyItemPrimaryCtaBinding implements OnClickListener.Listener {
    public final OnClickListener B;
    public long C;

    public EpoxyItemPrimaryCtaBindingImpl(DataBindingComponent dataBindingComponent, View view) {
    ...
    public final void a(int i) {
        ...
        if (ctaClickListener != null) {
            ctaClickListener.c4(contentCta);
        }
    }
