...
public abstract class EpoxyItemSecondaryCtaBinding extends ViewDataBinding {
    public BaseBottomSheetContract.CtaClickListener A;
    public final Button y;
    public ContentCta z;

    public EpoxyItemSecondaryCtaBinding(DataBindingComponent dataBindingComponent, View view, Button button) {
