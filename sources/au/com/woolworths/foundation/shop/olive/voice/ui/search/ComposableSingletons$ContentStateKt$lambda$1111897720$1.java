...
public final class ComposableSingletons$ContentStateKt$lambda$1111897720$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        if ((((Number) obj2).intValue() & 3) == 2 && composer.c()) {
            ...
            ContentStateKt.a(new VoiceSearchState.Failure(new VoiceSearchError.ProductNotFound("Rose water gel balm")), false, true, BoxScopeInstance.f944a.g(companion, Alignment.Companion.e), composer, 432);
            composer.f();
        }
        return Unit.f24250a;
    }
