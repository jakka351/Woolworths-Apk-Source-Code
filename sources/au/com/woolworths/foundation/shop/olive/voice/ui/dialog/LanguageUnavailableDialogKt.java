...
public final class LanguageUnavailableDialogKt {
    public static final void a(int i, Composer composer, Modifier modifier, Function0 onPrimaryAction, Function0 onDismissAction) {
        ...
        ComposerImpl composerImplV = composer.v(-445736150);
        if ((i & 6) == 0) {
        ...
        if ((i3 & 147) == 146 && composerImplV.c()) {
            ...
            String strC = StringResources_androidKt.c(composerImplV, R.string.olive_voice_language_unavailable_dialog_title);
            String strC2 = StringResources_androidKt.c(composerImplV, R.string.olive_voice_language_unavailable_dialog_body);
            ...
            if (z2 || objG2 == composer$Companion$Empty$1) {
                objG2 = new k(19, onDismissAction);
        ...
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new a(onPrimaryAction, onDismissAction, modifier2, i, 4);
        }
    }
}
