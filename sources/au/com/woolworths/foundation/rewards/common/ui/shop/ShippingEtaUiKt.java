...
public final class ShippingEtaUiKt {
    public static final void a(TextWithAlt textWithAlt, IconAsset.LocalAsset localAsset, Modifier modifier, Composer composer, int i) {
        ...
        ComposerImpl composerImplV = composer.v(529684099);
        if ((i & 6) == 0) {
        ...
        if ((i2 & 147) == 146 && composerImplV.c()) {
            ...
            IconAssetUiKt.b(localAsset2, RewardsColors.f5157a, null, composerImplV, (i2 >> 3) & 14, 4);
            Modifier modifierA = RowScopeInstance.f974a.a(PaddingKt.j(Modifier.Companion.d, 8, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 14), 1.0f, true);
            composerImplV.o(5004770);
            boolean z = (i2 & 14) == 4 || ((i2 & 8) != 0 && composerImplV.I(textWithAlt));
            Object objG = composerImplV.G();
            if (z || objG == Composer.Companion.f1624a) {
                objG = new a(textWithAlt, 0);
                composerImplV.A(objG);
            }
            composerImplV.V(false);
            TextKt.b(textWithAlt.getText(), SemanticsModifierKt.b(modifierA, false, (Function1) objG), 0L, 0L, null, 0L, null, null, 0L, 0, false, 0, 0, null, WxTheme.b(composerImplV).n, composerImplV, 0, 0, 65532);
            composerImplV = composerImplV;
            composerImplV.V(true);
        }
        RecomposeScopeImpl recomposeScopeImplX = composerImplV.X();
        if (recomposeScopeImplX != null) {
            recomposeScopeImplX.d = new b(textWithAlt, localAsset, modifier, i, 0);
        }
    }
}
