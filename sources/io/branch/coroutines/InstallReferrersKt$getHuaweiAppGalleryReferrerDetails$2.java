...
final class InstallReferrersKt$getHuaweiAppGalleryReferrerDetails$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super InstallReferrerResult>, Object> {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new InstallReferrersKt$getHuaweiAppGalleryReferrerDetails$2(this.q, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((InstallReferrersKt$getHuaweiAppGalleryReferrerDetails$2) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.f24250a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            BranchLogger.f("Caught getHuaweiAppGalleryReferrerDetails exception: " + e);
        }
        if (i == 0) {
            ResultKt.b(obj);
            if (DependencyUtilsKt.a("com.huawei.hms.ads.installreferrer.api.InstallReferrerClient")) {
                ...
                InstallReferrerClient.newBuilder(this.q).build().startConnection(new InstallReferrerStateListener() { // from class: io.branch.coroutines.InstallReferrersKt$getHuaweiAppGalleryReferrerDetails$2.1
                });
                this.p = 1;
