...
public final class CoroutineExceptionHandlerKt {
    public static final void a(Throwable th, CoroutineContext coroutineContext) {
        ...
        try {
            CoroutineExceptionHandler coroutineExceptionHandler = (CoroutineExceptionHandler) coroutineContext.get(CoroutineExceptionHandler.Key.d);
            if (coroutineExceptionHandler != null) {
                coroutineExceptionHandler.d(th);
            } else {
