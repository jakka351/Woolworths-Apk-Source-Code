...
final class DispatcherScheduler$scheduleDirect$1$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public DispatcherScheduler$scheduleDirect$1$1$1(Function1 function1, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new DispatcherScheduler$scheduleDirect$1$1$1(this.q, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((DispatcherScheduler$scheduleDirect$1$1$1) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.f24250a);
    }
