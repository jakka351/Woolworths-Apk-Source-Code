...
final class FlowKt__CountKt$count$1<T> extends ContinuationImpl {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        Object obj2 = flowKt__CountKt$count$1.q;
        CoroutineSingletons coroutineSingletons = CoroutineSingletons.d;
        int i2 = flowKt__CountKt$count$1.r;
        if (i2 == 0) {
            ResultKt.b(obj2);
            flowKt__CountKt$count$1.p = new Ref.IntRef();
            flowKt__CountKt$count$1.r = 1;
            throw null;
        }
        if (i2 != 1) {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        Ref.IntRef intRef = flowKt__CountKt$count$1.p;
        ResultKt.b(obj2);
