...
final class ChannelsKt__DeprecatedKt$single$1<E> extends ContinuationImpl {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        Object obj3 = channelsKt__DeprecatedKt$single$1.r;
        CoroutineSingletons coroutineSingletons = CoroutineSingletons.d;
        int i2 = channelsKt__DeprecatedKt$single$1.s;
        ReceiveChannel receiveChannel2 = null;
        if (i2 != 0) {
            if (i2 == 1) {
                ChannelIterator channelIterator = (ChannelIterator) channelsKt__DeprecatedKt$single$1.q;
                ReceiveChannel receiveChannel3 = channelsKt__DeprecatedKt$single$1.p;
                try {
                    ResultKt.b(obj3);
                    ...
                    channelsKt__DeprecatedKt$single$1.p = receiveChannel3;
                    channelsKt__DeprecatedKt$single$1.q = next;
                    channelsKt__DeprecatedKt$single$1.s = 2;
                    Object objB = channelIterator.b(channelsKt__DeprecatedKt$single$1);
                ...
                obj2 = channelsKt__DeprecatedKt$single$1.q;
                receiveChannel = channelsKt__DeprecatedKt$single$1.p;
                try {
                    ResultKt.b(obj3);
                } catch (Throwable th2) {
                    th = th2;
