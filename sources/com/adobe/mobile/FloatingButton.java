...
public class FloatingButton extends Button implements View.OnTouchListener {
    ...
    public float e;
    public float f;
    public OnButtonDetachedFromWindowListener g;
    public OnPositionChangedListener h;
    public float i;
    public float j;

    /* renamed from: com.adobe.mobile.FloatingButton$2, reason: invalid class name */
    final class AnonymousClass2 implements Runnable {
        @Override // java.lang.Runnable
        public final void run() {
            try {
                FloatingButton floatingButton = (FloatingButton) ((ViewGroup) StaticMethods.q().getWindow().getDecorView().getRootView()).findViewWithTag("ADBFloatingButtonTag");
                if (floatingButton != null) {
                    floatingButton.setVisibility(8);
                }
            } catch (Exception e) {
                int i = FloatingButton.k;
                StaticMethods.I("%s - error hiding the Target Preview button (%s)", "FloatingButton", e);
            }
        }
    }

    public interface OnButtonDetachedFromWindowListener {
        void b(FloatingButton floatingButton);
    }
    ...
    public final void a(float f, float f2) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        try {
            ...
            OnPositionChangedListener onPositionChangedListener = this.h;
            if (onPositionChangedListener != null) {
                onPositionChangedListener.a(f, f2);
            }
        } catch (Exception e) {
            StaticMethods.I("%s - Could not set display co-ordinates for FloatingButton (%s)", "FloatingButton", e);
        }
    }

    public final void b(Activity activity, TargetPreviewManager targetPreviewManager, TargetPreviewManager targetPreviewManager2) {
        if (activity == null) {
            StaticMethods.J("Could not show the Target Preview button - no activity set!", new Object[0]);
            return;
        }
        ...
        this.g = targetPreviewManager;
        this.h = targetPreviewManager2;
        try {
            ...
            activity.runOnUiThread(new Runnable() { // from class: com.adobe.mobile.FloatingButton.1
                ...
                public final void run() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
                    ...
                    final int measuredWidth = viewGroup2.getMeasuredWidth() == 0 ? i2 : viewGroup2.getMeasuredWidth();
                    final int measuredHeight = viewGroup2.getMeasuredHeight() == 0 ? i : viewGroup2.getMeasuredHeight();
                    FloatingButton floatingButton = (FloatingButton) viewGroup2.findViewWithTag("ADBFloatingButtonTag");
                    if (floatingButton != null) {
                        float width = TargetPreviewManager.d().b;
                        float height = TargetPreviewManager.d().c;
                        float f = measuredWidth;
                        int i3 = FloatingButton.k;
                        if (width > f - floatingButton.getWidth()) {
                            width = f - floatingButton.getWidth();
                        }
                        float f2 = measuredHeight;
                        if (height > f2 - floatingButton.getHeight()) {
                            height = f2 - floatingButton.getHeight();
                        }
                        floatingButton.a(width, height);
                        return;
                    }
                    FloatingButton floatingButton2 = FloatingButton.this;
                    floatingButton2.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.adobe.mobile.FloatingButton.1.1
                        @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
                        public final void onGlobalLayout() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
                            FloatingButton floatingButton3 = FloatingButton.this;
                            ViewTreeObserver viewTreeObserver = floatingButton3.getViewTreeObserver();
                            try {
                                ...
                                StaticMethods.I("%s - Error while removing onGlobalLayoutListener (%s)", "FloatingButton", e);
                            }
                            float width2 = floatingButton3.i;
                            int i4 = measuredHeight;
                            int i5 = measuredWidth;
                            if (width2 < BitmapDescriptorFactory.HUE_RED || floatingButton3.j < BitmapDescriptorFactory.HUE_RED) {
                                floatingButton3.a((i5 / 2) - (floatingButton3.getWidth() / 2), (i4 / 2) - (floatingButton3.getHeight() / 2));
                                return;
                            }
                            float f3 = i5;
                            if (width2 > f3 - floatingButton3.getWidth()) {
                                width2 = f3 - floatingButton3.getWidth();
                            }
                            floatingButton3.i = width2;
                            float f4 = i4;
                            float height2 = floatingButton3.j;
                            if (height2 > f4 - floatingButton3.getHeight()) {
                                height2 = f4 - floatingButton3.getHeight();
                            }
                            floatingButton3.j = height2;
                            floatingButton3.a(floatingButton3.i, floatingButton3.j);
                        }
                    });
                    viewGroup2.addView(floatingButton2);
                    ViewGroup.LayoutParams layoutParams = floatingButton2.getLayoutParams();
                    if (layoutParams != null) {
                        int i4 = FloatingButton.k;
                        int iRound2 = 210;
                        try {
                            iRound = Math.round(80 * floatingButton2.getResources().getDisplayMetrics().density);
                        } catch (Exception unused) {
                            iRound = 210;
                        }
                        layoutParams.width = iRound;
                        try {
                            iRound2 = Math.round(80 * floatingButton2.getResources().getDisplayMetrics().density);
            ...
            StaticMethods.K("%s - could not show Target Preview button (%s)", "FloatingButton", e);
        }
    }

    public float getXCompat() {
        try {
            return ((Float) getClass().getSuperclass().getSuperclass().getSuperclass().getDeclaredMethod("getX", null).invoke(this, null)).floatValue();
        } catch (Exception e) {
            StaticMethods.I("%s - Could not get x co-ordinate for FloatingButton (%s)", "FloatingButton", e);
            return -1.0f;
        }
    }
    ...
    public float getYCompat() {
        try {
            return ((Float) getClass().getSuperclass().getSuperclass().getSuperclass().getDeclaredMethod("getY", null).invoke(this, null)).floatValue();
        } catch (Exception e) {
            StaticMethods.I("%s - Could not get y co-ordinate for FloatingButton (%s)", "FloatingButton", e);
            return -1.0f;
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        OnButtonDetachedFromWindowListener onButtonDetachedFromWindowListener = this.g;
        if (onButtonDetachedFromWindowListener != null) {
            onButtonDetachedFromWindowListener.b(this);
        }
    }

    @Override // android.view.View.OnTouchListener
    public final boolean onTouch(View view, MotionEvent motionEvent) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        if (motionEvent.getAction() == 1) {
            ...
            float fAbs = Math.abs(rawY - this.e) + Math.abs(rawX - this.d);
            if (fAbs > this.f) {
                this.f = fAbs;
            }
        }
