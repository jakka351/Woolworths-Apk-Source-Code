...
final class b implements FrameSourceListener {

    /* renamed from: a, reason: collision with root package name */
    private final WeakReference f18847a;

    public b(Camera owner) {
        Intrinsics.h(owner, "owner");
        this.f18847a = new WeakReference(owner);
    }
    ...
    public final void onFrameOutput(FrameSource frameSource, FrameData frame) {
        ...
        Camera camera = (Camera) this.f18847a.get();
