...
final class h extends Lambda implements Function1 {
    ...
    final /* synthetic */ NativeWrappedPromise f18583a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public h(NativeWrappedPromise nativeWrappedPromise) {
        super(1);
        this.f18583a = nativeWrappedPromise;
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Object obj) {
        WrappedPromiseUtilsKt.synchronizedSetValueIfNoValue(this.f18583a, ((Boolean) obj).booleanValue());
        return Unit.f24250a;
    }
}
