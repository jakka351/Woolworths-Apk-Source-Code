...
public final class C0927y3 implements InterfaceC0600e4 {
    @Override // com.scandit.datacapture.barcode.InterfaceC0600e4
    public final BarcodePickIcon a(BarcodePickState state) {
        Intrinsics.h(state, "state");
        int i = AbstractC0912x3.f18258a[state.ordinal()];
        if (i != 1 && i != 2) {
            if (i == 3) {
                return new C0798q9(R.drawable.sc_ic_barcode_pick_plus);
            }
            if (i == 4) {
