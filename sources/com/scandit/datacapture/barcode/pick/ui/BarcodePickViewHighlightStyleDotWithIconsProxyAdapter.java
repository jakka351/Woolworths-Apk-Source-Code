...
@Metadata(d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\n\b\u0000\u0018\u00002\u00020\u0001B\u0019\u0012\u0006\u0010 \u001a\u00020\u0002\u0012\b\b\u0002\u0010\u0014\u001a\u00020\u000f¢\u0006\u0004\b!\u0010\"J\b\u0010\u0003\u001a\u00020\u0002H\u0016J\b\u0010\u0005\u001a\u00020\u0004H\u0016J\u0010\u0010\t\u001a\u00020\b2\u0006\u0010\u0007\u001a\u00020\u0006H\u0016J\u0018\u0010\f\u001a\u00020\u000b2\u0006\u0010\n\u001a\u00020\b2\u0006\u0010\u0007\u001a\u00020\u0006H\u0016J\u0012\u0010\r\u001a\u0004\u0018\u00010\b2\u0006\u0010\u0007\u001a\u00020\u0006H\u0016J\u001a\u0010\u000e\u001a\u00020\u000b2\b\u0010\n\u001a\u0004\u0018\u00010\b2\u0006\u0010\u0007\u001a\u00020\u0006H\u0016R\u001a\u0010\u0014\u001a\u00020\u000f8\u0000X\u0080\u0004¢\u0006\f\n\u0004\b\u0010\u0010\u0011\u001a\u0004\b\u0012\u0010\u0013R\u0014\u0010\u0018\u001a\u00020\u00158VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\u0016\u0010\u0017R$\u0010\u001f\u001a\u00020\u00192\u0006\u0010\u001a\u001a\u00020\u00198V@VX\u0096\u000e¢\u0006\f\u001a\u0004\b\u001b\u0010\u001c\"\u0004\b\u001d\u0010\u001e¨\u0006#"}, d2 = {"Lcom/scandit/datacapture/barcode/pick/ui/BarcodePickViewHighlightStyleDotWithIconsProxyAdapter;", "Lcom/scandit/datacapture/barcode/pick/ui/BarcodePickViewHighlightStyleDotWithIconsProxy;", "Lcom/scandit/datacapture/barcode/internal/module/pick/ui/NativeBarcodePickViewHighlightStyleDotWithIcons;", "_impl", "Lcom/scandit/datacapture/barcode/internal/module/pick/ui/NativeBarcodePickViewHighlightStyle;", "_highlightStyleImpl", "Lcom/scandit/datacapture/barcode/pick/capture/BarcodePickState;", "state", "Lcom/scandit/datacapture/core/ui/style/Brush;", "getBrushForState", "brush", "", "setBrushForState", "getSelectedBrushForState", "setSelectedBrushForState", "Lcom/scandit/datacapture/tools/internal/sdk/ProxyCache;", "b", "Lcom/scandit/datacapture/tools/internal/sdk/ProxyCache;", "getProxyCache$scandit_barcode_capture", "()Lcom/scandit/datacapture/tools/internal/sdk/ProxyCache;", "proxyCache", "Lcom/scandit/datacapture/barcode/pick/ui/BarcodePickIconStyle;", "getIconStyle", "()Lcom/scandit/datacapture/barcode/pick/ui/BarcodePickIconStyle;", "iconStyle", "", "p0", "getStyleResponseCacheEnabled", "()Z", "setStyleResponseCacheEnabled", "(Z)V", "styleResponseCacheEnabled", "_NativeBarcodePickViewHighlightStyleDotWithIcons", "<init>", "(Lcom/scandit/datacapture/barcode/internal/module/pick/ui/NativeBarcodePickViewHighlightStyleDotWithIcons;Lcom/scandit/datacapture/tools/internal/sdk/ProxyCache;)V", "scandit-barcode-capture"}, k = 1, mv = {1, 8, 0})
...
public final class BarcodePickViewHighlightStyleDotWithIconsProxyAdapter implements BarcodePickViewHighlightStyleDotWithIconsProxy {
    ...
    private final NativeBarcodePickViewHighlightStyleDotWithIcons f17948a;

    /* renamed from: b, reason: from kotlin metadata */
    private final ProxyCache proxyCache;
    private final NativeBarcodePickViewHighlightStyle c;

    public BarcodePickViewHighlightStyleDotWithIconsProxyAdapter(@NotNull NativeBarcodePickViewHighlightStyleDotWithIcons _NativeBarcodePickViewHighlightStyleDotWithIcons, @NotNull ProxyCache proxyCache) {
        Intrinsics.h(_NativeBarcodePickViewHighlightStyleDotWithIcons, "_NativeBarcodePickViewHighlightStyleDotWithIcons");
        Intrinsics.h(proxyCache, "proxyCache");
        this.f17948a = _NativeBarcodePickViewHighlightStyleDotWithIcons;
    ...
    public Brush getBrushForState(@NotNull BarcodePickState state) {
        ...
        NativeBrush _1 = this.f17948a.brushForState(BarcodeNativeTypeFactory.INSTANCE.convert(state));
    ...
    public BarcodePickIconStyle getIconStyle() {
        NativeBarcodePickIconStyle _0 = this.f17948a.getIconStyle();
    ...
    public Brush getSelectedBrushForState(@NotNull BarcodePickState state) {
        Intrinsics.h(state, "state");
        NativeBrush nativeBrushSelectedBrushForState = this.f17948a.selectedBrushForState(BarcodeNativeTypeFactory.INSTANCE.convert(state));
    ...
    public boolean getStyleResponseCacheEnabled() {
        return this.f17948a.getStyleResponseCacheEnabled();
    }
    ...
    public void setBrushForState(@NotNull Brush brush, @NotNull BarcodePickState state) {
        ...
        Intrinsics.h(state, "state");
        this.f17948a.setBrushForState(CoreNativeTypeFactory.INSTANCE.convert(brush), BarcodeNativeTypeFactory.INSTANCE.convert(state));
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleDotWithIconsProxy
    public void setSelectedBrushForState(@Nullable Brush brush, @NotNull BarcodePickState state) {
        Intrinsics.h(state, "state");
        this.f17948a.setSelectedBrushForState(brush != null ? CoreNativeTypeFactory.INSTANCE.convert(brush) : null, BarcodeNativeTypeFactory.INSTANCE.convert(state));
    }

    @Override // com.scandit.datacapture.barcode.pick.ui.BarcodePickViewHighlightStyleDotWithIconsProxy
    public void setStyleResponseCacheEnabled(boolean z) {
        this.f17948a.setStyleResponseCacheEnabled(z);
    }

    public /* synthetic */ BarcodePickViewHighlightStyleDotWithIconsProxyAdapter(NativeBarcodePickViewHighlightStyleDotWithIcons nativeBarcodePickViewHighlightStyleDotWithIcons, ProxyCache proxyCache, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(nativeBarcodePickViewHighlightStyleDotWithIcons, (i & 2) != 0 ? ProxyCacheKt.getGlobalProxyCache() : proxyCache);
    }
}
