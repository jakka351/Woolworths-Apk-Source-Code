...
@StabilityInferred
@Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\bÇ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J&\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\r¨\u0006\u000e"}, d2 = {"Lcom/woolworths/product/list/legacy/adapter/ProductsOnSpecialByCategoryQuery_VariablesAdapter;", "", "<init>", "()V", "serializeVariables", "", "writer", "Lcom/apollographql/apollo/api/json/JsonWriter;", "value", "Lcom/woolworths/product/list/legacy/ProductsOnSpecialByCategoryQuery;", "customScalarAdapters", "Lcom/apollographql/apollo/api/CustomScalarAdapters;", "withDefaultValues", "", "product-list-legacy_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes7.dex */
public final class ProductsOnSpecialByCategoryQuery_VariablesAdapter {
    public static final int $stable = 0;

    @NotNull
    public static final ProductsOnSpecialByCategoryQuery_VariablesAdapter INSTANCE = new ProductsOnSpecialByCategoryQuery_VariablesAdapter();

    private ProductsOnSpecialByCategoryQuery_VariablesAdapter() {
    }

    public final void serializeVariables(@NotNull JsonWriter writer, @NotNull ProductsOnSpecialByCategoryQuery value, @NotNull CustomScalarAdapters customScalarAdapters, boolean withDefaultValues) {
        ...
        if (value.getIncludeMarketProducts() instanceof Optional.Present) {
            writer.F1("includeMarketProducts");
            Adapters.d(Adapters.l).toJson(writer, customScalarAdapters, (Optional.Present) value.getIncludeMarketProducts());
        }
