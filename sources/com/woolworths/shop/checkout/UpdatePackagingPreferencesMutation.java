...
import com.woolworths.shop.checkout.adapter.UpdatePackagingPreferencesMutation_ResponseAdapter;
import com.woolworths.shop.checkout.fragment.CheckoutContent;
import kotlin.Metadata;
import kotlin.jvm.internal.Intrinsics;

@StabilityInferred
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0087\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0003\u0003\u0004\u0005¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/UpdatePackagingPreferencesMutation;", "Lcom/apollographql/apollo/api/Mutation;", "Lcom/woolworths/shop/checkout/UpdatePackagingPreferencesMutation$Data;", "Data", "UpdatePackagingPreferences", "Companion", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes7.dex */
public final /* data */ class UpdatePackagingPreferencesMutation implements Mutation<Data> {
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/UpdatePackagingPreferencesMutation$Companion;", "", "", "OPERATION_ID", "Ljava/lang/String;", "OPERATION_NAME", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/UpdatePackagingPreferencesMutation$Data;", "Lcom/apollographql/apollo/api/Mutation$Data;", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Data implements Mutation.Data {

        /* renamed from: a, reason: collision with root package name */
        public final UpdatePackagingPreferences f21922a;

        public Data(UpdatePackagingPreferences updatePackagingPreferences) {
            this.f21922a = updatePackagingPreferences;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.c(this.f21922a, ((Data) obj).f21922a);
        }

        public final int hashCode() {
            UpdatePackagingPreferences updatePackagingPreferences = this.f21922a;
            if (updatePackagingPreferences == null) {
                return 0;
            }
            return updatePackagingPreferences.hashCode();
        }

        public final String toString() {
            return "Data(updatePackagingPreferences=" + this.f21922a + ")";
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/UpdatePackagingPreferencesMutation$UpdatePackagingPreferences;", "", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class UpdatePackagingPreferences {

        /* renamed from: a, reason: collision with root package name */
        public final String f21923a;
        public final CheckoutContent b;

        public UpdatePackagingPreferences(String str, CheckoutContent checkoutContent) {
            this.f21923a = str;
        ...
        public final boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdatePackagingPreferences)) {
                return false;
            }
            UpdatePackagingPreferences updatePackagingPreferences = (UpdatePackagingPreferences) obj;
            return Intrinsics.c(this.f21923a, updatePackagingPreferences.f21923a) && Intrinsics.c(this.b, updatePackagingPreferences.b);
        }

        public final int hashCode() {
            return this.b.hashCode() + (this.f21923a.hashCode() * 31);
        }

        public final String toString() {
            return "UpdatePackagingPreferences(__typename=" + this.f21923a + ", checkoutContent=" + this.b + ")";
        }
    }

    public UpdatePackagingPreferencesMutation(int i, Optional optional, boolean z, boolean z2) {
        this.f21921a = i;
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdatePackagingPreferencesMutation)) {
            return false;
        }
        UpdatePackagingPreferencesMutation updatePackagingPreferencesMutation = (UpdatePackagingPreferencesMutation) obj;
        return this.f21921a == updatePackagingPreferencesMutation.f21921a && Intrinsics.c(this.b, updatePackagingPreferencesMutation.b) && Intrinsics.c(this.c, updatePackagingPreferencesMutation.c) && Intrinsics.c(this.d, updatePackagingPreferencesMutation.d) && this.e == updatePackagingPreferencesMutation.e && this.f == updatePackagingPreferencesMutation.f && Intrinsics.c(this.g, updatePackagingPreferencesMutation.g) && Intrinsics.c(this.h, updatePackagingPreferencesMutation.h) && Intrinsics.c(this.i, updatePackagingPreferencesMutation.i);
    }

    public final int hashCode() {
        return this.i.hashCode() + a.c(this.h, a.c(this.g, b.e(b.e(a.c(this.d, a.c(this.c, a.c(this.b, Integer.hashCode(this.f21921a) * 31, 31), 31), 31), 31, this.e), 31, this.f), 31), 31);
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String id() {
        return "019eb72c232198fe7f02d9907733e969811851a1f97b7a393703e11994e0a690";
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String name() {
        return "updatePackagingPreferences";
    }

    @Override // com.apollographql.apollo.api.Executable
    public final void serializeVariables(JsonWriter jsonWriter, CustomScalarAdapters customScalarAdapters, boolean z) {
        Intrinsics.h(customScalarAdapters, "customScalarAdapters");
        jsonWriter.F1("packagingId");
        Adapters.b.toJson(jsonWriter, customScalarAdapters, Integer.valueOf(this.f21921a));
    ...
    public final String toString() {
        StringBuilder sb = new StringBuilder("UpdatePackagingPreferencesMutation(packagingId=");
