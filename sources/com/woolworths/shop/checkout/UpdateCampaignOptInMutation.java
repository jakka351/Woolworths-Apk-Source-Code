...
import com.woolworths.shop.checkout.adapter.UpdateCampaignOptInMutation_ResponseAdapter;
import com.woolworths.shop.checkout.fragment.CheckoutContent;
import kotlin.Metadata;
import kotlin.jvm.internal.Intrinsics;

@StabilityInferred
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0087\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0003\u0003\u0004\u0005¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateCampaignOptInMutation;", "Lcom/apollographql/apollo/api/Mutation;", "Lcom/woolworths/shop/checkout/UpdateCampaignOptInMutation$Data;", "Data", "UpdateCampaignOptIn", "Companion", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes7.dex */
public final /* data */ class UpdateCampaignOptInMutation implements Mutation<Data> {
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateCampaignOptInMutation$Companion;", "", "", "OPERATION_ID", "Ljava/lang/String;", "OPERATION_NAME", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateCampaignOptInMutation$Data;", "Lcom/apollographql/apollo/api/Mutation$Data;", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Data implements Mutation.Data {

        /* renamed from: a, reason: collision with root package name */
        public final UpdateCampaignOptIn f21910a;

        public Data(UpdateCampaignOptIn updateCampaignOptIn) {
            this.f21910a = updateCampaignOptIn;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.c(this.f21910a, ((Data) obj).f21910a);
        }

        public final int hashCode() {
            UpdateCampaignOptIn updateCampaignOptIn = this.f21910a;
            if (updateCampaignOptIn == null) {
                return 0;
            }
            return updateCampaignOptIn.hashCode();
        }

        public final String toString() {
            return "Data(updateCampaignOptIn=" + this.f21910a + ")";
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateCampaignOptInMutation$UpdateCampaignOptIn;", "", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class UpdateCampaignOptIn {

        /* renamed from: a, reason: collision with root package name */
        public final String f21911a;
        public final CheckoutContent b;

        public UpdateCampaignOptIn(String str, CheckoutContent checkoutContent) {
            this.f21911a = str;
        ...
        public final boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdateCampaignOptIn)) {
                return false;
            }
            UpdateCampaignOptIn updateCampaignOptIn = (UpdateCampaignOptIn) obj;
            return Intrinsics.c(this.f21911a, updateCampaignOptIn.f21911a) && Intrinsics.c(this.b, updateCampaignOptIn.b);
        }

        public final int hashCode() {
            return this.b.hashCode() + (this.f21911a.hashCode() * 31);
        }

        public final String toString() {
            return "UpdateCampaignOptIn(__typename=" + this.f21911a + ", checkoutContent=" + this.b + ")";
        }
    }

    public UpdateCampaignOptInMutation(int i, boolean z, Optional optional, boolean z2, boolean z3) {
        this.f21909a = i;
        this.b = z;
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateCampaignOptInMutation)) {
            return false;
        }
        UpdateCampaignOptInMutation updateCampaignOptInMutation = (UpdateCampaignOptInMutation) obj;
        return this.f21909a == updateCampaignOptInMutation.f21909a && this.b == updateCampaignOptInMutation.b && Intrinsics.c(this.c, updateCampaignOptInMutation.c) && Intrinsics.c(this.d, updateCampaignOptInMutation.d) && Intrinsics.c(this.e, updateCampaignOptInMutation.e) && this.f == updateCampaignOptInMutation.f && this.g == updateCampaignOptInMutation.g && Intrinsics.c(this.h, updateCampaignOptInMutation.h) && Intrinsics.c(this.i, updateCampaignOptInMutation.i) && Intrinsics.c(this.j, updateCampaignOptInMutation.j);
    }

    public final int hashCode() {
        return this.j.hashCode() + a.c(this.i, a.c(this.h, b.e(b.e(a.c(this.e, a.c(this.d, a.c(this.c, b.e(Integer.hashCode(this.f21909a) * 31, 31, this.b), 31), 31), 31), 31, this.f), 31, this.g), 31), 31);
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String id() {
        return "63613827a1949dde826b5f569edfd0a783a34a854d8a85df3f911def9f479832";
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String name() {
        return "updateCampaignOptIn";
    }
    ...
    public final void serializeVariables(JsonWriter jsonWriter, CustomScalarAdapters customScalarAdapters, boolean z) {
        ...
        jsonWriter.F1("id");
        d.y(this.f21909a, Adapters.b, jsonWriter, customScalarAdapters, "value");
    ...
    public final String toString() {
        StringBuilder sb = new StringBuilder("UpdateCampaignOptInMutation(id=");
