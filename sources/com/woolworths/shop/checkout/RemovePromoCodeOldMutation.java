...
import com.woolworths.shop.checkout.adapter.RemovePromoCodeOldMutation_ResponseAdapter;
import com.woolworths.shop.checkout.fragment.CheckoutContent;
import kotlin.Metadata;
import kotlin.jvm.internal.Intrinsics;

@StabilityInferred
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0087\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0003\u0003\u0004\u0005¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/RemovePromoCodeOldMutation;", "Lcom/apollographql/apollo/api/Mutation;", "Lcom/woolworths/shop/checkout/RemovePromoCodeOldMutation$Data;", "Data", "RemovePromoCode", "Companion", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes7.dex */
public final /* data */ class RemovePromoCodeOldMutation implements Mutation<Data> {

    /* renamed from: a, reason: collision with root package name */
    public final Optional f21886a;
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/RemovePromoCodeOldMutation$Companion;", "", "", "OPERATION_ID", "Ljava/lang/String;", "OPERATION_NAME", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/RemovePromoCodeOldMutation$Data;", "Lcom/apollographql/apollo/api/Mutation$Data;", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Data implements Mutation.Data {

        /* renamed from: a, reason: collision with root package name */
        public final RemovePromoCode f21887a;

        public Data(RemovePromoCode removePromoCode) {
            this.f21887a = removePromoCode;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.c(this.f21887a, ((Data) obj).f21887a);
        }

        public final int hashCode() {
            RemovePromoCode removePromoCode = this.f21887a;
            if (removePromoCode == null) {
                return 0;
            }
            return removePromoCode.hashCode();
        }

        public final String toString() {
            return "Data(removePromoCode=" + this.f21887a + ")";
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/RemovePromoCodeOldMutation$RemovePromoCode;", "", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class RemovePromoCode {

        /* renamed from: a, reason: collision with root package name */
        public final String f21888a;
        public final CheckoutContent b;

        public RemovePromoCode(String str, CheckoutContent checkoutContent) {
            this.f21888a = str;
        ...
        public final boolean equals(Object obj) {
            ...
            return Intrinsics.c(this.f21888a, removePromoCode.f21888a) && Intrinsics.c(this.b, removePromoCode.b);
        }

        public final int hashCode() {
            return this.b.hashCode() + (this.f21888a.hashCode() * 31);
        }

        public final String toString() {
            return "RemovePromoCode(__typename=" + this.f21888a + ", checkoutContent=" + this.b + ")";
        }
    }

    public RemovePromoCodeOldMutation(Optional optional, boolean z, boolean z2) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof RemovePromoCodeOldMutation)) {
            return false;
        }
        RemovePromoCodeOldMutation removePromoCodeOldMutation = (RemovePromoCodeOldMutation) obj;
        return Intrinsics.c(this.f21886a, removePromoCodeOldMutation.f21886a) && Intrinsics.c(this.b, removePromoCodeOldMutation.b) && Intrinsics.c(this.c, removePromoCodeOldMutation.c) && this.d == removePromoCodeOldMutation.d && this.e == removePromoCodeOldMutation.e && Intrinsics.c(this.f, removePromoCodeOldMutation.f) && Intrinsics.c(this.g, removePromoCodeOldMutation.g) && Intrinsics.c(this.h, removePromoCodeOldMutation.h);
    }

    public final int hashCode() {
        return this.h.hashCode() + a.c(this.g, a.c(this.f, b.e(b.e(a.c(this.c, a.c(this.b, this.f21886a.hashCode() * 31, 31), 31), 31, this.d), 31, this.e), 31), 31);
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String id() {
        return "dc4c34a11d24784efa17deab49760261d195153db4e4ef5790d887a04b16723b";
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String name() {
        return "RemovePromoCodeOld";
    }

    @Override // com.apollographql.apollo.api.Executable
    public final void serializeVariables(JsonWriter jsonWriter, CustomScalarAdapters customScalarAdapters, boolean z) {
        Intrinsics.h(customScalarAdapters, "customScalarAdapters");
        Optional optional = this.f21886a;
    ...
    public final String toString() {
        StringBuilder sbP = a.p("RemovePromoCodeOldMutation(includeMarketPickupSheet=", this.f21886a, ", includeIdVerificationBottomSheet=", this.b, ", includeExtraInfoContent=");
        a.y(sbP, this.c, ", includePanelMarkdown=", this.d, ", includeContactDetails=");
        a.z(sbP, this.e, ", includeTimeSelectionContent=", this.f, ", includeSuggestedTimeSlot=");
        sbP.append(this.g);
