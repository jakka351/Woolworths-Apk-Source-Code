...
import com.woolworths.shop.checkout.adapter.AddPromoCodeOldMutation_ResponseAdapter;
import com.woolworths.shop.checkout.fragment.CheckoutContent;
import kotlin.Metadata;
import kotlin.jvm.internal.Intrinsics;

@StabilityInferred
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0087\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0003\u0003\u0004\u0005¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/AddPromoCodeOldMutation;", "Lcom/apollographql/apollo/api/Mutation;", "Lcom/woolworths/shop/checkout/AddPromoCodeOldMutation$Data;", "Data", "AddPromoCode", "Companion", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes7.dex */
public final /* data */ class AddPromoCodeOldMutation implements Mutation<Data> {
    ...
    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/AddPromoCodeOldMutation$AddPromoCode;", "", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class AddPromoCode {

        /* renamed from: a, reason: collision with root package name */
        public final String f21797a;
        public final CheckoutContent b;

        public AddPromoCode(String str, CheckoutContent checkoutContent) {
            this.f21797a = str;
        ...
        public final boolean equals(Object obj) {
            ...
            return Intrinsics.c(this.f21797a, addPromoCode.f21797a) && Intrinsics.c(this.b, addPromoCode.b);
        }

        public final int hashCode() {
            return this.b.hashCode() + (this.f21797a.hashCode() * 31);
        }

        public final String toString() {
            return "AddPromoCode(__typename=" + this.f21797a + ", checkoutContent=" + this.b + ")";
        }
    }

    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/AddPromoCodeOldMutation$Companion;", "", "", "OPERATION_ID", "Ljava/lang/String;", "OPERATION_NAME", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/AddPromoCodeOldMutation$Data;", "Lcom/apollographql/apollo/api/Mutation$Data;", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Data implements Mutation.Data {

        /* renamed from: a, reason: collision with root package name */
        public final AddPromoCode f21798a;

        public Data(AddPromoCode addPromoCode) {
            this.f21798a = addPromoCode;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.c(this.f21798a, ((Data) obj).f21798a);
        }

        public final int hashCode() {
            AddPromoCode addPromoCode = this.f21798a;
            if (addPromoCode == null) {
                return 0;
            }
            return addPromoCode.hashCode();
        }

        public final String toString() {
            return "Data(addPromoCode=" + this.f21798a + ")";
        }
    }

    public AddPromoCodeOldMutation(String value, Optional optional, boolean z, boolean z2) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof AddPromoCodeOldMutation)) {
            return false;
        }
        AddPromoCodeOldMutation addPromoCodeOldMutation = (AddPromoCodeOldMutation) obj;
        return Intrinsics.c(this.f21796a, addPromoCodeOldMutation.f21796a) && Intrinsics.c(this.b, addPromoCodeOldMutation.b) && Intrinsics.c(this.c, addPromoCodeOldMutation.c) && Intrinsics.c(this.d, addPromoCodeOldMutation.d) && this.e == addPromoCodeOldMutation.e && this.f == addPromoCodeOldMutation.f && Intrinsics.c(this.g, addPromoCodeOldMutation.g) && Intrinsics.c(this.h, addPromoCodeOldMutation.h) && Intrinsics.c(this.i, addPromoCodeOldMutation.i);
    }

    public final int hashCode() {
        return this.i.hashCode() + a.c(this.h, a.c(this.g, b.e(b.e(a.c(this.d, a.c(this.c, a.c(this.b, this.f21796a.hashCode() * 31, 31), 31), 31), 31, this.e), 31, this.f), 31), 31);
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String id() {
        return "59e136c1a65d927c76c2bfb50bbb998e3a19430a9583de0e6d47a4bdb53da531";
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String name() {
        return "AddPromoCodeOld";
    }
    ...
    public final void serializeVariables(JsonWriter jsonWriter, CustomScalarAdapters customScalarAdapters, boolean z) {
        ...
        jsonWriter.F1("value");
        Adapters.f13493a.toJson(jsonWriter, customScalarAdapters, this.f21796a);
    ...
    public final String toString() {
        StringBuilder sbR = a.r("AddPromoCodeOldMutation(value=", this.f21796a, ", includeMarketPickupSheet=", this.b, ", includeIdVerificationBottomSheet=");
