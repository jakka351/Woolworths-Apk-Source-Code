...
import com.woolworths.shop.checkout.adapter.UpdateFulfilmentWindowMutation_ResponseAdapter;
import com.woolworths.shop.checkout.fragment.CheckoutContent;
import kotlin.Metadata;
import kotlin.jvm.internal.Intrinsics;

@StabilityInferred
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0087\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0003\u0003\u0004\u0005¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateFulfilmentWindowMutation;", "Lcom/apollographql/apollo/api/Mutation;", "Lcom/woolworths/shop/checkout/UpdateFulfilmentWindowMutation$Data;", "Data", "UpdateFulfilmentWindow", "Companion", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes7.dex */
public final /* data */ class UpdateFulfilmentWindowMutation implements Mutation<Data> {
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateFulfilmentWindowMutation$Companion;", "", "", "OPERATION_ID", "Ljava/lang/String;", "OPERATION_NAME", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateFulfilmentWindowMutation$Data;", "Lcom/apollographql/apollo/api/Mutation$Data;", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Data implements Mutation.Data {

        /* renamed from: a, reason: collision with root package name */
        public final UpdateFulfilmentWindow f21916a;

        public Data(UpdateFulfilmentWindow updateFulfilmentWindow) {
            this.f21916a = updateFulfilmentWindow;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.c(this.f21916a, ((Data) obj).f21916a);
        }

        public final int hashCode() {
            UpdateFulfilmentWindow updateFulfilmentWindow = this.f21916a;
            if (updateFulfilmentWindow == null) {
                return 0;
            }
            return updateFulfilmentWindow.hashCode();
        }

        public final String toString() {
            return "Data(updateFulfilmentWindow=" + this.f21916a + ")";
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateFulfilmentWindowMutation$UpdateFulfilmentWindow;", "", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class UpdateFulfilmentWindow {

        /* renamed from: a, reason: collision with root package name */
        public final String f21917a;
        public final CheckoutContent b;

        public UpdateFulfilmentWindow(String str, CheckoutContent checkoutContent) {
            this.f21917a = str;
        ...
        public final boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdateFulfilmentWindow)) {
                return false;
            }
            UpdateFulfilmentWindow updateFulfilmentWindow = (UpdateFulfilmentWindow) obj;
            return Intrinsics.c(this.f21917a, updateFulfilmentWindow.f21917a) && Intrinsics.c(this.b, updateFulfilmentWindow.b);
        }

        public final int hashCode() {
            return this.b.hashCode() + (this.f21917a.hashCode() * 31);
        }

        public final String toString() {
            return "UpdateFulfilmentWindow(__typename=" + this.f21917a + ", checkoutContent=" + this.b + ")";
        }
    }

    public UpdateFulfilmentWindowMutation(int i, String windowDate, Optional optional, Optional optional2, boolean z, boolean z2) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateFulfilmentWindowMutation)) {
            return false;
        }
        UpdateFulfilmentWindowMutation updateFulfilmentWindowMutation = (UpdateFulfilmentWindowMutation) obj;
        return this.f21915a == updateFulfilmentWindowMutation.f21915a && Intrinsics.c(this.b, updateFulfilmentWindowMutation.b) && Intrinsics.c(this.c, updateFulfilmentWindowMutation.c) && Intrinsics.c(this.d, updateFulfilmentWindowMutation.d) && Intrinsics.c(this.e, updateFulfilmentWindowMutation.e) && Intrinsics.c(this.f, updateFulfilmentWindowMutation.f) && this.g == updateFulfilmentWindowMutation.g && this.h == updateFulfilmentWindowMutation.h && Intrinsics.c(this.i, updateFulfilmentWindowMutation.i) && Intrinsics.c(this.j, updateFulfilmentWindowMutation.j) && Intrinsics.c(this.k, updateFulfilmentWindowMutation.k);
    }

    public final int hashCode() {
        return this.k.hashCode() + a.c(this.j, a.c(this.i, b.e(b.e(a.c(this.f, a.c(this.e, a.c(this.d, a.c(this.c, b.c(Integer.hashCode(this.f21915a) * 31, 31, this.b), 31), 31), 31), 31), 31, this.g), 31, this.h), 31), 31);
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String id() {
        return "4d3fb365b8b44cd90934119f665d2aa3207ba67dceae5c018cdb5d4dafd9b1f1";
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String name() {
        return "updateFulfilmentWindow";
    }
    ...
    public final void serializeVariables(JsonWriter jsonWriter, CustomScalarAdapters customScalarAdapters, boolean z) {
        ...
        d.y(this.f21915a, Adapters.b, jsonWriter, customScalarAdapters, "windowDate");
    ...
    public final String toString() {
        StringBuilder sbP = androidx.constraintlayout.core.state.a.p("UpdateFulfilmentWindowMutation(windowId=", this.f21915a, ", windowDate=", this.b, ", windowOption=");
        a.x(sbP, this.c, ", includeMarketPickupSheet=", this.d, ", includeIdVerificationBottomSheet=");
        a.x(sbP, this.e, ", includeExtraInfoContent=", this.f, ", includePanelMarkdown=");
        au.com.woolworths.android.onesite.a.D(sbP, this.g, ", includeContactDetails=", this.h, ", includeTimeSelectionContent=");
        a.x(sbP, this.i, ", includeSuggestedTimeSlot=", this.j, ", includeServiceFees=");
        return a.o(sbP, this.k, ")");
    }
}
