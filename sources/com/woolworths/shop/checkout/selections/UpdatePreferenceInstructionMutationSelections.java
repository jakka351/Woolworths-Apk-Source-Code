...
@StabilityInferred
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\bÇ\u0002\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/selections/UpdatePreferenceInstructionMutationSelections;", "", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes7.dex */
public final class UpdatePreferenceInstructionMutationSelections {

    /* renamed from: a, reason: collision with root package name */
    public static final List f22569a;
    ...
    static {
        ...
        f22569a = listR;
        CompiledField.Builder builder2 = new CompiledField.Builder("updatePreferenceInstruction", CheckoutContent.f11192a);
        new CompiledArgument.Builder(Mutation.m0);
        CompiledArgument compiledArgument = new CompiledArgument();
        new CompiledArgument.Builder(Mutation.n0);
