...
import com.woolworths.shop.checkout.adapter.RemoveProductMutation_ResponseAdapter;
import com.woolworths.shop.checkout.fragment.CheckoutContent;
import kotlin.Metadata;
import kotlin.jvm.internal.Intrinsics;

@StabilityInferred
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0087\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0003\u0003\u0004\u0005¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/RemoveProductMutation;", "Lcom/apollographql/apollo/api/Mutation;", "Lcom/woolworths/shop/checkout/RemoveProductMutation$Data;", "Data", "RemoveProduct", "Companion", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes7.dex */
public final /* data */ class RemoveProductMutation implements Mutation<Data> {
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/RemoveProductMutation$Companion;", "", "", "OPERATION_ID", "Ljava/lang/String;", "OPERATION_NAME", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/RemoveProductMutation$Data;", "Lcom/apollographql/apollo/api/Mutation$Data;", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Data implements Mutation.Data {

        /* renamed from: a, reason: collision with root package name */
        public final RemoveProduct f21884a;

        public Data(RemoveProduct removeProduct) {
            this.f21884a = removeProduct;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.c(this.f21884a, ((Data) obj).f21884a);
        }

        public final int hashCode() {
            RemoveProduct removeProduct = this.f21884a;
            if (removeProduct == null) {
                return 0;
            }
            return removeProduct.hashCode();
        }

        public final String toString() {
            return "Data(removeProduct=" + this.f21884a + ")";
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/RemoveProductMutation$RemoveProduct;", "", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class RemoveProduct {

        /* renamed from: a, reason: collision with root package name */
        public final String f21885a;
        public final CheckoutContent b;

        public RemoveProduct(String str, CheckoutContent checkoutContent) {
            this.f21885a = str;
        ...
        public final boolean equals(Object obj) {
            ...
            if (!(obj instanceof RemoveProduct)) {
                return false;
            }
            RemoveProduct removeProduct = (RemoveProduct) obj;
            return Intrinsics.c(this.f21885a, removeProduct.f21885a) && Intrinsics.c(this.b, removeProduct.b);
        }

        public final int hashCode() {
            return this.b.hashCode() + (this.f21885a.hashCode() * 31);
        }

        public final String toString() {
            return "RemoveProduct(__typename=" + this.f21885a + ", checkoutContent=" + this.b + ")";
        }
    }

    public RemoveProductMutation(String productId, Optional optional, boolean z, boolean z2) {
        Intrinsics.h(productId, "productId");
        this.f21883a = productId;
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof RemoveProductMutation)) {
            return false;
        }
        RemoveProductMutation removeProductMutation = (RemoveProductMutation) obj;
        return Intrinsics.c(this.f21883a, removeProductMutation.f21883a) && Intrinsics.c(this.b, removeProductMutation.b) && Intrinsics.c(this.c, removeProductMutation.c) && Intrinsics.c(this.d, removeProductMutation.d) && this.e == removeProductMutation.e && this.f == removeProductMutation.f && Intrinsics.c(this.g, removeProductMutation.g) && Intrinsics.c(this.h, removeProductMutation.h) && Intrinsics.c(this.i, removeProductMutation.i);
    }

    public final int hashCode() {
        return this.i.hashCode() + a.c(this.h, a.c(this.g, b.e(b.e(a.c(this.d, a.c(this.c, a.c(this.b, this.f21883a.hashCode() * 31, 31), 31), 31), 31, this.e), 31, this.f), 31), 31);
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String id() {
        return "1e41d0a1c18127de719ea4a907bf6091e0805e40f357990d0dacbe0131b777d8";
    }
    ...
    public final void serializeVariables(JsonWriter jsonWriter, CustomScalarAdapters customScalarAdapters, boolean z) {
        ...
        Adapters.f13493a.toJson(jsonWriter, customScalarAdapters, this.f21883a);
    ...
    public final String toString() {
        StringBuilder sbR = a.r("RemoveProductMutation(productId=", this.f21883a, ", includeMarketPickupSheet=", this.b, ", includeIdVerificationBottomSheet=");
