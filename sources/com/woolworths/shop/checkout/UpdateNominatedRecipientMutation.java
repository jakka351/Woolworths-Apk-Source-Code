...
import com.woolworths.shop.checkout.adapter.UpdateNominatedRecipientMutation_ResponseAdapter;
import com.woolworths.shop.checkout.fragment.CheckoutContent;
import kotlin.Metadata;
import kotlin.jvm.internal.Intrinsics;

@StabilityInferred
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0087\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0003\u0003\u0004\u0005¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateNominatedRecipientMutation;", "Lcom/apollographql/apollo/api/Mutation;", "Lcom/woolworths/shop/checkout/UpdateNominatedRecipientMutation$Data;", "Data", "UpdateNominatedRecipient", "Companion", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes7.dex */
public final /* data */ class UpdateNominatedRecipientMutation implements Mutation<Data> {
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateNominatedRecipientMutation$Companion;", "", "", "OPERATION_ID", "Ljava/lang/String;", "OPERATION_NAME", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateNominatedRecipientMutation$Data;", "Lcom/apollographql/apollo/api/Mutation$Data;", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Data implements Mutation.Data {

        /* renamed from: a, reason: collision with root package name */
        public final UpdateNominatedRecipient f21919a;

        public Data(UpdateNominatedRecipient updateNominatedRecipient) {
            this.f21919a = updateNominatedRecipient;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.c(this.f21919a, ((Data) obj).f21919a);
        }

        public final int hashCode() {
            UpdateNominatedRecipient updateNominatedRecipient = this.f21919a;
            if (updateNominatedRecipient == null) {
                return 0;
            }
            return updateNominatedRecipient.hashCode();
        }

        public final String toString() {
            return "Data(updateNominatedRecipient=" + this.f21919a + ")";
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateNominatedRecipientMutation$UpdateNominatedRecipient;", "", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class UpdateNominatedRecipient {

        /* renamed from: a, reason: collision with root package name */
        public final String f21920a;
        public final CheckoutContent b;

        public UpdateNominatedRecipient(String str, CheckoutContent checkoutContent) {
            this.f21920a = str;
        ...
        public final boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdateNominatedRecipient)) {
                return false;
            }
            UpdateNominatedRecipient updateNominatedRecipient = (UpdateNominatedRecipient) obj;
            return Intrinsics.c(this.f21920a, updateNominatedRecipient.f21920a) && Intrinsics.c(this.b, updateNominatedRecipient.b);
        }
        ...
        public final String toString() {
            return "UpdateNominatedRecipient(__typename=" + this.f21920a + ", checkoutContent=" + this.b + ")";
        }
    }

    public UpdateNominatedRecipientMutation(String value, Optional optional, boolean z, boolean z2) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateNominatedRecipientMutation)) {
            return false;
        }
        UpdateNominatedRecipientMutation updateNominatedRecipientMutation = (UpdateNominatedRecipientMutation) obj;
        return Intrinsics.c(this.f21918a, updateNominatedRecipientMutation.f21918a) && Intrinsics.c(this.b, updateNominatedRecipientMutation.b) && Intrinsics.c(this.c, updateNominatedRecipientMutation.c) && Intrinsics.c(this.d, updateNominatedRecipientMutation.d) && this.e == updateNominatedRecipientMutation.e && this.f == updateNominatedRecipientMutation.f && Intrinsics.c(this.g, updateNominatedRecipientMutation.g) && Intrinsics.c(this.h, updateNominatedRecipientMutation.h) && Intrinsics.c(this.i, updateNominatedRecipientMutation.i);
    }

    public final int hashCode() {
        return this.i.hashCode() + a.c(this.h, a.c(this.g, b.e(b.e(a.c(this.d, a.c(this.c, a.c(this.b, this.f21918a.hashCode() * 31, 31), 31), 31), 31, this.e), 31, this.f), 31), 31);
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String id() {
        return "840f220cd8784f7cb217dbaa29c45e4956ab00b849d725320f212ab201bc6c80";
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String name() {
        return "updateNominatedRecipient";
    }
    ...
    public final void serializeVariables(JsonWriter jsonWriter, CustomScalarAdapters customScalarAdapters, boolean z) {
        ...
        jsonWriter.F1("value");
        Adapters.f13493a.toJson(jsonWriter, customScalarAdapters, this.f21918a);
    ...
    public final String toString() {
        StringBuilder sbR = a.r("UpdateNominatedRecipientMutation(value=", this.f21918a, ", includeMarketPickupSheet=", this.b, ", includeIdVerificationBottomSheet=");
        a.x(sbR, this.c, ", includeExtraInfoContent=", this.d, ", includePanelMarkdown=");
        au.com.woolworths.android.onesite.a.D(sbR, this.e, ", includeContactDetails=", this.f, ", includeTimeSelectionContent=");
        a.x(sbR, this.g, ", includeSuggestedTimeSlot=", this.h, ", includeServiceFees=");
        return a.o(sbR, this.i, ")");
    }
}
