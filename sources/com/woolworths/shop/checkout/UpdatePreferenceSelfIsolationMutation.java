...
import com.woolworths.shop.checkout.adapter.UpdatePreferenceSelfIsolationMutation_ResponseAdapter;
import com.woolworths.shop.checkout.fragment.CheckoutContent;
import kotlin.Metadata;
import kotlin.jvm.internal.Intrinsics;

@StabilityInferred
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0087\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0003\u0003\u0004\u0005¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/UpdatePreferenceSelfIsolationMutation;", "Lcom/apollographql/apollo/api/Mutation;", "Lcom/woolworths/shop/checkout/UpdatePreferenceSelfIsolationMutation$Data;", "Data", "UpdatePreferenceSelfIsolation", "Companion", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes7.dex */
public final /* data */ class UpdatePreferenceSelfIsolationMutation implements Mutation<Data> {
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/UpdatePreferenceSelfIsolationMutation$Companion;", "", "", "OPERATION_ID", "Ljava/lang/String;", "OPERATION_NAME", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/UpdatePreferenceSelfIsolationMutation$Data;", "Lcom/apollographql/apollo/api/Mutation$Data;", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Data implements Mutation.Data {

        /* renamed from: a, reason: collision with root package name */
        public final UpdatePreferenceSelfIsolation f21931a;

        public Data(UpdatePreferenceSelfIsolation updatePreferenceSelfIsolation) {
            this.f21931a = updatePreferenceSelfIsolation;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.c(this.f21931a, ((Data) obj).f21931a);
        }

        public final int hashCode() {
            UpdatePreferenceSelfIsolation updatePreferenceSelfIsolation = this.f21931a;
            if (updatePreferenceSelfIsolation == null) {
                return 0;
            }
            return updatePreferenceSelfIsolation.hashCode();
        }

        public final String toString() {
            return "Data(updatePreferenceSelfIsolation=" + this.f21931a + ")";
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/UpdatePreferenceSelfIsolationMutation$UpdatePreferenceSelfIsolation;", "", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class UpdatePreferenceSelfIsolation {

        /* renamed from: a, reason: collision with root package name */
        public final String f21932a;
        public final CheckoutContent b;

        public UpdatePreferenceSelfIsolation(String str, CheckoutContent checkoutContent) {
            this.f21932a = str;
        ...
        public final boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdatePreferenceSelfIsolation)) {
                return false;
            }
            UpdatePreferenceSelfIsolation updatePreferenceSelfIsolation = (UpdatePreferenceSelfIsolation) obj;
            return Intrinsics.c(this.f21932a, updatePreferenceSelfIsolation.f21932a) && Intrinsics.c(this.b, updatePreferenceSelfIsolation.b);
        }
        ...
        public final String toString() {
            return "UpdatePreferenceSelfIsolation(__typename=" + this.f21932a + ", checkoutContent=" + this.b + ")";
        }
    }

    public UpdatePreferenceSelfIsolationMutation(boolean z, Optional optional, boolean z2, boolean z3) {
        this.f21930a = z;
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdatePreferenceSelfIsolationMutation)) {
            return false;
        }
        UpdatePreferenceSelfIsolationMutation updatePreferenceSelfIsolationMutation = (UpdatePreferenceSelfIsolationMutation) obj;
        return this.f21930a == updatePreferenceSelfIsolationMutation.f21930a && Intrinsics.c(this.b, updatePreferenceSelfIsolationMutation.b) && Intrinsics.c(this.c, updatePreferenceSelfIsolationMutation.c) && Intrinsics.c(this.d, updatePreferenceSelfIsolationMutation.d) && this.e == updatePreferenceSelfIsolationMutation.e && this.f == updatePreferenceSelfIsolationMutation.f && Intrinsics.c(this.g, updatePreferenceSelfIsolationMutation.g) && Intrinsics.c(this.h, updatePreferenceSelfIsolationMutation.h) && Intrinsics.c(this.i, updatePreferenceSelfIsolationMutation.i);
    }

    public final int hashCode() {
        return this.i.hashCode() + a.c(this.h, a.c(this.g, b.e(b.e(a.c(this.d, a.c(this.c, a.c(this.b, Boolean.hashCode(this.f21930a) * 31, 31), 31), 31), 31, this.e), 31, this.f), 31), 31);
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String id() {
        return "e1ba5981f6f69b87ab85ad5239d48b0fc2ece2a4288bf1f4d503ac1863d435e0";
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String name() {
        return "updatePreferenceSelfIsolation";
    }
    ...
    public final void serializeVariables(JsonWriter jsonWriter, CustomScalarAdapters customScalarAdapters, boolean z) {
        ...
        adapters$BooleanAdapter$1.toJson(jsonWriter, customScalarAdapters, Boolean.valueOf(this.f21930a));
    ...
    public final String toString() {
        StringBuilder sb = new StringBuilder("UpdatePreferenceSelfIsolationMutation(value=");
