...
import com.woolworths.shop.checkout.adapter.UpdateProductInstructionMutation_ResponseAdapter;
...
@StabilityInferred
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0087\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0003\u0003\u0004\u0005¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateProductInstructionMutation;", "Lcom/apollographql/apollo/api/Mutation;", "Lcom/woolworths/shop/checkout/UpdateProductInstructionMutation$Data;", "Data", "UpdateProductInstruction", "Companion", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes7.dex */
public final /* data */ class UpdateProductInstructionMutation implements Mutation<Data> {
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateProductInstructionMutation$Companion;", "", "", "OPERATION_ID", "Ljava/lang/String;", "OPERATION_NAME", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateProductInstructionMutation$Data;", "Lcom/apollographql/apollo/api/Mutation$Data;", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Data implements Mutation.Data {

        /* renamed from: a, reason: collision with root package name */
        public final UpdateProductInstruction f21934a;

        public Data(UpdateProductInstruction updateProductInstruction) {
            this.f21934a = updateProductInstruction;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.c(this.f21934a, ((Data) obj).f21934a);
        }

        public final int hashCode() {
            UpdateProductInstruction updateProductInstruction = this.f21934a;
            if (updateProductInstruction == null) {
                return 0;
            }
            return updateProductInstruction.hashCode();
        }

        public final String toString() {
            return "Data(updateProductInstruction=" + this.f21934a + ")";
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateProductInstructionMutation$UpdateProductInstruction;", "", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class UpdateProductInstruction {

        /* renamed from: a, reason: collision with root package name */
        public final String f21935a;
        public final CheckoutContent b;

        public UpdateProductInstruction(String str, CheckoutContent checkoutContent) {
            this.f21935a = str;
        ...
        public final boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdateProductInstruction)) {
                return false;
            }
            UpdateProductInstruction updateProductInstruction = (UpdateProductInstruction) obj;
            return Intrinsics.c(this.f21935a, updateProductInstruction.f21935a) && Intrinsics.c(this.b, updateProductInstruction.b);
        }

        public final int hashCode() {
            return this.b.hashCode() + (this.f21935a.hashCode() * 31);
        }

        public final String toString() {
            return "UpdateProductInstruction(__typename=" + this.f21935a + ", checkoutContent=" + this.b + ")";
        }
    }

    public UpdateProductInstructionMutation(String productId, double d, String text, Optional optional, boolean z, boolean z2) {
        Intrinsics.h(productId, "productId");
        Intrinsics.h(text, "text");
        this.f21933a = productId;
        this.b = d;
        this.c = text;
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateProductInstructionMutation)) {
            return false;
        }
        UpdateProductInstructionMutation updateProductInstructionMutation = (UpdateProductInstructionMutation) obj;
        return Intrinsics.c(this.f21933a, updateProductInstructionMutation.f21933a) && Double.compare(this.b, updateProductInstructionMutation.b) == 0 && Intrinsics.c(this.c, updateProductInstructionMutation.c) && Intrinsics.c(this.d, updateProductInstructionMutation.d) && Intrinsics.c(this.e, updateProductInstructionMutation.e) && Intrinsics.c(this.f, updateProductInstructionMutation.f) && this.g == updateProductInstructionMutation.g && this.h == updateProductInstructionMutation.h && Intrinsics.c(this.i, updateProductInstructionMutation.i) && Intrinsics.c(this.j, updateProductInstructionMutation.j) && Intrinsics.c(this.k, updateProductInstructionMutation.k);
    }

    public final int hashCode() {
        return this.k.hashCode() + a.c(this.j, a.c(this.i, b.e(b.e(a.c(this.f, a.c(this.e, a.c(this.d, b.c(android.support.v4.media.session.a.a(this.b, this.f21933a.hashCode() * 31, 31), 31, this.c), 31), 31), 31), 31, this.g), 31, this.h), 31), 31);
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String id() {
        return "285942c8df8da2ad14a8defcbec82fb12ebb21cc812b807fee9ef26a0d3fbe4b";
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String name() {
        return "updateProductInstruction";
    }

    @Override // com.apollographql.apollo.api.Executable
    public final void serializeVariables(JsonWriter jsonWriter, CustomScalarAdapters customScalarAdapters, boolean z) {
        Intrinsics.h(customScalarAdapters, "customScalarAdapters");
        jsonWriter.F1("productId");
        Adapters$StringAdapter$1 adapters$StringAdapter$1 = Adapters.f13493a;
        adapters$StringAdapter$1.toJson(jsonWriter, customScalarAdapters, this.f21933a);
        jsonWriter.F1("quantity");
        Adapters.c.toJson(jsonWriter, customScalarAdapters, Double.valueOf(this.b));
        jsonWriter.F1(TextBundle.TEXT_ENTRY);
    ...
    public final String toString() {
        StringBuilder sbR = au.com.woolworths.android.onesite.a.r(this.b, "UpdateProductInstructionMutation(productId=", this.f21933a, ", quantity=");
        sbR.append(", text=");
        sbR.append(this.c);
        sbR.append(", includeMarketPickupSheet=");
        sbR.append(this.d);
        sbR.append(", includeIdVerificationBottomSheet=");
        sbR.append(this.e);
        sbR.append(", includeExtraInfoContent=");
        sbR.append(this.f);
        sbR.append(", includePanelMarkdown=");
        sbR.append(this.g);
        sbR.append(", includeContactDetails=");
        sbR.append(this.h);
        sbR.append(", includeTimeSelectionContent=");
        sbR.append(this.i);
        sbR.append(", includeSuggestedTimeSlot=");
        sbR.append(this.j);
        sbR.append(", includeServiceFees=");
        sbR.append(this.k);
        sbR.append(")");
        return sbR.toString();
    }
