...
import com.woolworths.shop.checkout.adapter.UpdatePreferenceLeaveUnattendedMutation_ResponseAdapter;
import com.woolworths.shop.checkout.fragment.CheckoutContent;
import kotlin.Metadata;
import kotlin.jvm.internal.Intrinsics;

@StabilityInferred
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0087\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0003\u0003\u0004\u0005¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/UpdatePreferenceLeaveUnattendedMutation;", "Lcom/apollographql/apollo/api/Mutation;", "Lcom/woolworths/shop/checkout/UpdatePreferenceLeaveUnattendedMutation$Data;", "Data", "UpdatePreferenceLeaveUnattended", "Companion", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes7.dex */
public final /* data */ class UpdatePreferenceLeaveUnattendedMutation implements Mutation<Data> {
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/UpdatePreferenceLeaveUnattendedMutation$Companion;", "", "", "OPERATION_ID", "Ljava/lang/String;", "OPERATION_NAME", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/UpdatePreferenceLeaveUnattendedMutation$Data;", "Lcom/apollographql/apollo/api/Mutation$Data;", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Data implements Mutation.Data {

        /* renamed from: a, reason: collision with root package name */
        public final UpdatePreferenceLeaveUnattended f21928a;

        public Data(UpdatePreferenceLeaveUnattended updatePreferenceLeaveUnattended) {
            this.f21928a = updatePreferenceLeaveUnattended;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.c(this.f21928a, ((Data) obj).f21928a);
        }

        public final int hashCode() {
            UpdatePreferenceLeaveUnattended updatePreferenceLeaveUnattended = this.f21928a;
            if (updatePreferenceLeaveUnattended == null) {
                return 0;
            }
            return updatePreferenceLeaveUnattended.hashCode();
        }

        public final String toString() {
            return "Data(updatePreferenceLeaveUnattended=" + this.f21928a + ")";
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/UpdatePreferenceLeaveUnattendedMutation$UpdatePreferenceLeaveUnattended;", "", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class UpdatePreferenceLeaveUnattended {

        /* renamed from: a, reason: collision with root package name */
        public final String f21929a;
        public final CheckoutContent b;

        public UpdatePreferenceLeaveUnattended(String str, CheckoutContent checkoutContent) {
            this.f21929a = str;
        ...
        public final boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdatePreferenceLeaveUnattended)) {
                return false;
            }
            UpdatePreferenceLeaveUnattended updatePreferenceLeaveUnattended = (UpdatePreferenceLeaveUnattended) obj;
            return Intrinsics.c(this.f21929a, updatePreferenceLeaveUnattended.f21929a) && Intrinsics.c(this.b, updatePreferenceLeaveUnattended.b);
        }

        public final int hashCode() {
            return this.b.hashCode() + (this.f21929a.hashCode() * 31);
        }

        public final String toString() {
            return "UpdatePreferenceLeaveUnattended(__typename=" + this.f21929a + ", checkoutContent=" + this.b + ")";
        }
    }

    public UpdatePreferenceLeaveUnattendedMutation(boolean z, Optional optional, boolean z2, boolean z3) {
        this.f21927a = z;
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdatePreferenceLeaveUnattendedMutation)) {
            return false;
        }
        UpdatePreferenceLeaveUnattendedMutation updatePreferenceLeaveUnattendedMutation = (UpdatePreferenceLeaveUnattendedMutation) obj;
        return this.f21927a == updatePreferenceLeaveUnattendedMutation.f21927a && Intrinsics.c(this.b, updatePreferenceLeaveUnattendedMutation.b) && Intrinsics.c(this.c, updatePreferenceLeaveUnattendedMutation.c) && Intrinsics.c(this.d, updatePreferenceLeaveUnattendedMutation.d) && this.e == updatePreferenceLeaveUnattendedMutation.e && this.f == updatePreferenceLeaveUnattendedMutation.f && Intrinsics.c(this.g, updatePreferenceLeaveUnattendedMutation.g) && Intrinsics.c(this.h, updatePreferenceLeaveUnattendedMutation.h) && Intrinsics.c(this.i, updatePreferenceLeaveUnattendedMutation.i);
    }

    public final int hashCode() {
        return this.i.hashCode() + a.c(this.h, a.c(this.g, b.e(b.e(a.c(this.d, a.c(this.c, a.c(this.b, Boolean.hashCode(this.f21927a) * 31, 31), 31), 31), 31, this.e), 31, this.f), 31), 31);
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String id() {
        return "cbdddc1393771e66df4912b859c6179dc0f47e894b730c9032c47dff3671aece";
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String name() {
        return "updatePreferenceLeaveUnattended";
    }
    ...
    public final void serializeVariables(JsonWriter jsonWriter, CustomScalarAdapters customScalarAdapters, boolean z) {
        ...
        adapters$BooleanAdapter$1.toJson(jsonWriter, customScalarAdapters, Boolean.valueOf(this.f21927a));
    ...
    public final String toString() {
        StringBuilder sb = new StringBuilder("UpdatePreferenceLeaveUnattendedMutation(value=");
