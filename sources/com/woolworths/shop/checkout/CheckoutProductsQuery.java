...
import com.woolworths.shop.checkout.adapter.CheckoutProductsQuery_ResponseAdapter;
import com.woolworths.shop.checkout.fragment.CheckoutContent;
import kotlin.Metadata;
import kotlin.jvm.internal.Intrinsics;

@StabilityInferred
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0087\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0003\u0003\u0004\u0005¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/CheckoutProductsQuery;", "Lcom/apollographql/apollo/api/Query;", "Lcom/woolworths/shop/checkout/CheckoutProductsQuery$Data;", "Data", "CheckoutProducts", "Companion", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes7.dex */
public final /* data */ class CheckoutProductsQuery implements Query<Data> {

    /* renamed from: a, reason: collision with root package name */
    public final Optional f21822a;
    ...
    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/CheckoutProductsQuery$CheckoutProducts;", "", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class CheckoutProducts {

        /* renamed from: a, reason: collision with root package name */
        public final String f21823a;
        public final CheckoutContent b;

        public CheckoutProducts(String str, CheckoutContent checkoutContent) {
            this.f21823a = str;
        ...
        public final boolean equals(Object obj) {
            ...
            return Intrinsics.c(this.f21823a, checkoutProducts.f21823a) && Intrinsics.c(this.b, checkoutProducts.b);
        }

        public final int hashCode() {
            return this.b.hashCode() + (this.f21823a.hashCode() * 31);
        }

        public final String toString() {
            return "CheckoutProducts(__typename=" + this.f21823a + ", checkoutContent=" + this.b + ")";
        }
    }

    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/CheckoutProductsQuery$Companion;", "", "", "OPERATION_ID", "Ljava/lang/String;", "OPERATION_NAME", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/CheckoutProductsQuery$Data;", "Lcom/apollographql/apollo/api/Query$Data;", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Data implements Query.Data {

        /* renamed from: a, reason: collision with root package name */
        public final CheckoutProducts f21824a;

        public Data(CheckoutProducts checkoutProducts) {
            this.f21824a = checkoutProducts;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.c(this.f21824a, ((Data) obj).f21824a);
        }

        public final int hashCode() {
            CheckoutProducts checkoutProducts = this.f21824a;
            if (checkoutProducts == null) {
                return 0;
            }
            return checkoutProducts.hashCode();
        }

        public final String toString() {
            return "Data(checkoutProducts=" + this.f21824a + ")";
        }
    }

    public CheckoutProductsQuery(Optional optional, boolean z, boolean z2, Optional optional2) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof CheckoutProductsQuery)) {
            return false;
        }
        CheckoutProductsQuery checkoutProductsQuery = (CheckoutProductsQuery) obj;
        return Intrinsics.c(this.f21822a, checkoutProductsQuery.f21822a) && Intrinsics.c(this.b, checkoutProductsQuery.b) && Intrinsics.c(this.c, checkoutProductsQuery.c) && this.d == checkoutProductsQuery.d && this.e == checkoutProductsQuery.e && Intrinsics.c(this.f, checkoutProductsQuery.f) && Intrinsics.c(this.g, checkoutProductsQuery.g) && Intrinsics.c(this.h, checkoutProductsQuery.h);
    }

    public final int hashCode() {
        return this.h.hashCode() + a.c(this.g, a.c(this.f, b.e(b.e(a.c(this.c, a.c(this.b, this.f21822a.hashCode() * 31, 31), 31), 31, this.d), 31, this.e), 31), 31);
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String id() {
        return "1c51f2e455d63989ababb175a05376928fdeaa1b50eeabec33367a19f141f9a5";
    }
    ...
    public final void serializeVariables(JsonWriter jsonWriter, CustomScalarAdapters customScalarAdapters, boolean z) {
        ...
        Optional optional = this.f21822a;
    ...
    public final String toString() {
        StringBuilder sbP = a.p("CheckoutProductsQuery(includeMarketPickupSheet=", this.f21822a, ", includeIdVerificationBottomSheet=", this.b, ", includeExtraInfoContent=");
