...
import com.woolworths.shop.checkout.adapter.UpdateCollectionModeMutation_ResponseAdapter;
import com.woolworths.shop.checkout.fragment.CheckoutContent;
import kotlin.Metadata;
import kotlin.jvm.internal.Intrinsics;

@StabilityInferred
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0087\b\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0003\u0003\u0004\u0005¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateCollectionModeMutation;", "Lcom/apollographql/apollo/api/Mutation;", "Lcom/woolworths/shop/checkout/UpdateCollectionModeMutation$Data;", "Data", "UpdateCollectionMode", "Companion", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes7.dex */
public final /* data */ class UpdateCollectionModeMutation implements Mutation<Data> {

    /* renamed from: a, reason: collision with root package name */
    public final CollectionModeId f21912a;
    public final int b;
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0006X\u0086T¢\u0006\u0006\n\u0004\b\u0005\u0010\u0004¨\u0006\u0006"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateCollectionModeMutation$Companion;", "", "", "OPERATION_ID", "Ljava/lang/String;", "OPERATION_NAME", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateCollectionModeMutation$Data;", "Lcom/apollographql/apollo/api/Mutation$Data;", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class Data implements Mutation.Data {

        /* renamed from: a, reason: collision with root package name */
        public final UpdateCollectionMode f21913a;

        public Data(UpdateCollectionMode updateCollectionMode) {
            this.f21913a = updateCollectionMode;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof Data) && Intrinsics.c(this.f21913a, ((Data) obj).f21913a);
        }

        public final int hashCode() {
            UpdateCollectionMode updateCollectionMode = this.f21913a;
            if (updateCollectionMode == null) {
                return 0;
            }
            return updateCollectionMode.hashCode();
        }

        public final String toString() {
            return "Data(updateCollectionMode=" + this.f21913a + ")";
        }
    }

    @StabilityInferred
    @Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/shop/checkout/UpdateCollectionModeMutation$UpdateCollectionMode;", "", "shop-checkout_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final /* data */ class UpdateCollectionMode {

        /* renamed from: a, reason: collision with root package name */
        public final String f21914a;
        public final CheckoutContent b;

        public UpdateCollectionMode(String str, CheckoutContent checkoutContent) {
            this.f21914a = str;
        ...
        public final boolean equals(Object obj) {
            ...
            if (!(obj instanceof UpdateCollectionMode)) {
                return false;
            }
            UpdateCollectionMode updateCollectionMode = (UpdateCollectionMode) obj;
            return Intrinsics.c(this.f21914a, updateCollectionMode.f21914a) && Intrinsics.c(this.b, updateCollectionMode.b);
        }

        public final int hashCode() {
            return this.b.hashCode() + (this.f21914a.hashCode() * 31);
        }

        public final String toString() {
            return "UpdateCollectionMode(__typename=" + this.f21914a + ", checkoutContent=" + this.b + ")";
        }
    }

    public UpdateCollectionModeMutation(CollectionModeId modeId, int i, Optional optional, boolean z, boolean z2) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateCollectionModeMutation)) {
            return false;
        }
        UpdateCollectionModeMutation updateCollectionModeMutation = (UpdateCollectionModeMutation) obj;
        return this.f21912a == updateCollectionModeMutation.f21912a && this.b == updateCollectionModeMutation.b && Intrinsics.c(this.c, updateCollectionModeMutation.c) && Intrinsics.c(this.d, updateCollectionModeMutation.d) && Intrinsics.c(this.e, updateCollectionModeMutation.e) && this.f == updateCollectionModeMutation.f && this.g == updateCollectionModeMutation.g && Intrinsics.c(this.h, updateCollectionModeMutation.h) && Intrinsics.c(this.i, updateCollectionModeMutation.i) && Intrinsics.c(this.j, updateCollectionModeMutation.j);
    }

    public final int hashCode() {
        return this.j.hashCode() + a.c(this.i, a.c(this.h, b.e(b.e(a.c(this.e, a.c(this.d, a.c(this.c, b.a(this.b, this.f21912a.hashCode() * 31, 31), 31), 31), 31), 31, this.f), 31, this.g), 31), 31);
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String id() {
        return "2f613251cb3c68dd77afbe74d358c41d4bb66e90c156416cfe4586ba9c5b697b";
    }

    @Override // com.apollographql.apollo.api.Operation
    public final String name() {
        return "updateCollectionMode";
    }

    @Override // com.apollographql.apollo.api.Executable
    public final void serializeVariables(JsonWriter jsonWriter, CustomScalarAdapters customScalarAdapters, boolean z) {
        Intrinsics.h(customScalarAdapters, "customScalarAdapters");
        jsonWriter.F1("modeId");
        CollectionModeId_ResponseAdapter.b(jsonWriter, customScalarAdapters, this.f21912a);
        jsonWriter.F1("addressId");
        Adapters.b.toJson(jsonWriter, customScalarAdapters, Integer.valueOf(this.b));
    ...
    public final String toString() {
        StringBuilder sb = new StringBuilder("UpdateCollectionModeMutation(modeId=");
