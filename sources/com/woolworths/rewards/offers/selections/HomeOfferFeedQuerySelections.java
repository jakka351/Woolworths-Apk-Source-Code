...
import com.woolworths.rewards.offers.fragment.selections.RewardsHomeOfferFeedFieldsSelections;
import java.util.List;
import kotlin.Metadata;
import kotlin.collections.CollectionsKt;

@StabilityInferred
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\bÇ\u0002\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lcom/woolworths/rewards/offers/selections/HomeOfferFeedQuerySelections;", "", "offers_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes7.dex */
public final class HomeOfferFeedQuerySelections {

    /* renamed from: a, reason: collision with root package name */
    public static final List f21046a;
    ...
    static {
        ...
        builder.b(RewardsHomeOfferFeedFieldsSelections.h);
        List listR = CollectionsKt.R(compiledFieldC, builder.a());
        f21046a = listR;
        CompiledField.Builder builder2 = new CompiledField.Builder("rewardsOfferFeed", OfferFeed.f9694a);
