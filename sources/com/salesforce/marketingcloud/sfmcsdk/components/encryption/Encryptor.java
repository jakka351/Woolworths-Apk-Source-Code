...
class Encryptor {
    ...
    public static String decryptBytes(byte[] bArr, byte[] bArr2, byte[] bArr3) throws BadPaddingException, IllegalBlockSizeException {
        try {
    ...
    private static byte[] decryptWithPrivateKey(PrivateKey privateKey, String str, String str2) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
    ...
    private static byte[] encryptWithPublicKey(PublicKey publicKey, String str, String str2) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
    ...
    private static Cipher getBestCipher(String str) {
        try {
            return AES_GCM_CIPHER.equals(str) ? Cipher.getInstance(str) : Cipher.getInstance(str, getLegacyEncryptionProvider());
        } catch (Exception e) {
