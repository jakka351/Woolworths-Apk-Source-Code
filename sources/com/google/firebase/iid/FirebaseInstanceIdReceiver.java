...
public final class FirebaseInstanceIdReceiver extends CloudMessagingReceiver {
    ...
    public final int onMessageReceive(Context context, CloudMessage cloudMessage) {
        try {
            return ((Integer) Tasks.await(new FcmBroadcastProcessor(context).b(cloudMessage.getIntent()))).intValue();
    ...
    public final void onNotificationDismissed(Context context, Bundle bundle) {
        ...
        if (MessagingAnalytics.d(intentPutExtras)) {
            MessagingAnalytics.c(intentPutExtras.getExtras(), "_nd");
        }
    }
}
