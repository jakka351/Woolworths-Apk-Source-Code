...
public class SafeParcelReader {
    ...
    public static class ParseException extends RuntimeException {
        public ParseException(@NonNull String str, @NonNull Parcel parcel) {
            ...
            a.x(iDataPosition, str, " Parcel: pos=", " size=", sb);
            sb.append(iDataSize);
            super(sb.toString());
        }
    }
    ...
    public static void ensureAtEnd(@NonNull Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(a.n(new StringBuilder(String.valueOf(i).length() + 26), "Overread allowed size end=", i), parcel);
        }
    }
    ...
    public static int validateObjectHeader(@NonNull Parcel parcel) {
        ...
        throw new ParseException(c.l(iDataPosition, i, "Size read is invalid start=", " end=", new StringBuilder(String.valueOf(iDataPosition).length() + 32 + String.valueOf(i).length())), parcel);
    }
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        ...
        androidx.constraintlayout.core.state.a.t(i2, size, "Expected size ", " got ", sb);
        throw new ParseException(a.p(sb, " (0x", hexString, ")"), parcel);
    }
    ...
    private static void zzb(Parcel parcel, int i, int i2, int i3) {
        ...
        androidx.constraintlayout.core.state.a.t(i3, i2, "Expected size ", " got ", sb);
        throw new ParseException(a.p(sb, " (0x", hexString, ")"), parcel);
    }
}
