...
final class zzav extends zzos {
    ...
    */
    ...
    private final String zzaG() {
        ...
        StringBuilder sb = new StringBuilder(a.b(str.length(), 5, str2.length(), 1));
        androidx.constraintlayout.core.state.a.B(sb, "(", str, " OR ", str2);
        sb.append(")");
        return sb.toString();
    }

    private static final String zzaH(List list) {
        return list.isEmpty() ? "" : a.h(" AND (upload_type IN (", TextUtils.join(", ", list), "))");
    }
    ...
    public final long zzA(String str, com.google.android.gms.internal.measurement.zzib zzibVar, String str2, Map map, zzls zzlsVar, Long l) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            StringBuilder sb = new StringBuilder(c.f(1, str3) + String.valueOf(str4).length());
            sb.append(str3);
            sb.append("=");
            sb.append(str4);
    ...
    */
    ...
    public final boolean zzD(String str) {
        ...
        String strZzaG = zzaG();
        return zzay(androidx.constraintlayout.core.state.a.l(new StringBuilder((String.valueOf(strZzaH).length() + 61) + strZzaG.length()), "SELECT COUNT(1) > 0 FROM upload_queue WHERE app_id=?", strZzaH, " AND NOT ", strZzaG), new String[]{str}) != 0;
    }
    ...
    */
    ...
    public final void zzJ(List list) throws SQLException {
        ...
        if (zzag()) {
            ...
            String strP = a.p(new StringBuilder(String.valueOf(strJoin).length() + 2), "(", strJoin, ")");
            if (zzay(a.p(new StringBuilder(strP.length() + 80), "SELECT COUNT(1) FROM queue WHERE rowid IN ", strP, " AND retry_count =  2147483647 LIMIT 1"), null) > 0) {
                c.C(this.zzu, "The number of upload retries exceeds the limit. Will remain unchanged.");
            }
            try {
                SQLiteDatabase sQLiteDatabaseZze = zze();
                StringBuilder sb = new StringBuilder(strP.length() + 127);
    ...
    public final Object zzL(Cursor cursor, int i) {
        ...
        if (type == 0) {
            c.w(this.zzu, "Loaded invalid null value from database");
            return null;
        }
        if (type == 1) {
        ...
        c.w(this.zzu, "Loaded invalid blob type value, ignoring it");
        return null;
    }
    ...
    */
    ...
    public final void zzv(zzh zzhVar, boolean z, boolean z2) {
        ...
        contentValues.put(k.a.q, zzhVar.zzr());
        ...
        contentValues.put(nnlllnn.nnlllln.w007700770077www, (Long) 0L);
