...
public abstract class PhenotypeFlag<T> {
    ...
    private static boolean zzf() {
        if (zzan == null) {
            ...
            zzan = Boolean.valueOf(PermissionChecker.a(context, "com.google.android.providers.gsf.permission.READ_GSERVICES", Binder.getCallingPid(), Binder.getCallingUid(), Binder.getCallingPid() == Process.myPid() ? context.getPackageName() : null) == 0);
        }
