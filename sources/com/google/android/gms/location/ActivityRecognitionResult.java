...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    */
    ...
    public String toString() {
        ...
        long j = this.zzb;
        long j2 = this.zzc;
        StringBuilder sb = new StringBuilder(a.a(strValueOf.length(), 59, String.valueOf(j).length(), 24, String.valueOf(j2).length()) + 1);
        androidx.compose.ui.input.pointer.a.w(sb, "ActivityRecognitionResult [probableActivities=", strValueOf, ", timeMillis=");
        sb.append(j);
