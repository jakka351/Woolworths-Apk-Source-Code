...
public class zzl {
    ...
    @ShowFirstParty
    public static TokenData zza(final Context context, final Account account, final String str, Bundle bundle, long j, @Nullable Executor executor) throws GoogleAuthException, IOException {
        Preconditions.checkNotMainThread("Calling this from your main thread can lead to deadlock");
    ...
    private static Object zzi(Task task, String str) throws IOException, ApiException {
        try {
            ...
            String strH = a.h("Interrupted while waiting for the task of ", str, " to finish.");
            zzd.w(strH, new Object[0]);
            throw new IOException(strH, e);
        } catch (CancellationException e2) {
            String strH2 = a.h("Canceled while waiting for the task of ", str, " to finish.");
            zzd.w(strH2, new Object[0]);
            throw new IOException(strH2, e2);
        } catch (ExecutionException e3) {
            Throwable cause = e3.getCause();
            if (cause instanceof ApiException) {
                throw ((ApiException) cause);
            }
            String strH3 = a.h("Unable to get a result for ", str, " due to ExecutionException.");
            zzd.w(strH3, new Object[0]);
            throw new IOException(strH3, e3);
        }
    }
    ...
    public static void zzn(Context context, String str, @Nullable String str2, @Nullable Intent intent, @Nullable PendingIntent pendingIntent) throws GoogleAuthException, IOException {
        ...
        if (GoogleApiAvailability.getInstance().getApkVersion(context) >= Integer.MAX_VALUE && pendingIntent == null) {
            logger.e(a.h("Recovery PendingIntent is missing on current Gms version: 2147483647 for method: ", str, ". It should always be present on or above Gms version 2147483647. This indicates a bug in Gms implementation."), new Object[0]);
        }
        if (intent == null) {
            logger.e(a.j("no recovery Intent found with status=", str2, " for method=", str, ". This shouldn't happen"), new Object[0]);
        }
        throw new UserRecoverableAuthException(str2, intent);
    }
