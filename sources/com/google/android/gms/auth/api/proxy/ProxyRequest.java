...
public class ProxyRequest extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull String str) {
            ...
            if (!Patterns.WEB_URL.matcher(str).matches()) {
                throw new IllegalArgumentException(a.h("The supplied url [ ", str, "] is not match Patterns.WEB_URL!"));
            }
            this.zza = str;
        }
    ...
    public String toString() {
        return android.support.v4.media.session.a.p("ProxyRequest[ url: ", this.httpMethod, this.url, ", method: ", " ]");
    }
