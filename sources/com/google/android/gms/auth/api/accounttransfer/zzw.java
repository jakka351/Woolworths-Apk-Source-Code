...
public final class zzw extends zzbz {
    ...
    public final void setDecodedBytesInternal(FastJsonResponse.Field field, String str, byte[] bArr) {
        int safeParcelableFieldId = field.getSafeParcelableFieldId();
        if (safeParcelableFieldId != 4) {
            throw new IllegalArgumentException(a.e(safeParcelableFieldId, "Field with id=", " is not known to be a byte array."));
        }
        this.zzf = bArr;
    ...
    public final void setIntegerInternal(FastJsonResponse.Field field, String str, int i) {
        int safeParcelableFieldId = field.getSafeParcelableFieldId();
        if (safeParcelableFieldId != 3) {
            throw new IllegalArgumentException(a.e(safeParcelableFieldId, "Field with id=", " is not known to be an int."));
        }
        this.zze = i;
        this.zza.add(Integer.valueOf(safeParcelableFieldId));
    }
