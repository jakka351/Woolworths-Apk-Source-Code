...
public enum zzmv implements zzba {
    ...
    AGGREGATED_ON_DEVICE_BARCODE_DETECTION(DatastoreTestTrace.FirestoreV1Action.DATABASE_CONTENTS_BEFORE_ACTION_FIELD_NUMBER),
    AGGREGATED_ON_DEVICE_FACE_DETECTION(DatastoreTestTrace.FirestoreV1Action.MATCHING_DOCUMENTS_FIELD_NUMBER),
    ...
    OPTIONAL_MODULE_LANGUAGE_ID_INIT(e6.h),
