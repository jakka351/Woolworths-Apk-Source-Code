...
final class zzip extends zziq<zzjb.zzf> {
    ...
    public final <UT, UB> UB zza(zzld zzldVar, Object obj, zzio zzioVar, zziu<zzjb.zzf> zziuVar, UB ub, zzlu<UT, UB> zzluVar) throws IOException {
        ...
        if (zzmlVar != zzml.zzn) {
            ...
            if ((i2 == 17 || i2 == 18) && (objZza = zziuVar.zza((zziu<zzjb.zzf>) zzeVar.zzd)) != null) {
                objZza2 = zzjf.zza(objZza, objZza2);
            }
            zziuVar.zza((zziu<zzjb.zzf>) zzeVar.zzd, objZza2);
            return ub;
        }
        zzldVar.zzh();
        throw null;
    ...
    public final void zza(zzht zzhtVar, Object obj, zzio zzioVar, zziu<zzjb.zzf> zziuVar) throws IOException {
        ...
        if (byteBufferWrap.hasArray()) {
            ...
            zzky.zza().zza((zzky) zzkkVarZze).zza(zzkkVarZze, zzhoVar, zzioVar);
            zziuVar.zza((zziu<zzjb.zzf>) zzeVar.zzd, zzkkVarZze);
