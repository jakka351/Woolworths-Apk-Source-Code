...
public final class zzaen {
    ...
    */
    public static com.google.firebase.FirebaseException zza(com.google.android.gms.common.api.Status r3) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzaen.zza(com.google.android.gms.common.api.Status):com.google.firebase.FirebaseException");
    }
    ...
    public static boolean zzc(Exception exc) {
        if (exc instanceof FirebaseAuthException) {
            return ((FirebaseAuthException) exc).d.endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzd(Exception exc) {
        if (exc instanceof FirebaseAuthException) {
            return ((FirebaseAuthException) exc).d.endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof FirebaseAuthException) {
            return ((FirebaseAuthException) exc).d.endsWith("APP_NOT_AUTHORIZED");
        }
        return false;
    }
    ...
    public static FirebaseException zza(Status status, AuthCredential authCredential, @Nullable String str, @Nullable String str2) {
        ...
        return new FirebaseAuthUserCollisionException(zza(statusCode), zza(zzb(statusCode), status));
    }

    public static FirebaseAuthMultiFactorException zza(FirebaseAuth firebaseAuth, zzaas zzaasVar, @Nullable FirebaseUser firebaseUser) {
        ...
        List<MultiFactorInfo> listZzc3 = zzaasVar.zzc();
        String strZzb = zzaasVar.zzb();
        Preconditions.checkNotNull(listZzc3);
        Preconditions.checkNotEmpty(strZzb);
        zzam zzamVar = new zzam();
        zzamVar.f = new ArrayList();
        zzamVar.g = new ArrayList();
        for (MultiFactorInfo multiFactorInfo3 : listZzc3) {
            if (multiFactorInfo3 instanceof PhoneMultiFactorInfo) {
                zzamVar.f.add((PhoneMultiFactorInfo) multiFactorInfo3);
            } else if (multiFactorInfo3 instanceof TotpMultiFactorInfo) {
                zzamVar.g.add((TotpMultiFactorInfo) multiFactorInfo3);
            } else {
                throw new IllegalArgumentException("MultiFactorInfo must be either PhoneMultiFactorInfo or TotpMultiFactorInfo. The factorId of this MultiFactorInfo: ".concat(multiFactorInfo3.d()));
            }
        }
        zzamVar.e = strZzb;
        FirebaseApp firebaseApp = firebaseAuth.f15191a;
        firebaseApp.a();
        new zzal(arrayList, zzamVar, firebaseApp.b, zzaasVar.zza(), (zzaf) firebaseUser, arrayList2);
        return new FirebaseAuthMultiFactorException(str, str2);
    }
    ...
    private static String zza(String str, Status status) {
        return TextUtils.isEmpty(status.getStatusMessage()) ? str : String.format(a.g(str, " [ %s ]"), status.getStatusMessage());
    }

    public static boolean zza(Exception exc) {
        if (exc instanceof FirebaseAuthException) {
            return ((FirebaseAuthException) exc).d.endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
}
