...
public final class zzfc extends zzcy {
                ...
                if (this.zzc != null) {
                    ...
                    if (zzcyVar != null) {
                        if (!zzcyVar.zza()) {
                            ...
                            throw new GeneralSecurityException(a.j("Cannot use parsing strategy ", this.zzc.toString(), " when new keys are picked according to ", String.valueOf(this.zzd), "."));
                        }
    ...
    public final String toString() {
        ...
        return androidx.constraintlayout.core.state.a.l(a.v("LegacyKmsEnvelopeAead Parameters (kekUri: ", str, ", dekParsingStrategy: ", strValueOf, ", dekParametersForNewKeys: "), String.valueOf(this.zzd), ", variant: ", String.valueOf(this.zza), ")");
    }
