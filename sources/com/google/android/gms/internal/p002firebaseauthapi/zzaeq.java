...
public final class zzaeq extends AsyncTask<Void, Void, zzaep> {
    ...
    public final zzaep doInBackground(Void... voidArr) {
        try {
            ...
            httpURLConnectionZza.addRequestProperty(RequestBuilder.CONTENT_TYPE, "application/json; charset=UTF-8");
            httpURLConnectionZza.setConnectTimeout(60000);
            new zzafe(zzaesVar.zza(), this.zzg, zzafc.zza().zzb()).zza(httpURLConnectionZza);
            int iF = Callback.f(httpURLConnectionZza);
            if (iF != 200) {
                String strZza = zza(httpURLConnectionZza);
                zza.e("Error getting project config. Failed with " + strZza + " " + iF, new Object[0]);
                return zzaep.zzb(strZza);
            }
            zzahq zzahqVar = new zzahq();
            zzahqVar.zza(new String(zza(Callback.a(httpURLConnectionZza), 128)));
            ...
            zza.e(a.A("ConversionException encountered: ", e.getMessage()), new Object[0]);
            return null;
        } catch (IOException e2) {
            zza.e(a.A("IOException occurred: ", e2.getMessage()), new Object[0]);
            return null;
        } catch (NullPointerException e3) {
            zza.e(a.A("Null pointer encountered: ", e3.getMessage()), new Object[0]);
            return null;
        }
    }
    ...
    private static String zza(HttpURLConnection httpURLConnection) throws zzacn {
        try {
            if (Callback.f(httpURLConnection) < 400) {
                return null;
            }
    ...
    public final void onPostExecute(zzaep zzaepVar) {
        ...
        if (zzaesVar == null) {
            ...
            zzaesVar.zza(this.zze.build(), this.zzb, FirebaseAuth.getInstance(this.zzg).o);
        } else {
            zzaesVar.zza(this.zzb, zzao.a(strZzb));
        }
    }
    ...
    private static boolean zza(String str) {
        try {
            ...
            zza.e(a.i("Error parsing URL for auth domain check: ", str, ". ", e.getMessage()), new Object[0]);
        }
        return false;
    }
