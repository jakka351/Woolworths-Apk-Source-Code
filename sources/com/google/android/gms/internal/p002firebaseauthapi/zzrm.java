            ...
            if (zzoaVarZza.zzc().equals(zzbk.zza)) {
                ...
                if (zzbiVarZzb instanceof zzrk) {
                    ...
                    if (!(zzbiVarZzb instanceof zzof)) {
                        throw new GeneralSecurityException(a.i("Cannot get output prefix for key of class ", zzbiVarZzb.getClass().getName(), " with parameters ", String.valueOf(zzbiVarZzb.zza())));
                    }
