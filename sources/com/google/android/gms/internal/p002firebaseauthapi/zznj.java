            ...
            if (bigInteger.compareTo(eCParameterSpec.getOrder()) < 0) {
                ...
                for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
                    if (bigInteger.testBit(iBitLength)) {
                        zzniVarZza = zza(zzniVarZza, zzniVarZza2, a2, bigIntegerZza);
                        zzniVarZza2 = zza(zzniVarZza2, a2, bigIntegerZza);
                    } else {
                        zzniVarZza2 = zza(zzniVarZza, zzniVarZza2, a2, bigIntegerZza);
                        zzniVarZza = zza(zzniVarZza, a2, bigIntegerZza);
                    }
                }
                if (zzniVarZza.zza()) {
