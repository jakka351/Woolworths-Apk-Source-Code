...
public final class zzpw {
    ...
    public final <KeyT extends zzbi, PrimitiveT> PrimitiveT zza(KeyT keyt, Class<PrimitiveT> cls) throws GeneralSecurityException {
        ...
        throw new GeneralSecurityException(a.h("No PrimitiveConstructor for ", String.valueOf(zzpxVar), " available, see https://developers.google.com/tink/faq/registration_errors"));
    }
