...
public final class zzafu {
    ...
    private static void zza(HttpURLConnection httpURLConnection, zzafv<?> zzafvVar, Type type) {
        try {
            try {
                ...
                InputStream inputStreamA = zza(iF) ? Callback.a(httpURLConnection) : httpURLConnection.getErrorStream();
    ...
    public static void zza(String str, zzafv<?> zzafvVar, Type type, zzafe zzafeVar) throws IOException {
        try {
    ...
    public static void zza(String str, zzafa zzafaVar, zzafv<?> zzafvVar, Type type, zzafe zzafeVar) throws IOException {
        try {
            ...
            httpURLConnection.setConnectTimeout(60000);
            zzafeVar.zza(httpURLConnection);
            BufferedOutputStream bufferedOutputStream = new BufferedOutputStream(Callback.d(httpURLConnection), bytes.length);
            try {
