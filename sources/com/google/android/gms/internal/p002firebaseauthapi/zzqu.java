...
public final class zzqu extends zzrn {
    ...
    public static final class zzb {
        ...
        public final zzb zzb(int i) throws GeneralSecurityException {
            if (i < 10 || 16 < i) {
                throw new GeneralSecurityException(a.d(i, "Invalid tag size for AesCmacParameters: "));
            }
    ...
    public final String toString() {
        ...
        int i = this.zzb;
        return a.m(b.u("AES-CMAC Parameters (variant: ", i, strValueOf, ", ", "-byte tags, and "), this.zza, "-byte key)");
    }
