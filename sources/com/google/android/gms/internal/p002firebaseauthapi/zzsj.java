    ...
    public static zzrh zzb(zzqe zzqeVar) throws GeneralSecurityException {
        if (zzqeVar.zza().zzf().equals("type.googleapis.com/google.crypto.tink.HmacKey")) {
            try {
                ...
                throw new GeneralSecurityException(a.d(zzweVarZza.zzb(), "Parsing HmacParameters failed: unknown Version "));
            } catch (zzall e) {
                throw new GeneralSecurityException("Parsing HmacParameters failed: ", e);
            }
        }
        throw new IllegalArgumentException(a.A("Wrong type URL in call to HmacProtoSerialization.parseParameters: ", zzqeVar.zza().zzf()));
    }
