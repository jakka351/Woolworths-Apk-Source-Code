...
interface zzaol {
    ...
    void zza(int i, zzajv zzajvVar) throws IOException;

    <K, V> void zza(int i, zzamd<K, V> zzamdVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    @Deprecated
    void zza(int i, Object obj, zzanb zzanbVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<zzajv> list) throws IOException;

    @Deprecated
    void zza(int i, List<?> list, zzanb zzanbVar) throws IOException;
    ...
    void zzb(int i, Object obj, zzanb zzanbVar) throws IOException;

    void zzb(int i, List<String> list) throws IOException;

    void zzb(int i, List<?> list, zzanb zzanbVar) throws IOException;
