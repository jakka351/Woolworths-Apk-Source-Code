...
public final class zzge {
    ...
    public static final class zza extends zzcg<zza, C0299zza> implements zzdq {
        ...
        public static final class C0299zza extends zzcg.zza<zza, C0299zza> implements zzdq {
            private C0299zza() {
                super(zza.zzsm);
            }

            public /* synthetic */ C0299zza(zzgf zzgfVar) {
                this();
            }
        }
    ...
    public static final class zzj extends zzcg<zzj, zzb> implements zzdq {
        ...
        public static final class zzb extends zzcg.zza<zzj, zzb> implements zzdq {
            ...
            public /* synthetic */ zzb(zzgf zzgfVar) {
                this();
            }
        }
    ...
    public static final class zzq extends zzcg.zzd<zzq, zza> implements zzdq {
        ...
        public enum zzb implements zzcj {
            ...
            ADWORDS_MOBILE(133),
            ADWORDS_MOBILE_ANDROID_PRIMES(BERTags.FLAGS),
            ...
            SAMPLE_IOS_PRIMES(DatastoreTestTrace.FirestoreV1Action.DATABASE_CONTENTS_BEFORE_ACTION_FIELD_NUMBER),
            ...
            PDF_VIEWER(190),
            BIGTOP(191),
            VOICE(BERTags.PRIVATE),
            MYFIBER(194),
            RECORDED_PAGES(195),
            MOB_DOG(197),
            WALLET_APP(198),
            GBOARD(199),
            CRONET_GMM(DatastoreTestTrace.FirestoreV1Action.MATCHING_DOCUMENTS_FIELD_NUMBER),
            TRUSTED_FACE(204),
            MATCHSTICK(205),
            ...
            CHIME(nlnlnnn.xxx00780078x0078),
            BEACON_GCORE(301),
            ANDROID_STUDIO(302),
            DOCS_OFFLINE(306),
            FREIGHTER(307),
            ...
            ANDROID_MIGRATE(DilithiumEngine.DilithiumPolyT1PackedBytes),
            ...
            HALLWAY(382),
            SPACES(383),
            TOOLKIT_QUICKSTART(KyberEngine.KyberPolyBytes),
            ...
            EARTH_ANDROID_PRIMES(WalletConstants.ERROR_CODE_ILLEGAL_CALLER),
            CORP_ANDROID_AIUTO(WalletConstants.ERROR_CODE_APP_LABEL_UNAVAILABLE),
            ...
            public static zzb zzax(int i) {
                switch (i) {
                    ...
                    case nlnlnnn.xxx00780078x0078 /* 300 */:
                        return CHIME;
                    case 301:
                        return BEACON_GCORE;
                    case 302:
