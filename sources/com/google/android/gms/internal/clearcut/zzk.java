...
public final class zzk {
    ...
    public static long zza(byte[] bArr) {
        ...
        if (length < 0 || length > bArr2.length) {
            throw new IndexOutOfBoundsException(c.k(67, length, "Out of bound index with offput: 0 and length: "));
        }
        char c = '/';
        char c2 = 0;
        if (length <= 32) {
        ...
        while (true) {
            ...
            if (i7 == i2) {
                ...
                zza(bArr2, i4 - 31, jRotateRight7 + jArr2[1], zzb(bArr2, i4 - 47) + jZzb14, jArr2);
                return zza(a.f(jZzb14 ^ (jZzb14 >>> c6), -4348849565147123417L, zza(jArr3[c4], jArr2[c4], j8), j11), zza(jArr3[1], jArr2[1], j8) + jRotateRight7, j8);
            }
            bArr2 = bArr;
