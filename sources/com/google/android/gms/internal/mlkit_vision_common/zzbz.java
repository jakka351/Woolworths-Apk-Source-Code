...
final class zzbz implements ObjectEncoder {
    ...
    private static final FieldDescriptor zzg = a.C(6, new FieldDescriptor.Builder("detectedBarcodeFormats"));
    private static final FieldDescriptor zzh = a.C(7, new FieldDescriptor.Builder("detectedBarcodeValueTypes"));
