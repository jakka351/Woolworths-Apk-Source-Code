...
final class zzcv implements ObjectEncoder {
    ...
    private static final FieldDescriptor zzd = a.C(3, new FieldDescriptor.Builder("modelInitializationMs"));
    private static final FieldDescriptor zze = a.C(4, new FieldDescriptor.Builder("confidenceThreshold"));
