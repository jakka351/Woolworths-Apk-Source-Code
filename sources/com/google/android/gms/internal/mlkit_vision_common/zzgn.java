...
final class zzgn implements ObjectEncoder {
    ...
    private static final FieldDescriptor zzc = a.C(2, new FieldDescriptor.Builder("stages"));
    private static final FieldDescriptor zzd = a.C(3, new FieldDescriptor.Builder("runMiniBenchmark"));
