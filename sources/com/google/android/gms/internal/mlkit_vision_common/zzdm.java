...
final class zzdm implements ObjectEncoder {
    ...
    private static final FieldDescriptor zzb = a.C(1, new FieldDescriptor.Builder("supportedFormats"));
    ...
    private static final FieldDescriptor zze = a.C(4, new FieldDescriptor.Builder("allowManualInput"));
