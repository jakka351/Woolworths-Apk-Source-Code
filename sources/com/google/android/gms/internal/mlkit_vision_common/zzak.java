...
final class zzak implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor zzb = a.C(1, new FieldDescriptor.Builder("key"));
    private static final FieldDescriptor zzc = a.C(2, new FieldDescriptor.Builder("value"));
    ...
    public final ObjectEncoderContext zzc(@NonNull FieldDescriptor fieldDescriptor, @Nullable Object obj, boolean z) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
        if (obj != null) {
    ...
    public final zzak zzd(@NonNull FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (!z || i != 0) {
    ...
    public final zzak zze(@NonNull FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (!z || j != 0) {
            zzai zzaiVarZzj = zzj(fieldDescriptor);
            zzah zzahVar = zzah.DEFAULT;
            int iOrdinal = zzaiVarZzj.zzb().ordinal();
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    @NonNull
    public final ObjectEncoderContext add(@NonNull FieldDescriptor fieldDescriptor, @Nullable Object obj) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
    ...
    @NonNull
    public final ObjectEncoderContext add(@NonNull String str, @Nullable Object obj) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
