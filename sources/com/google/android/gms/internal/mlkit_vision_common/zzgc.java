...
final class zzgc implements ObjectEncoder {
    ...
    private static final FieldDescriptor zze = a.C(4, new FieldDescriptor.Builder("loadDurationMs"));
    private static final FieldDescriptor zzf = a.C(5, new FieldDescriptor.Builder("sessionDurationMs"));
    private static final FieldDescriptor zzg = a.C(6, new FieldDescriptor.Builder("sessionTotalInferenceDurationMs"));
