...
final class zzcd implements ObjectEncoder {
    ...
    private static final FieldDescriptor zze = a.C(4, new FieldDescriptor.Builder("detectorOptions"));
    private static final FieldDescriptor zzf = a.C(5, new FieldDescriptor.Builder("contourDetectedFaces"));
    private static final FieldDescriptor zzg = a.C(6, new FieldDescriptor.Builder("nonContourDetectedFaces"));
