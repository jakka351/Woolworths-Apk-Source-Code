        ...
        while (true) {
            ...
            if (obj == null) {
                ...
                try {
                    ...
                    String strP = YU.a.p(new StringBuilder(name.length() + 1 + String.valueOf(hexString).length()), name, "@", hexString);
                    ...
                    StringBuilder sb = new StringBuilder(au.com.woolworths.shop.checkout.ui.confirmation.c.e(strP.length() + 8, 1, name2));
                    sb.append("<");
                    sb.append(strP);
                    sb.append(" threw ");
                    sb.append(name2);
