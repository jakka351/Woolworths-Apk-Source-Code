...
class zzhkr extends AbstractMap {
    private Object[] zza;
    private int zzb;
    private Map zzc;
    private boolean zzd;
    private volatile zzhkq zze;
    private Map zzf;
    ...
    public final Object zzg(int i) {
        zzh();
        Object value = ((zzhko) this.zza[i]).getValue();
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i2] = new zzhko(this, (Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    private final int zzm(Comparable comparable) {
        ...
        int i3 = 0;
        if (i2 >= 0) {
            int iCompareTo = comparable.compareTo(((zzhko) this.zza[i2]).zza());
            if (iCompareTo > 0) {
                return -(i + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i3 <= i2) {
            int i4 = (i3 + i2) / 2;
            int iCompareTo2 = comparable.compareTo(((zzhko) this.zza[i4]).zza());
            if (iCompareTo2 < 0) {
                i2 = i4 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof zzhkr)) {
            return super.equals(obj);
        }
        zzhkr zzhkrVar = (zzhkr) obj;
        int size = size();
        if (size != zzhkrVar.size()) {
            return false;
        }
        int i = this.zzb;
        if (i != zzhkrVar.zzb) {
            return entrySet().equals(zzhkrVar.entrySet());
        }
        for (int i2 = 0; i2 < i; i2++) {
            if (!zzd(i2).equals(zzhkrVar.zzd(i2))) {
                return false;
            }
        }
        if (i != size) {
            return this.zzc.equals(zzhkrVar.zzc);
        }
        return true;
    }
    ...
    public final Object get(Object obj) {
        ...
        return iZzm >= 0 ? ((zzhko) this.zza[iZzm]).getValue() : this.zzc.get(comparable);
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int iZzm = zzm(comparable);
        if (iZzm >= 0) {
            return ((zzhko) this.zza[iZzm]).setValue(obj);
        }
        zzh();
        if (this.zza == null) {
        ...
        if (this.zzb == 16) {
            zzhko zzhkoVar = (zzhko) this.zza[15];
            this.zzb = 15;
            zzo().put(zzhkoVar.zza(), zzhkoVar.getValue());
        }
        Object[] objArr = this.zza;
        int length = objArr.length;
        System.arraycopy(objArr, i, objArr, i + 1, 15 - i);
        this.zza[i] = new zzhko(this, comparable, obj);
        this.zzb++;
        return null;
    }
    ...
    public /* synthetic */ zzhkr(byte[] bArr) {
        Map map = Collections.EMPTY_MAP;
        this.zzc = map;
        this.zzf = map;
    }
