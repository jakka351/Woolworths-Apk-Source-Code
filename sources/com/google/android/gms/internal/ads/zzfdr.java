...
public final class zzfdr {
    ...
    public static void zzb(Bundle bundle, @Nullable String str, @Nullable String str2, boolean z) {
        if (!z || str2 == null) {
            return;
        }
    ...
    public static void zzc(Bundle bundle, @Nullable String str, int i, boolean z) {
        if (z) {
            bundle.putInt(str, i);
        }
    }

    public static void zzd(Bundle bundle, @Nullable String str, boolean z, boolean z2) {
        if (z2) {
