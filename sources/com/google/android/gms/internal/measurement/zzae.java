...
public final class zzae implements Iterable, zzao, zzak {
    ...
    public final void zzn(int i, zzao zzaoVar) {
        ...
        if (i < 0) {
            throw new IndexOutOfBoundsException(a.n(new StringBuilder(String.valueOf(i).length() + 21), "Out of bounds index: ", i));
        }
        if (zzaoVar == null) {
    ...
    public final void zzq(int i, zzao zzaoVar) {
        if (i < 0) {
            throw new IllegalArgumentException(a.n(new StringBuilder(String.valueOf(i).length() + 21), "Invalid value index: ", i));
        }
        if (i >= zzh()) {
            zzn(i, zzaoVar);
            return;
