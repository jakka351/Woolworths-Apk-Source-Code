...
public enum zzrb implements zzfc {
    ...
    OPTIONAL_MODULE_INIT_ERROR(DatastoreTestTrace.FirestoreV1Action.DATABASE_CONTENTS_BEFORE_ACTION_FIELD_NUMBER),
    OPTIONAL_MODULE_INFERENCE_ERROR(DatastoreTestTrace.FirestoreV1Action.MATCHING_DOCUMENTS_FIELD_NUMBER),
    ...
    CODE_SCANNER_APP_NAME_UNAVAILABLE(e6.h),
