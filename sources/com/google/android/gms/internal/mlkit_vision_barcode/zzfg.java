...
final class zzfg implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor zzb = a.z(1, new FieldDescriptor.Builder("key"));
    private static final FieldDescriptor zzc = a.z(2, new FieldDescriptor.Builder("value"));
    private static final ObjectEncoder zzd = new ObjectEncoder() { // from class: com.google.android.gms.internal.mlkit_vision_barcode.zzff
        @Override // com.google.firebase.encoders.ObjectEncoder
        public final void encode(Object obj, Object obj2) throws IOException {
            zzfg.zzg((Map.Entry) obj, (ObjectEncoderContext) obj2);
        }
    };
    ...
    public zzfg(OutputStream outputStream, Map map, Map map2, ObjectEncoder objectEncoder) {
    ...
    private static int zzh(FieldDescriptor fieldDescriptor) {
        zzfe zzfeVar = (zzfe) fieldDescriptor.a(zzfe.class);
        if (zzfeVar != null) {
            return zzfeVar.zza();
        }
    ...
    public final zzfg zzd(@NonNull FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (!z || i != 0) {
    ...
    public final zzfg zze(@NonNull FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (!z || j != 0) {
            zzfe zzfeVarZzj = zzj(fieldDescriptor);
            int iOrdinal = zzfeVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
    ...
    public final zzfg zzf(@Nullable Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.zzf.get(obj.getClass());
