...
public final class zzht implements zzgx {
    ...
    public final Object zzb(@NotNull Object obj, @NotNull Object obj2) throws zzce {
        ...
        if (z5 && (obj2 instanceof byte[])) {
            ...
            IntRange intRangeO = RangesKt.o(0, length3);
            ArrayList arrayList11 = new ArrayList(CollectionsKt.s(intRangeO, 10));
        ...
        if (z6 && (obj2 instanceof short[])) {
            ...
            IntRange intRangeO2 = RangesKt.o(0, length4);
            ArrayList arrayList12 = new ArrayList(CollectionsKt.s(intRangeO2, 10));
        ...
        if (z7 && (obj2 instanceof int[])) {
            ...
            IntRange intRangeO3 = RangesKt.o(0, length5);
            ArrayList arrayList13 = new ArrayList(CollectionsKt.s(intRangeO3, 10));
        ...
        IntRange intRangeO4 = RangesKt.o(0, length6);
        ArrayList arrayList14 = new ArrayList(CollectionsKt.s(intRangeO4, 10));
