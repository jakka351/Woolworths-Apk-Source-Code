...
public final class MaterialContainerTransform extends Transition {
    ...
    public static final ProgressThresholdsGroup e = new ProgressThresholdsGroup(new ProgressThresholds(BitmapDescriptorFactory.HUE_RED, 0.25f), new ProgressThresholds(BitmapDescriptorFactory.HUE_RED, 1.0f), new ProgressThresholds(BitmapDescriptorFactory.HUE_RED, 1.0f), new ProgressThresholds(BitmapDescriptorFactory.HUE_RED, 0.75f));
    public static final ProgressThresholdsGroup f = new ProgressThresholdsGroup(new ProgressThresholds(0.6f, 0.9f), new ProgressThresholds(BitmapDescriptorFactory.HUE_RED, 1.0f), new ProgressThresholds(BitmapDescriptorFactory.HUE_RED, 0.9f), new ProgressThresholds(0.3f, 0.9f));
    public static final ProgressThresholdsGroup g = new ProgressThresholdsGroup(new ProgressThresholds(0.1f, 0.4f), new ProgressThresholds(0.1f, 1.0f), new ProgressThresholds(0.1f, 1.0f), new ProgressThresholds(0.1f, 0.9f));
    public static final ProgressThresholdsGroup h = new ProgressThresholdsGroup(new ProgressThresholds(0.6f, 0.9f), new ProgressThresholds(BitmapDescriptorFactory.HUE_RED, 0.9f), new ProgressThresholds(BitmapDescriptorFactory.HUE_RED, 0.9f), new ProgressThresholds(0.2f, 0.9f));
    ...
    public static class ProgressThresholdsGroup {
        ...
        /* renamed from: a, reason: collision with root package name */
        public final ProgressThresholds f14696a;
        ...
        public ProgressThresholdsGroup(ProgressThresholds progressThresholds, ProgressThresholds progressThresholds2, ProgressThresholds progressThresholds3, ProgressThresholds progressThresholds4) {
            this.f14696a = progressThresholds;
    ...
    public static final class TransitionDrawable extends Drawable {
        ...
        public TransitionDrawable(PathMotion pathMotion, View view, RectF rectF, ShapeAppearanceModel shapeAppearanceModel, float f, View view2, RectF rectF2, ShapeAppearanceModel shapeAppearanceModel2, float f2, boolean z, FadeModeEvaluator fadeModeEvaluator, FitModeEvaluator fitModeEvaluator, ProgressThresholdsGroup progressThresholdsGroup) {
            ...
            RectF rectF5 = TransitionUtils.f14702a;
        ...
        public final void b(Canvas canvas) {
            ...
            Rect bounds = getBounds();
            RectF rectF = this.u;
            TransitionUtils.f(canvas, bounds, rectF.left, rectF.top, this.C.f14692a, this.B.f14690a, new CanvasCompat.CanvasOperation() { // from class: com.google.android.material.transition.platform.MaterialContainerTransform.TransitionDrawable.1
                @Override // com.google.android.material.canvas.CanvasCompat.CanvasOperation
                public final void a(Canvas canvas2) {
                    TransitionDrawable.this.f14697a.draw(canvas2);
                }
            });
        }
        ...
        public final void d(float f) {
            ...
            ProgressThresholds progressThresholds2 = progressThresholdsGroup.f14696a;
            ProgressThresholds progressThresholds3 = progressThresholdsGroup.c;
            float f11 = progressThresholds.f14695a;
            ...
            RectF rectF7 = this.x;
            rectF7.set(rectF5);
            float f17 = progressThresholds3.f14695a;
            ...
            float f19 = progressThresholds4.f14695a;
            ...
            if (f < f19) {
                ...
                if (f > f20) {
                    ...
                    TransitionUtils.AnonymousClass1 anonymousClass1 = new TransitionUtils.CornerSizeBinaryOperator() { // from class: com.google.android.material.transition.platform.TransitionUtils.1
                        ...
                        /* renamed from: a */
                        public final /* synthetic */ RectF f14703a;
            ...
            maskEvaluator.f14693a.op(path2, path, Path.Op.UNION);
            ...
            this.B = this.z.a(f4, progressThresholds2.f14695a, progressThresholds2.b);
            Paint paint = this.j;
            if (paint.getColor() != 0) {
                paint.setAlpha(this.B.f14690a);
            }
            Paint paint2 = this.k;
        ...
        public final void draw(Canvas canvas) {
            ...
            canvas.clipPath(this.n.f14693a);
            c(canvas, this.i);
            if (this.B.c) {
                b(canvas);
                a(canvas);
    ...
    public static void a(TransitionValues transitionValues) throws Resources.NotFoundException {
        ShapeAppearanceModel shapeAppearanceModelA;
        ...
        map.put("materialContainerTransition:shapeAppearance", shapeAppearanceModelA.h(new ShapeAppearanceModel.CornerSizeUnaryOperator() { // from class: com.google.android.material.transition.platform.a
            @Override // com.google.android.material.shape.ShapeAppearanceModel.CornerSizeUnaryOperator
            public final CornerSize c(CornerSize cornerSize) {
                RectF rectF3 = TransitionUtils.f14702a;
    ...
    @Override // android.transition.Transition
    public final void captureStartValues(TransitionValues transitionValues) throws Resources.NotFoundException {
        a(transitionValues);
    }
    ...
    public final Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) throws Resources.NotFoundException {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (rectF2 != null && shapeAppearanceModel != null) {
                ...
                if (getDuration() == -1 && (iC = MotionUtils.c(context, i, -1)) != -1) {
                    setDuration(iC);
                }
                PathMotion pathMotion = getPathMotion();
                FadeModeEvaluator fadeModeEvaluator = z ? FadeModeEvaluators.f14689a : FadeModeEvaluators.b;
                float fWidth = rectF2.width();
                float fHeight = rectF2.height();
                float fWidth2 = rectF3.width();
                float fHeight2 = rectF3.height();
                FitModeEvaluator fitModeEvaluator = (!z ? (fWidth2 * fHeight) / fWidth >= fHeight2 : (fHeight2 * fWidth) / fWidth2 >= fHeight) ? FitModeEvaluators.b : FitModeEvaluators.f14691a;
                PathMotion pathMotion2 = getPathMotion();
                if ((pathMotion2 instanceof ArcMotion) || (pathMotion2 instanceof MaterialArcMotion)) {
                    ProgressThresholdsGroup progressThresholdsGroup2 = z ? g : h;
                    progressThresholdsGroup = new ProgressThresholdsGroup(progressThresholdsGroup2.f14696a, progressThresholdsGroup2.b, progressThresholdsGroup2.c, progressThresholdsGroup2.d);
                } else {
                    ProgressThresholdsGroup progressThresholdsGroup3 = z ? e : f;
                    progressThresholdsGroup = new ProgressThresholdsGroup(progressThresholdsGroup3.f14696a, progressThresholdsGroup3.b, progressThresholdsGroup3.c, progressThresholdsGroup3.d);
                }
