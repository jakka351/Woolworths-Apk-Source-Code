...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public static class RangeSliderState extends AbsSavedState {
        public static final Parcelable.Creator<RangeSliderState> CREATOR = new AnonymousClass1();
        public float d;
        public int e;
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.z0 = rangeSliderState.d;
        int i = rangeSliderState.e;
        this.A0 = i;
        setSeparationUnit(i);
    }
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        rangeSliderState.d = this.z0;
        rangeSliderState.e = this.A0;
    ...
    public RangeSlider(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) throws Resources.NotFoundException {
        ...
        TypedArray typedArrayD = ThemeEnforcement.d(context, attributeSet, com.google.android.material.R.styleable.T, i, 2132084152, new int[0]);
        ...
        this.z0 = typedArrayD.getDimension(0, BitmapDescriptorFactory.HUE_RED);
        typedArrayD.recycle();
    }
}
