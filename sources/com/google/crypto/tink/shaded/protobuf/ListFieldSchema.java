...
abstract class ListFieldSchema {
    ...
    public static final ListFieldSchemaFull f15105a = new ListFieldSchemaFull();
    ...
    public static final class ListFieldSchemaFull extends ListFieldSchema {
        ...
        public static List d(Object obj, int i, long j) {
            ...
            if (list.isEmpty()) {
                ...
                UnsafeUtil.p(obj, j, lazyStringArrayList);
                return lazyStringArrayList;
            }
            if (c.isAssignableFrom(list.getClass())) {
                ArrayList arrayList = new ArrayList(list.size() + i);
                arrayList.addAll(list);
                UnsafeUtil.p(obj, j, arrayList);
                return arrayList;
            }
            if (list instanceof UnmodifiableLazyStringList) {
                ...
                UnsafeUtil.p(obj, j, lazyStringArrayList2);
            ...
            if ((list instanceof PrimitiveNonBoxingCollection) && (list instanceof Internal.ProtobufList)) {
                ...
                if (!protobufList.r()) {
                    ...
                    UnsafeUtil.p(obj, j, protobufListA);
        ...
        public final void a(long j, Object obj) {
            ...
            UnsafeUtil.p(obj, j, objUnmodifiableList);
        }
    ...
    public static final class ListFieldSchemaLite extends ListFieldSchema {
        @Override // com.google.crypto.tink.shaded.protobuf.ListFieldSchema
        public final void a(long j, Object obj) {
            ((Internal.ProtobufList) UnsafeUtil.d.m(j, obj)).p();
        }
        ...
        public final void b(Object obj, long j, Object obj2) {
            ...
            UnsafeUtil.p(obj, j, protobufList);
        }
