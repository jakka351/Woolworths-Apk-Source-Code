...
public final class EllipticCurves {
    ...
    public static final class CurveType {
        public static final CurveType d;
        public static final CurveType e;
        public static final CurveType f;
        public static final /* synthetic */ CurveType[] g;

        static {
            CurveType curveType = new CurveType("NIST_P256", 0);
            d = curveType;
            CurveType curveType2 = new CurveType("NIST_P384", 1);
            e = curveType2;
            CurveType curveType3 = new CurveType("NIST_P521", 2);
            f = curveType3;
            g = new CurveType[]{curveType, curveType2, curveType3};
        }
    ...
    public static final class EcdsaEncoding {
        public static final EcdsaEncoding d;
        public static final EcdsaEncoding e;
        public static final /* synthetic */ EcdsaEncoding[] f;

        static {
            EcdsaEncoding ecdsaEncoding = new EcdsaEncoding("IEEE_P1363", 0);
            d = ecdsaEncoding;
            EcdsaEncoding ecdsaEncoding2 = new EcdsaEncoding(ASN1Encoding.DER, 1);
            e = ecdsaEncoding2;
            f = new EcdsaEncoding[]{ecdsaEncoding, ecdsaEncoding2};
        }
    ...
    public static final class PointFormatType {
        public static final PointFormatType d;
        public static final PointFormatType e;
        public static final PointFormatType f;
        public static final /* synthetic */ PointFormatType[] g;

        static {
            PointFormatType pointFormatType = new PointFormatType("UNCOMPRESSED", 0);
            d = pointFormatType;
            PointFormatType pointFormatType2 = new PointFormatType("COMPRESSED", 1);
            e = pointFormatType2;
            PointFormatType pointFormatType3 = new PointFormatType("DO_NOT_USE_CRUNCHY_UNCOMPRESSED", 2);
            f = pointFormatType3;
            g = new PointFormatType[]{pointFormatType, pointFormatType2, pointFormatType3};
        }
        ...
        public static PointFormatType[] values() {
            return (PointFormatType[]) g.clone();
        }
    }
    ...
    public static ECParameterSpec b(CurveType curveType) throws NoSuchAlgorithmException {
        int iOrdinal = curveType.ordinal();
        if (iOrdinal == 0) {
    ...
    public static ECPrivateKey c(CurveType curveType, byte[] bArr) throws NoSuchAlgorithmException {
        return (ECPrivateKey) ((KeyFactory) EngineFactory.j.a("EC")).generatePrivate(new ECPrivateKeySpec(new BigInteger(1, bArr), b(curveType)));
    }

    public static ECPublicKey d(CurveType curveType, byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ECParameterSpec eCParameterSpecB = b(curveType);
        ECPoint eCPoint = new ECPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
        a(eCPoint, eCParameterSpecB.getCurve());
        return (ECPublicKey) ((KeyFactory) EngineFactory.j.a("EC")).generatePublic(new ECPublicKeySpec(eCPoint, eCParameterSpecB));
    }
