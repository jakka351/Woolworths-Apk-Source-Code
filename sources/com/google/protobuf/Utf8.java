...
final class Utf8 {
    ...
    public static final Processor f16094a;
    ...
    public static abstract class Processor {
            ...
            while (i < i3) {
                ...
                if (DecodeUtil.b(b2)) {
                    ...
                    while (i8 < i3) {
                        ...
                        i8++;
                        DecodeUtil.c(b3, cArr, i7);
                        i7++;
                    }
                    i5 = i7;
                    i = i8;
                } else if (DecodeUtil.d(b2)) {
                    if (i6 >= i3) {
                        throw InvalidProtocolBufferException.c();
                    }
                    i += 2;
                    DecodeUtil.e(b2, byteBuffer.get(i6), cArr, i5);
                    i5++;
                } else if (DecodeUtil.f(b2)) {
                    if (i6 >= i3 - 1) {
                        throw InvalidProtocolBufferException.c();
                    }
                    int i9 = i + 2;
                    i += 3;
                    DecodeUtil.g(b2, byteBuffer.get(i6), byteBuffer.get(i9), cArr, i5);
                    i5++;
                } else {
                    if (i6 >= i3 - 2) {
                        throw InvalidProtocolBufferException.c();
        ...
        public static int h(ByteBuffer byteBuffer, int i, int i2, int i3) {
            ...
            Processor processor = Utf8.f16094a;
            int i9 = i3 - 7;
            int i10 = i6;
    ...
    public static final class SafeProcessor extends Processor {
        ...
        public final String a(int i, int i2, byte[] bArr) throws InvalidProtocolBufferException {
            ...
            while (i < i3) {
                ...
                if (DecodeUtil.b(b2)) {
                    ...
                    i += 2;
                    DecodeUtil.e(b2, bArr[i6], cArr, i5);
                    i5++;
                } else if (DecodeUtil.f(b2)) {
                    if (i6 >= i3 - 1) {
                        throw InvalidProtocolBufferException.c();
                    ...
                    int i9 = i + 2;
                    i += 3;
                    DecodeUtil.g(b2, bArr[i6], bArr[i9], cArr, i5);
                    i5++;
                } else {
                    if (i6 >= i3 - 2) {
                        throw InvalidProtocolBufferException.c();
        ...
        */
        public final int f(int r12, int r13, byte[] r14, int r15) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.Utf8.SafeProcessor.f(int, int, byte[], int):int");
        }
    ...
    public static final class UnsafeProcessor extends Processor {
        public static int j(int i, int i2, long j) {
            ...
            if (i2 == 1) {
                return Utf8.e(i, UnsafeUtil.c.f(j));
            }
            if (i2 != 2) {
        ...
        public static int k(long j, byte[] bArr, int i, int i2) {
            ...
            if (i2 == 1) {
                return Utf8.e(i, UnsafeUtil.h(j, bArr));
            }
            if (i2 == 2) {
                return Utf8.f(i, UnsafeUtil.h(j, bArr), UnsafeUtil.h(j + 1, bArr));
            }
            throw new AssertionError();
        }
        ...
        public final String c(ByteBuffer byteBuffer, int i, int i2) throws InvalidProtocolBufferException {
            ...
            long jB = UnsafeUtil.b(byteBuffer) + i;
            long j2 = i2 + jB;
            char[] cArr = new char[i2];
            int i3 = 0;
            while (true) {
                ...
                byte bF = UnsafeUtil.c.f(jB);
                if (!DecodeUtil.b(bF)) {
                    break;
                }
                jB++;
                DecodeUtil.c(bF, cArr, i3);
                i3++;
            }
            int i4 = i3;
            while (jB < j2) {
                long j3 = jB + j;
                UnsafeUtil.MemoryAccessor memoryAccessor = UnsafeUtil.c;
                byte bF2 = memoryAccessor.f(jB);
                if (DecodeUtil.b(bF2)) {
                    int i5 = i4 + 1;
                    DecodeUtil.c(bF2, cArr, i4);
                    while (j3 < j2) {
                        byte bF3 = UnsafeUtil.c.f(j3);
                        if (!DecodeUtil.b(bF3)) {
                            break;
                        }
                        j3 += j;
                        DecodeUtil.c(bF3, cArr, i5);
                        i5++;
                    }
                    i4 = i5;
                    jB = j3;
                } else if (DecodeUtil.d(bF2)) {
                    if (j3 >= j2) {
                        throw InvalidProtocolBufferException.c();
                    }
                    jB += 2;
                    DecodeUtil.e(bF2, memoryAccessor.f(j3), cArr, i4);
                    i4++;
                } else if (DecodeUtil.f(bF2)) {
                    if (j3 >= j2 - j) {
                        throw InvalidProtocolBufferException.c();
                    }
                    long j4 = 2 + jB;
                    jB += 3;
                    DecodeUtil.g(bF2, memoryAccessor.f(j3), memoryAccessor.f(j4), cArr, i4);
                    i4++;
                } else {
                    if (j3 >= j2 - 2) {
                        throw InvalidProtocolBufferException.c();
                    ...
                    jB += 4;
                    DecodeUtil.a(bF2, bF4, bF5, memoryAccessor.f(j5), cArr, i4);
                    i4 += 2;
                }
                j = 1;
            }
        ...
        public final int d(int i, int i2, String str, byte[] bArr) {
            ...
            while (true) {
                ...
                UnsafeUtil.m(bArr, j4, (byte) cCharAt);
                i4++;
                j4 = 1 + j4;
            }
            if (i4 == length) {
            ...
            while (i4 < length) {
                ...
                if (cCharAt2 < 128 && j4 < j5) {
                    UnsafeUtil.m(bArr, j4, (byte) cCharAt2);
                    j3 = j5;
                    j2 = j;
                    j4 += j;
                    ...
                    if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || j4 > j5 - 3) {
                        ...
                        if (i5 != length) {
                            ...
                            if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                UnsafeUtil.m(bArr, j4, (byte) ((codePoint >>> 18) | 240));
                                UnsafeUtil.m(bArr, j4 + j2, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j6 = j4 + 3;
                                UnsafeUtil.m(bArr, j4 + 2, (byte) (((codePoint >>> 6) & 63) | 128));
                                j4 += 4;
                                UnsafeUtil.m(bArr, j6, (byte) ((codePoint & 63) | 128));
                                i4 = i5;
                            } else {
                                i4 = i5;
                            }
                    ...
                    UnsafeUtil.m(bArr, j4, (byte) ((cCharAt2 >>> '\f') | 480));
                    long j7 = j4 + 2;
                    j3 = j5;
                    UnsafeUtil.m(bArr, j4 + j2, (byte) (((cCharAt2 >>> 6) & 63) | 128));
                    j4 += 3;
                    UnsafeUtil.m(bArr, j7, (byte) ((cCharAt2 & '?') | 128));
                } else {
                    j2 = j;
                    long j8 = j4 + j2;
                    UnsafeUtil.m(bArr, j4, (byte) ((cCharAt2 >>> 6) | 960));
                    j4 += 2;
                    UnsafeUtil.m(bArr, j8, (byte) ((cCharAt2 & '?') | 128));
                    j3 = j5;
                }
                i4++;
                j = j2;
        ...
        /* JADX WARN: Code restructure failed: missing block: B:13:0x0036, code lost:
            ...
            if (com.google.protobuf.UnsafeUtil.h(r4, r22) > (-65)) goto L17;
         */
        /* JADX WARN: Code restructure failed: missing block: B:32:0x0069, code lost:
        
            if (com.google.protobuf.UnsafeUtil.h(r4, r22) > (-65)) goto L33;
         */
        /* JADX WARN: Code restructure failed: missing block: B:53:0x00b0, code lost:
        
            if (com.google.protobuf.UnsafeUtil.h(r4, r22) > (-65)) goto L54;
         */
        @Override // com.google.protobuf.Utf8.Processor
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        ...
        */
        public final int f(int r20, int r21, byte[] r22, int r23) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.Utf8.UnsafeProcessor.f(int, int, byte[], int):int");
        }
        ...
        public final int i(ByteBuffer byteBuffer, int i, int i2, int i3) {
            ...
            long jB = UnsafeUtil.b(byteBuffer) + i2;
            long j3 = (i3 - i2) + jB;
            if (i == 0) {
                j = 1;
                b = 0;
                ...
                if (b2 < -32) {
                    ...
                    if (bF2 == 0) {
                        long j4 = jB + 1;
                        bF2 = UnsafeUtil.c.f(jB);
                        if (j4 >= j3) {
                            return Utf8.e(b2, bF2);
                        }
                        jB = j4;
                    }
                    if (bF2 > -65) {
                    ...
                    if (b3 == 0) {
                        long j5 = jB + 1;
                        byte bF3 = UnsafeUtil.c.f(jB);
                        if (j5 >= j3) {
                            return Utf8.e(b2, bF3);
                        }
                        jB = j5;
                        b3 = bF3;
                        bF = 0;
                    ...
                    if (bF == 0) {
                        long j6 = jB + 1;
                        bF = UnsafeUtil.c.f(jB);
                        if (j6 >= j3) {
                            return Utf8.f(b2, b3, bF);
                        }
                        jB = j6;
                    }
                    if (b3 > -65) {
            ...
            if (i5 < 16) {
                ...
                while (true) {
                    if (i7 > 0) {
                        ...
                        int i8 = i5 - i6;
                        while (i8 >= 8 && (UnsafeUtil.c.k(j8) & (-9187201950435737472L)) == 0) {
                            j8 += 8;
                            i8 -= 8;
                        }
                        i4 = i5 - i8;
            ...
            while (true) {
                ...
                if (bF4 < -32) {
                    ...
                    long j12 = j10 + j;
                    if (UnsafeUtil.c.f(j10) > -65) {
                        return -1;
                    }
                    j10 = j12;
                } else if (bF4 < -16) {
                    if (i10 < 2) {
                        return j(bF4, i10, j10);
                    }
                    i9 -= 3;
                    long j13 = j10 + j;
                    UnsafeUtil.MemoryAccessor memoryAccessor = UnsafeUtil.c;
                    byte bF5 = memoryAccessor.f(j10);
                    if (bF5 > -65) {
                        return -1;
                    }
                    if (bF4 == -32 && bF5 < -96) {
                    ...
                    byte bF6 = memoryAccessor2.f(j10);
                    if (bF6 > -65) {
                        return -1;
                    }
                    ...
                    long j15 = 2 + j10;
                    if (memoryAccessor2.f(j14) > -65) {
                        return -1;
                    }
                    j10 += 3;
                    if (memoryAccessor2.f(j15) > -65) {
                        return -1;
                    }
                }
            }
    ...
    static {
        f16094a = (UnsafeUtil.e && UnsafeUtil.d && !Android.a()) ? new UnsafeProcessor() : new SafeProcessor();
    }
