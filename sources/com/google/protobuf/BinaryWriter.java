...
abstract class BinaryWriter extends ByteOutput implements Writer {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f16019a[WireFormat.FieldType.l.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f16019a[WireFormat.FieldType.k.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f16019a[WireFormat.FieldType.j.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f16019a[WireFormat.FieldType.h.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f16019a[WireFormat.FieldType.t.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f16019a[WireFormat.FieldType.u.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f16019a[WireFormat.FieldType.v.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f16019a[WireFormat.FieldType.w.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f16019a[WireFormat.FieldType.n.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f16019a[WireFormat.FieldType.r.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f16019a[WireFormat.FieldType.i.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f16019a[WireFormat.FieldType.g.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f16019a[WireFormat.FieldType.f.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f16019a[WireFormat.FieldType.p.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f16019a[WireFormat.FieldType.q.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f16019a[WireFormat.FieldType.s.ordinal()] = 17;
    ...
    public static final class SafeDirectWriter extends BinaryWriter {
        ...
        public final void a0(int i) {
            d0(CodedOutputStream.Y(i));
            throw null;
        }

        @Override // com.google.protobuf.BinaryWriter
        public final void b0(long j) {
            e0(CodedOutputStream.Z(j));
        }
    ...
    public static final class UnsafeDirectWriter extends BinaryWriter {
        ...
        @Override // com.google.protobuf.BinaryWriter
        public final int T() {
            return this.f16018a + ((int) (0 - this.b));
        }
    ...
    public static final class UnsafeHeapWriter extends BinaryWriter {
        ...
        */
        public final void d(int r14, java.lang.String r15) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.BinaryWriter.UnsafeHeapWriter.d(int, java.lang.String):void");
        }
    ...
    public final void L(int i, MapEntryLite.Metadata metadata, Map map) {
        for (Map.Entry entry : map.entrySet()) {
            ...
            Z(this, 1, metadata.f16067a, entry.getKey());
            d0(T() - iT);
            c0(i, 2);
        }
    }
