...
class m5 extends y5<String> {
    ...
    private String s() {
        ...
        if (telephonyManagerK != null) {
            return telephonyManagerK.getNetworkOperatorName() == null ? k : telephonyManagerK.getNetworkOperatorName();
        }
    ...
    public String j() {
        ...
        a4.b(YU.a.A("Collectors > Network provider : ", strS));
        return strS;
    }
}
