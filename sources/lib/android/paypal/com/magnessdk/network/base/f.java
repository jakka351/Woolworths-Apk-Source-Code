...
final class f extends SSLSocketFactory {
    ...
    public TrustManager[] f24908a;
    public SSLSocketFactory b;
    public TrustManager[] c;

    public static f a() throws NoSuchAlgorithmException, KeyManagementException {
        f fVar = new f();
        try {
            SSLContext sSLContext = SSLContext.getInstance("TLS");
            TrustManager[] trustManagerArrC = fVar.c();
            fVar.c = trustManagerArrC;
            sSLContext.init(null, trustManagerArrC, null);
            fVar.b = sSLContext.getSocketFactory();
            return fVar;
        } catch (Exception e) {
    ...
    public final TrustManager[] c() throws NoSuchAlgorithmException, IOException, KeyStoreException, CertificateException {
        if (this.f24908a == null) {
            try {
                ...
                lib.android.paypal.com.magnessdk.log.a.b(e2, f.class);
            }
            this.f24908a = this.c;
        }
        return this.f24908a;
