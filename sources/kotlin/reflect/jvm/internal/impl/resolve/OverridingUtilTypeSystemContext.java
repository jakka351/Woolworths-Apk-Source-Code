...
public final class OverridingUtilTypeSystemContext implements ClassicTypeSystemContext {
    ...
    public final Map f24534a;
    public final KotlinTypeChecker.TypeConstructorEquality b;

    public OverridingUtilTypeSystemContext(HashMap map, KotlinTypeChecker.TypeConstructorEquality equalityAxioms) {
        Intrinsics.h(equalityAxioms, "equalityAxioms");
        this.f24534a = map;
    ...
    public final boolean s0(TypeConstructorMarker c1, TypeConstructorMarker c2) {
        ...
        if (ClassicTypeSystemContext.DefaultImpls.a(c1, c2)) {
            return true;
        }
        TypeConstructor typeConstructor = (TypeConstructor) c1;
        TypeConstructor typeConstructor2 = (TypeConstructor) c2;
        if (this.b.a(typeConstructor, typeConstructor2)) {
            return true;
        }
        Map map = this.f24534a;
        if (map == null) {
            return false;
        }
    ...
    public final TypeCheckerState t0() {
        return new TypeCheckerState(true, true, this, KotlinTypePreparator.Default.f24624a, KotlinTypeRefiner.Default.f24625a);
    }
