...
final class Utils {
    ...
    public static final Type[] f27007a = new Type[0];
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public final String toString() {
            return YU.a.o(new StringBuilder(), Utils.n(this.d), "[]");
        }
    }
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        public final String toString() {
            ...
            sb.append(Utils.n(type));
            sb.append("<");
            sb.append(Utils.n(typeArr[0]));
            for (int i = 1; i < typeArr.length; i++) {
                sb.append(", ");
                sb.append(Utils.n(typeArr[i]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    public static final class WildcardTypeImpl implements WildcardType {
        ...
        public final Type[] getLowerBounds() {
            Type type = this.e;
            return type != null ? new Type[]{type} : Utils.f27007a;
        }
        ...
        public final String toString() {
            Type type = this.e;
            if (type != null) {
                return "? super " + Utils.n(type);
            }
            Type type2 = this.d;
            if (type2 == Object.class) {
                return "?";
            }
            return "? extends " + Utils.n(type2);
        }
    }
    ...
    public static Type d(int i, ParameterizedType parameterizedType) {
        ...
        StringBuilder sbR = YU.a.r(i, "Index ", " not in range [0,");
    ...
    public static IllegalArgumentException i(Method method, Exception exc, String str, Object... objArr) {
        StringBuilder sbT = YU.a.t(String.format(str, objArr), "\n    for method ");
    ...
    public static IllegalArgumentException j(Method method, int i, String str, Object... objArr) {
        return i(method, null, androidx.constraintlayout.core.state.a.i(str, " (", Platform.b.a(i, method), ")"), objArr);
    }

    public static IllegalArgumentException k(Method method, Exception exc, int i, String str, Object... objArr) {
        return i(method, exc, androidx.constraintlayout.core.state.a.i(str, " (", Platform.b.a(i, method), ")"), objArr);
    }
    ...
    */
    public static java.lang.reflect.Type l(java.lang.reflect.Type r8, java.lang.Class r9, java.lang.reflect.Type r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: retrofit2.Utils.l(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type):java.lang.reflect.Type");
    }
