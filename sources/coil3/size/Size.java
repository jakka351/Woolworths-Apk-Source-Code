...
public final /* data */ class Size {
    ...
    public final Dimension f13149a;
    ...
    public final boolean equals(Object obj) {
        ...
        Size size = (Size) obj;
        return Intrinsics.c(this.f13149a, size.f13149a) && Intrinsics.c(this.b, size.b);
    }
    ...
    public final String toString() {
        return "Size(width=" + this.f13149a + ", height=" + this.b + ')';
    }
}
