...
public interface CacheStrategy {
    ...
    public static final DefaultCacheStrategy f13121a = new DefaultCacheStrategy();
    ...
    public static final class ReadResult {
        ...
        /* renamed from: a, reason: collision with root package name */
        public final NetworkResponse f13122a;

        public ReadResult(NetworkResponse networkResponse) {
            this.f13122a = networkResponse;
        }
        ...
        public final boolean equals(Object obj) {
            ...
            return (obj instanceof ReadResult) && Intrinsics.c(this.f13122a, ((ReadResult) obj).f13122a);
        }

        public final int hashCode() {
            NetworkResponse networkResponse = this.f13122a;
        ...
        public final String toString() {
            return "ReadResult(request=null, response=" + this.f13122a + ')';
        }
    }
    ...
    public static final class WriteResult {
        ...
        /* renamed from: a, reason: collision with root package name */
        public final NetworkResponse f13123a;
        ...
        public final boolean equals(Object obj) {
            ...
            if (obj instanceof WriteResult) {
                return Intrinsics.c(this.f13123a, ((WriteResult) obj).f13123a);
            }
            return false;
        }

        public final int hashCode() {
            NetworkResponse networkResponse = this.f13123a;
            if (networkResponse != null) {
                return networkResponse.hashCode();
            }
            return 0;
        ...
        public final String toString() {
            return "WriteResult(response=" + this.f13123a + ')';
        }
    }
