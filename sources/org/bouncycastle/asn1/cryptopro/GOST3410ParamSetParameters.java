...
public class GOST3410ParamSetParameters extends ASN1Object {
    ...
    public GOST3410ParamSetParameters(int i, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3) {
        ...
        this.f26793a = new ASN1Integer(bigInteger3);
    }
    ...
    public static GOST3410ParamSetParameters getInstance(Object obj) {
        ...
        throw new IllegalArgumentException(a.g(obj, "Invalid GOST3410Parameter: "));
    }

    public BigInteger getA() {
        return this.f26793a.getPositiveValue();
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f26793a);
    ...
    public GOST3410ParamSetParameters(ASN1Sequence aSN1Sequence) {
        ...
        this.f26793a = (ASN1Integer) objects.nextElement();
    }
