...
public abstract class ASN1Util {
    public static ASN1TaggedObject checkTag(ASN1TaggedObject aSN1TaggedObject, int i, int i2) {
        ...
        throw new IllegalStateException(a.i("Expected ", getTagText(i, i2), " tag but found ", getTagText(aSN1TaggedObject)));
    }
    ...
    public static String getTagText(int i, int i2) {
        return a.e(i2, i != 64 ? i != 128 ? i != 192 ? "[UNIVERSAL " : "[PRIVATE " : "[CONTEXT " : "[APPLICATION ", "]");
    }
    ...
    public static ASN1TaggedObjectParser checkTag(ASN1TaggedObjectParser aSN1TaggedObjectParser, int i, int i2) {
        ...
        throw new IllegalStateException(a.i("Expected ", getTagText(i, i2), " tag but found ", getTagText(aSN1TaggedObjectParser)));
    }
