...
public abstract class ASN1BitString extends ASN1Primitive implements ASN1String, ASN1BitStringParser {
    ...
    public static ASN1BitString getInstance(Object obj) {
        ...
        if (obj instanceof ASN1Encodable) {
            ...
            try {
                ...
                throw new IllegalArgumentException(a.k(e, new StringBuilder("failed to construct BIT STRING from byte[]: ")));
            }
        }
    ...
    public InputStream getOctetStream() throws IOException {
        ...
        throw new IOException(YU.a.d(i, "expected octet-aligned bitstring, but found padBits: "));
    }
    ...
    public String getString() {
        try {
            ...
            throw new ASN1ParsingException(a.k(e, new StringBuilder("Internal error encoding BitString: ")), e);
        }
    }
    ...
    public int hashCode() {
        ...
        return (Arrays.hashCode(bArr, 0, length) * 257) ^ ((byte) ((255 << i) & bArr[length]));
    }
