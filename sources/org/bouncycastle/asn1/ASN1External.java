...
public abstract class ASN1External extends ASN1Primitive {
    ...
    private static int checkEncoding(int i) {
        if (i < 0 || i > 2) {
            throw new IllegalArgumentException(a.d(i, "invalid encoding value: "));
        }
        return i;
    }
    ...
    public static ASN1External getInstance(Object obj) {
        ...
        if (obj instanceof ASN1Encodable) {
            ...
            try {
                ...
                throw new IllegalArgumentException(au.com.woolworths.feature.rewards.everydayextras.signup.selections.a.k(e, new StringBuilder("failed to construct external from byte[]: ")));
            }
        }
