...
public class ASN1StreamParser {
    ...
    public ASN1Encodable parseImplicitConstructedDL(int i) throws IOException {
        ...
        throw new ASN1Exception(a.k(i, new StringBuilder("unknown DL object encountered: 0x")));
    }
    ...
    public ASN1Encodable parseImplicitConstructedIL(int i) throws IOException {
        ...
        throw new ASN1Exception(a.k(i, new StringBuilder("unknown BER object encountered: 0x")));
    }
    ...
    public ASN1Encodable parseObject(int i) throws IOException {
        if (i < 0 || i > 30) {
            throw new IllegalArgumentException(YU.a.d(i, "invalid universal tag number: "));
        }
        ...
        throw new IOException(YU.a.d(i2, "unexpected identifier encountered: "));
    }
