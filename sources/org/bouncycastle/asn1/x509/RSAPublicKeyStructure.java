...
public class RSAPublicKeyStructure extends ASN1Object {
    ...
    public static RSAPublicKeyStructure getInstance(Object obj) {
        ...
        throw new IllegalArgumentException(a.g(obj, "Invalid RSAPublicKeyStructure: "));
    }
    ...
    public RSAPublicKeyStructure(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() != 2) {
            throw new IllegalArgumentException(kotlin.reflect.jvm.internal.impl.types.checker.a.j(aSN1Sequence, new StringBuilder("Bad sequence size: ")));
        }
