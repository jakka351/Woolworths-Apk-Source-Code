...
public class PKIXNameConstraintValidator implements NameConstraintValidator {
    ...
    private String stringifyIPCollection(Set set) {
        ...
        while (it.hasNext()) {
            ...
            sbS.append(stringifyIP((byte[]) it.next()));
        }
        sbS.append("]");
        return sbS.toString();
    }
    ...
    private String stringifyOtherNameCollection(Set set) {
        ...
        while (it.hasNext()) {
            ...
            sbS.append(otherName.getTypeID().getId());
            sbS.append(":");
            try {
                sbS.append(Hex.toHexString(otherName.getValue().toASN1Primitive().getEncoded()));
            } catch (IOException e) {
                sbS.append(e.toString());
            }
        }
        sbS.append("]");
        return sbS.toString();
    ...
    private boolean withinDomain(String str, String str2) {
        ...
        String[] strArrSplit = Strings.split(str2, JwtParser.SEPARATOR_CHAR);
        String[] strArrSplit2 = Strings.split(str, JwtParser.SEPARATOR_CHAR);
    ...
    public void intersectEmptyPermittedSubtree(int i) {
        ...
        if (i == 4) {
            ...
            if (i != 7) {
                throw new IllegalStateException(a.d(i, "Unknown tag encountered: "));
            }
    ...
    public void intersectPermittedSubtree(GeneralSubtree[] generalSubtreeArr) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            if (iIntValue == 0) {
                ...
                if (iIntValue != 7) {
                    throw new IllegalStateException(a.d(iIntValue, "Unknown tag encountered: "));
                }
