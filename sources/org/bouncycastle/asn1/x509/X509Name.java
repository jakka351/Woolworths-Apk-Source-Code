...
public class X509Name extends ASN1Object {
    ...
    private ASN1ObjectIdentifier decodeOID(String str, Hashtable hashtable) {
        ...
        throw new IllegalArgumentException(a.h("Unknown object id - ", strTrim, " - passed to distinguished name"));
    }
    ...
    private ASN1Primitive decodeObject(String str) {
        try {
            ...
            throw new IllegalStateException(kotlin.reflect.jvm.internal.impl.types.checker.a.f("unknown encoding in name: ", e));
        }
    }
