...
public abstract class AbstractX500NameStyle implements X500NameStyle {
    ...
    public boolean areEqual(X500Name x500Name, X500Name x500Name2) throws CloneNotSupportedException {
    ...
    @Override // org.bouncycastle.asn1.x500.X500NameStyle
    public int calculateHashCode(X500Name x500Name) throws CloneNotSupportedException {
        RDN[] rDNs = x500Name.getRDNs();
        int iHashCode = 0;
        for (int i = 0; i != rDNs.length; i++) {
