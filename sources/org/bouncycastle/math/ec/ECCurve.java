...
public abstract class ECCurve {
    ...
    protected ECFieldElement f26805a;
    ...
    public static abstract class AbstractF2m extends ECCurve {
        ...
        public boolean isKoblitz() {
            ...
            return this.f26805a.isZero() || this.f26805a.isOne();
        }
    ...
    public static abstract class AbstractFp extends ECCurve {
        ...
        public ECPoint decompressPoint(int i, BigInteger bigInteger) {
            ECFieldElement eCFieldElementFromBigInteger = fromBigInteger(bigInteger);
            ECFieldElement eCFieldElementSqrt = eCFieldElementFromBigInteger.square().add(this.f26805a).multiply(eCFieldElementFromBigInteger).add(this.b).sqrt();
    ...
    public static class F2m extends AbstractF2m {
        ...
        public ECCurve cloneCurve() {
            return new F2m(this.m, this.k1, this.k2, this.k3, this.f26805a, this.b, this.order, this.cofactor);
        }
        ...
        public F2m(int i, int i2, int i3, int i4, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
            ...
            this.f26805a = fromBigInteger(bigInteger);
    ...
    public static class Fp extends AbstractFp {
        ...
        @Override // org.bouncycastle.math.ec.ECCurve
        public ECCurve cloneCurve() {
            return new Fp(this.q, this.r, this.f26805a, this.b, this.order, this.cofactor);
        }
        ...
        public Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, BigInteger bigInteger5, boolean z) {
            ...
            this.f26805a = fromBigInteger(bigInteger2);
    ...
    public static int getNumberOfIterations(int i, int i2) {
        ...
        if (i >= 1024) {
            ...
            return a.D(i2, 111, 2, 5);
        }
        if (i < 512) {
            if (i2 <= 80) {
                return 40;
            }
            return a.D(i2, 79, 2, 40);
        }
        if (i2 <= 80) {
            return 5;
        }
