...
public class SM2P256V1Field {
    ...
    private static void addPInvTo(int[] iArr) {
        ...
        long j4 = ((iArr[2] & M) - 1) + j2;
        iArr[2] = (int) j4;
        long j5 = (iArr[3] & M) + 1 + (j4 >> 32);
        iArr[3] = (int) j5;
        long j6 = j5 >> 32;
        if (j6 != 0) {
            long j7 = j6 + (iArr[4] & M);
            iArr[4] = (int) j7;
            long j8 = (j7 >> 32) + (iArr[5] & M);
            iArr[5] = (int) j8;
            long j9 = (j8 >> 32) + (iArr[6] & M);
            iArr[6] = (int) j9;
            j6 = j9 >> 32;
        }
        iArr[7] = (int) ((M & iArr[7]) + 1 + j6);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j14 = (iArr[0] & M) + j13 + j6 + j7 + j8;
        iArr2[0] = (int) j14;
        long j15 = (((iArr[1] & M) + j13) - j) + j7 + j8 + (j14 >> 32);
        iArr2[1] = (int) j15;
        long j16 = ((iArr[2] & M) - j12) + (j15 >> 32);
        iArr2[2] = (int) j16;
        long j17 = ((((iArr[3] & M) + j13) - j2) - j3) + j6 + (j16 >> 32);
        iArr2[3] = (int) j17;
        long j18 = ((((iArr[4] & M) + j13) - j9) - j) + j7 + (j17 >> 32);
        iArr2[4] = (int) j18;
        long j19 = (iArr[5] & M) + j11 + j3 + (j18 >> 32);
        iArr2[5] = (int) j19;
        long j20 = (iArr[6] & M) + j4 + j7 + j8 + (j19 >> 32);
        iArr2[6] = (int) j20;
        long j21 = (iArr[7] & M) + j13 + j11 + j5 + (j20 >> 32);
        iArr2[7] = (int) j21;
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if (i != 0) {
            ...
            long j6 = ((iArr[2] & M) - j2) + j4;
            iArr[2] = (int) j6;
            long j7 = (iArr[3] & M) + j2 + (j6 >> 32);
            iArr[3] = (int) j7;
            long j8 = j7 >> 32;
            if (j8 != 0) {
                long j9 = j8 + (iArr[4] & M);
                iArr[4] = (int) j9;
                long j10 = (j9 >> 32) + (iArr[5] & M);
                iArr[5] = (int) j10;
                long j11 = (j10 >> 32) + (iArr[6] & M);
                iArr[6] = (int) j11;
                j8 = j11 >> 32;
            }
            long j12 = (M & iArr[7]) + j2 + j8;
            iArr[7] = (int) j12;
            j = j12 >> 32;
        } else {
            j = 0;
