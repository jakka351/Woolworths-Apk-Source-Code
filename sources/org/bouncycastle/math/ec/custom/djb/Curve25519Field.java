...
public class Curve25519Field {
    ...
    private static int addPExtTo(int[] iArr) {
        ...
        long j3 = ((iArr[8] & M) - 19) + jIncAt;
        iArr[8] = (int) j3;
        long jDecAt = j3 >> 32;
        if (jDecAt != 0) {
            jDecAt = Nat.decAt(15, iArr, 9);
        }
        long j4 = (iArr[15] & M) + (M & (iArr2[15] + 1)) + jDecAt;
        iArr[15] = (int) j4;
        return (int) (j4 >> 32);
    }
    ...
    private static int addPTo(int[] iArr) {
        ...
        long j2 = (M & iArr[7]) + llqqqql.aa0061aaaa + jDecAt;
        iArr[7] = (int) j2;
        return (int) (j2 >> 32);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        int i2 = iArr2[7];
        iArr2[7] = Nat.addWordTo(7, (((i2 >>> 31) - (i >>> 31)) + iMulByWordAddTo) * 19, iArr2) + (Integer.MAX_VALUE & i2);
        if (Nat256.gte(iArr2, P)) {
            subPFrom(iArr2);
        }
    }
    ...
    private static int subPExtFrom(int[] iArr) {
        ...
        long j3 = (iArr[8] & M) + 19 + jDecAt;
        iArr[8] = (int) j3;
        long jIncAt = j3 >> 32;
        if (jIncAt != 0) {
            jIncAt = Nat.incAt(15, iArr, 9);
        }
        long j4 = ((iArr[15] & M) - (M & (iArr2[15] + 1))) + jIncAt;
        iArr[15] = (int) j4;
        return (int) (j4 >> 32);
    }
    ...
    private static int subPFrom(int[] iArr) {
        ...
        long j2 = ((M & iArr[7]) - llqqqql.aa0061aaaa) + jIncAt;
        iArr[7] = (int) j2;
        return (int) (j2 >> 32);
    }
