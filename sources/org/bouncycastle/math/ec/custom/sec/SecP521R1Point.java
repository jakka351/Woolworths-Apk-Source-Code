...
public class SecP521R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (Nat.isZero(i2, iArrCreate6)) {
            return Nat.isZero(i2, iArrCreate3) ? twice() : curve.getInfinity();
        }
        SecP521R1Field.square(iArrCreate6, iArrCreate4, iArrCreate);
        int[] iArrCreate7 = Nat.create(i2);
        ...
        if (!zIsOne) {
            ...
            SecP521R1Field.multiply(iArr8, secP521R1FieldElement5.x, iArr8, iArrCreate);
        }
        if (!zIsOne2) {
            int[] iArr9 = secP521R1FieldElement9.x;
            SecP521R1Field.multiply(iArr9, secP521R1FieldElement6.x, iArr9, iArrCreate);
        }
    ...
    public ECPoint twice() {
        ...
        if (!zIsOne) {
            ...
            SecP521R1Field.multiply(iArr6, secP521R1FieldElement3.x, iArr6, iArrCreate);
        }
