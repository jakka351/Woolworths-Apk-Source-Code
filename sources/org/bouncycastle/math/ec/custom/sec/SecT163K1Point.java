...
public class SecT163K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        ECFieldElement eCFieldElementO = a.o(eCFieldElement2, eCFieldElementMultiply, eCFieldElementSquare);
        if (eCFieldElementO.isZero()) {
            return new SecT163K1Point(curve, eCFieldElementO, curve.getB());
        }
        ECFieldElement eCFieldElementSquare2 = eCFieldElementO.square();
        ECFieldElement eCFieldElementMultiply2 = zIsOne ? eCFieldElementO : eCFieldElementO.multiply(eCFieldElementSquare);
        ECFieldElement eCFieldElementSquare3 = eCFieldElement2.add(eCFieldElement).square();
        return new SecT163K1Point(curve, eCFieldElementSquare2, eCFieldElementSquare3.add(eCFieldElementO).add(eCFieldElementSquare).multiply(eCFieldElementSquare3).add(eCFieldElementSquare2), new ECFieldElement[]{eCFieldElementMultiply2});
    }
