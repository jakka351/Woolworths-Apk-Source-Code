...
public class SecT239K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        ECFieldElement eCFieldElementO;
        ...
        if (rawXCoord.isZero()) {
            ...
            eCFieldElementO = a.o(eCFieldElementDivide, eCFieldElementDivide, xCoord);
            if (eCFieldElementO.isZero()) {
                return new SecT239K1Point(curve, eCFieldElementO, curve.getB());
            }
            eCFieldElementAdd = eCFieldElementDivide.multiply(xCoord.add(eCFieldElementO)).add(eCFieldElementO).add(yCoord).divide(eCFieldElementO).add(eCFieldElementO);
            ...
            eCFieldElementO = eCFieldElementMultiply7;
            eCFieldElementFromBigInteger = eCFieldElementMultiply9;
            eCFieldElementAdd = eCFieldElementSquarePlusProduct;
        }
        return new SecT239K1Point(curve, eCFieldElementO, eCFieldElementAdd, new ECFieldElement[]{eCFieldElementFromBigInteger});
    }
