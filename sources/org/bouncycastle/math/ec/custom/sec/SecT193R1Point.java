...
public class SecT193R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            eCFieldElementAdd = a.o(eCFieldElementDivide, eCFieldElementDivide, xCoord).add(curve.getA());
    ...
    public ECPoint twice() {
        ...
        ECFieldElement eCFieldElementO = a.o(eCFieldElement, eCFieldElementMultiply2, a2);
        if (eCFieldElementO.isZero()) {
            return new SecT193R1Point(curve, eCFieldElementO, curve.getB().sqrt());
        }
        ECFieldElement eCFieldElementSquare2 = eCFieldElementO.square();
        ECFieldElement eCFieldElementMultiply3 = zIsOne ? eCFieldElementO : eCFieldElementO.multiply(eCFieldElementSquare);
        if (!zIsOne) {
            eCFieldElementMultiply = eCFieldElementMultiply.multiply(eCFieldElement2);
        }
        return new SecT193R1Point(curve, eCFieldElementSquare2, eCFieldElementMultiply.squarePlusProduct(eCFieldElementO, eCFieldElementMultiply2).add(eCFieldElementSquare2).add(eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3});
    }
