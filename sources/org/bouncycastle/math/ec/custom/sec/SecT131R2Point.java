...
public class SecT131R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElementO.isZero()) {
            return new SecT131R2Point(curve, eCFieldElementO, curve.getB().sqrt());
        }
        ...
        return new SecT131R2Point(curve, eCFieldElementSquare2, eCFieldElementMultiply.squarePlusProduct(eCFieldElementO, eCFieldElementMultiply2).add(eCFieldElementSquare2).add(eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3});
    }
