...
public class SecP384R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        int i2 = i;
        if (Nat.isZero(i2, iArrCreate6)) {
            return Nat.isZero(i2, iArrCreate7) ? twice() : curve.getInfinity();
        }
        SecP384R1Field.square(iArrCreate6, iArrCreate4, iArrCreate);
        int[] iArrCreate8 = Nat.create(i2);
        ...
        SecP384R1Field.reduce32(Nat.addBothTo(i2, iArrCreate4, iArrCreate4, iArrCreate8), iArrCreate8);
        ...
        if (!zIsOne) {
            ...
            SecP384R1Field.multiply(iArr6, secP384R1FieldElement5.x, iArr6, iArrCreate);
        }
        if (!zIsOne2) {
            int[] iArr7 = secP384R1FieldElement9.x;
            SecP384R1Field.multiply(iArr7, secP384R1FieldElement6.x, iArr7, iArrCreate);
        }
    ...
    public ECPoint twice() {
        ...
        if (!zIsOne) {
            ...
            SecP384R1Field.multiply(iArr6, secP384R1FieldElement3.x, iArr6, iArrCreate);
        }
