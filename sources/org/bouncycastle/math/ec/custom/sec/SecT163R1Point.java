...
public class SecT163R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElementO.isZero()) {
            return new SecT163R1Point(curve, eCFieldElementO, curve.getB().sqrt());
        }
        ...
        return new SecT163R1Point(curve, eCFieldElementSquare2, eCFieldElementMultiply.squarePlusProduct(eCFieldElementO, eCFieldElementMultiply2).add(eCFieldElementSquare2).add(eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3});
    }
