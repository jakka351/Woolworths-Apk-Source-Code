    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementO.isZero()) {
                return new SecT409K1Point(curve, eCFieldElementO, curve.getB());
            }
        ...
        return new SecT409K1Point(curve, eCFieldElementO, eCFieldElementAdd, new ECFieldElement[]{eCFieldElementFromBigInteger});
    }
