...
public abstract class ECPoint {
    ...
    public static abstract class AbstractF2m extends ECPoint {
        ...
        public boolean satisfiesCurveEquation() {
            ...
            if (zIsOne) {
                eCFieldElementMultiplyPlusProduct = a.o(eCFieldElement5, eCFieldElement5, a2);
    ...
    public static class F2m extends AbstractF2m {
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            if (coordinateSystem == 0) {
                ...
                ECFieldElement eCFieldElementAdd5 = a.o(eCFieldElementDivide, eCFieldElementDivide, eCFieldElementAdd3).add(curve.getA());
            ...
            if (eCFieldElement.isZero()) {
                ...
                eCFieldElementAdd2 = a.o(eCFieldElementDivide2, eCFieldElementDivide2, xCoord).add(curve.getA());
        ...
        public ECPoint twice() {
            ...
            ECFieldElement eCFieldElementO = a.o(eCFieldElement2, eCFieldElementMultiply4, eCFieldElementMultiply5);
            if (eCFieldElementO.isZero()) {
                return new F2m(curve, eCFieldElementO, curve.getB().sqrt());
            }
            ECFieldElement eCFieldElementSquare4 = eCFieldElementO.square();
            ECFieldElement eCFieldElementMultiply6 = zIsOne2 ? eCFieldElementO : eCFieldElementO.multiply(eCFieldElementSquare3);
            ECFieldElement b = curve.getB();
            if (b.bitLength() < (curve.getFieldSize() >> 1)) {
                ECFieldElement eCFieldElementSquare5 = eCFieldElement2.add(eCFieldElementMultiply).square();
                eCFieldElementAdd = eCFieldElementSquare5.add(eCFieldElementO).add(eCFieldElementSquare3).multiply(eCFieldElementSquare5).add(b.isOne() ? eCFieldElementMultiply5.add(eCFieldElementSquare3).square() : eCFieldElementMultiply5.squarePlusProduct(b, eCFieldElementSquare3.square())).add(eCFieldElementSquare4);
                if (!a2.isZero()) {
                    if (!a2.isOne()) {
            ...
            eCFieldElementAdd = eCFieldElementMultiply.squarePlusProduct(eCFieldElementO, eCFieldElementMultiply4).add(eCFieldElementSquare4);
    ...
    public static class Fp extends AbstractFp {
        ...
        */
        ...
        public ECPoint timesPow2(int i) {
            ...
            if (coordinateSystem == 4) {
                return new Fp(curve, eCFieldElementMultiply, eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger, a2});
            }
            throw new IllegalStateException("unsupported coordinate system");
        }
