...
public class UrlBase64 {
    ...
    public static byte[] encode(byte[] bArr) {
        ...
        try {
            ...
            throw new EncoderException(a.f(e, new StringBuilder("exception encoding URL safe base64 data: ")), e);
        }
    }
    ...
    public static byte[] decode(String str) {
        ...
        try {
            ...
            throw new DecoderException(a.f(e, new StringBuilder("exception decoding URL safe base64 string: ")), e);
        }
    }
