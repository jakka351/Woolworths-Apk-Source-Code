...
public class Hex {
    ...
    public static byte[] decodeStrict(String str) {
        try {
            ...
            throw new DecoderException(a.f(e, new StringBuilder("exception decoding Hex string: ")), e);
        }
    }
    ...
    public static byte[] encode(byte[] bArr, int i, int i2) {
        ...
        try {
            ...
            throw new EncoderException(a.f(e, new StringBuilder("exception encoding Hex string: ")), e);
        }
    }
    ...
    public static byte[] decode(byte[] bArr) {
        ...
        try {
            ...
            throw new DecoderException(a.f(e, new StringBuilder("exception decoding Hex data: ")), e);
        }
    }
}
