...
public class Base64 {
    ...
    public static int decode(byte[] bArr, int i, int i2, OutputStream outputStream) {
        try {
            ...
            throw new DecoderException(a.f(e, new StringBuilder("unable to decode base64 data: ")), e);
        }
    }
    ...
    public static byte[] encode(byte[] bArr, int i, int i2) {
        ...
        try {
            ...
            throw new EncoderException(a.f(e, new StringBuilder("exception encoding base64 string: ")), e);
        }
    }
    ...
    public static byte[] decode(String str) {
        ...
        try {
            ...
            throw new DecoderException(a.f(e, new StringBuilder("unable to decode base64 string: ")), e);
        }
    }
