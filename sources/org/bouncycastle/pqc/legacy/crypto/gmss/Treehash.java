...
public class Treehash {
    ...
    public void initialize() {
        if (!this.seedInitialized) {
            throw new IllegalStateException(a.m(new StringBuilder("Seed "), this.maxHeight, " not initialized"));
        }
    ...
    public String toString() {
        String strO = "Treehash    : ";
        for (int i = 0; i < this.tailLength + 6; i++) {
            strO = a.m(a.s(strO), getStatInt()[i], " ");
        }
        for (int i2 = 0; i2 < this.tailLength + 3; i2++) {
            strO = getStatByte()[i2] != null ? a.o(a.s(strO), new String(Hex.encode(getStatByte()[i2])), " ") : a.g(strO, "null ");
        }
        StringBuilder sbT = a.t(strO, "  ");
        sbT.append(this.messDigestTree.getDigestSize());
        return sbT.toString();
    }
