...
public class GMSSLeaf {
    ...
    public String toString() {
        String strM = "";
        for (int i = 0; i < 4; i++) {
            strM = a.m(a.s(strM), getStatInt()[i], " ");
        }
        StringBuilder sbT = a.t(strM, " ");
        sbT.append(this.mdsize);
        sbT.append(" ");
        sbT.append(this.keysize);
        sbT.append(" ");
        String strM2 = a.m(sbT, this.two_power_w, " ");
        byte[][] statByte = getStatByte();
        for (int i2 = 0; i2 < 4; i2++) {
            strM2 = statByte[i2] != null ? a.o(a.s(strM2), new String(Hex.encode(statByte[i2])), " ") : a.g(strM2, "null ");
        }
        return strM2;
    }
