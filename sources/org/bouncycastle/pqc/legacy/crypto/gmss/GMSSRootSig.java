...
public class GMSSRootSig {
    ...
    public String toString() {
        String strL = a.l(this.big8, "  ", new StringBuilder(""));
        int[] statInt = getStatInt();
        byte[][] statByte = getStatByte();
        for (int i = 0; i < 9; i++) {
            strL = YU.a.m(YU.a.s(strL), statInt[i], " ");
        }
        for (int i2 = 0; i2 < 5; i2++) {
            strL = YU.a.o(YU.a.s(strL), new String(Hex.encode(statByte[i2])), " ");
        }
        return strL;
    }
