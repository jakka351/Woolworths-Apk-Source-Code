...
class BIKECipherSpi extends CipherSpi {
    ...
    public void engineSetMode(String str) throws NoSuchAlgorithmException {
        throw new NoSuchAlgorithmException(YU.a.A("Cannot support mode ", str));
    }

    @Override // javax.crypto.CipherSpi
    public void engineSetPadding(String str) throws NoSuchPaddingException {
        throw new NoSuchPaddingException(YU.a.h("Padding ", str, " unknown"));
    }
    ...
    public void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (algorithmParameterSpec == null) {
            ...
            if (!(algorithmParameterSpec instanceof KEMParameterSpec)) {
                throw new InvalidAlgorithmParameterException(YU.a.o(new StringBuilder(), this.algorithmName, " can only accept KTSParameterSpec"));
            }
        ...
        if (i == 3) {
            if (!(key instanceof BCBIKEPublicKey)) {
                throw new InvalidKeyException(YU.a.o(new StringBuilder("Only a "), this.algorithmName, " public key can be used for wrapping"));
            }
        ...
        if (!(key instanceof BCBIKEPrivateKey)) {
            throw new InvalidKeyException(YU.a.o(new StringBuilder("Only a "), this.algorithmName, " private key can be used for unwrapping"));
        }
