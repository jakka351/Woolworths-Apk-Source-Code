...
class NTRULPRimeCipherSpi extends CipherSpi {
    ...
    @Override // javax.crypto.CipherSpi
    public Key engineUnwrap(byte[] bArr, String str, int i) throws DataLengthException, NoSuchAlgorithmException, InvalidKeyException {
        if (i != 3) {
    ...
    @Override // javax.crypto.CipherSpi
    public byte[] engineWrap(Key key) throws DataLengthException, DestroyFailedException, IllegalBlockSizeException, InvalidKeyException {
