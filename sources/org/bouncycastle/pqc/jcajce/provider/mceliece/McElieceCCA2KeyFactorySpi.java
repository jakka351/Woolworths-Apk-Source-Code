...
public class McElieceCCA2KeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        if (!(keySpec instanceof PKCS8EncodedKeySpec)) {
            throw new InvalidKeySpecException(a.b(keySpec, new StringBuilder("Unsupported key specification: "), "."));
        }
        try {
            ...
            throw new InvalidKeySpecException(kotlin.reflect.jvm.internal.impl.types.checker.a.f("Unable to decode PKCS8EncodedKeySpec: ", e));
        }
    }
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        try {
            ...
            try {
                ...
                throw new InvalidKeySpecException(au.com.woolworths.feature.rewards.everydayextras.signup.selections.a.k(e, new StringBuilder("Unable to decode X509EncodedKeySpec: ")));
            }
    ...
    public KeySpec getKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        if (key instanceof BCMcElieceCCA2PrivateKey) {
            ...
            if (!(key instanceof BCMcElieceCCA2PublicKey)) {
                throw new InvalidKeySpecException(a.a(key, new StringBuilder("Unsupported key type: "), "."));
            }
            if (X509EncodedKeySpec.class.isAssignableFrom(cls)) {
                return new X509EncodedKeySpec(key.getEncoded());
            }
        }
        throw new InvalidKeySpecException(androidx.constraintlayout.core.state.a.e(cls, "Unknown key specification: ", "."));
    }
