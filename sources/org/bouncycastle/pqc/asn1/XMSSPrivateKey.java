...
public class XMSSPrivateKey extends ASN1Object {
    ...
    private XMSSPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.index = a.b(aSN1Sequence2, 0);
        this.secretKeySeed = a.C(aSN1Sequence2, 1);
        this.secretKeyPRF = a.C(aSN1Sequence2, 2);
        this.publicSeed = a.C(aSN1Sequence2, 3);
        this.root = a.C(aSN1Sequence2, 4);
