...
public class RainbowPublicKey extends ASN1Object {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        for (int i2 = 0; i2 < this.coeffSingular.length; i2++) {
            aSN1EncodableVectorN.add(new DEROctetString(this.coeffSingular[i2]));
        }
        ASN1EncodableVector aSN1EncodableVectorN2 = a.n(aSN1EncodableVectorN, aSN1EncodableVector);
        aSN1EncodableVectorN2.add(new DEROctetString(this.coeffScalar));
    ...
    private RainbowPublicKey(ASN1Sequence aSN1Sequence) {
        ...
        for (int i = 0; i < aSN1Sequence2.size(); i++) {
            this.coeffQuadratic[i] = a.D(aSN1Sequence2, i);
        }
        ...
        for (int i2 = 0; i2 < aSN1Sequence3.size(); i2++) {
            this.coeffSingular[i2] = a.D(aSN1Sequence3, i2);
        }
        this.coeffScalar = a.D((ASN1Sequence) aSN1Sequence.getObjectAt(4), 0);
    }
}
