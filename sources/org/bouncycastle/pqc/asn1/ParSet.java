...
public class ParSet extends ASN1Object {
    ...
    private static int checkBigIntegerInIntRangeAndPositive(ASN1Encodable aSN1Encodable) {
        ...
        throw new IllegalArgumentException(a.d(iIntValueExact, "BigInteger not in Range: "));
    }
    ...
    private ParSet(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() != 4) {
            throw new IllegalArgumentException(kotlin.reflect.jvm.internal.impl.types.checker.a.j(aSN1Sequence, new StringBuilder("sie of seqOfParams = ")));
        }
