...
public class RainbowPrivateKey extends ASN1Object {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVectorN.add(new DEROctetString(this.b1));
        aSN1EncodableVector.add(new DERSequence(aSN1EncodableVectorN));
        ASN1EncodableVector aSN1EncodableVector3 = new ASN1EncodableVector();
        for (int i2 = 0; i2 < this.invA2.length; i2++) {
            aSN1EncodableVector3.add(new DEROctetString(this.invA2[i2]));
        }
        ASN1EncodableVector aSN1EncodableVectorN2 = a.n(aSN1EncodableVector3, aSN1EncodableVector);
        aSN1EncodableVectorN2.add(new DEROctetString(this.b2));
        aSN1EncodableVector.add(new DERSequence(aSN1EncodableVectorN2));
        ...
        for (int i3 = 0; i3 < this.layers.length; i3++) {
            ...
            for (int i4 = 0; i4 < bArrConvertArray.length; i4++) {
                ...
                for (int i5 = 0; i5 < bArrConvertArray[i4].length; i5++) {
                    aSN1EncodableVector8.add(new DEROctetString(bArrConvertArray[i4][i5]));
                }
            ...
            for (int i6 = 0; i6 < bArrConvertArray2.length; i6++) {
                ...
                for (int i7 = 0; i7 < bArrConvertArray2[i6].length; i7++) {
                    aSN1EncodableVector10.add(new DEROctetString(bArrConvertArray2[i6][i7]));
                }
