...
class Wots {
    ...
    public static void expand_seed(byte[] bArr, int i, byte[] bArr2, int i2) throws DataLengthException, IllegalArgumentException {
    ...
    public void wots_sign(HashFunctions hashFunctions, byte[] bArr, int i, byte[] bArr2, byte[] bArr3, byte[] bArr4) throws DataLengthException, IllegalArgumentException {
        int[] iArr = new int[67];
        int i2 = 0;
        int i3 = 0;
        int i4 = 0;
