...
public class SPHINCS256Signer implements MessageSigner {
    ...
    public static void compute_authpath_wots(HashFunctions hashFunctions, byte[] bArr, byte[] bArr2, int i, Tree.leafaddr leafaddrVar, byte[] bArr3, byte[] bArr4, int i2) {
        ...
        while (true) {
            ...
            byte[] bArr8 = bArr7;
            wots.wots_pkgen(hashFunctions3, bArr8, (int) (j5 * 2144), bArr6, (int) (j5 * j2), bArr4, 0);
            bArr7 = bArr8;
            leafaddrVar2.subleaf++;
        ...
        while (true) {
            leafaddrVar2.subleaf = j3;
            long j6 = leafaddrVar2.subleaf;
            if (j6 >= j2) {
                break;
            }
            Tree.l_tree(hashFunctions, bArr5, (int) ((j6 * j2) + llqqqql.c00630063c0063c0063), bArr7, (int) (j6 * 2144), bArr4, 0);
            j3 = leafaddrVar2.subleaf + 1;
        }
        int i3 = 0;
        for (int i4 = 32; i4 > 0; i4 >>>= 1) {
            for (int i5 = 0; i5 < i4; i5 += 2) {
                hashFunctions.hash_2n_n_mask(bArr5, ((i5 >>> 1) * 32) + ((i4 >>> 1) * 32), bArr5, (i5 * 32) + (i4 * 32), bArr4, (i3 + 7) * 64);
            }
            i3++;
        }
        int i6 = (int) leafaddrVar.subleaf;
        for (int i7 = 0; i7 < i2; i7++) {
            System.arraycopy(bArr5, (((i6 >>> i7) ^ 1) * 32) + ((32 >>> i7) * 32), bArr2, (i7 * 32) + i, 32);
        }
    ...
    public byte[] crypto_sign(HashFunctions hashFunctions, byte[] bArr, byte[] bArr2) throws DataLengthException, IllegalArgumentException {
        ...
        while (i8 < i3) {
            ...
            Seed.get_seed(hashFunctions2, bArr14, i7, bArr11, leafaddrVar2);
            byte[] bArr15 = bArr3;
            HashFunctions hashFunctions3 = hashFunctions2;
            Wots wots2 = wots;
            byte[] bArr16 = bArr12;
            ...
            byte[] bArr18 = bArr13;
            int i9 = iHorst_sign;
            wots2.wots_sign(hashFunctions3, bArr15, i9, bArr18, bArr17, bArr16);
            byte[] bArr19 = bArr11;
            Tree.leafaddr leafaddrVar3 = leafaddrVar2;
            compute_authpath_wots(hashFunctions, bArr18, bArr15, i9 + 2144, leafaddrVar3, bArr19, bArr16, 5);
            bArr13 = bArr18;
            bArr3 = bArr15;
            iHorst_sign = i9 + 2304;
            long j2 = leafaddrVar3.subtree;
            leafaddrVar3.subleaf = (int) (j2 & 31);
            leafaddrVar3.subtree = j2 >>> 5;
            i8++;
