...
public class PrivateKeyInfoFactory {
    ...
    public static PrivateKeyInfo createPrivateKeyInfo(AsymmetricKeyParameter asymmetricKeyParameter, ASN1Set aSN1Set) throws IOException {
        ...
        if (asymmetricKeyParameter instanceof SPHINCSPlusPrivateKeyParameters) {
            ...
            return new PrivateKeyInfo(new AlgorithmIdentifier(Utils.sphincsPlusOidLookup(sPHINCSPlusPrivateKeyParameters.getParameters())), new SPHINCSPLUSPrivateKey(0, sPHINCSPlusPrivateKeyParameters.getSeed(), sPHINCSPlusPrivateKeyParameters.getPrf(), new SPHINCSPLUSPublicKey(sPHINCSPlusPrivateKeyParameters.getPublicSeed(), sPHINCSPlusPrivateKeyParameters.getRoot())), aSN1Set);
        }
        ...
        if (asymmetricKeyParameter instanceof KyberPrivateKeyParameters) {
            ...
            return new PrivateKeyInfo(new AlgorithmIdentifier(Utils.kyberOidLookup(kyberPrivateKeyParameters.getParameters())), new KyberPrivateKey(0, kyberPrivateKeyParameters.getS(), kyberPrivateKeyParameters.getHPK(), kyberPrivateKeyParameters.getNonce(), new KyberPublicKey(kyberPrivateKeyParameters.getT(), kyberPrivateKeyParameters.getRho())), aSN1Set);
        }
        ...
        aSN1EncodableVector3.add(new DERBitString(dilithiumPrivateKeyParameters.getRho()));
        aSN1EncodableVector3.add(new DERBitString(dilithiumPrivateKeyParameters.getK()));
        aSN1EncodableVector3.add(new DERBitString(dilithiumPrivateKeyParameters.getTr()));
        aSN1EncodableVector3.add(new DERBitString(dilithiumPrivateKeyParameters.getS1()));
        aSN1EncodableVector3.add(new DERBitString(dilithiumPrivateKeyParameters.getS2()));
        aSN1EncodableVector3.add(new DERBitString(dilithiumPrivateKeyParameters.getT0()));
        return new PrivateKeyInfo(new AlgorithmIdentifier(Utils.dilithiumOidLookup(dilithiumPrivateKeyParameters.getParameters())), new DERSequence(aSN1EncodableVector3), aSN1Set, dilithiumPrivateKeyParameters.getPublicKeyParameters().getEncoded());
    }
}
