...
class CMCEEngine {
    ...
    public static void cbrecursion(byte[] bArr, long j, long j2, short[] sArr, int i, long j3, long j4, int[] iArr) {
        ...
        if (j3 <= 10) {
            for (long j20 = 0; j20 < j9; j20 += j5) {
                int i11 = (int) (j9 + j20);
                iArr[i11] = ((iArr[(int) j20] & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) << 10) | (iArr[i11] & 1023);
            }
            long j21 = j5;
            while (j21 < j3 - j5) {
                long j22 = 0;
            ...
            for (long j27 = 0; j27 < j9; j27 += j5) {
                int i19 = (int) (j9 + j27);
                iArr[i19] = (iArr[(int) j27] << 16) | (iArr[i19] & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH);
            }
            long j28 = j5;
            while (j28 < j3 - j5) {
                long j29 = 0;
        ...
        for (long j55 = 0; j55 < j7; j55 += j6) {
            long j56 = j55 * 2;
            iArr[(int) ((j4 / 4) + j4 + j55)] = sArr2[(int) j56] | (sArr2[(int) (j56 + j6)] << 16);
        }
        long j57 = j2 * 2;
        long j58 = (j4 / 4) + j4;
        long j59 = j3 - j6;
    ...
    private int mov_columns(byte[][] bArr, short[] sArr, long[] jArr) {
        ...
        if (this.usePadding) {
            for (int i6 = 0; i6 < 32; i6++) {
                ...
                while (i8 < 8) {
                    int i9 = i8 + 1;
                    bArr2[i8] = (byte) (((bArr2[i8] & 255) >> i5) | (bArr2[i9] << (8 - i5)));
                    i8 = i9;
                }
        ...
        while (true) {
            ...
            if (i11 >= 32) {
                ...
                while (i12 < i2) {
                    ...
                    int i14 = i13;
                    while (i14 < i) {
                        long jSame_mask64 = (sArr[r11] ^ sArr[r15]) & same_mask64((short) i14, (short) r19[i12]);
                        sArr[i3 + i12] = (short) (sArr[r11] ^ jSame_mask64);
                        sArr[i3 + i14] = (short) (jSame_mask64 ^ sArr[r15]);
                        i14++;
                        i13 = i13;
                        jArr3 = jArr3;
                        i = 64;
                ...
                for (int i15 = 0; i15 < this.PK_NROWS; i15++) {
                    if (this.usePadding) {
                        ...
                        while (i17 < 8) {
                            int i18 = i17 + 1;
                            bArr2[i17] = (byte) (((bArr2[i17] & 255) >> i5) | (bArr2[i18] << (8 - i5)));
                            i17 = i18;
                        }
                        jLoad8 = Utils.load8(bArr2, 0);
                    } else {
                        jLoad8 = Utils.load8(bArr[i15], i4);
                    }
                    for (int i19 = 0; i19 < 32; i19++) {
                        long j3 = jArr4[i19];
                        long j4 = ((jLoad8 >> i19) ^ (jLoad8 >> ((int) j3))) & 1;
                        jLoad8 = (jLoad8 ^ (j4 << ((int) j3))) ^ (j4 << i19);
                    }
                    if (this.usePadding) {
                        ...
                        int i20 = i4 + 8;
                        int i21 = 8 - i5;
                        bArr3[i20] = (byte) ((((bArr3[i20] & 255) >>> i5) << i5) | ((bArr2[7] & 255) >>> i21));
                        bArr3[i4] = (byte) (((bArr2[0] & 255) << i5) | (((bArr3[i4] & 255) << i21) >>> i21));
                        for (int i22 = 7; i22 >= 1; i22--) {
                            bArr[i15][i4 + i22] = (byte) (((bArr2[i22] & 255) << i5) | ((bArr2[i22 - 1] & 255) >>> i21));
                        }
                    } else {
                        Utils.store8(bArr[i15], i4, jLoad8);
                    }
                }
                return 0;
            }
            ...
            for (int i25 = i23; i25 < 32; i25++) {
                long j8 = jArr2[i11];
                jArr2[i11] = j8 ^ (jArr2[i25] & (((j8 >> iCtz) & 1) - 1));
            }
            int i26 = i23;
            while (i26 < 32) {
                long j9 = jArr2[i26];
                long j10 = j2;
                jArr2[i26] = j9 ^ (jArr2[i11] & (-((j9 >> iCtz) & j10)));
                i26++;
                j2 = j10;
                z2 = false;
            }
    ...
    private int pk_gen(byte[] bArr, byte[] bArr2, int[] iArr, short[] sArr, long[] jArr) {
        ...
        while (true) {
                        ...
                        if (i23 != 0) {
                            ...
                            while (true) {
                                ...
                                while (i27 < (this.SYS_N / 8) - 1) {
                                    ...
                                    int i28 = (bArr4[i27] & 255) >>> i23;
                                    i27++;
                                    bArr[i25] = (byte) ((bArr4[i27] << (8 - i23)) | i28);
                                    i25++;
                                }
                                bArr[i25] = (byte) ((bArr3[i24][i27] & 255) >>> i23);
                                i24++;
                                i25++;
                            }
                        } else {
            ...
            int i30 = i18 + 1;
            for (int i31 = i30; i31 < this.PK_NROWS; i31++) {
                byte b2 = (byte) (-((byte) (((byte) (((byte) (bArr3[i18][i13] ^ bArr3[i31][i13])) >> i29)) & b)));
                int i32 = 0;
                while (i32 < this.SYS_N / 8) {
                    byte[] bArr5 = bArr3[i18];
                    bArr5[i32] = (byte) (bArr5[i32] ^ (bArr3[i31][i32] & b2));
                    i32++;
                    b = b;
                }
            }
            byte b3 = b;
            if (((bArr3[i18][i13] >> i29) & 1) == 0) {
                return -1;
            }
            for (int i33 = 0; i33 < this.PK_NROWS; i33++) {
                if (i33 != i18) {
                    byte b4 = (byte) (-((byte) (((byte) (bArr3[i33][i13] >> i29)) & 1)));
                    for (int i34 = 0; i34 < this.SYS_N / 8; i34++) {
                        byte[] bArr6 = bArr3[i33];
                        bArr6[i34] = (byte) (bArr6[i34] ^ (bArr3[i18][i34] & b4));
                    }
                }
            }
            i18 = i30;
    ...
    public byte[] decompress_private_key(byte[] bArr) {
        ...
        int i2 = ((1 << this.GFBITS) * 4) + (this.SYS_N / 8) + this.IRR_BYTES;
        int i3 = i2 + 32;
        ...
        if (bArr.length <= 40) {
            ...
            int i5 = i2 - i4;
            for (int i6 = 0; i6 < this.SYS_T; i6++) {
                sArr2[i6] = Utils.load_gf(bArr3, (i6 * 2) + i5, this.GFMASK);
            }
            generate_irr_poly(sArr2);
            for (int i7 = 0; i7 < this.SYS_T; i7++) {
                Utils.store_gf(bArr4, i7 * 2, sArr2[i7]);
            }
        ...
        if (length <= i8 + 40) {
            ...
            if (this.usePivots) {
                ...
                for (int i14 = 0; i14 < (1 << this.GFBITS); i14++) {
                    sArr[i14] = (short) (jArr[i14] & this.GFMASK);
                }
            }
    ...
    public void kem_keypair(byte[] bArr, byte[] bArr2, SecureRandom secureRandom) {
        ...
        byte[] bArr4 = {64};
        secureRandom.nextBytes(bArr3);
        int i8 = (this.SYS_T * 2) + ((1 << this.GFBITS) * 4) + (this.SYS_N / 8);
        int i9 = i8 + 32;
        ...
        while (true) {
            ...
            byte[] bArrCopyOfRange = Arrays.copyOfRange(bArr5, i8, i8 + 32);
            System.arraycopy(bArr6, i7, bArr2, i7, i5);
            byte[] bArrCopyOfRange2 = Arrays.copyOfRange(bArrCopyOfRange, i7, i5);
            int i10 = this.SYS_T;
            ...
            if (generate_irr_poly(sArr2) != -1) {
                for (int i13 = i7; i13 < this.SYS_T; i13++) {
                    Utils.store_gf(bArr2, (i13 * 2) + 40, sArr2[i13]);
                }
                int i14 = this.GFBITS;
