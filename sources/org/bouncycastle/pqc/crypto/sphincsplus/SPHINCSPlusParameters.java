...
public class SPHINCSPlusParameters {
    ...
    public static class HarakaSEngineProvider implements SPHINCSPlusEngineProvider {
        ...
        public SPHINCSPlusEngine get() {
            return new SPHINCSPlusEngine.HarakaSEngine(this.robust, this.n, this.w, this.d, this.f26807a, this.k, this.h);
        }
    ...
    public static class Sha2EngineProvider implements SPHINCSPlusEngineProvider {
        ...
        @Override // org.bouncycastle.pqc.crypto.sphincsplus.SPHINCSPlusEngineProvider
        public SPHINCSPlusEngine get() {
            return new SPHINCSPlusEngine.Sha2Engine(this.robust, this.n, this.w, this.d, this.f26808a, this.k, this.h);
        }
    ...
    public static class Shake256EngineProvider implements SPHINCSPlusEngineProvider {
        ...
        @Override // org.bouncycastle.pqc.crypto.sphincsplus.SPHINCSPlusEngineProvider
        public SPHINCSPlusEngine get() {
            return new SPHINCSPlusEngine.Shake256Engine(this.robust, this.n, this.w, this.d, this.f26809a, this.k, this.h);
        }
    ...
    static {
        ...
        SPHINCSPlusParameters sPHINCSPlusParameters7 = new SPHINCSPlusParameters(Integers.valueOf(66049), "sha2-128f-simple", new Sha2EngineProvider(false, 16, 16, 22, 6, 33, 66));
        sha2_128f_simple = sPHINCSPlusParameters7;
        SPHINCSPlusParameters sPHINCSPlusParameters8 = new SPHINCSPlusParameters(Integers.valueOf(66050), "sha2-128s-simple", new Sha2EngineProvider(false, 16, 16, 7, 12, 14, 63));
        sha2_128s_simple = sPHINCSPlusParameters8;
        SPHINCSPlusParameters sPHINCSPlusParameters9 = new SPHINCSPlusParameters(Integers.valueOf(66051), "sha2-192f-simple", new Sha2EngineProvider(false, 24, 16, 22, 8, 33, 66));
        sha2_192f_simple = sPHINCSPlusParameters9;
        SPHINCSPlusParameters sPHINCSPlusParameters10 = new SPHINCSPlusParameters(Integers.valueOf(66052), "sha2-192s-simple", new Sha2EngineProvider(false, 24, 16, 7, 14, 17, 63));
        sha2_192s_simple = sPHINCSPlusParameters10;
        SPHINCSPlusParameters sPHINCSPlusParameters11 = new SPHINCSPlusParameters(Integers.valueOf(66053), "sha2-256f-simple", new Sha2EngineProvider(false, 32, 16, 17, 9, 35, 68));
        sha2_256f_simple = sPHINCSPlusParameters11;
        SPHINCSPlusParameters sPHINCSPlusParameters12 = new SPHINCSPlusParameters(Integers.valueOf(66054), "sha2-256s-simple", new Sha2EngineProvider(false, 32, 16, 8, 14, 22, 64));
        ...
        SPHINCSPlusParameters sPHINCSPlusParameters19 = new SPHINCSPlusParameters(Integers.valueOf(131585), "shake-128f-simple", new Shake256EngineProvider(false, 16, 16, 22, 6, 33, 66));
        shake_128f_simple = sPHINCSPlusParameters19;
        SPHINCSPlusParameters sPHINCSPlusParameters20 = new SPHINCSPlusParameters(Integers.valueOf(131586), "shake-128s-simple", new Shake256EngineProvider(false, 16, 16, 7, 12, 14, 63));
        shake_128s_simple = sPHINCSPlusParameters20;
        SPHINCSPlusParameters sPHINCSPlusParameters21 = new SPHINCSPlusParameters(Integers.valueOf(131587), "shake-192f-simple", new Shake256EngineProvider(false, 24, 16, 22, 8, 33, 66));
        shake_192f_simple = sPHINCSPlusParameters21;
        SPHINCSPlusParameters sPHINCSPlusParameters22 = new SPHINCSPlusParameters(Integers.valueOf(131588), "shake-192s-simple", new Shake256EngineProvider(false, 24, 16, 7, 14, 17, 63));
        shake_192s_simple = sPHINCSPlusParameters22;
        SPHINCSPlusParameters sPHINCSPlusParameters23 = new SPHINCSPlusParameters(Integers.valueOf(131589), "shake-256f-simple", new Shake256EngineProvider(false, 32, 16, 17, 9, 35, 68));
        shake_256f_simple = sPHINCSPlusParameters23;
        SPHINCSPlusParameters sPHINCSPlusParameters24 = new SPHINCSPlusParameters(Integers.valueOf(131590), "shake-256s-simple", new Shake256EngineProvider(false, 32, 16, 8, 14, 22, 64));
