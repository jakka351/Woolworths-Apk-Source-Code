...
abstract class Symmetric {
    ...
    public static class AesSymmetric extends Symmetric {
        ...
        private void aes128(byte[] bArr, int i, int i2) throws DataLengthException {
            this.cipher.processBytes(new byte[i2], 0, i2, bArr, i);
        }

        private void streamInit(byte[] bArr, short s) throws IllegalArgumentException {
        ...
        public void stream128init(byte[] bArr, short s) throws IllegalArgumentException {
            streamInit(bArr, s);
        }

        @Override // org.bouncycastle.pqc.crypto.crystals.dilithium.Symmetric
        public void stream128squeezeBlocks(byte[] bArr, int i, int i2) throws DataLengthException {
            aes128(bArr, i, i2);
        }

        @Override // org.bouncycastle.pqc.crypto.crystals.dilithium.Symmetric
        public void stream256init(byte[] bArr, short s) throws IllegalArgumentException {
            streamInit(bArr, s);
        }

        @Override // org.bouncycastle.pqc.crypto.crystals.dilithium.Symmetric
        public void stream256squeezeBlocks(byte[] bArr, int i, int i2) throws DataLengthException {
            aes128(bArr, i, i2);
        }
    }
