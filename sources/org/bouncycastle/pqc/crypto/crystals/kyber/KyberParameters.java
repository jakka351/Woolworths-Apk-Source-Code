...
public class KyberParameters implements KEMParameters {
    ...
    public static final KyberParameters kyber768 = new KyberParameters("kyber768", 3, BERTags.PRIVATE, false);
    ...
    public static final KyberParameters kyber768_aes = new KyberParameters("kyber768-aes", 3, BERTags.PRIVATE, true);
