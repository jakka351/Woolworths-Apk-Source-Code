...
abstract class Symmetric {
    ...
    public static class AesSymmetric extends Symmetric {
        ...
        @Override // org.bouncycastle.pqc.crypto.crystals.kyber.Symmetric
        public void prf(byte[] bArr, byte[] bArr2, byte b) throws DataLengthException, IllegalArgumentException {
        ...
        @Override // org.bouncycastle.pqc.crypto.crystals.kyber.Symmetric
        public void xofAbsorb(byte[] bArr, byte b, byte b2) throws IllegalArgumentException {
        ...
        @Override // org.bouncycastle.pqc.crypto.crystals.kyber.Symmetric
        public void xofSqueezeBlocks(byte[] bArr, int i, int i2) throws DataLengthException {
            aes128(bArr, i, i2);
        }
    }
