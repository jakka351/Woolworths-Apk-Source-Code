...
class Poly {
    ...
    private void cbd(short[] sArr, byte[] bArr, int i) {
        ...
        if (this.engine.getSABER_MU() == 6) {
            for (int i3 = 0; i3 < this.SABER_N / 4; i3++) {
                int iLoad_littleendian = (int) load_littleendian(bArr, (i3 * 3) + i, 3);
                int i4 = 0;
                for (int i5 = 0; i5 < 3; i5++) {
                    i4 += (iLoad_littleendian >> i5) & 2396745;
                }
                iArr[0] = i4 & 7;
                iArr[1] = (i4 >>> 6) & 7;
                iArr[2] = (i4 >>> 12) & 7;
        ...
        if (this.engine.getSABER_MU() == 8) {
            for (int i7 = 0; i7 < this.SABER_N / 4; i7++) {
                int i8 = i7 * 4;
                int iLoad_littleendian2 = (int) load_littleendian(bArr, i + i8, 4);
                int i9 = 0;
                for (int i10 = 0; i10 < 4; i10++) {
                    i9 += (iLoad_littleendian2 >>> i10) & 286331153;
                }
                iArr[0] = i9 & 15;
                iArr[1] = (i9 >>> 8) & 15;
                iArr[2] = (i9 >>> 16) & 15;
        ...
        if (this.engine.getSABER_MU() == 10) {
            ...
            while (i11 < this.SABER_N / i2) {
                long jLoad_littleendian = load_littleendian(bArr, (i11 * 5) + i, 5);
                long j = 0;
                for (int i12 = 0; i12 < 5; i12++) {
                    j += (jLoad_littleendian >>> i12) & 35468117025L;
                }
                int[] iArr2 = iArr;
                iArr2[0] = (int) (j & 31);
                char c3 = c;
    ...
    private void toom_cook_4way(short[] sArr, short[] sArr2, short[] sArr3) {
        ...
        for (int i11 = 0; i11 < this.N_SB_RES; i11++) {
            ...
            int i18 = iArr21[i11];
            int i19 = i17 - i16;
            int i20 = ((i15 & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) - (i14 & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH)) >>> 1;
            int i21 = i14 + i20;
            int i22 = ((i13 + i16) - (i21 << 6)) - i21;
            int i23 = (i21 - i18) - i12;
            int i24 = (i23 * 45) + i22;
            int i25 = (((((((i16 - i12) - (i18 << 6)) << 1) + i19) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) - (i23 << 3)) * 43691) >> 3;
            int i26 = (((i24 & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) + ((i20 & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) << 4)) * 36409) >> 1;
            int i27 = -(i20 + i26);
            int i28 = ((((i26 & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) * 30) - ((i19 + i24) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH)) * 61167) >> 2;
            int i29 = i23 - i25;
            int i30 = i26 - i28;
            sArr3[i11] = (short) (sArr3[i11] + (i18 & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH));
            int i31 = i11 + 64;
            sArr3[i31] = (short) (sArr3[i31] + (i28 & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH));
            int i32 = i11 + 128;
            sArr3[i32] = (short) (sArr3[i32] + (i25 & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH));
            int i33 = i11 + BERTags.PRIVATE;
            sArr3[i33] = (short) (sArr3[i33] + (i27 & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH));
            int i34 = i11 + 256;
            sArr3[i34] = (short) (sArr3[i34] + (i29 & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH));
            int i35 = i11 + DilithiumEngine.DilithiumPolyT1PackedBytes;
            sArr3[i35] = (short) (sArr3[i35] + (i30 & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH));
            int i36 = i11 + KyberEngine.KyberPolyBytes;
            sArr3[i36] = (short) (sArr3[i36] + (i12 & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH));
        }
    }
