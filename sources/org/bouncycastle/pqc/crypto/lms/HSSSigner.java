...
public class HSSSigner implements MessageSigner {
    ...
    public byte[] generateSignature(byte[] bArr) {
        try {
            ...
            throw new IllegalStateException(a.k(e, new StringBuilder("unable to encode signature: ")));
        }
    }
    ...
    public boolean verifySignature(byte[] bArr, byte[] bArr2) {
        try {
            ...
            throw new IllegalStateException(a.k(e, new StringBuilder("unable to decode signature: ")));
        }
    }
}
