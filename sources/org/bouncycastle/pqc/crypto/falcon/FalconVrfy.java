...
class FalconVrfy {
    ...
    public boolean complete_private(byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, int i3, byte[] bArr4, int i4, int i5, short[] sArr, int i6) {
        int i7 = 1 << i5;
        int i8 = i6 + i7;
        ...
        for (int i13 = 0; i13 < i7; i13++) {
            int i14 = sArr[i6 + i13] & HPKE.aead_EXPORT_ONLY;
    ...
    public int count_nttzero(short[] sArr, int i, int i2, short[] sArr2, int i3) {
        int i4 = 1 << i2;
        ...
        for (int i7 = 0; i7 < i4; i7++) {
            i6 += ((sArr2[i3 + i7] & HPKE.aead_EXPORT_ONLY) - 1) >>> 31;
        }
        return i6;
    }

    public int is_invertible(short[] sArr, int i, int i2, short[] sArr2, int i3) {
        int i4 = 1 << i2;
        for (int i5 = 0; i5 < i4; i5++) {
            short s = sArr[i + i5];
            sArr2[i3 + i5] = (short) (s + ((-(s >>> 31)) & 12289));
        ...
        int i6 = 0;
        for (int i7 = 0; i7 < i4; i7++) {
            i6 |= (sArr2[i3 + i7] & HPKE.aead_EXPORT_ONLY) - 1;
        }
        return 1 - (i6 >>> 31);
    }

    public void mq_NTT(short[] sArr, int i, int i2) {
        int i3 = 1;
        int i4 = 1 << i2;
        int i5 = i4;
        while (i3 < i4) {
            ...
            while (i7 < i3) {
                ...
                for (int i10 = i8; i10 < i9; i10++) {
                    int i11 = i + i10;
                    int i12 = sArr[i11] & HPKE.aead_EXPORT_ONLY;
                    int i13 = i11 + i6;
                    int iMq_montymul = mq_montymul(sArr[i13], s);
                    sArr[i11] = (short) mq_add(i12, iMq_montymul);
                    sArr[i13] = (short) mq_sub(i12, iMq_montymul);
                }
                i7++;
                i8 += i5;
            }
    ...
    public int mq_add(int i, int i2) {
        int i3 = (i + i2) - 12289;
        return i3 + ((-(i3 >>> 31)) & 12289);
    }

    public int mq_conv_small(int i) {
        return i + ((-(i >>> 31)) & 12289);
    }

    public int mq_div_12289(int i, int i2) {
        int iMq_montymul = mq_montymul(i2, 10952);
        ...
        return mq_montymul(mq_montymul(mq_montysqr(mq_montymul(mq_montysqr(mq_montysqr(mq_montymul(mq_montysqr(mq_montysqr(iMq_montymul4)), iMq_montymul3))), iMq_montymul4)), iMq_montymul), i);
    }

    public void mq_iNTT(short[] sArr, int i, int i2) {
        int i3;
        int i4 = 1 << i2;
        int i5 = 1;
        int i6 = i4;
        ...
        for (int i15 = i4; i15 > 1; i15 >>= 1) {
            iMq_rshift1 = mq_rshift1(iMq_rshift1);
        }
        while (i3 < i4) {
            int i16 = i + i3;
            sArr[i16] = (short) mq_montymul(sArr[i16], iMq_rshift1);
            i3++;
        }
    }

    public int mq_montymul(int i, int i2) {
        int i3 = i * i2;
        int i4 = (((((i3 * 12287) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH) * 12289) + i3) >>> 16) - 12289;
        return i4 + ((-(i4 >>> 31)) & 12289);
    }

    public int mq_montysqr(int i) {
        return mq_montymul(i, i);
    }

    public void mq_poly_montymul_ntt(short[] sArr, int i, short[] sArr2, int i2, int i3) {
        int i4 = 1 << i3;
        for (int i5 = 0; i5 < i4; i5++) {
            int i6 = i + i5;
    ...
    public void mq_poly_sub(short[] sArr, int i, short[] sArr2, int i2, int i3) {
        int i4 = 1 << i3;
        for (int i5 = 0; i5 < i4; i5++) {
            int i6 = i + i5;
    ...
    public void mq_poly_tomonty(short[] sArr, int i, int i2) {
        int i3 = 1 << i2;
    ...
    public int mq_rshift1(int i) {
        return (i + ((-(i & 1)) & 12289)) >>> 1;
    }

    public int mq_sub(int i, int i2) {
        int i3 = i - i2;
        return i3 + ((-(i3 >>> 31)) & 12289);
    }
    ...
    public int verify_raw(short[] sArr, int i, short[] sArr2, int i2, short[] sArr3, int i3, int i4, short[] sArr4, int i5) {
        ...
        for (int i8 = 0; i8 < i6; i8++) {
            int i9 = i5 + i8;
            int i10 = sArr4[i9] & HPKE.aead_EXPORT_ONLY;
            sArr4[i9] = (short) (i10 - ((-((6144 - i10) >>> 31)) & 12289));
        }
        return this.common.is_short(sArr4, i5, sArr2, i2, i4);
    }

    public int verify_recover(short[] sArr, int i, short[] sArr2, int i2, short[] sArr3, int i3, short[] sArr4, int i4, int i5, short[] sArr5, int i6) {
        int i7 = 1 << i5;
        ...
        for (int i10 = 0; i10 < i7; i10++) {
            ...
            i9 |= (s3 & HPKE.aead_EXPORT_ONLY) - 1;
            int i11 = i + i10;
            sArr[i11] = (short) mq_div_12289(sArr[i11] & HPKE.aead_EXPORT_ONLY, s3 & HPKE.aead_EXPORT_ONLY);
        }
        mq_iNTT(sArr, i, i5);
        return ((~i9) & (-this.common.is_short(sArr3, i3, sArr4, i4, i5))) >>> 31;
    }
}
