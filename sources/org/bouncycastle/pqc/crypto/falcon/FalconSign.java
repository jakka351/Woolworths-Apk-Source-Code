...
class FalconSign {
    ...
    public int do_sign_dyn(SamplerZ samplerZ, SamplerCtx samplerCtx, short[] sArr, int i, byte[] bArr, int i2, byte[] bArr2, int i3, byte[] bArr3, int i4, byte[] bArr4, int i5, short[] sArr2, int i6, int i7, FalconFPR[] falconFPRArr, int i8) {
        ...
        System.arraycopy(falconFPRArr, i13, falconFPRArr, i14, iMKN);
        ...
        this.fft.poly_neg(falconFPRArr, i11, i7);
        int i17 = i14 + iMKN;
        System.arraycopy(falconFPRArr, i12, falconFPRArr, i14, iMKN);
        System.arraycopy(falconFPRArr, i13, falconFPRArr, i17, iMKN);
        ...
        System.arraycopy(falconFPRArr, i12, falconFPRArr, i17, iMKN);
        this.fft.poly_mul_fft(falconFPRArr, i17, falconFPRArr, i9, i7);
        System.arraycopy(falconFPRArr, i14, falconFPRArr, i12, iMKN);
        this.fft.poly_mul_fft(falconFPRArr, i13, falconFPRArr, i11, i7);
        ...
        for (int i20 = 0; i20 < iMKN; i20++) {
            int iFpr_rint = (sArr2[i6 + i20] & HPKE.aead_EXPORT_ONLY) - ((int) this.fpr.fpr_rint(falconFPRArr[i12 + i20]));
            i18 += iFpr_rint * iFpr_rint;
            i19 |= i18;
            sArr3[i20] = (short) iFpr_rint;
        }
        int i21 = (-(i19 >>> 31)) | i18;
    ...
    public int do_sign_tree(SamplerZ samplerZ, SamplerCtx samplerCtx, short[] sArr, int i, FalconFPR[] falconFPRArr, int i2, short[] sArr2, int i3, int i4, FalconFPR[] falconFPRArr2, int i5) {
        ...
        for (int i12 = 0; i12 < iMKN; i12++) {
            int iFpr_rint = (sArr2[i3 + i12] & HPKE.aead_EXPORT_ONLY) - ((int) this.fpr.fpr_rint(falconFPRArr2[i5 + i12]));
