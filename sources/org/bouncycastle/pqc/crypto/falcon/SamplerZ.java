...
class SamplerZ {
    ...
    public int gaussian0_sampler(FalconRNG falconRNG) {
        ...
        int i = ((int) jPrng_get_u64) & 16777215;
        ...
        for (int i4 = 0; i4 < 54; i4 += 3) {
            i3 += ((iPrng_get_u8 - iArr[i4]) - (((i2 - iArr[i4 + 1]) - ((i - iArr[i4 + 2]) >>> 31)) >>> 31)) >>> 31;
        }
        return i3;
    }
    ...
    public int sampler(SamplerCtx samplerCtx, FalconFPR falconFPR, FalconFPR falconFPR2) {
        ...
        do {
            ...
            int iPrng_get_u8 = samplerCtx.p.prng_get_u8() & 1;
            iC = a.c(iPrng_get_u8 << 1, 1, iGaussian0_sampler, iPrng_get_u8);
            FPREngine fPREngine4 = this.fpr;
            falconFPRFpr_mul = fPREngine4.fpr_mul(fPREngine4.fpr_sqr(fPREngine4.fpr_sub(fPREngine4.fpr_of(iC), falconFPRFpr_sub)), falconFPRFpr_half);
            fPREngine = this.fpr;
