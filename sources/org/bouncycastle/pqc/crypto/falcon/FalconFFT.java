...
class FalconFFT {
    ...
    public void FFT(FalconFPR[] falconFPRArr, int i, int i2) {
        ...
        while (i7 < i3) {
            ...
            while (i11 < i10) {
                ...
                int i14 = (i6 + i11) << i4;
                FalconFPR falconFPR = falconFPRArr2[i14];
                FalconFPR falconFPR2 = falconFPRArr2[i14 + i4];
                int i15 = i12;
                while (i15 < i13) {
                    int i16 = i + i15;
                    ...
                    int i20 = i18 + i19;
                    int i21 = i6;
                    ComplexNumberWrapper complexNumberWrapperFPC_MUL = FPC_MUL(falconFPRArr[i18], falconFPRArr[i20], falconFPR, falconFPR2);
                    FalconFPR falconFPR5 = complexNumberWrapperFPC_MUL.re;
                    ...
                    falconFPRArr[i16] = complexNumberWrapperFPC_ADD.re;
                    falconFPRArr[i17] = complexNumberWrapperFPC_ADD.im;
                    ComplexNumberWrapper complexNumberWrapperFPC_SUB = FPC_SUB(falconFPR3, falconFPR4, falconFPR5, falconFPR6);
                    falconFPRArr[i18] = complexNumberWrapperFPC_SUB.re;
                    falconFPRArr[i20] = complexNumberWrapperFPC_SUB.im;
                    i15++;
                    i5 = i19;
                    i6 = i21;
                    i7 = i22;
    ...
    public void iFFT(FalconFPR[] falconFPRArr, int i, int i2) {
        ...
        while (true) {
            ...
            while (i3 < i6) {
                ...
                int i13 = (i9 + i11) << i4;
                FalconFPR falconFPR = falconFPRArr2[i13];
                FalconFPR falconFPRFpr_neg = fPREngine.fpr_neg(falconFPRArr2[i13 + i4]);
                int i14 = i3;
                while (i14 < i12) {
                    int i15 = i + i14;
                    ...
                    falconFPRArr[i15] = complexNumberWrapperFPC_ADD.re;
                    falconFPRArr[i16] = complexNumberWrapperFPC_ADD.im;
                    ComplexNumberWrapper complexNumberWrapperFPC_SUB = FPC_SUB(falconFPR2, falconFPR3, falconFPR4, falconFPR5);
                    ComplexNumberWrapper complexNumberWrapperFPC_MUL = FPC_MUL(complexNumberWrapperFPC_SUB.re, complexNumberWrapperFPC_SUB.im, falconFPR, falconFPRFpr_neg);
                    falconFPRArr[i17] = complexNumberWrapperFPC_MUL.re;
                    falconFPRArr[i19] = complexNumberWrapperFPC_MUL.im;
                    i14++;
                    i6 = i18;
                    i7 = i20;
                    i9 = i21;
    ...
    public void poly_LDL_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, FalconFPR[] falconFPRArr3, int i3, int i4) {
        ...
        for (int i6 = 0; i6 < i5; i6++) {
            ...
            FalconFPR falconFPR7 = complexNumberWrapperFPC_DIV.re;
            ...
            ComplexNumberWrapper complexNumberWrapperFPC_SUB = FPC_SUB(falconFPR5, falconFPR6, complexNumberWrapperFPC_MUL.re, complexNumberWrapperFPC_MUL.im);
            falconFPRArr3[i10] = complexNumberWrapperFPC_SUB.re;
            falconFPRArr3[i11] = complexNumberWrapperFPC_SUB.im;
    ...
    public void poly_LDLmv_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, FalconFPR[] falconFPRArr3, int i3, FalconFPR[] falconFPRArr4, int i4, FalconFPR[] falconFPRArr5, int i5, int i6) {
        ...
        for (int i8 = 0; i8 < i7; i8++) {
            ...
            ComplexNumberWrapper complexNumberWrapperFPC_SUB = FPC_SUB(falconFPR5, falconFPR6, complexNumberWrapperFPC_MUL.re, complexNumberWrapperFPC_MUL.im);
            int i12 = i + i8;
            falconFPRArr[i12] = complexNumberWrapperFPC_SUB.re;
            falconFPRArr[i12 + i7] = complexNumberWrapperFPC_SUB.im;
            int i13 = i2 + i8;
    ...
    public void poly_add_muladj_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, FalconFPR[] falconFPRArr3, int i3, FalconFPR[] falconFPRArr4, int i4, FalconFPR[] falconFPRArr5, int i5, int i6) {
        ...
        for (int i8 = 0; i8 < i7; i8++) {
            ...
            FalconFPR falconFPR9 = complexNumberWrapperFPC_MUL.re;
            ...
            FalconFPR falconFPR11 = complexNumberWrapperFPC_MUL2.re;
    ...
    public void poly_div_autoadj_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, int i3) {
        int i4 = (1 << i3) >> 1;
        for (int i5 = 0; i5 < i4; i5++) {
            FalconFPR falconFPRFpr_inv = this.fpr.fpr_inv(falconFPRArr2[i2 + i5]);
            int i6 = i + i5;
            falconFPRArr[i6] = this.fpr.fpr_mul(falconFPRArr[i6], falconFPRFpr_inv);
            int i7 = i6 + i4;
            falconFPRArr[i7] = this.fpr.fpr_mul(falconFPRArr[i7], falconFPRFpr_inv);
        }
    }
    ...
    public void poly_div_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, int i3) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            ...
            int i7 = i6 + i4;
            int i8 = i2 + i5;
            ComplexNumberWrapper complexNumberWrapperFPC_DIV = FPC_DIV(falconFPRArr[i6], falconFPRArr[i7], falconFPRArr2[i8], falconFPRArr2[i8 + i4]);
            falconFPRArr[i6] = complexNumberWrapperFPC_DIV.re;
            falconFPRArr[i7] = complexNumberWrapperFPC_DIV.im;
        }
    }
    ...
    public void poly_invnorm2_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, FalconFPR[] falconFPRArr3, int i3, int i4) {
        ...
        for (int i6 = 0; i6 < i5; i6++) {
            ...
            FPREngine fPREngine2 = this.fpr;
            falconFPRArr[i + i6] = fPREngine.fpr_inv(fPREngine.fpr_add(falconFPRFpr_add, fPREngine2.fpr_add(fPREngine2.fpr_sqr(falconFPR3), this.fpr.fpr_sqr(falconFPR4))));
        }
    }
    ...
    public void poly_merge_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, FalconFPR[] falconFPRArr3, int i3, int i4) {
        ...
        for (int i8 = 0; i8 < i7; i8++) {
            ...
            int i11 = (i8 + i6) << 1;
            ComplexNumberWrapper complexNumberWrapperFPC_MUL = FPC_MUL(falconFPR3, falconFPR4, falconFPRArr4[i11], falconFPRArr4[i11 + 1]);
            FalconFPR falconFPR5 = complexNumberWrapperFPC_MUL.re;
            FalconFPR falconFPR6 = complexNumberWrapperFPC_MUL.im;
            ComplexNumberWrapper complexNumberWrapperFPC_ADD = FPC_ADD(falconFPR, falconFPR2, falconFPR5, falconFPR6);
            FalconFPR falconFPR7 = complexNumberWrapperFPC_ADD.re;
            FalconFPR falconFPR8 = complexNumberWrapperFPC_ADD.im;
            int i12 = (i8 << 1) + i;
            falconFPRArr[i12] = falconFPR7;
            falconFPRArr[i12 + i6] = falconFPR8;
            ComplexNumberWrapper complexNumberWrapperFPC_SUB = FPC_SUB(falconFPR, falconFPR2, falconFPR5, falconFPR6);
            FalconFPR falconFPR9 = complexNumberWrapperFPC_SUB.re;
            FalconFPR falconFPR10 = complexNumberWrapperFPC_SUB.im;
            int i13 = i12 + 1;
            falconFPRArr[i13] = falconFPR9;
            falconFPRArr[i13 + i6] = falconFPR10;
        }
    }
    ...
    public void poly_mul_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, int i3) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            ...
            int i7 = i6 + i4;
            int i8 = i2 + i5;
            ComplexNumberWrapper complexNumberWrapperFPC_MUL = FPC_MUL(falconFPRArr[i6], falconFPRArr[i7], falconFPRArr2[i8], falconFPRArr2[i8 + i4]);
            falconFPRArr[i6] = complexNumberWrapperFPC_MUL.re;
            falconFPRArr[i7] = complexNumberWrapperFPC_MUL.im;
        }
    }
    ...
    public void poly_muladj_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, int i3) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            ...
            int i7 = i6 + i4;
            int i8 = i2 + i5;
            ComplexNumberWrapper complexNumberWrapperFPC_MUL = FPC_MUL(falconFPRArr[i6], falconFPRArr[i7], falconFPRArr2[i8], this.fpr.fpr_neg(falconFPRArr2[i8 + i4]));
            falconFPRArr[i6] = complexNumberWrapperFPC_MUL.re;
            falconFPRArr[i7] = complexNumberWrapperFPC_MUL.im;
        }
    }
    ...
    public void poly_split_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, FalconFPR[] falconFPRArr3, int i3, int i4) {
        ...
        for (int i8 = 0; i8 < i7; i8++) {
            ...
            FalconFPR falconFPR5 = complexNumberWrapperFPC_ADD.re;
            ...
            FalconFPR falconFPR7 = complexNumberWrapperFPC_SUB.re;
            FalconFPR falconFPR8 = complexNumberWrapperFPC_SUB.im;
            FPREngine fPREngine = this.fpr;
            FalconFPR[] falconFPRArr4 = fPREngine.fpr_gm_tab;
            int i12 = (i8 + i6) << 1;
            ComplexNumberWrapper complexNumberWrapperFPC_MUL = FPC_MUL(falconFPR7, falconFPR8, falconFPRArr4[i12], fPREngine.fpr_neg(falconFPRArr4[i12 + 1]));
            FalconFPR falconFPR9 = complexNumberWrapperFPC_MUL.re;
            FalconFPR falconFPR10 = complexNumberWrapperFPC_MUL.im;
            int i13 = i2 + i8;
            falconFPRArr2[i13] = this.fpr.fpr_half(falconFPR9);
            falconFPRArr2[i13 + i7] = this.fpr.fpr_half(falconFPR10);
        }
    }
