...
class PointerUnion extends Pointer {
    ...
    public void fill(int i, byte[] bArr, int i2, int i3) {
        ...
        if (i4 != 0) {
            ...
            jArr[i5] = jArr[i5] & (~((-1) << (i4 << 3)));
            int i6 = 0;
            while (i4 < 8 && i6 < i3) {
                long[] jArr2 = this.array;
                jArr2[i5] = jArr2[i5] | ((bArr[i2] & 255) << (i4 << 3));
                i2++;
                i6++;
                i4++;
            }
    ...
    public long get() {
        ...
        long[] jArr = this.array;
        int i2 = this.cp;
        return (jArr[i2 + 1] << ((8 - i) << 3)) | (jArr[i2] >>> (i << 3));
    }
    ...
    public long getWithCheck() {
        ...
        return (jArr[i + 1] << ((8 - i2) << 3)) | (jArr[i] >>> (i2 << 3));
    }
    ...
    public void set(int i, long j) {
        ...
        long[] jArr = this.array;
        int i5 = this.cp;
        jArr[i5 + i] = (j << i3) | (jArr[i5 + i] & ((-1) >>> i4));
        jArr[i5 + i + 1] = (((-1) << i3) & jArr[i5 + i + 1]) | (j >>> i4);
    }
    ...
    public void setAnd(int i, long j) {
        ...
        int i5 = this.cp;
        int i6 = i5 + i;
        jArr[i6] = jArr[i6] & ((j << i3) | ((-1) >>> i4));
        int i7 = i5 + i + 1;
        jArr[i7] = (((-1) << i3) | (j >>> i4)) & jArr[i7];
    }
    ...
    public void setAndThenXorByte(int i, long j, long j2) {
        ...
        long[] jArr = this.array;
        int i4 = (i2 & 7) << 3;
        long j3 = (((j & 255) << i4) | (~(255 << i4))) & jArr[i3];
        jArr[i3] = j3;
        jArr[i3] = j3 ^ ((j2 & 255) << i4);
    }
    ...
    public void setByte(int i) {
        ...
        jArr[i2] = (j << (i3 << 3)) | (jArr[i2] & ((-1) >>> ((8 - i3) << 3)));
    }
    ...
    public void setRangeClear(int i, int i2) {
        ...
        long[] jArr = this.array;
        int i4 = this.cp + i;
        jArr[i4] = jArr[i4] & ((-1) >>> ((8 - i3) << 3));
        super.setRangeClear(i + 1, i2);
        long[] jArr2 = this.array;
        int i5 = this.cp + i2 + 1;
        jArr2[i5] = jArr2[i5] & ((-1) << (this.remainder << 3));
    }
    ...
    public void setXor(int i, long j) {
        ...
        int i3 = this.cp;
        int i4 = i3 + i;
        jArr[i4] = jArr[i4] ^ (j << (i2 << 3));
        int i5 = i3 + i + 1;
        jArr[i5] = (j >>> ((8 - i2) << 3)) ^ jArr[i5];
    }
    ...
    public void setXorRangeAndMask(Pointer pointer, int i, long j) {
        ...
        while (i7 < i) {
            int i8 = i4 + 1;
            long j2 = pointer.array[i4] & j;
            long[] jArr = this.array;
            jArr[i3] = jArr[i3] ^ (j2 << i5);
            i3++;
            jArr[i3] = (j2 >>> i6) ^ jArr[i3];
            i7++;
            i4 = i8;
        }
    }
    ...
    public long get(int i) {
        ...
        long[] jArr = this.array;
        int i3 = this.cp;
        return (jArr[(i3 + i) + 1] << ((8 - i2) << 3)) | (jArr[i3 + i] >>> (i2 << 3));
    }
    ...
    public long getWithCheck(int i) {
        ...
        return (jArr[i2 + 1] << ((8 - i3) << 3)) | (jArr[i2] >>> (i3 << 3));
    }
    ...
    public void setXor(long j) {
        ...
        long[] jArr = this.array;
        int i2 = this.cp;
        jArr[i2] = jArr[i2] ^ (j << (i << 3));
        int i3 = i2 + 1;
        jArr[i3] = (j >>> ((8 - i) << 3)) ^ jArr[i3];
    }
