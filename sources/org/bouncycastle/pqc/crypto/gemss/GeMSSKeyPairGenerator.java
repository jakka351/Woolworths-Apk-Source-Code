...
public class GeMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public AsymmetricCipherKeyPair generateKeyPair() {
        ...
        int i = engine.HFEDegJ + 2;
        int i2 = engine.HFEDegI;
        int i3 = (((i2 + 1) * engine.HFEv) + (engine.NB_MONOMIAL_VINEGAR - 1) + i + (((i2 + 1) * i2) >>> 1)) * engine.NB_WORD_GFqn;
        int i4 = (((engine.LTRIANGULAR_NV_SIZE << 1) + i3) + (engine.LTRIANGULAR_N_SIZE << 1)) << 3;
        ...
        int i6 = engine.SIZE_SEED_SK;
        byte[] bArr2 = new byte[i6];
        byte[] bArr3 = new byte[((engine.NB_MONOMIAL_PK * engine.HFEm) + 7) >> 3];
        System.arraycopy(bArrSec_rand, 0, bArr2, 0, i6);
        ...
        if (engine.HFEmr8 != 0) {
            int i7 = engine.NB_MONOMIAL_PK;
            int i8 = engine.NB_BYTES_GFqm;
            PointerUnion pointerUnion = new PointerUnion((i7 * i8) + ((8 - (i8 & 7)) & 7));
            for (int i9 = (engine.NB_BYTES_GFqm & 7) != 0 ? 1 : 0; i9 < engine.NB_MONOMIAL_PK; i9++) {
            ...
            int bytesMove = 0;
            while (i5 < engine.NB_MONOMIAL_PK) {
