...
class GeMSSEngine {
    ...
    /* JADX WARN: Removed duplicated region for block: B:178:0x03be A[LOOP:0: B:176:0x03b8->B:178:0x03be, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:182:0x03d1 A[LOOP:1: B:180:0x03c9->B:182:0x03d1, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:185:0x03c3 A[EDGE_INSN: B:185:0x03c3->B:179:0x03c3 BREAK  A[LOOP:0: B:176:0x03b8->B:178:0x03be], SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:186:0x03d4 A[SYNTHETIC] */
    ...
    */
    public GeMSSEngine(int r37, int r38, int r39, int r40, int r41, int r42, int r43, int r44) {
        /*
    ...
    private void CMP_AND_SWAP_CST_TIME(Pointer pointer, Pointer pointer2, Pointer pointer3) {
        ...
        while (true) {
            ...
            if (i2 >= i3) {
                ...
                jCMP_LT_UINT |= (-GeMSSUtils.NORBITS_UINT(i2 ^ j)) & GeMSSUtils.CMP_LT_UINT(pointer2.get(i2), pointer.get(i2));
                i2++;
            }
        }
    }
    ...
    public int crypto_sign_open(byte[] bArr, byte[] bArr2, byte[] bArr3) {
        ...
        Pointer pointer4 = new Pointer((this.NB_WORD_UNCOMP_EQ * i4) + 1);
        PointerUnion pointerUnion3 = new PointerUnion(pointerUnion);
        while (i2 < this.HFEmr8 - 1) {
            pointerUnion3.setByteIndex((this.NB_BYTES_EQUATION * i2) + this.ACCESS_last_equations8);
            jConvMQ_uncompressL_gf2 ^= convMQ_uncompressL_gf2(new Pointer(pointer4, (this.NB_WORD_UNCOMP_EQ * i2) + 1), pointerUnion3) << i2;
            i2++;
        }
        pointerUnion3.setByteIndex((this.NB_BYTES_EQUATION * i2) + this.ACCESS_last_equations8);
        long jConvMQ_last_uncompressL_gf2 = jConvMQ_uncompressL_gf2 ^ (convMQ_last_uncompressL_gf2(new Pointer(pointer4, (this.NB_WORD_UNCOMP_EQ * i2) + 1), pointerUnion3) << i2);
        if (this.HFENr8 != 0) {
            int i5 = this.HFEnvr;
            if (i5 == 0) {
                ...
                if (i5 > i6) {
                    ...
                    pointer4.set(i7 * this.NB_WORD_UNCOMP_EQ, j);
                } else {
                    pointer4.setXor((this.NB_WORD_UNCOMP_EQ * i7) - 1, j << (64 - (i6 - i5)));
                    pointer4.set(i7 * this.NB_WORD_UNCOMP_EQ, j >>> (this.LOST_BITS - this.HFEnvr));
                }
            }
    ...
    public void fast_sort_gf2n(Pointer pointer, int i) {
        ...
        Pointer pointer7 = new Pointer();
        int i4 = i - 1;
        int iHighest_One = GeMSSUtils.Highest_One(i4);
        int i5 = iHighest_One;
        while (true) {
            i2 = 0;
            if (i5 <= 1) {
            ...
            int i6 = i5 << 1;
            int i7 = i / i6;
            int iMax = Math.max(0, (i - (i6 * i7)) - i5);
        ...
        while (iHighest_One > 1) {
            int i13 = i2;
            while (i13 < i - iHighest_One) {
                Pointer pointer13 = pointer6;
                Pointer pointer14 = pointer5;
                copy_for_casct(pointer12, pointer7, pointer3, pointer13, pointer14, iHighest_One, i13);
                pointer5 = pointer14;
    ...
    public void genSecretMQS_gf2_opt(Pointer pointer, Pointer pointer2) {
        ...
        while (i9 < this.HFEn) {
            ...
            pointer11.move((this.SIZE_ROW * i17) + i17);
            pointer9 = pointer15;
            i = i10;
            pointer3 = pointer16;
            i9 = i15;
    ...
    */
    public void invMatrixLU_gf2(org.bouncycastle.pqc.crypto.gemss.Pointer r18, org.bouncycastle.pqc.crypto.gemss.Pointer r19, org.bouncycastle.pqc.crypto.gemss.Pointer r20, org.bouncycastle.pqc.crypto.gemss.GeMSSEngine.FunctionParams r21) {
        /*
            ...
            r1 = r20
            r11.<init>(r1)
            int[] r1 = org.bouncycastle.pqc.crypto.gemss.GeMSSEngine.AnonymousClass1.$SwitchMap$org$bouncycastle$pqc$crypto$gemss$GeMSSEngine$FunctionParams
            int r2 = r21.ordinal()
            r1 = r1[r2]
            r12 = 0
            r13 = 1
    ...
    public int sign_openHFE_huncomp_pk(byte[] bArr, int i, byte[] bArr2, PointerUnion pointerUnion, PointerUnion pointerUnion2) {
        ...
        while (i2 < this.NB_ITE) {
            ...
            pointer6.setAnd((((i3 - 1) * this.SIZE_DIGEST_UINT) + this.NB_WORD_GF2m) - 1, this.MASK_GF2m);
            i2 = i3 + 1;
        }
        pointer6.setAnd((((i2 - 1) * this.SIZE_DIGEST_UINT) + this.NB_WORD_GF2m) - 1, this.MASK_GF2m);
        ...
        for (int i4 = this.NB_ITE - 1; i4 > 0; i4--) {
            ...
            int i5 = (((this.NB_ITE - 1) - i4) * this.NB_WORD_GF2nvm) + this.NB_WORD_GF2nv;
