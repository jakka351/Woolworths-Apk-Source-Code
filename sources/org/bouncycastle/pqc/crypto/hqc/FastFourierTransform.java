...
class FastFourierTransform {
    ...
    public static void computeFFTRec(int[] iArr, int[] iArr2, int i, int i2, int i3, int[] iArr3, int i4, int i5) {
        ...
        if (iArr3[i15] != 1) {
            ...
            while (true) {
                ...
                iMult = GFCalculator.mult(iMult, iArr3[i15]);
                iArr2[i8] = GFCalculator.mult(iMult, iArr2[i8]);
                i8++;
                iArr8 = iArr4;
            }
        } else {
        ...
        for (int i17 = i7; i17 < i15; i17++) {
            int iMult2 = GFCalculator.mult(iArr3[i17], GFCalculator.inverse(iArr3[i15]));
            iArr7[i17] = iMult2;
            iArr4[i17] = GFCalculator.mult(iMult2, iMult2) ^ iArr7[i17];
        }
        computeSubsetSum(iArr9, iArr7, i15);
        int i18 = i3 - 1;
        int[] iArr13 = iArr4;
        computeFFTRec(iArr10, iArr5, (i + 1) / 2, i15, i18, iArr13, i4, i5);
        int i19 = i6 << (i15 & 15);
        if (i <= 3) {
            iArr[i7] = iArr10[i7];
            iArr[i19] = iArr10[i7] ^ iArr6[i7];
            for (int i20 = i6; i20 < i19; i20++) {
                int iMult3 = iArr10[i20] ^ GFCalculator.mult(iArr9[i20], iArr6[i7]);
                iArr[i20] = iMult3;
                iArr[i19 + i20] = iMult3 ^ iArr6[i7];
            }
            return;
        }
        computeFFTRec(iArr11, iArr6, i / 2, i15, i18, iArr13, i4, i5);
        int i21 = i7;
        System.arraycopy(iArr11, i21, iArr, i19, i19);
        iArr[i21] = iArr10[i21];
        iArr[i19] = iArr10[i21] ^ iArr[i19];
        for (int i22 = i6; i22 < i19; i22++) {
            int iMult4 = iArr10[i22] ^ GFCalculator.mult(iArr9[i22], iArr11[i22]);
            iArr[i22] = iMult4;
            int i23 = i19 + i22;
            iArr[i23] = iMult4 ^ iArr[i23];
        }
    }
    ...
    public static void fastFourierTransform(int[] iArr, int[] iArr2, int i, int i2) {
        ...
        for (int i7 = 1; i7 < 128; i7++) {
            int iMult = iArr6[i7] ^ GFCalculator.mult(iArr9[i7], iArr7[i7]);
            iArr[i7] = iMult;
            int i8 = 128 + i7;
            iArr[i8] = iMult ^ iArr[i8];
        }
    }
