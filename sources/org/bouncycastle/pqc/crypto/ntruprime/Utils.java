...
class Utils {
    public static int bToUnsignedInt(byte b) {
        return b & 255;
    }
    ...
    public static void checkForSmallPolynomial(byte[] bArr, byte[] bArr2, int i, int i2) {
        ...
        int iCheckNotEqualToZero = checkNotEqualToZero(i3 - i2);
        for (int i5 = 0; i5 < i2; i5++) {
            bArr[i5] = (byte) (((bArr2[i5] ^ 1) & (~iCheckNotEqualToZero)) ^ 1);
        }
        while (i2 < i) {
            bArr[i2] = (byte) (bArr2[i2] & (~iCheckNotEqualToZero));
            i2++;
        }
    }
    ...
    public static void cryptoSort(int[] iArr, int i) {
        if (i < 2) {
            return;
        }
        int i2 = 1;
        ...
        if (i > 1) {
            ...
            while (true) {
                ...
                if (i9 > 4194048) {
                    int i10 = i8 / 2;
                    iArr[i10] = 65536;
                    sArr5[i10] = (short) ((bToUnsignedInt(bArr[i7 + 1]) * 256) + bToUnsignedInt(bArr[i7]));
                    i7 += 2;
            ...
            while (i14 < i4) {
                int i15 = i14 / 2;
                int[] unsignedDivMod = getUnsignedDivMod((iArr[i15] * sToUnsignedInt(sArr3[i15])) + sToUnsignedInt(sArr5[i15]), sArr2[i14]);
                int i16 = i13 + 1;
    ...
    public static void expand(int[] iArr, byte[] bArr) throws DataLengthException, IllegalArgumentException {
    ...
    public static void generatePolynomialInRQFromSeed(short[] sArr, byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        int[] iArr = new int[i];
        expand(iArr, bArr);
    ...
    public static void getEncodedPolynomial(byte[] bArr, short[] sArr, int i, int i2) {
        ...
        short[] sArr3 = new short[i];
        for (int i3 = 0; i3 < i; i3++) {
            sArr2[i3] = (short) a.D(i2, 1, 2, sArr[i3]);
        }
        for (int i4 = 0; i4 < i; i4++) {
            sArr3[i4] = (short) i2;
        }
    ...
    public static int getInverseInRQ(int i, int i2) {
        int modFreeze = i;
        for (int i3 = 1; i3 < i2 - 2; i3++) {
            modFreeze = getModFreeze(modFreeze * i, i2);
        }
        return modFreeze;
    }

    public static int getModFreeze(int i, int i2) {
        int i3 = (i2 - 1) / 2;
    ...
    public static void getOneThirdInverseInRQ(short[] sArr, byte[] bArr, int i, int i2) {
        ...
        for (int i7 = 0; i7 < (i * 2) - 1; i7++) {
            ...
            sArr5[0] = 0;
            int i8 = -i6;
            int iCheckLessThanZero = checkLessThanZero(i8) & checkNotEqualToZero(sArr3[0]);
            i6 = (i6 ^ ((i8 ^ i6) & iCheckLessThanZero)) + 1;
            for (int i9 = 0; i9 < i3; i9++) {
                short s = sArr2[i9];
                int i10 = (sArr3[i9] ^ s) & iCheckLessThanZero;
                sArr2[i9] = (short) (s ^ i10);
                sArr3[i9] = (short) (sArr3[i9] ^ i10);
                short s2 = sArr5[i9];
                int i11 = (sArr4[i9] ^ s2) & iCheckLessThanZero;
    ...
    private static int[] getUnsignedDivMod(int i, int i2) {
        long jIToUnsignedLong = iToUnsignedLong(i);
        long j = i2;
        long jIToUnsignedLong2 = iToUnsignedLong(Integer.MIN_VALUE) / j;
        long j2 = (jIToUnsignedLong * jIToUnsignedLong2) >>> 31;
        long j3 = jIToUnsignedLong - (j2 * j);
        long j4 = (jIToUnsignedLong2 * j3) >>> 31;
        long j5 = (j3 - (j4 * j)) - j;
        long j6 = j2 + j4 + 1;
        long j7 = -(j5 >>> 63);
    ...
    public static long iToUnsignedLong(int i) {
    ...
    public static boolean isInvertiblePolynomialInR3(byte[] bArr, byte[] bArr2, int i) {
        ...
        for (int i6 = 0; i6 < (i * 2) - 1; i6++) {
            ...
            int i8 = -i5;
            int iCheckLessThanZero = checkLessThanZero(i8) & checkNotEqualToZero(bArr4[0]);
            i5 = (i5 ^ ((i8 ^ i5) & iCheckLessThanZero)) + 1;
            for (int i9 = 0; i9 < i2; i9++) {
                byte b = bArr3[i9];
                int i10 = (bArr4[i9] ^ b) & iCheckLessThanZero;
                bArr3[i9] = (byte) (b ^ i10);
                bArr4[i9] = (byte) (bArr4[i9] ^ i10);
                byte b2 = bArr6[i9];
                int i11 = (bArr5[i9] ^ b2) & iCheckLessThanZero;
                bArr6[i9] = (byte) (b2 ^ i11);
                bArr5[i9] = (byte) (bArr5[i9] ^ i11);
            }
            for (int i12 = 0; i12 < i2; i12++) {
                bArr4[i12] = (byte) getModFreeze((bArr3[i12] * i7) + bArr4[i12], 3);
            }
            for (int i13 = 0; i13 < i2; i13++) {
                bArr5[i13] = (byte) getModFreeze((bArr6[i13] * i7) + bArr5[i13], 3);
            }
            int i14 = 0;
            while (i14 < i) {
                int i15 = i14 + 1;
    ...
    public static void minmax(int[] iArr, int i, int i2) {
        int i3 = iArr[i];
        int i4 = iArr[i2];
        int i5 = i3 ^ i4;
        int i6 = i4 - i3;
    ...
    public static void multiplicationInR3(byte[] bArr, byte[] bArr2, byte[] bArr3, int i) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            ...
            for (int i5 = 0; i5 <= i4; i5++) {
                modFreeze = (byte) getModFreeze((bArr2[i5] * bArr3[i4 - i5]) + modFreeze, 3);
            }
            bArr4[i4] = modFreeze;
        }
        for (int i6 = i; i6 < i3; i6++) {
            ...
            for (int i7 = (i6 - i) + 1; i7 < i; i7++) {
                modFreeze2 = (byte) getModFreeze((bArr2[i7] * bArr3[i6 - i7]) + modFreeze2, 3);
            }
            bArr4[i6] = modFreeze2;
        }
    ...
    public static void multiplicationInRQ(short[] sArr, short[] sArr2, byte[] bArr, int i, int i2) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            ...
            for (int i6 = 0; i6 <= i5; i6++) {
                modFreeze = (short) getModFreeze((sArr2[i6] * bArr[i5 - i6]) + modFreeze, i2);
            }
            sArr3[i5] = modFreeze;
        }
        for (int i7 = i; i7 < i4; i7++) {
            ...
            for (int i8 = (i7 - i) + 1; i8 < i; i8++) {
                modFreeze2 = (short) getModFreeze((sArr2[i8] * bArr[i7 - i8]) + modFreeze2, i2);
            }
            sArr3[i7] = modFreeze2;
        }
    ...
    public static void right(byte[] bArr, short[] sArr, byte[] bArr2, int i, int i2, int i3, int i4) {
        for (int i5 = 0; i5 < bArr.length; i5++) {
            bArr[i5] = (byte) (-checkLessThanZero(getModFreeze(a.C(i2, 4, getModFreeze((bArr2[i5] * i4) - i3, i) - sArr[i5], 1), i)));
        }
    }
    ...
    public static int sToUnsignedInt(short s) {
        return s & HPKE.aead_EXPORT_ONLY;
    }
    ...
    public static void top(byte[] bArr, short[] sArr, byte[] bArr2, int i, int i2, int i3) {
        for (int i4 = 0; i4 < bArr.length; i4++) {
            bArr[i4] = (byte) ((((getModFreeze((((i - 1) / 2) * bArr2[i4]) + sArr[i4], i) + i2) * i3) + 16384) >>> 15);
        }
    }
