...
class Tape {
    ...
    public void computeAuxTape(byte[] bArr) {
        ...
        for (int i = this.engine.numRounds; i > 0; i--) {
            ...
            KMatricesWithPointer kMatricesWithPointerKMatrix = picnicEngine3.lowmcConstants.KMatrix(picnicEngine3, i);
            ...
            int i2 = i - 1;
            KMatricesWithPointer kMatricesWithPointerLMatrixInv = picnicEngine4.lowmcConstants.LMatrixInv(picnicEngine4, i2);
            ...
            if (i == 1) {
                ...
                this.pos = i3 * 2 * i2;
                tapesToParityBits(iArr2, i3);
            }
            PicnicEngine picnicEngine5 = this.engine;
            int i4 = picnicEngine5.stateSizeBits;
            this.pos = (i4 * 2 * i2) + i4;
    ...
    public void setAuxBits(byte[] bArr) {
        PicnicEngine picnicEngine = this.engine;
        int i = picnicEngine.numMPCParties - 1;
