...
public class X509V3CertificateGenerator {
    ...
    public void copyAndAddExtension(String str, boolean z, X509Certificate x509Certificate) throws CertificateParsingException {
        ...
        if (extensionValue == null) {
            throw new CertificateParsingException(a.h("extension ", str, " not present"));
        }
        try {
    ...
    public void setIssuerDN(X500Principal x500Principal) {
        try {
            ...
            throw new IllegalArgumentException(kotlin.reflect.jvm.internal.impl.types.checker.a.f("can't process principal: ", e));
        }
    }
    ...
    public void setPublicKey(PublicKey publicKey) throws IllegalArgumentException {
        try {
            ...
            throw new IllegalArgumentException(kotlin.reflect.jvm.internal.impl.types.checker.a.e(e, new StringBuilder("unable to process key - ")));
        }
    }
    ...
    public void setSignatureAlgorithm(String str) {
        ...
        try {
            ...
            throw new IllegalArgumentException(a.A("Unknown signature type requested: ", str));
        }
    }
