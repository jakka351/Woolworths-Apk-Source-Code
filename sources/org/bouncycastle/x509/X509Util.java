...
class X509Util {
    ...
    public static byte[] calculateSignature(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str, String str2, PrivateKey privateKey, SecureRandom secureRandom, ASN1Encodable aSN1Encodable) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, IOException, NoSuchProviderException {
    ...
    public static Implementation getImplementation(String str, String str2) throws NoSuchAlgorithmException {
        ...
        throw new NoSuchAlgorithmException(a.A("cannot find implementation ", str2));
    }
    ...
    public static Provider getProvider(String str) throws NoSuchProviderException {
        ...
        throw new NoSuchProviderException(a.h("Provider ", str, " not found"));
    }
    ...
    public static byte[] calculateSignature(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str, PrivateKey privateKey, SecureRandom secureRandom, ASN1Encodable aSN1Encodable) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, IOException {
        if (aSN1ObjectIdentifier == null) {
            throw new IllegalStateException("no signature algorithm specified");
        }
    ...
    public static Implementation getImplementation(String str, String str2, Provider provider) throws NoSuchAlgorithmException {
        ...
        if (property2 != null) {
            try {
                ...
                StringBuilder sbU = a.u("algorithm ", upperCase, " in provider ");
                sbU.append(provider.getName());
                sbU.append(" but no class \"");
                sbU.append(property2);
                sbU.append("\" found!");
                throw new IllegalStateException(sbU.toString());
            } catch (Exception unused2) {
                StringBuilder sbU2 = a.u("algorithm ", upperCase, " in provider ");
                sbU2.append(provider.getName());
                sbU2.append(" but class \"");
                sbU2.append(property2);
                sbU2.append("\" inaccessible!");
                throw new IllegalStateException(sbU2.toString());
            }
        }
        StringBuilder sbU3 = a.u("cannot find implementation ", upperCase, " for provider ");
        sbU3.append(provider.getName());
        throw new NoSuchAlgorithmException(sbU3.toString());
    }
}
