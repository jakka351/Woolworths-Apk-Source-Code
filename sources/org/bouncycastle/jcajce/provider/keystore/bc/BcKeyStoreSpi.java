...
public class BcKeyStoreSpi extends KeyStoreSpi implements BCKeyStore {
    ...
    public Key decodeKey(DataInputStream dataInputStream) throws IOException {
        ...
        if (utf.equals("PKCS#8") || utf.equals("PKCS8")) {
            ...
            if (!utf.equals("X.509") && !utf.equals("X509")) {
                ...
                throw new IOException(a.h("Key format ", utf, " not recognised!"));
            }
        ...
        try {
            ...
            throw new IOException(kotlin.reflect.jvm.internal.impl.types.checker.a.e(e, new StringBuilder("Exception creating key: ")));
        }
    }
    ...
    public void engineSetCertificateEntry(String str, Certificate certificate) throws KeyStoreException {
        StoreEntry storeEntry = (StoreEntry) this.table.get(str);
        if (storeEntry != null && storeEntry.getType() != 1) {
            throw new KeyStoreException(a.A("key store already has a key entry with alias ", str));
        }
    ...
    public Cipher makePBECipher(String str, int i, char[] cArr, byte[] bArr, int i2) throws InvalidKeyException, IOException, InvalidAlgorithmParameterException {
        try {
            ...
            throw new IOException(android.support.v4.media.session.a.n(e, "Error initialising store of key store: "));
        }
    }
