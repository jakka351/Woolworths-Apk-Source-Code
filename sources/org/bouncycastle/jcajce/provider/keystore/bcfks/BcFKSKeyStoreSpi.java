...
class BcFKSKeyStoreSpi extends KeyStoreSpi {
    ...
    public static class Def extends BcFKSKeyStoreSpi {
        ...
        @Override // org.bouncycastle.jcajce.provider.keystore.bcfks.BcFKSKeyStoreSpi, java.security.KeyStoreSpi
        public /* bridge */ /* synthetic */ void engineStore(OutputStream outputStream, char[] cArr) throws BadPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, IOException, InvalidKeyException, CertificateException {
        ...
        @Override // org.bouncycastle.jcajce.provider.keystore.bcfks.BcFKSKeyStoreSpi, java.security.KeyStoreSpi
        public /* bridge */ /* synthetic */ void engineStore(KeyStore.LoadStoreParameter loadStoreParameter) throws BadPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, SignatureException, UnsupportedCallbackException, IOException, InvalidKeyException, CertificateException {
        ...
        public Key engineGetKey(String str, char[] cArr) throws InvalidKeySpecException, NoSuchAlgorithmException, UnrecoverableKeyException {
            try {
                ...
                if (this.cache.containsKey(str) && !Arrays.constantTimeAreEqual(this.cache.get(str), bArrCalculateMac)) {
                    throw new UnrecoverableKeyException(a.h("unable to recover key (", str, ")"));
                }
                ...
                StringBuilder sbU = a.u("unable to recover key (", str, "): ");
                sbU.append(e.getMessage());
                throw new UnrecoverableKeyException(sbU.toString());
            }
        }
    ...
    private KeyDerivationFunc generatePkbdAlgorithmIdentifier(ASN1ObjectIdentifier aSN1ObjectIdentifier, int i) {
        ...
        throw new IllegalStateException(c.n("unknown derivation algorithm: ", aSN1ObjectIdentifier));
    }
    ...
    public Key engineGetKey(String str, char[] cArr) throws InvalidKeySpecException, UnrecoverableKeyException, NoSuchAlgorithmException {
        ...
        if (!objectData.getType().equals(PRIVATE_KEY) && !objectData.getType().equals(PROTECTED_PRIVATE_KEY)) {
            if (!objectData.getType().equals(SECRET_KEY) && !objectData.getType().equals(PROTECTED_SECRET_KEY)) {
                throw new UnrecoverableKeyException(a.h("BCFKS KeyStore unable to recover secret key (", str, "): type not recognized"));
            }
            ...
            try {
                ...
                throw new UnrecoverableKeyException(a.f(e, a.u("BCFKS KeyStore unable to recover secret key (", str, "): ")));
            }
        }
        ...
        try {
            ...
            throw new UnrecoverableKeyException(a.f(e2, a.u("BCFKS KeyStore unable to recover private key (", str, "): ")));
        }
    }
    ...
    public void engineSetCertificateEntry(String str, Certificate certificate) throws KeyStoreException {
        ...
        if (objectData == null) {
            ...
            if (!objectData.getType().equals(CERTIFICATE)) {
                throw new KeyStoreException(a.A("BCFKS KeyStore already has a key entry with alias ", str));
            }
    ...
    public void engineSetKeyEntry(String str, Key key, char[] cArr, Certificate[] certificateArr) throws KeyStoreException {
        ...
        if (key instanceof PrivateKey) {
            ...
            try {
                ...
                throw new ExtKeyStoreException(kotlin.reflect.jvm.internal.impl.types.checker.a.e(e, new StringBuilder("BCFKS KeyStore exception storing private key: ")), e);
            }
        } else {
            ...
            try {
                ...
                throw new ExtKeyStoreException(kotlin.reflect.jvm.internal.impl.types.checker.a.e(e2, new StringBuilder("BCFKS KeyStore exception storing private key: ")), e2);
            }
        }
        this.lastModifiedDate = date;
    }
    ...
    @Override // java.security.KeyStoreSpi
    public void engineStore(OutputStream outputStream, char[] cArr) throws BadPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, IOException, InvalidKeyException, CertificateException {
    ...
    @Override // java.security.KeyStoreSpi
    public void engineStore(KeyStore.LoadStoreParameter loadStoreParameter) throws BadPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, SignatureException, UnsupportedCallbackException, IOException, InvalidKeyException, CertificateException {
        ...
        if (certificateArr != null) {
            try {
                ...
                try {
                    ...
                    throw new ExtKeyStoreException(kotlin.reflect.jvm.internal.impl.types.checker.a.e(e, new StringBuilder("BCFKS KeyStore exception storing protected private key: ")), e);
                }
            } catch (Exception e2) {
            ...
            try {
                ...
                throw new ExtKeyStoreException(kotlin.reflect.jvm.internal.impl.types.checker.a.e(e3, new StringBuilder("BCFKS KeyStore exception storing protected private key: ")), e3);
            }
        }
        this.lastModifiedDate = date;
    }
