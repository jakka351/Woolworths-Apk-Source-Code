...
public class PBEPBKDF2 {
    ...
    public static class BasePBKDF2 extends BaseSecretKeyFactory {
        ...
        private int getDigestCode(ASN1ObjectIdentifier aSN1ObjectIdentifier) throws InvalidKeySpecException {
            ...
            throw new InvalidKeySpecException(c.n("Invalid KeySpec: unknown PRF algorithm ", aSN1ObjectIdentifier));
        }
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            a.i(a.e(sb2, aSN1ObjectIdentifier, configurableProvider, "PBKDF2", str), "$PBKDF2withUTF8", configurableProvider, "SecretKeyFactory.PBKDF2");
            ...
            sb3.append(str);
            a.i(sb3, "$PBKDF2with8BIT", configurableProvider, "SecretKeyFactory.PBKDF2WITHASCII");
