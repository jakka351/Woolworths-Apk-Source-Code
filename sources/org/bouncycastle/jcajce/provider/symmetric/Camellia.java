...
public final class Camellia {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.h(sb, str, "$AlgParams", configurableProvider, "AlgorithmParameters.CAMELLIA");
            ...
            a.i(a.g(configurableProvider, "Alg.Alias.AlgorithmParameters", "CAMELLIA", str, aSN1ObjectIdentifier3), "$AlgParamGen", configurableProvider, "AlgorithmParameterGenerator.CAMELLIA");
            ...
            a.i(a.g(configurableProvider, "Alg.Alias.Cipher", "CAMELLIAWRAP", str, aSN1ObjectIdentifier6), "$KeyFactory", configurableProvider, "SecretKeyFactory.CAMELLIA");
            ...
            StringBuilder sbG = a.g(configurableProvider, "KeyGenerator", YU.a.o(a.d(a.g(configurableProvider, "KeyGenerator", YU.a.o(a.d(a.g(configurableProvider, "KeyGenerator", YU.a.o(a.d(a.c(a.g(configurableProvider, "Alg.Alias.SecretKeyFactory", "CAMELLIA", str, aSN1ObjectIdentifier3), "$KeyGen", configurableProvider, "KeyGenerator.CAMELLIA", str), "$KeyGen128", configurableProvider, "KeyGenerator", aSN1ObjectIdentifier4), str, "$KeyGen192"), str, aSN1ObjectIdentifier5), "$KeyGen256", configurableProvider, "KeyGenerator", aSN1ObjectIdentifier6), str, "$KeyGen128"), str, aSN1ObjectIdentifier), "$KeyGen192", configurableProvider, "KeyGenerator", aSN1ObjectIdentifier2), str, "$KeyGen256"), str, aSN1ObjectIdentifier3);
            sbG.append("$GMAC");
            addGMacAlgorithm(configurableProvider, "CAMELLIA", sbG.toString(), YU.a.g(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "CAMELLIA", YU.a.g(str, "$Poly1305"), YU.a.g(str, "$Poly1305KeyGen"));
        }
    }
