...
public final class DES {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        private void addAlias(ConfigurableProvider configurableProvider, ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
            StringBuilder sbF = a.f(aSN1ObjectIdentifier, new StringBuilder("Alg.Alias.KeyGenerator."), configurableProvider, str, "Alg.Alias.KeyFactory.");
            sbF.append(aSN1ObjectIdentifier.getId());
            configurableProvider.addAlgorithm(sbF.toString(), str);
        }
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.h(sb, str, "$ECB", configurableProvider, "Cipher.DES");
            ASN1ObjectIdentifier aSN1ObjectIdentifier = OIWObjectIdentifiers.desCBC;
            a.j(configurableProvider, str, "$CBC", "Cipher", aSN1ObjectIdentifier);
            ...
            sb2.append(str);
            a.i(a.c(a.c(a.c(sb2, "$KeyGenerator", configurableProvider, "KeyGenerator.DES", str), "$KeyFactory", configurableProvider, "SecretKeyFactory.DES", str), "$CMAC", configurableProvider, "Mac.DESCMAC", str), "$CBCMAC", configurableProvider, "Mac.DESMAC");
            configurableProvider.addAlgorithm("Mac.DESMAC/CFB8", a.a("Alg.Alias.Mac.DES", "DESMAC", str, "$DESCFB8", configurableProvider));
            configurableProvider.addAlgorithm("Alg.Alias.Mac.DES/CFB8", "DESMAC/CFB8");
            a.h(new StringBuilder(), str, "$DES64", configurableProvider, "Mac.DESMAC64");
            configurableProvider.addAlgorithm("Mac.DESMAC64WITHISO7816-4PADDING", a.a("Alg.Alias.Mac.DES64", "DESMAC64", str, "$DES64with7816d4", configurableProvider));
            ...
            a.h(new StringBuilder(), str, "$DES9797Alg3", configurableProvider, "Mac.DESWITHISO9797");
            configurableProvider.addAlgorithm("Mac.ISO9797ALG3MAC", a.a("Alg.Alias.Mac.DESISO9797MAC", "DESWITHISO9797", str, "$DES9797Alg3", configurableProvider));
            configurableProvider.addAlgorithm("Alg.Alias.Mac.ISO9797ALG3", "ISO9797ALG3MAC");
            a.h(new StringBuilder(), str, "$DES9797Alg3with7816d4", configurableProvider, "Mac.ISO9797ALG3WITHISO7816-4PADDING");
            ...
            StringBuilder sbG = a.g(configurableProvider, "Alg.Alias.AlgorithmParameters", "DES", str, aSN1ObjectIdentifier);
            sbG.append("$AlgParamGen");
            configurableProvider.addAlgorithm("AlgorithmParameterGenerator.DES", sbG.toString());
            a.i(a.c(a.c(a.e(new StringBuilder("Alg.Alias.AlgorithmParameterGenerator."), aSN1ObjectIdentifier, configurableProvider, "DES", str), "$PBEWithMD2", configurableProvider, "Cipher.PBEWITHMD2ANDDES", str), "$PBEWithMD5", configurableProvider, "Cipher.PBEWITHMD5ANDDES", str), "$PBEWithSHA1", configurableProvider, "Cipher.PBEWITHSHA1ANDDES");
            ...
            a.h(a.b(a.b(new StringBuilder(), str, "$PBEWithMD2KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHMD2ANDDES"), str, "$PBEWithMD5KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHMD5ANDDES"), str, "$PBEWithSHA1KeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHSHA1ANDDES");
            ...
            c.y(c.q(new StringBuilder("Alg.Alias.SecretKeyFactory."), aSN1ObjectIdentifier3, configurableProvider, "PBEWITHMD5ANDDES", "Alg.Alias.SecretKeyFactory."), aSN1ObjectIdentifier4, configurableProvider, "PBEWITHSHA1ANDDES");
        }
    }
