...
public final class IDEA {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            a.h(new StringBuilder(), str, "$ECB", configurableProvider, "Cipher.IDEA");
            ...
            a.i(a.c(a.g(configurableProvider, "KeyGenerator", YU.a.o(a.b(a.b(new StringBuilder(), str, "$PBEWithSHAAndIDEA", configurableProvider, "Cipher.PBEWITHSHAANDIDEA-CBC"), str, "$KeyGen", configurableProvider, "KeyGenerator.IDEA"), str, "$KeyGen"), str, aSN1ObjectIdentifier), "$PBEWithSHAAndIDEAKeyGen", configurableProvider, "SecretKeyFactory.PBEWITHSHAANDIDEA-CBC", str), "$Mac", configurableProvider, "Mac.IDEAMAC");
            configurableProvider.addAlgorithm("Mac.IDEAMAC/CFB8", a.a("Alg.Alias.Mac.IDEA", "IDEAMAC", str, "$CFB8Mac", configurableProvider));
