...
public class TLSKDF {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.h(a.b(a.b(a.b(a.b(sb, str, "$TLS10", configurableProvider, "SecretKeyFactory.TLS10KDF"), str, "$TLS11", configurableProvider, "SecretKeyFactory.TLS11KDF"), str, "$TLS12withSHA256", configurableProvider, "SecretKeyFactory.TLS12WITHSHA256KDF"), str, "$TLS12withSHA384", configurableProvider, "SecretKeyFactory.TLS12WITHSHA384KDF"), str, "$TLS12withSHA512", configurableProvider, "SecretKeyFactory.TLS12WITHSHA512KDF");
        }
    }
    ...
    public static class TLS12 extends TLSKeyMaterialFactory {
        ...
        private byte[] PRF(TLSKeyMaterialSpec tLSKeyMaterialSpec, Mac mac) throws IllegalStateException, DataLengthException, IllegalArgumentException {
    ...
    public static byte[] PRF_legacy(TLSKeyMaterialSpec tLSKeyMaterialSpec) throws IllegalStateException, DataLengthException, IllegalArgumentException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void hmac_hash(Mac mac, byte[] bArr, byte[] bArr2, byte[] bArr3) throws IllegalStateException, DataLengthException, IllegalArgumentException {
