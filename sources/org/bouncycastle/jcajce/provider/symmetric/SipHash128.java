...
public final class SipHash128 {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.h(sb, str, "$Mac24", configurableProvider, "Mac.SIPHASH128-2-4");
            configurableProvider.addAlgorithm("KeyGenerator.SIPHASH128", a.a("Mac.SIPHASH128-4-8", a.a("Alg.Alias.Mac.SIPHASH128", "SIPHASH128-2-4", str, "$Mac48", configurableProvider), str, "$KeyGen", configurableProvider));
