...
public final class DESede {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.h(sb, str, "$ECB", configurableProvider, "Cipher.DESEDE");
            ...
            a.h(new StringBuilder(), str, "$Wrap", configurableProvider, "Cipher.DESEDEWRAP");
            configurableProvider.addAlgorithm("Cipher", PKCSObjectIdentifiers.id_alg_CMS3DESwrap, str + "$Wrap");
            a.h(new StringBuilder(), str, "$RFC3211", configurableProvider, "Cipher.DESEDERFC3211WRAP");
            ...
            if (configurableProvider.hasAlgorithm("MessageDigest", McElieceCCA2KeyGenParameterSpec.SHA1)) {
                ...
                sb2.append(str);
                a.i(sb2, "$PBEWithSHAAndDES2Key", configurableProvider, "Cipher.PBEWITHSHAAND2-KEYTRIPLEDES-CBC");
            ...
            StringBuilder sbP = c.p(str, "$KeyGenerator", "KeyGenerator.DESEDE", "KeyGenerator.", configurableProvider);
            sbP.append(aSN1ObjectIdentifier);
            configurableProvider.addAlgorithm(sbP.toString(), str + "$KeyGenerator3");
            StringBuilder sb3 = new StringBuilder();
            sb3.append(str);
            a.i(a.c(sb3, "$KeyGenerator", configurableProvider, "KeyGenerator.DESEDEWRAP", str), "$KeyFactory", configurableProvider, "SecretKeyFactory.DESEDE");
            configurableProvider.addAlgorithm("SecretKeyFactory", OIWObjectIdentifiers.desEDE, str + "$KeyFactory");
            a.h(a.b(new StringBuilder(), str, "$CMAC", configurableProvider, "Mac.DESEDECMAC"), str, "$CBCMAC", configurableProvider, "Mac.DESEDEMAC");
            configurableProvider.addAlgorithm("Mac.DESEDEMAC/CFB8", a.a("Alg.Alias.Mac.DESEDE", "DESEDEMAC", str, "$DESedeCFB8", configurableProvider));
            configurableProvider.addAlgorithm("Alg.Alias.Mac.DESEDE/CFB8", "DESEDEMAC/CFB8");
            a.h(new StringBuilder(), str, "$DESede64", configurableProvider, "Mac.DESEDEMAC64");
            configurableProvider.addAlgorithm("Mac.DESEDEMAC64WITHISO7816-4PADDING", a.a("Alg.Alias.Mac.DESEDE64", "DESEDEMAC64", str, "$DESede64with7816d4", configurableProvider));
