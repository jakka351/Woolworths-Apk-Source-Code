...
abstract class SymmetricAlgorithmProvider extends AlgorithmProvider {
    public void addCMacAlgorithm(ConfigurableProvider configurableProvider, String str, String str2, String str3) {
        ...
        StringBuilder sbP = c.p(str, "-CMAC", a.h("Alg.Alias.Mac.", str, "CMAC"), "KeyGenerator.", configurableProvider);
        sbP.append(str);
        sbP.append("-CMAC");
        configurableProvider.addAlgorithm(sbP.toString(), str3);
        configurableProvider.addAlgorithm(a.h("Alg.Alias.KeyGenerator.", str, "CMAC"), str + "-CMAC");
    }
    ...
    public void addGMacAlgorithm(ConfigurableProvider configurableProvider, String str, String str2, String str3) {
        ...
        StringBuilder sbP = c.p(str, "-GMAC", a.h("Alg.Alias.Mac.", str, "GMAC"), "KeyGenerator.", configurableProvider);
        sbP.append(str);
        sbP.append("-GMAC");
        configurableProvider.addAlgorithm(sbP.toString(), str3);
        configurableProvider.addAlgorithm(a.h("Alg.Alias.KeyGenerator.", str, "GMAC"), str + "-GMAC");
    }
