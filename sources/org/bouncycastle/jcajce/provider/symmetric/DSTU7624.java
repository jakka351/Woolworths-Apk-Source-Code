...
public class DSTU7624 {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.h(sb, str, "$AlgParams", configurableProvider, "AlgorithmParameters.DSTU7624");
            ASN1ObjectIdentifier aSN1ObjectIdentifier = UAObjectIdentifiers.dstu7624cbc_128;
            a.j(configurableProvider, str, "$AlgParams", "AlgorithmParameters", aSN1ObjectIdentifier);
            ASN1ObjectIdentifier aSN1ObjectIdentifier2 = UAObjectIdentifiers.dstu7624cbc_256;
            a.j(configurableProvider, str, "$AlgParams", "AlgorithmParameters", aSN1ObjectIdentifier2);
            ...
            configurableProvider.addAlgorithm("Cipher", aSN1ObjectIdentifier3, YU.a.o(a.d(a.g(configurableProvider, "Cipher", YU.a.o(new StringBuilder(), str, "$CBC128"), str, aSN1ObjectIdentifier), "$CBC256", configurableProvider, "Cipher", aSN1ObjectIdentifier2), str, "$CBC512"));
            ASN1ObjectIdentifier aSN1ObjectIdentifier7 = UAObjectIdentifiers.dstu7624ofb_128;
            a.j(configurableProvider, str, "$OFB128", "Cipher", aSN1ObjectIdentifier7);
            ASN1ObjectIdentifier aSN1ObjectIdentifier8 = UAObjectIdentifiers.dstu7624ofb_256;
            a.j(configurableProvider, str, "$OFB256", "Cipher", aSN1ObjectIdentifier8);
            ASN1ObjectIdentifier aSN1ObjectIdentifier9 = UAObjectIdentifiers.dstu7624ofb_512;
            a.j(configurableProvider, str, "$OFB512", "Cipher", aSN1ObjectIdentifier9);
            ASN1ObjectIdentifier aSN1ObjectIdentifier10 = UAObjectIdentifiers.dstu7624cfb_128;
            a.j(configurableProvider, str, "$CFB128", "Cipher", aSN1ObjectIdentifier10);
            ASN1ObjectIdentifier aSN1ObjectIdentifier11 = UAObjectIdentifiers.dstu7624cfb_256;
            a.j(configurableProvider, str, "$CFB256", "Cipher", aSN1ObjectIdentifier11);
            ASN1ObjectIdentifier aSN1ObjectIdentifier12 = UAObjectIdentifiers.dstu7624cfb_512;
            a.j(configurableProvider, str, "$CFB512", "Cipher", aSN1ObjectIdentifier12);
            ASN1ObjectIdentifier aSN1ObjectIdentifier13 = UAObjectIdentifiers.dstu7624ctr_128;
            a.j(configurableProvider, str, "$CTR128", "Cipher", aSN1ObjectIdentifier13);
            ASN1ObjectIdentifier aSN1ObjectIdentifier14 = UAObjectIdentifiers.dstu7624ctr_256;
            a.j(configurableProvider, str, "$CTR256", "Cipher", aSN1ObjectIdentifier14);
            ASN1ObjectIdentifier aSN1ObjectIdentifier15 = UAObjectIdentifiers.dstu7624ctr_512;
            a.j(configurableProvider, str, "$CTR512", "Cipher", aSN1ObjectIdentifier15);
            ASN1ObjectIdentifier aSN1ObjectIdentifier16 = UAObjectIdentifiers.dstu7624ccm_128;
            a.j(configurableProvider, str, "$CCM128", "Cipher", aSN1ObjectIdentifier16);
            ASN1ObjectIdentifier aSN1ObjectIdentifier17 = UAObjectIdentifiers.dstu7624ccm_256;
            a.j(configurableProvider, str, "$CCM256", "Cipher", aSN1ObjectIdentifier17);
            ...
            a.h(new StringBuilder(), str, "$Wrap", configurableProvider, "Cipher.DSTU7624KW");
            StringBuilder sbR = c.r(configurableProvider, "Cipher.DSTU7624-128KW", a.a("Alg.Alias.Cipher.DSTU7624WRAP", "DSTU7624KW", str, "$Wrap128", configurableProvider), "Alg.Alias.Cipher.");
            ASN1ObjectIdentifier aSN1ObjectIdentifier19 = UAObjectIdentifiers.dstu7624kw_128;
            sbR.append(aSN1ObjectIdentifier19.getId());
            configurableProvider.addAlgorithm(sbR.toString(), "DSTU7624-128KW");
            StringBuilder sbR2 = c.r(configurableProvider, "Cipher.DSTU7624-256KW", a.a("Alg.Alias.Cipher.DSTU7624-128WRAP", "DSTU7624-128KW", str, "$Wrap256", configurableProvider), "Alg.Alias.Cipher.");
            ASN1ObjectIdentifier aSN1ObjectIdentifier20 = UAObjectIdentifiers.dstu7624kw_256;
            sbR2.append(aSN1ObjectIdentifier20.getId());
            configurableProvider.addAlgorithm(sbR2.toString(), "DSTU7624-256KW");
            StringBuilder sbR3 = c.r(configurableProvider, "Cipher.DSTU7624-512KW", a.a("Alg.Alias.Cipher.DSTU7624-256WRAP", "DSTU7624-256KW", str, "$Wrap512", configurableProvider), "Alg.Alias.Cipher.");
            ASN1ObjectIdentifier aSN1ObjectIdentifier21 = UAObjectIdentifiers.dstu7624kw_512;
            sbR3.append(aSN1ObjectIdentifier21.getId());
            configurableProvider.addAlgorithm(sbR3.toString(), "DSTU7624-512KW");
            StringBuilder sbR4 = c.r(configurableProvider, "Mac.DSTU7624-128GMAC", a.a("Mac.DSTU7624GMAC", a.a("Alg.Alias.Cipher.DSTU7624-512WRAP", "DSTU7624-512KW", str, "$GMAC", configurableProvider), str, "$GMAC128", configurableProvider), "Alg.Alias.Mac.");
            ASN1ObjectIdentifier aSN1ObjectIdentifier22 = UAObjectIdentifiers.dstu7624gmac_128;
            sbR4.append(aSN1ObjectIdentifier22.getId());
            configurableProvider.addAlgorithm(sbR4.toString(), "DSTU7624-128GMAC");
