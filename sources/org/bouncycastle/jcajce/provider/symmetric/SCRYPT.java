...
public class SCRYPT {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.h(sb, str, "$ScryptWithUTF8", configurableProvider, "SecretKeyFactory.SCRYPT");
            a.j(configurableProvider, str, "$ScryptWithUTF8", "SecretKeyFactory", MiscObjectIdentifiers.id_scrypt);
        }
    }
