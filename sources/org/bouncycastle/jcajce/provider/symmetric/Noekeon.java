...
public final class Noekeon {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addGMacAlgorithm(configurableProvider, "NOEKEON", a.o(org.bouncycastle.jcajce.provider.asymmetric.a.b(org.bouncycastle.jcajce.provider.asymmetric.a.b(org.bouncycastle.jcajce.provider.asymmetric.a.b(org.bouncycastle.jcajce.provider.asymmetric.a.b(sb, str, "$AlgParams", configurableProvider, "AlgorithmParameters.NOEKEON"), str, "$AlgParamGen", configurableProvider, "AlgorithmParameterGenerator.NOEKEON"), str, "$ECB", configurableProvider, "Cipher.NOEKEON"), str, "$KeyGen", configurableProvider, "KeyGenerator.NOEKEON"), str, "$GMAC"), a.g(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "NOEKEON", a.g(str, "$Poly1305"), a.g(str, "$Poly1305KeyGen"));
        }
    }
