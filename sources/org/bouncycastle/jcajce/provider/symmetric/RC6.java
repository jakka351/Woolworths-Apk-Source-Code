...
public final class RC6 {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addGMacAlgorithm(configurableProvider, "RC6", a.o(org.bouncycastle.jcajce.provider.asymmetric.a.b(org.bouncycastle.jcajce.provider.asymmetric.a.b(org.bouncycastle.jcajce.provider.asymmetric.a.b(sb, str, "$ECB", configurableProvider, "Cipher.RC6"), str, "$KeyGen", configurableProvider, "KeyGenerator.RC6"), str, "$AlgParams", configurableProvider, "AlgorithmParameters.RC6"), str, "$GMAC"), a.g(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "RC6", a.g(str, "$Poly1305"), a.g(str, "$Poly1305KeyGen"));
        }
    }
