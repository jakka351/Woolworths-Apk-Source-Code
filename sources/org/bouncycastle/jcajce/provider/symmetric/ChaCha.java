...
public final class ChaCha {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.h(a.b(a.b(a.b(a.b(sb, str, "$Base", configurableProvider, "Cipher.CHACHA"), str, "$KeyGen", configurableProvider, "KeyGenerator.CHACHA"), str, "$Base7539", configurableProvider, "Cipher.CHACHA7539"), str, "$KeyGen7539", configurableProvider, "KeyGenerator.CHACHA7539"), str, "$AlgParams", configurableProvider, "AlgorithmParameters.CHACHA7539");
            ...
            StringBuilder sbC = a.c(a.e(sb2, aSN1ObjectIdentifier, configurableProvider, "CHACHA7539", str), "$BaseCC20P1305", configurableProvider, "Cipher.CHACHA20-POLY1305", str);
            sbC.append("$AlgParamsCC1305");
            configurableProvider.addAlgorithm("AlgorithmParameters.CHACHA20-POLY1305", sbC.toString());
            c.y(c.q(c.q(c.q(new StringBuilder("Alg.Alias.Cipher."), aSN1ObjectIdentifier, configurableProvider, "CHACHA20-POLY1305", "Alg.Alias.AlgorithmParameters."), aSN1ObjectIdentifier, configurableProvider, "CHACHA20-POLY1305", "Alg.Alias.Cipher.OID."), aSN1ObjectIdentifier, configurableProvider, "CHACHA20-POLY1305", "Alg.Alias.AlgorithmParameters.OID."), aSN1ObjectIdentifier, configurableProvider, "CHACHA20-POLY1305");
        }
    }
