...
public final class Twofish {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.h(a.b(a.b(sb, str, "$ECB", configurableProvider, "Cipher.Twofish"), str, "$KeyGen", configurableProvider, "KeyGenerator.Twofish"), str, "$AlgParams", configurableProvider, "AlgorithmParameters.Twofish");
            ...
            addGMacAlgorithm(configurableProvider, "Twofish", YU.a.o(a.b(a.b(new StringBuilder(), str, "$PBEWithSHA", configurableProvider, "Cipher.PBEWITHSHAANDTWOFISH-CBC"), str, "$PBEWithSHAKeyFactory", configurableProvider, "SecretKeyFactory.PBEWITHSHAANDTWOFISH-CBC"), str, "$GMAC"), YU.a.g(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "Twofish", YU.a.g(str, "$Poly1305"), YU.a.g(str, "$Poly1305KeyGen"));
        }
    }
