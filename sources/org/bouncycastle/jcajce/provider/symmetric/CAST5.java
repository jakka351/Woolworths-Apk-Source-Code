...
public final class CAST5 {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.h(sb, str, "$AlgParams", configurableProvider, "AlgorithmParameters.CAST5");
            configurableProvider.addAlgorithm("AlgorithmParameterGenerator.CAST5", a.a("Alg.Alias.AlgorithmParameters.1.2.840.113533.7.66.10", "CAST5", str, "$AlgParamGen", configurableProvider));
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameterGenerator.1.2.840.113533.7.66.10", "CAST5");
            a.h(new StringBuilder(), str, "$ECB", configurableProvider, "Cipher.CAST5");
            ...
            a.h(new StringBuilder(), str, "$KeyGen", configurableProvider, "KeyGenerator.CAST5");
