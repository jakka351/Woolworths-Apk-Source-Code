...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public Key engineDoPhase(Key key, boolean z) throws IllegalStateException, InvalidKeyException {
        ...
        try {
            ...
            throw new InvalidKeyException(a.f(e, new StringBuilder("calculation failed: "))) { // from class: org.bouncycastle.jcajce.provider.asymmetric.ecgost12.KeyAgreementSpi.1
