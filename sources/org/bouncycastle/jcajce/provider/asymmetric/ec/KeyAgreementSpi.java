...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public void doInitFromKey(Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (obj instanceof ECMQVBasicAgreement) {
            ...
            if (!z && !(algorithmParameterSpec instanceof MQVParameterSpec)) {
                ...
                throw new InvalidAlgorithmParameterException(a.o(sb, getSimpleName(MQVParameterSpec.class), " for initialisation"));
            }
            if (z) {
        ...
        if (!(algorithmParameterSpec instanceof DHUParameterSpec)) {
            if (!(key instanceof PrivateKey)) {
                ...
                throw new InvalidKeyException(a.o(sb2, getSimpleName(ECPrivateKey.class), " for initialisation"));
            }
    ...
    public Key engineDoPhase(Key key, boolean z) throws IllegalStateException, InvalidKeyException {
        ...
        try {
            ...
            throw new InvalidKeyException(a.f(e, new StringBuilder("calculation failed: "))) { // from class: org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi.1
