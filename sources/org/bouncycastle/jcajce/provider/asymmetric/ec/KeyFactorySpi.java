...
public class KeyFactorySpi extends BaseKeyFactorySpi implements AsymmetricKeyInfoConverter {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        try {
            ...
            throw new InvalidKeySpecException(a.k(e, new StringBuilder("bad encoding: ")));
        }
    }
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        try {
            ...
            throw new InvalidKeySpecException(YU.a.f(e, new StringBuilder("invalid KeySpec: ")), e);
        }
    }
    ...
    public KeySpec engineGetKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        ...
        if (cls.isAssignableFrom(OpenSSHPublicKeySpec.class) && (key instanceof ECPublicKey)) {
            ...
            try {
                ...
                throw new IllegalArgumentException(a.k(e, new StringBuilder("unable to produce encoding: ")));
            }
        }
        ...
        try {
            ...
            throw new IllegalArgumentException(a.k(e2, new StringBuilder("cannot encoded key: ")));
        }
    }
