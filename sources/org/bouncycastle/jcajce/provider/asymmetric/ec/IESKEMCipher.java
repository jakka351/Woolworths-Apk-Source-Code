...
public class IESKEMCipher extends BaseCipherSpi {
    ...
    public int engineDoFinal(byte[] bArr, int i, int i2, byte[] bArr2, int i3) throws IllegalStateException, DataLengthException, BadPaddingException, IllegalBlockSizeException, IllegalArgumentException, ShortBufferException {
    ...
    public void engineInit(int i, Key key, AlgorithmParameters algorithmParameters, SecureRandom secureRandom) throws InvalidParameterSpecException, InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (algorithmParameters != null) {
            try {
                ...
                throw new InvalidAlgorithmParameterException(a.e(e, new StringBuilder("cannot recognise parameters: ")));
            }
        } else {
            parameterSpec = null;
        }
    ...
    public void engineSetMode(String str) throws NoSuchAlgorithmException {
        throw new NoSuchAlgorithmException(YU.a.A("can't support mode ", str));
    }
    ...
    @Override // javax.crypto.CipherSpi
    public byte[] engineDoFinal(byte[] bArr, int i, int i2) throws IllegalStateException, DataLengthException, BadPaddingException, IllegalBlockSizeException, IllegalArgumentException {
        if (i2 != 0) {
            this.buffer.write(bArr, i, i2);
        }
        ...
        int i8 = i6 + i;
        ECPoint eCPointDecodePoint = curve.decodePoint(Arrays.copyOfRange(bArr, i, i8));
