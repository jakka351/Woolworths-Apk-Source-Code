...
public class IESCipher extends BaseCipherSpi {
    ...
    public int engineGetKeySize(Key key) {
        ...
        throw new IllegalArgumentException(a.A("unknown XDH key algorithm ", algorithm));
    }
    ...
    public void engineInit(int i, Key key, AlgorithmParameters algorithmParameters, SecureRandom secureRandom) throws InvalidParameterSpecException, InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (algorithmParameters != null) {
            try {
                ...
                throw new InvalidAlgorithmParameterException(kotlin.reflect.jvm.internal.impl.types.checker.a.e(e, new StringBuilder("cannot recognise parameters: ")));
            }
        } else {
            parameterSpec = null;
        }
    ...
    public void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (i2 != 0 && (nonce == null || nonce.length != i2)) {
            throw new InvalidAlgorithmParameterException(a.m(new StringBuilder("NONCE in IES Parameters needs to be "), this.ivLength, " bytes long"));
        }
        if (i == 1 || i == 3) {
