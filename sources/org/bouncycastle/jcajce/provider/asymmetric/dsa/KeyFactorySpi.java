...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        if (keySpec instanceof DSAPublicKeySpec) {
            try {
                ...
                throw new InvalidKeySpecException(a.f(e, new StringBuilder("invalid KeySpec: "))) { // from class: org.bouncycastle.jcajce.provider.asymmetric.dsa.KeyFactorySpi.1
    ...
    public KeySpec engineGetKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        ...
        if (cls.isAssignableFrom(OpenSSHPublicKeySpec.class) && (key instanceof DSAPublicKey)) {
            ...
            try {
                ...
                throw new IllegalArgumentException(au.com.woolworths.feature.rewards.everydayextras.signup.selections.a.k(e, new StringBuilder("unable to produce encoding: ")));
            }
        }
        ...
        try {
            ...
            throw new IllegalArgumentException(au.com.woolworths.feature.rewards.everydayextras.signup.selections.a.k(e2, new StringBuilder("unable to produce encoding: ")));
        }
    }
    ...
    public PrivateKey generatePrivate(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        throw new IOException(kotlin.reflect.jvm.internal.impl.types.checker.a.g("algorithm identifier ", algorithm, " in key not recognised"));
    }
