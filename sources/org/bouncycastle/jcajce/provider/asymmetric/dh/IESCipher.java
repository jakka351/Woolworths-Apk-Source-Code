...
public class IESCipher extends BaseCipherSpi {
    ...
    public void engineSetMode(String str) throws NoSuchAlgorithmException {
        ...
        if (upperCase.equals("NONE")) {
            ...
            if (!upperCase.equals("DHAES")) {
                throw new IllegalArgumentException(YU.a.A("can't support mode ", str));
            }
            z = true;
        }
        this.dhaesMode = z;
    ...
    public void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (i2 != 0 && (nonce == null || nonce.length != i2)) {
            throw new InvalidAlgorithmParameterException(YU.a.m(new StringBuilder("NONCE in IES Parameters needs to be "), this.ivLength, " bytes long"));
        }
        if (i == 1 || i == 3) {
