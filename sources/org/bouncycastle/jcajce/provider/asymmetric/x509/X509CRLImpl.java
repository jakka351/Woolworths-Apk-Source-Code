...
abstract class X509CRLImpl extends X509CRL {
    ...
    private void doVerify(PublicKey publicKey, SignatureCreator signatureCreator) throws NoSuchAlgorithmException, SignatureException, IOException, InvalidKeyException, CRLException, NoSuchProviderException, InvalidAlgorithmParameterException {
        ...
        if ((publicKey instanceof CompositePublicKey) && X509SignatureUtil.isCompositeAlgorithm(this.c.getSignatureAlgorithm())) {
            ...
            ASN1Sequence aSN1Sequence2 = ASN1Sequence.getInstance(ASN1BitString.getInstance(this.c.getSignature()).getBytes());
            boolean z = false;
            while (i != publicKeys.size()) {
                if (publicKeys.get(i) != null) {
                    ...
                    try {
                        checkSignature(publicKeys.get(i), signatureCreator.createSignature(X509SignatureUtil.getSignatureName(algorithmIdentifier)), algorithmIdentifier.getParameters(), ASN1BitString.getInstance(aSN1Sequence2.getObjectAt(i)).getBytes());
                        e = null;
                        z = true;
        ...
        if (!X509SignatureUtil.isCompositeAlgorithm(this.c.getSignatureAlgorithm())) {
            ...
            try {
                ...
                throw new SignatureException(a.k(e2, new StringBuilder("cannot decode signature parameters: ")));
            }
        }
        ASN1Sequence aSN1Sequence3 = ASN1Sequence.getInstance(this.c.getSignatureAlgorithm().getParameters());
        ASN1Sequence aSN1Sequence4 = ASN1Sequence.getInstance(ASN1BitString.getInstance(this.c.getSignature()).getBytes());
        boolean z2 = false;
        while (i != aSN1Sequence4.size()) {
            ...
            try {
                checkSignature(publicKey, signatureCreator.createSignature(X509SignatureUtil.getSignatureName(algorithmIdentifier2)), algorithmIdentifier2.getParameters(), ASN1BitString.getInstance(aSN1Sequence4.getObjectAt(i)).getBytes());
                e = null;
                z2 = true;
    ...
    */
    ...
    @Override // java.security.cert.X509CRL
    public void verify(PublicKey publicKey) throws NoSuchAlgorithmException, SignatureException, IOException, InvalidKeyException, CRLException, NoSuchProviderException, InvalidAlgorithmParameterException {
    ...
    public byte[] getExtensionValue(String str) {
        ...
        try {
            ...
            throw new IllegalStateException(kotlin.reflect.jvm.internal.impl.types.checker.a.e(e, new StringBuilder("error parsing ")));
        }
    }

    @Override // java.security.cert.X509CRL
    public void verify(PublicKey publicKey, final String str) throws NoSuchAlgorithmException, SignatureException, IOException, InvalidKeyException, CRLException, NoSuchProviderException, InvalidAlgorithmParameterException {
