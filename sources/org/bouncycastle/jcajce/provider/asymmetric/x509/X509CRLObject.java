...
class X509CRLObject extends X509CRLImpl {
    ...
    private static String createSigAlgName(CertificateList certificateList) throws CRLException {
        try {
            ...
            throw new X509CRLException(a.f(e, new StringBuilder("CRL contents invalid: ")), e);
        }
    }
    ...
    private static byte[] createSigAlgParams(CertificateList certificateList) throws CRLException {
        try {
            ...
            throw new CRLException(android.support.v4.media.session.a.n(e, "CRL contents invalid: "));
        }
    }

    private X509CRLInternal getInternalCRL() throws IOException {
        byte[] encoded;
