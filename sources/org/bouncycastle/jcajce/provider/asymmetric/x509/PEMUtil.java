...
class PEMUtil {
    ...
    public static class Boundaries {
        ...
        private Boundaries(String str) {
            this._header = a.h("-----BEGIN ", str, "-----");
            this._footer = a.h("-----END ", str, "-----");
        }
    ...
    public PEMUtil(String str) {
        this._supportedBoundaries = new Boundaries[]{new Boundaries(str), new Boundaries(a.A("X509 ", str)), new Boundaries("PKCS7")};
    }
