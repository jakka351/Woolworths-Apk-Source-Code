...
public class RIPEMD256 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            StringBuilder sbE = a.e(new StringBuilder("Alg.Alias.MessageDigest."), TeleTrusTObjectIdentifiers.ripemd256, configurableProvider, "RIPEMD256", str);
            sbE.append("$HashMac");
            addHMACAlgorithm(configurableProvider, "RIPEMD256", sbE.toString(), YU.a.g(str, "$KeyGenerator"));
        }
    }
