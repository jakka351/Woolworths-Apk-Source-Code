...
public class RIPEMD320 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addHMACAlgorithm(configurableProvider, "RIPEMD320", a.o(org.bouncycastle.jcajce.provider.asymmetric.a.b(sb, str, "$Digest", configurableProvider, "MessageDigest.RIPEMD320"), str, "$HashMac"), a.g(str, "$KeyGenerator"));
        }
    }
