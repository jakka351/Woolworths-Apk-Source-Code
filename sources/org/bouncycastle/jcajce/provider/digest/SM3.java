...
public class SM3 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.h(sb, str, "$Digest", configurableProvider, "MessageDigest.SM3");
            ...
            StringBuilder sbE = a.e(new StringBuilder("Alg.Alias.MessageDigest."), GMObjectIdentifiers.sm3, configurableProvider, "SM3", str);
            sbE.append("$HashMac");
            addHMACAlgorithm(configurableProvider, "SM3", sbE.toString(), YU.a.g(str, "$KeyGenerator"));
