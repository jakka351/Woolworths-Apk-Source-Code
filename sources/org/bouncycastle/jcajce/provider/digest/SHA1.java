...
public class SHA1 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.h(sb, str, "$Digest", configurableProvider, "MessageDigest.SHA-1");
            ...
            StringBuilder sbE = a.e(sb2, aSN1ObjectIdentifier, configurableProvider, McElieceCCA2KeyGenParameterSpec.SHA1, str);
            sbE.append("$HashMac");
            addHMACAlgorithm(configurableProvider, "SHA1", sbE.toString(), YU.a.g(str, "$KeyGenerator"));
            ...
            sb3.append(str);
            a.i(sb3, "$SHA1Mac", configurableProvider, "Mac.PBEWITHHMACSHA1");
            ...
            configurableProvider.addAlgorithm("SecretKeyFactory.PBEWITHHMACSHA1", a.a("Alg.Alias.Mac." + aSN1ObjectIdentifier, "PBEWITHHMACSHA", str, "$PBEWithMacKeyFactory", configurableProvider));
        }
    }
