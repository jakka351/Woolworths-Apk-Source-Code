...
public class RIPEMD160 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            StringBuilder sbE = a.e(new StringBuilder("Alg.Alias.MessageDigest."), TeleTrusTObjectIdentifiers.ripemd160, configurableProvider, "RIPEMD160", str);
            sbE.append("$HashMac");
            addHMACAlgorithm(configurableProvider, "RIPEMD160", sbE.toString(), YU.a.g(str, "$KeyGenerator"));
            ...
            sb2.append(str);
            a.i(sb2, "$PBEWithHmac", configurableProvider, "Mac.PBEWITHHMACRIPEMD160");
        }
    }
