...
public class GOST3411 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.h(sb, str, "$Digest", configurableProvider, "MessageDigest.GOST3411");
            ...
            StringBuilder sbE = a.e(sb2, aSN1ObjectIdentifier, configurableProvider, "GOST3411", str);
            sbE.append("$HashMac");
            addHMACAlgorithm(configurableProvider, "GOST3411", sbE.toString(), YU.a.g(str, "$KeyGenerator"));
            ...
            StringBuilder sbE2 = a.e(new StringBuilder("Alg.Alias.MessageDigest."), RosstandartObjectIdentifiers.id_tc26_gost_3411_12_256, configurableProvider, "GOST3411-2012-256", str);
            sbE2.append("$HashMac2012_256");
            addHMACAlgorithm(configurableProvider, "GOST3411-2012-256", sbE2.toString(), YU.a.g(str, "$KeyGenerator2012_256"));
            ...
            StringBuilder sbE3 = a.e(new StringBuilder("Alg.Alias.MessageDigest."), RosstandartObjectIdentifiers.id_tc26_gost_3411_12_512, configurableProvider, "GOST3411-2012-512", str);
            sbE3.append("$HashMac2012_512");
            addHMACAlgorithm(configurableProvider, "GOST3411-2012-512", sbE3.toString(), YU.a.g(str, "$KeyGenerator2012_512"));
            addHMACAlias(configurableProvider, "GOST3411-2012-512", RosstandartObjectIdentifiers.id_tc26_hmac_gost_3411_12_512);
            c.y(c.p(str, "$PBEWithMacKeyFactory", "SecretKeyFactory.PBEWITHHMACGOST3411", "Alg.Alias.SecretKeyFactory.", configurableProvider), aSN1ObjectIdentifier, configurableProvider, "PBEWITHHMACGOST3411");
        }
    }
