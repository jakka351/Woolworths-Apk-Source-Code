...
public class RSADigestSigner implements Signer {
    ...
    private byte[] derEncode(byte[] bArr) throws IOException {
        ...
        try {
            ...
            throw new IOException(a.l(e, new StringBuilder("malformed DigestInfo for NONEwithRSA hash: ")));
        }
    }
    ...
    public byte[] generateSignature() throws DataLengthException, CryptoException {
        ...
        try {
            ...
            throw new CryptoException(a.k(e, new StringBuilder("unable to encode signature: ")), e);
        }
    }
