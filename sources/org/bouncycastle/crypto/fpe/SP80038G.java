...
class SP80038G {
    ...
    public static int calculateB_FF1(int i, int i2) {
        int iNumberOfTrailingZeros = Integers.numberOfTrailingZeros(i);
        int iBitLength = iNumberOfTrailingZeros * i2;
        int i3 = i >>> iNumberOfTrailingZeros;
        if (i3 != 1) {
            iBitLength += BigInteger.valueOf(i3).pow(i2).bitLength();
        }
        return (iBitLength + 7) / 8;
    }

    public static BigInteger[] calculateModUV(BigInteger bigInteger, int i, int i2) {
        BigInteger bigIntegerPow = bigInteger.pow(i);
    ...
    public static byte[] calculateP_FF1(int i, byte b, int i2, int i3) {
    ...
    public static BigInteger calculateY_FF1(BlockCipher blockCipher, byte[] bArr, int i, int i2, int i3, byte[] bArr2, short[] sArr, RadixConverter radixConverter) throws IllegalStateException, DataLengthException {
        ...
        bArr3[i4] = (byte) i3;
        System.arraycopy(bArrAsUnsignedByteArray, 0, bArr3, i5 - bArrAsUnsignedByteArray.length, bArrAsUnsignedByteArray.length);
        ...
        if (i2 > 16) {
            ...
            for (int i7 = 1; i7 < i6; i7++) {
                int i8 = i7 * 16;
                System.arraycopy(bArrPrf, 0, bArr4, i8, 16);
        ...
        return num(bArrPrf, 0, i2);
    }

    public static BigInteger calculateY_FF3(BlockCipher blockCipher, byte[] bArr, int i, int i2, short[] sArr, RadixConverter radixConverter) throws IllegalStateException, DataLengthException {
        byte[] bArr2 = new byte[16];
        Pack.intToBigEndian(i2, bArr2, 0);
        xor(bArr, i, bArr2, 0, 4);
        byte[] bArrAsUnsignedByteArray = BigIntegers.asUnsignedByteArray(radixConverter.fromEncoding(sArr));
        if (16 - bArrAsUnsignedByteArray.length < 4) {
            throw new IllegalStateException("input out of range");
        }
        System.arraycopy(bArrAsUnsignedByteArray, 0, bArr2, 16 - bArrAsUnsignedByteArray.length, bArrAsUnsignedByteArray.length);
        rev(bArr2);
    ...
    public static void checkArgs(BlockCipher blockCipher, boolean z, int i, byte[] bArr, int i2, int i3) {
    ...
    public static void checkData(boolean z, int i, byte[] bArr, int i2, int i3) {
        checkLength(z, i, i3);
    ...
    private static void checkLength(boolean z, int i, int i2) {
        ...
        if (i2 >= 2) {
            ...
            if (Math.pow(d, i2) >= 1000000.0d) {
                if (!z && i2 > (iFloor = ((int) Math.floor(Math.log(TWO_TO_96) / Math.log(d))) * 2)) {
                    throw new IllegalArgumentException(a.d(iFloor, "maximum input length is "));
                }
                return;
            }
        }
    ...
    public static short[] decFF1(BlockCipher blockCipher, RadixConverter radixConverter, byte[] bArr, int i, int i2, int i3, short[] sArr, short[] sArr2) throws IllegalStateException, DataLengthException {
        int radix = radixConverter.getRadix();
        int length = bArr.length;
        int iCalculateB_FF1 = calculateB_FF1(radix, i3);
        int i4 = (iCalculateB_FF1 + 7) & (-4);
        byte[] bArrCalculateP_FF1 = calculateP_FF1(radix, (byte) i2, i, length);
        BigInteger[] bigIntegerArrCalculateModUV = calculateModUV(BigInteger.valueOf(radix), i2, i3);
        int i5 = 9;
        short[] sArr3 = sArr2;
        int i6 = i2;
        short[] sArr4 = sArr;
        while (i5 >= 0) {
            int i7 = iCalculateB_FF1;
            byte[] bArr2 = bArrCalculateP_FF1;
            int i8 = i5;
            i6 = i - i6;
            radixConverter.toEncoding(radixConverter.fromEncoding(sArr3).subtract(calculateY_FF1(blockCipher, bArr, i7, i4, i8, bArr2, sArr4, radixConverter)).mod(bigIntegerArrCalculateModUV[i8 & 1]), i6, sArr3);
            i5 = i8 - 1;
            short[] sArr5 = sArr3;
            sArr3 = sArr4;
            sArr4 = sArr5;
    ...
    private static short[] decFF3_1(BlockCipher blockCipher, RadixConverter radixConverter, byte[] bArr, int i, int i2, int i3, short[] sArr, short[] sArr2) throws IllegalStateException, DataLengthException {
        BigInteger[] bigIntegerArrCalculateModUV = calculateModUV(BigInteger.valueOf(radixConverter.getRadix()), i2, i3);
        rev(sArr);
        rev(sArr2);
        short[] sArr3 = sArr;
        short[] sArr4 = sArr2;
        ...
        while (i4 >= 0) {
            ...
            radixConverter2.toEncoding(radixConverter2.fromEncoding(sArr4).subtract(calculateY_FF3(blockCipher2, bArr, 4 - (i5 * 4), i4, sArr3, radixConverter2)).mod(bigIntegerArrCalculateModUV[1 - i5]), i3, sArr4);
            i4--;
            short[] sArr5 = sArr3;
            sArr3 = sArr4;
            sArr4 = sArr5;
    ...
    public static byte[] decryptFF3(BlockCipher blockCipher, RadixConverter radixConverter, byte[] bArr, byte[] bArr2, int i, int i2) {
    ...
    private static short[] encFF1(BlockCipher blockCipher, RadixConverter radixConverter, byte[] bArr, int i, int i2, int i3, short[] sArr, short[] sArr2) throws IllegalStateException, DataLengthException {
        int radix = radixConverter.getRadix();
        int length = bArr.length;
        int iCalculateB_FF1 = calculateB_FF1(radix, i3);
        int i4 = (iCalculateB_FF1 + 7) & (-4);
        ...
        while (i5 < 10) {
            ...
            int i8 = i5;
            i6 = i - i6;
            radixConverter.toEncoding(radixConverter.fromEncoding(sArr3).add(calculateY_FF1(blockCipher, bArr, i7, i4, i8, bArr2, sArr4, radixConverter)).mod(bigIntegerArrCalculateModUV[i8 & 1]), i6, sArr3);
            i5 = i8 + 1;
            short[] sArr5 = sArr3;
            sArr3 = sArr4;
            sArr4 = sArr5;
    ...
    private static short[] encFF3_1(BlockCipher blockCipher, RadixConverter radixConverter, byte[] bArr, int i, int i2, int i3, short[] sArr, short[] sArr2) throws IllegalStateException, DataLengthException {
        BigInteger[] bigIntegerArrCalculateModUV = calculateModUV(BigInteger.valueOf(radixConverter.getRadix()), i2, i3);
        rev(sArr);
        rev(sArr2);
        short[] sArr3 = sArr2;
        ...
        while (i4 < 8) {
            ...
            BlockCipher blockCipher2 = blockCipher;
            RadixConverter radixConverter2 = radixConverter;
            radixConverter2.toEncoding(radixConverter2.fromEncoding(sArr).add(calculateY_FF3(blockCipher2, bArr, 4 - (i5 * 4), i4, sArr3, radixConverter2)).mod(bigIntegerArrCalculateModUV[1 - i5]), i2, sArr);
            i4++;
            short[] sArr4 = sArr3;
            sArr3 = sArr;
            sArr = sArr4;
    ...
    public static byte[] encryptFF3(BlockCipher blockCipher, RadixConverter radixConverter, byte[] bArr, byte[] bArr2, int i, int i2) {
        checkArgs(blockCipher, false, radixConverter.getRadix(), bArr2, i, i2);
        if (bArr.length == 8) {
    ...
    public static short[] encryptFF3w(BlockCipher blockCipher, RadixConverter radixConverter, byte[] bArr, short[] sArr, int i, int i2) {
        checkArgs(blockCipher, false, radixConverter.getRadix(), sArr, i, i2);
        if (bArr.length == 8) {
    ...
    public static byte[] implDecryptFF3(BlockCipher blockCipher, RadixConverter radixConverter, byte[] bArr, byte[] bArr2, int i, int i2) {
        int i3 = i2 / 2;
        int i4 = i2 - i3;
        return toByte(decFF3_1(blockCipher, radixConverter, bArr, i2, i3, i4, toShort(bArr2, i, i4), toShort(bArr2, i + i4, i3)));
    }

    public static short[] implDecryptFF3w(BlockCipher blockCipher, RadixConverter radixConverter, byte[] bArr, short[] sArr, int i, int i2) {
        int i3 = i2 / 2;
        int i4 = i2 - i3;
    ...
    public static byte[] implEncryptFF3(BlockCipher blockCipher, RadixConverter radixConverter, byte[] bArr, byte[] bArr2, int i, int i2) {
        int i3 = i2 / 2;
        int i4 = i2 - i3;
        return toByte(encFF3_1(blockCipher, radixConverter, bArr, i2, i3, i4, toShort(bArr2, i, i4), toShort(bArr2, i + i4, i3)));
    }

    public static short[] implEncryptFF3w(BlockCipher blockCipher, RadixConverter radixConverter, byte[] bArr, short[] sArr, int i, int i2) {
        int i3 = i2 / 2;
        int i4 = i2 - i3;
        short[] sArr2 = new short[i4];
        short[] sArr3 = new short[i3];
    ...
    public static BigInteger num(byte[] bArr, int i, int i2) {
    ...
    public static void checkArgs(BlockCipher blockCipher, boolean z, int i, short[] sArr, int i2, int i3) {
        checkCipher(blockCipher);
        if (i < 2 || i > 65536) {
            throw new IllegalArgumentException();
        }
    ...
    public static void checkData(boolean z, int i, short[] sArr, int i2, int i3) {
        checkLength(z, i, i3);
        for (int i4 = 0; i4 < i3; i4++) {
            if ((sArr[i2 + i4] & HPKE.aead_EXPORT_ONLY) >= i) {
                throw new IllegalArgumentException("input data outside of radix");
            }
        }
    }
