...
public final class SerpentEngine extends SerpentEngineBase {
    ...
    public void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        int iLittleEndianToInt = this.wKey[131] ^ Pack.littleEndianToInt(bArr, i + 12);
        int[] iArr = {this.wKey[128] ^ Pack.littleEndianToInt(bArr, i), this.wKey[129] ^ Pack.littleEndianToInt(bArr, i + 4), this.wKey[130] ^ Pack.littleEndianToInt(bArr, i + 8), iLittleEndianToInt};
        ...
        Pack.intToLittleEndian(this.wKey[3] ^ iArr[3], bArr2, i2 + 12);
    }
