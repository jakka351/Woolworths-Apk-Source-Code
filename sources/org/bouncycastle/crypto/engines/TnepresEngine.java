...
public final class TnepresEngine extends SerpentEngineBase {
    ...
    public void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        int[] iArr = {iBigEndianToInt, this.wKey[129] ^ Pack.bigEndianToInt(bArr, i + 8), this.wKey[130] ^ Pack.bigEndianToInt(bArr, i + 4), this.wKey[131] ^ Pack.bigEndianToInt(bArr, i)};
        int iBigEndianToInt = this.wKey[128] ^ Pack.bigEndianToInt(bArr, i + 12);
        ...
        Pack.intToBigEndian(this.wKey[0] ^ iArr[0], bArr2, i2 + 12);
    }

    @Override // org.bouncycastle.crypto.engines.SerpentEngineBase
    public void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        int[] iArr = {iBigEndianToInt, Pack.bigEndianToInt(bArr, i + 8), Pack.bigEndianToInt(bArr, i + 4), Pack.bigEndianToInt(bArr, i)};
