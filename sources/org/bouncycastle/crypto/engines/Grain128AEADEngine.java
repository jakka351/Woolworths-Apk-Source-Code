...
public class Grain128AEADEngine implements AEADCipher {
    ...
    private void doProcessAADBytes(byte[] bArr, int i, int i2) {
        ...
        if (i2 < 128) {
            ...
            int iLen_length = len_length(i2);
            byte[] bArr3 = new byte[iLen_length + 1 + i2];
            bArr3[0] = (byte) (iLen_length | 128);
            int i4 = i2;
            int i5 = 0;
            while (i5 < iLen_length) {
                i5++;
                bArr3[i5] = (byte) i4;
                i4 >>>= 8;
            }
    ...
    public int doFinal(byte[] bArr, int i) throws InvalidCipherTextException, IllegalStateException {
        ...
        System.arraycopy(bArrIntToLittleEndian, 0, bArr, i, bArrIntToLittleEndian.length);
        reset(false);
