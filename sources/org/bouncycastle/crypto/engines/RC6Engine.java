...
public class RC6Engine implements BlockCipher {
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i4 = 20;
        while (i4 >= 1) {
            int iRotateLeft = rotateLeft(a.B(iRotateRight, 2, 1, iRotateRight), 5);
            int iRotateLeft2 = rotateLeft(a.B(i3, 2, 1, i3), 5);
            int i5 = i4 * 2;
    ...
    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i5 = 1;
        while (i5 <= 20) {
            int iRotateLeft = rotateLeft(a.B(i3, 2, 1, i3), 5);
            int iRotateLeft2 = rotateLeft(a.B(i4, 2, 1, i4), 5);
            int i6 = i5 * 2;
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        if (!(cipherParameters instanceof KeyParameter)) {
            throw new IllegalArgumentException(kotlin.reflect.jvm.internal.impl.types.checker.a.h("invalid parameter passed to RC6 init - ", cipherParameters));
        }
