...
public final class TwofishEngine implements BlockCipher {
    ...
    private void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (i3 < 16) {
            ...
            iLittleEndianToInt4 = Integers.rotateLeft(iLittleEndianToInt4, 1) ^ (((iFe32_3 * i4) + iFe32_0) + this.gSubKeys[i5 + 1]);
            int iFe32_02 = Fe32_0(iLittleEndianToInt3);
            int iFe32_32 = Fe32_3(iLittleEndianToInt4);
            int i6 = i4;
            int i7 = i5 + 3;
            ...
            i5 += 4;
            iLittleEndianToInt2 = Integers.rotateLeft(iLittleEndianToInt2, 1) ^ (((iFe32_32 * 2) + iFe32_02) + this.gSubKeys[i7]);
            i3 += 2;
            i4 = i6;
        }
