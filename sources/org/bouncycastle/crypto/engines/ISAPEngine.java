...
public class ISAPEngine implements AEADCipher {
    ...
    public abstract class ISAPAEAD_K implements ISAP_AEAD {
        ...
        private short ROL16(short s, int i) {
            int i2 = s & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH;
        ...
        public void thetaRhoPiChiIota(short[] sArr, short[] sArr2, short[] sArr3) {
            ...
            sArr2[0] = (short) (this.KeccakF400RoundConstants[19] ^ (((~sROL166) & sROL167) ^ s));
        ...
        public void thetaRhoPiChiIotaPrepareTheta(int i, short[] sArr, short[] sArr2, short[] sArr3) {
            ...
            sArr[24] = s5;
            short sROL169 = ROL16(s5, 14);
            short s6 = (short) (this.KeccakF400RoundConstants[i] ^ (((~sROL166) & sROL167) ^ s));
            sArr2[0] = s6;
            sArr3[0] = s6;
            ...
            short s18 = (short) (((~sROL1613) & sROL1614) ^ sROL1612);
            sArr2[7] = s18;
            ...
            short s28 = (short) (((~sROL1618) & sROL1619) ^ sROL1617);
            sArr2[12] = s28;
            sArr3[2] = (short) (s28 ^ sArr3[2]);
            short s29 = (short) (((~sROL1619) & sROL1615) ^ sROL1618);
            sArr2[13] = s29;
            ...
            short s49 = (short) (sROL1628 ^ ((~sROL1629) & sROL1625));
            sArr2[23] = s49;
    ...
    public class ISAPAEAD_K_128A extends ISAPAEAD_K {
        public ISAPAEAD_K_128A() {
            super();
            this.ISAP_IV1_16 = new short[]{-32767, 400, jxxxxxj.iii00690069i0069, 2056};
            this.ISAP_IV2_16 = new short[]{-32766, 400, jxxxxxj.iii00690069i0069, 2056};
            this.ISAP_IV3_16 = new short[]{-32765, 400, jxxxxxj.iii00690069i0069, 2056};
        }
