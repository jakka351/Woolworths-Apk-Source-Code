...
public class GOST3412_2015Engine implements BlockCipher {
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        if (cipherParameters instanceof KeyParameter) {
            ...
            throw new IllegalArgumentException(kotlin.reflect.jvm.internal.impl.types.checker.a.h("invalid parameter passed to GOST3412_2015 init - ", cipherParameters));
        }
    }
