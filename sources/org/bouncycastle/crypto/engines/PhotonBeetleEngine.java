...
public class PhotonBeetleEngine implements AEADCipher {
    ...
    private void rhoohr(byte[] bArr, int i, byte[] bArr2, int i2, int i3) {
        ...
        int iMin = Math.min(i3, this.RATE_INBYTES_HALF);
        int i6 = 0;
        while (true) {
    ...
    public int doFinal(byte[] bArr, int i) throws InvalidCipherTextException, IllegalStateException {
        ...
        byte bSelect = select(i2 != 0, length % this.RATE_INBYTES == 0, (byte) 3, (byte) 4);
        byte bSelect2 = select(length != 0, i2 % this.RATE_INBYTES == 0, (byte) 5, (byte) 6);
        if (length != 0) {
            ...
            bArr5[i10] = (byte) ((bSelect << this.LAST_THREE_BITS_OFFSET) ^ bArr5[i10]);
        }
        if (i2 != 0) {
            ...
            while (i13 < i12 - 1) {
                ...
                rhoohr(bArr, (i13 * i14) + i, byteArray, i13 * i14, i14);
                i13++;
            }
            ...
            int i16 = i2 - (i13 * i15);
            photonBeetleEngine.rhoohr(bArr2, (i13 * i15) + i, byteArray, i13 * i15, i16);
            ...
            bArr7[i17] = (byte) (bArr7[i17] ^ (bSelect2 << photonBeetleEngine.LAST_THREE_BITS_OFFSET));
        } else {
            photonBeetleEngine = this;
            bArr2 = bArr;
        }
