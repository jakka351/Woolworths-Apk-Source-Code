...
public class EthereumIESEngine {
    ...
    private byte[] decryptBlock(byte[] bArr, int i, int i2) throws InvalidCipherTextException, IllegalStateException, DataLengthException, IllegalArgumentException {
        ...
        if (this.cipher == null) {
            ...
            byte[] bArr10 = new byte[this.cipher.getOutputSize((i2 - this.V.length) - this.mac.getMacSize())];
            BufferedBlockCipher bufferedBlockCipher = this.cipher;
            byte[] bArr11 = this.V;
            bArr3 = bArr;
            iProcessBytes = bufferedBlockCipher.processBytes(bArr3, i + bArr11.length, (i2 - bArr11.length) - this.mac.getMacSize(), bArr10, 0);
            bArr4 = bArr10;
        }
        ...
        Mac mac2 = this.mac;
        byte[] bArr15 = this.V;
        mac2.update(bArr3, i + bArr15.length, (i2 - bArr15.length) - length2);
        if (encodingV != null) {
    ...
    private byte[] encryptBlock(byte[] bArr, int i, int i2) throws InvalidCipherTextException, IllegalStateException, DataLengthException, IllegalArgumentException {
        ...
        if (this.cipher == null) {
            ...
            i2 = this.cipher.doFinal(bArr9, iProcessBytes) + iProcessBytes;
            bArr2 = bArr7;
            bArr3 = bArr9;
        }
        byte[] encodingV = this.param.getEncodingV();
