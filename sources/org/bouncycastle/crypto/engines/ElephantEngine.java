...
public class ElephantEngine implements AEADCipher {
    ...
    private void checkAad() {
        ...
        if (i == 5) {
            throw new IllegalArgumentException(a.o(new StringBuilder(), this.algorithmName, " cannot be reused for encryption"));
        }
        if (i == 7) {
            throw new IllegalArgumentException(a.o(new StringBuilder(), this.algorithmName, " cannot process AAD when the length of the ciphertext to be processed exceeds the a block size"));
        }
        if (i == 8) {
            throw new IllegalArgumentException(a.o(new StringBuilder(), this.algorithmName, " cannot process AAD when the length of the plaintext to be processed exceeds the a block size"));
        }
    }
    ...
    */
    ...
    public int doFinal(byte[] bArr, int i) throws InvalidCipherTextException, IllegalStateException {
        ...
        int i3;
        if (!this.initialised) {
            throw new IllegalArgumentException(a.o(new StringBuilder(), this.algorithmName, " needs call init function before doFinal"));
        }
        ...
        int i8 = ((i6 * i7) + i4) - (this.forEncryption ? (byte) 0 : this.CRYPTO_ABYTES);
        ...
        int iProcessBytes = processBytes(this.inputMessage, bArr, i, Math.max(i9 + i2, i11), i3, i10, i8, i11 + 1) + i;
    ...
    public int getOutputSize(int i) {
        ...
        if (i2 != 1) {
            if (i2 == 3) {
                throw new IllegalArgumentException(a.o(new StringBuilder(), this.algorithmName, " needs call init function before getUpdateOutputSize"));
            }
            if (i2 == 4 || i2 == 5) {
                return 0;
            }
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (!(cipherParameters instanceof ParametersWithIV)) {
            throw new IllegalArgumentException(a.o(new StringBuilder(), this.algorithmName, " init parameters must include an IV"));
        }
        ParametersWithIV parametersWithIV = (ParametersWithIV) cipherParameters;
        byte[] iv = parametersWithIV.getIV();
        this.npub = iv;
        if (iv == null || iv.length != 12) {
            throw new IllegalArgumentException(a.o(new StringBuilder(), this.algorithmName, " requires exactly 12 bytes of IV"));
        }
        if (!(parametersWithIV.getParameters() instanceof KeyParameter)) {
            throw new IllegalArgumentException(a.o(new StringBuilder(), this.algorithmName, " init parameters must include a key"));
        }
        byte[] key = ((KeyParameter) parametersWithIV.getParameters()).getKey();
        if (key.length != 16) {
            throw new IllegalArgumentException(a.o(new StringBuilder(), this.algorithmName, " key must be 128 bits long"));
        }
