...
public class SkeinEngine implements Memoable {
    ...
    public class UBI {
        ...
        public void update(byte[] bArr, int i, int i2, long[] jArr) throws IllegalStateException, DataLengthException {
            int i3 = 0;
            while (i2 > i3) {
    ...
    public SkeinEngine(int i, int i2) {
        ...
        if (i2 % 8 != 0) {
            throw new IllegalArgumentException(a.d(i2, "Output size must be a multiple of 8 bits. :"));
        }
    ...
    private void output(long j, byte[] bArr, int i, int i2) throws IllegalStateException, DataLengthException {
    ...
    private void ubiComplete(int i, byte[] bArr) throws IllegalStateException, DataLengthException {
        ubiInit(i);
