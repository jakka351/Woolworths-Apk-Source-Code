...
public class Blake3Digest implements ExtendedDigest, Memoable, Xof {
    ...
    private void mixG(int i, int i2, int i3, int i4, int i5) {
        ...
        int[] iArr = this.theV;
        int i7 = i6 + 1;
        int i8 = iArr[i3] + this.theM[this.theIndices[i6]] + iArr[i2];
        iArr[i2] = i8;
        iArr[i5] = Integers.rotateRight(iArr[i5] ^ i8, 16);
        int[] iArr2 = this.theV;
        int i9 = iArr2[i4] + iArr2[i5];
        iArr2[i4] = i9;
        iArr2[i3] = Integers.rotateRight(i9 ^ iArr2[i3], 12);
        int[] iArr3 = this.theV;
        int i10 = iArr3[i3] + this.theM[this.theIndices[i7]] + iArr3[i2];
        iArr3[i2] = i10;
        iArr3[i5] = Integers.rotateRight(iArr3[i5] ^ i10, 8);
        int[] iArr4 = this.theV;
        int i11 = iArr4[i4] + iArr4[i5];
        iArr4[i4] = i11;
        iArr4[i3] = Integers.rotateRight(i11 ^ iArr4[i3], 7);
    }
        ...
        if (i2 >= 0) {
            ...
            if (j < 0 || i2 <= j) {
                ...
                if (i4 < 64) {
                    ...
                    System.arraycopy(this.theBuffer, this.thePos, bArr, i, iMin);
                    this.thePos += iMin;
                    i += iMin;
                    i3 = i2 - iMin;
                } else {
                ...
                while (i3 > 0) {
                    ...
                    System.arraycopy(this.theBuffer, 0, bArr, i, iMin2);
                    this.thePos += iMin2;
                    i += iMin2;
                    i3 -= iMin2;
                }
