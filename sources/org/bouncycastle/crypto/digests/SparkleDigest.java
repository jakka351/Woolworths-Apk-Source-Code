...
public class SparkleDigest implements ExtendedDigest {
    ...
    public int doFinal(byte[] bArr, int i) {
        if (i > bArr.length - this.DIGEST_BYTES) {
            throw new OutputLengthException(a.o(new StringBuilder(), this.algorithmName, " input buffer too short"));
        }
    ...
    public void update(byte[] bArr, int i, int i2) {
        if (i > bArr.length - i2) {
            throw new DataLengthException(a.o(new StringBuilder(), this.algorithmName, " input buffer too short"));
        }
        if (i2 < 1) {
            return;
        }
