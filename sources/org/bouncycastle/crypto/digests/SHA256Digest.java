...
public class SHA256Digest extends GeneralDigest implements SavableDigest {
    ...
    public void processBlock() {
        ...
        for (int i7 = 0; i7 < 8; i7++) {
            ...
            int[] iArr3 = K;
            int i8 = iSum1 + iArr3[i6] + this.X[i6] + i5;
            int i9 = iSum04 + i8;
            int iSum05 = Sum0(iSum0) + Maj(iSum0, iSum02, iSum03) + i8;
            int i10 = i6 + 1;
            int iSum12 = Sum1(i9) + Ch(i9, i2, i3) + iArr3[i10] + this.X[i10] + i4;
            int i11 = iSum03 + iSum12;
            int iSum06 = Sum0(iSum05) + Maj(iSum05, iSum0, iSum02) + iSum12;
            int i12 = i6 + 2;
            int iSum13 = Sum1(i11) + Ch(i11, i9, i2) + iArr3[i12] + this.X[i12] + i3;
            int i13 = iSum02 + iSum13;
            int iSum07 = Sum0(iSum06) + Maj(iSum06, iSum05, iSum0) + iSum13;
            int i14 = i6 + 3;
            int iSum14 = Sum1(i13) + Ch(i13, i11, i9) + iArr3[i14] + this.X[i14] + i2;
            int i15 = iSum0 + iSum14;
            int iSum08 = Sum0(iSum07) + Maj(iSum07, iSum06, iSum05) + iSum14;
            int i16 = i6 + 4;
            int iSum15 = Sum1(i15) + Ch(i15, i13, i11) + iArr3[i16] + this.X[i16] + i9;
            i5 = iSum05 + iSum15;
            iSum04 = Sum0(iSum08) + Maj(iSum08, iSum07, iSum06) + iSum15;
            int i17 = i6 + 5;
            int iSum16 = Sum1(i5) + Ch(i5, i15, i13) + iArr3[i17] + this.X[i17] + i11;
            i4 = iSum06 + iSum16;
            iSum03 = Sum0(iSum04) + Maj(iSum04, iSum08, iSum07) + iSum16;
            int i18 = i6 + 6;
            int iSum17 = Sum1(i4) + Ch(i4, i5, i15) + iArr3[i18] + this.X[i18] + i13;
            i3 = iSum07 + iSum17;
            iSum02 = Sum0(iSum03) + Maj(iSum03, iSum04, iSum08) + iSum17;
            int i19 = i6 + 7;
            int iSum18 = Sum1(i3) + Ch(i3, i4, i5) + iArr3[i19] + this.X[i19] + i15;
            i2 = iSum08 + iSum18;
