...
public abstract class LongDigest implements ExtendedDigest, Memoable, EncodableDigest {
    ...
    public void processBlock() {
        ...
        while (i2 < 10) {
            ...
            long j15 = j12;
            long j16 = j9;
            long jSum1 = Sum1(j12) + Ch(j12, j14, j9);
            long[] jArr3 = K;
            int i4 = i3 + 1;
            long j17 = jSum1 + jArr3[i3] + this.W[i3] + j10;
            long j18 = j6 + j17;
            long j19 = j11;
            long j20 = j13;
            long j21 = j8;
            long jSum0 = Sum0(j11) + Maj(j19, j20, j21) + j17;
            long jSum12 = Sum1(j18) + Ch(j18, j15, j14) + jArr3[i4];
            int i5 = i3 + 2;
            long j22 = jSum12 + this.W[i4] + j16;
            long j23 = j21 + j22;
            long jSum02 = Sum0(jSum0) + Maj(jSum0, j19, j20) + j22;
            int i6 = i3 + 3;
            long jSum13 = Sum1(j23) + Ch(j23, j18, j15) + jArr3[i5] + this.W[i5] + j14;
            long j24 = j20 + jSum13;
            long jSum03 = Sum0(jSum02) + Maj(jSum02, jSum0, j19) + jSum13;
            long jSum14 = Sum1(j24) + Ch(j24, j23, j18) + jArr3[i6];
            int i7 = i3 + 4;
            long j25 = jSum14 + this.W[i6] + j15;
            long j26 = j19 + j25;
            long jSum04 = Sum0(jSum03) + Maj(jSum03, jSum02, jSum0) + j25;
            long jSum15 = Sum1(j26) + Ch(j26, j24, j23) + jArr3[i7];
            int i8 = i3 + 5;
            long j27 = jSum15 + this.W[i7] + j18;
            long j28 = jSum0 + j27;
            long jSum05 = Sum0(jSum04) + Maj(jSum04, jSum03, jSum02) + j27;
            long jSum16 = Sum1(j28) + Ch(j28, j26, j24) + jArr3[i8];
            int i9 = i3 + 6;
            long j29 = jSum16 + this.W[i8] + j23;
            long j30 = jSum02 + j29;
            long jSum06 = Sum0(jSum05) + Maj(jSum05, jSum04, jSum03) + j29;
            int i10 = i3 + 7;
            long jSum17 = Sum1(j30) + Ch(j30, j28, j26) + jArr3[i9] + this.W[i9] + j24;
            long j31 = jSum03 + jSum17;
            long jSum07 = Sum0(jSum06) + Maj(jSum06, jSum05, jSum04) + jSum17;
            i3 += 8;
            long jSum18 = Sum1(j31) + Ch(j31, j30, j28) + jArr3[i10] + this.W[i10] + j26;
