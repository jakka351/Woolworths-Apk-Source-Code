...
public class AEAD {
    ...
    public byte[] open(byte[] bArr, byte[] bArr2) throws InvalidCipherTextException, IllegalStateException, DataLengthException, IllegalArgumentException {
        short s = this.aeadId;
        if (s != 1 && s != 2 && s != 3) {
    ...
    public byte[] seal(byte[] bArr, byte[] bArr2) throws InvalidCipherTextException, IllegalStateException, DataLengthException, IllegalArgumentException {
        short s = this.aeadId;
        if (s != 1 && s != 2 && s != 3) {
            throw new IllegalStateException("Export only mode, cannot be used to seal/open");
        }
