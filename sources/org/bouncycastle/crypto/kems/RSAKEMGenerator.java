...
public class RSAKEMGenerator implements EncapsulatedSecretGenerator {
    ...
    public static byte[] generateKey(DerivationFunction derivationFunction, BigInteger bigInteger, BigInteger bigInteger2, int i) throws DataLengthException, IllegalArgumentException {
