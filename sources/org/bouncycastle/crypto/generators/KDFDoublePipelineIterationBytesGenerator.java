...
public class KDFDoublePipelineIterationBytesGenerator implements MacDerivationFunction {
    ...
    private void generateNext() throws IllegalStateException, DataLengthException {
        if (this.generatedBytes == 0) {
            ...
            this.prf.doFinal(this.f26800a, 0);
        } else {
            Mac mac2 = this.prf;
            byte[] bArr2 = this.f26800a;
            mac2.update(bArr2, 0, bArr2.length);
            this.prf.doFinal(this.f26800a, 0);
        }
        Mac mac3 = this.prf;
        byte[] bArr3 = this.f26800a;
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws IllegalStateException, DataLengthException, IllegalArgumentException {
        ...
        if (i4 < 0 || i4 >= this.maxSizeExcl) {
            throw new DataLengthException(a.m(new StringBuilder("Current KDFCTR may only be used for "), this.maxSizeExcl, " bytes"));
        }
        if (i3 % this.h == 0) {
            generateNext();
        }
