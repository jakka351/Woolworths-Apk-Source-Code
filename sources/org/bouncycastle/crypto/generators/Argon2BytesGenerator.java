...
public class Argon2BytesGenerator {
    ...
    private void digest(byte[] bArr, byte[] bArr2, int i, int i2) {
        ...
        for (int i3 = 1; i3 < this.parameters.getLanes(); i3++) {
            ...
            block.xorWith(this.memory[(i4 - 1) + (i3 * i4)]);
        }
        block.toBytes(bArr);
    ...
    private void fillSegment(FillBlock fillBlock, Position position) {
        ...
        int iC = a.C(position2.slice, this.segmentLength, position2.lane * this.laneLength, startingIndex);
        int prevOffset = getPrevOffset(iC);
        ...
        while (true) {
            ...
            long pseudoRandom = getPseudoRandom(fillBlock2, startingIndex, block, block2, i2, zIsDataIndependentAddressing);
            boolean z = zIsDataIndependentAddressing;
            ...
            zIsDataIndependentAddressing = z;
            prevOffset = i;
            blockClear = block;
            blockClear2 = block2;
        }
    ...
    private static void quarterRound(long[] jArr, int i, int i2, int i3, int i4) {
        ...
        long j2 = jArr[i2];
        long j3 = jArr[i3];
        long jF = androidx.compose.ui.input.pointer.a.f((j & M32L) * 2, M32L & j2, j2, j);
        long jRotateRight = Longs.rotateRight(j3 ^ jF, i4);
        jArr[i] = jF;
