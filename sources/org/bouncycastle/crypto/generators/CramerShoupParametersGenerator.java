...
public class CramerShoupParametersGenerator {
    ...
    public static class ParametersHelper {
        ...
        public static BigInteger[] generateSafePrimes(int i, int i2, SecureRandom secureRandom) throws IllegalArgumentException {
    ...
    public CramerShoupParameters generateParameters(DHParameters dHParameters) {
        ...
        return new CramerShoupParameters(p, g, bigIntegerSelectGenerator, SHA256Digest.newInstance());
    }
}
