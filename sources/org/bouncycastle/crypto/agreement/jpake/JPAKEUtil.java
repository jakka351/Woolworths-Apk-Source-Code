...
public class JPAKEUtil {
    ...
    public static BigInteger calculateMacTag(String str, String str2, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, BigInteger bigInteger5, Digest digest) throws IllegalStateException, DataLengthException {
    ...
    private static void updateMac(Mac mac, String str) throws IllegalStateException, DataLengthException {
        byte[] uTF8ByteArray = Strings.toUTF8ByteArray(str);
    ...
    public static void validateNotNull(Object obj, String str) {
        if (obj == null) {
            throw new NullPointerException(a.g(str, " must not be null"));
        }
    }

    public static void validateParticipantIdsDiffer(String str, String str2) throws CryptoException {
        if (str.equals(str2)) {
            throw new CryptoException(a.h("Both participants are using the same participantId (", str, "). This is not allowed. Each participant must use a unique participantId."));
        }
    }

    public static void validateParticipantIdsEqual(String str, String str2) throws CryptoException {
        if (!str.equals(str2)) {
            throw new CryptoException(a.j("Received payload from incorrect partner (", str2, "). Expected to receive payload from ", str, "."));
        }
    }
    ...
    private static void updateMac(Mac mac, BigInteger bigInteger) throws IllegalStateException, DataLengthException {
        byte[] bArrAsUnsignedByteArray = BigIntegers.asUnsignedByteArray(bigInteger);
