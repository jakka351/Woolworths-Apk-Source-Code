...
public class SRP6Client {
    ...
    private BigInteger calculateS() {
        ...
        return this.B.subtract(this.g.modPow(this.x, this.N).multiply(bigIntegerCalculateK).mod(this.N)).mod(this.N).modPow(this.u.multiply(this.x).add(this.f26796a), this.N);
    }
    ...
    public BigInteger generateClientCredentials(byte[] bArr, byte[] bArr2, byte[] bArr3) {
        ...
        this.f26796a = bigIntegerSelectPrivateValue;
