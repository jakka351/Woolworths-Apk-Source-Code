...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    ...
    public BouncyCastleProvider() {
        super(PROVIDER_NAME, 1.75d, info);
    ...
    public void addAlgorithm(String str, String str2) {
        if (containsKey(str)) {
            throw new IllegalStateException(a.h("duplicate provider key (", str, ") found"));
        }
        put(str, str2);
    }
    ...
    public void addAttributes(String str, Map<String, String> map) {
        ...
        for (String str2 : map.keySet()) {
            ...
            if (containsKey(strO)) {
                throw new IllegalStateException(a.h("duplicate provider attribute key (", strO, ") found"));
            }
            put(strO, map.get(str2));
        }
    }
    ...
    public final Provider.Service getService(String str, String str2) {
        ...
        String strO = b.o(str, ".", Strings.toUpperCase(str2));
        Provider.Service service2 = this.serviceMap.get(strO);
        if (service2 != null) {
            return service2;
        }
        synchronized (this) {
            try {
                if (this.serviceMap.containsKey(strO)) {
                    service = this.serviceMap.get(strO);
                } else {
                    service = super.getService(str, str2);
                    if (service == null) {
                        return null;
                    }
                    this.serviceMap.put(strO, service);
