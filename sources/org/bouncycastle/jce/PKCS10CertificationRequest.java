...
public class PKCS10CertificationRequest extends CertificationRequest {
    ...
    public static String getSignatureName(AlgorithmIdentifier algorithmIdentifier) {
        ...
        return a.o(new StringBuilder(), getDigestAlgName(RSASSAPSSparams.getInstance(parameters).getHashAlgorithm().getAlgorithm()), "withRSAandMGF1");
    }
    ...
    private void setSignatureParameters(Signature signature, ASN1Encodable aSN1Encodable) throws NoSuchAlgorithmException, SignatureException, IOException, InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        try {
            ...
            throw new SignatureException(au.com.woolworths.feature.rewards.everydayextras.signup.selections.a.k(e2, new StringBuilder("IOException decoding parameters: ")));
        }
    }
    ...
    public boolean verify(PublicKey publicKey, String str) throws NoSuchAlgorithmException, SignatureException, IOException, InvalidKeyException, NoSuchProviderException, InvalidAlgorithmParameterException {
        ...
        try {
            ...
            throw new SignatureException(android.support.v4.media.session.a.n(e2, "exception encoding TBS cert request - "));
        }
    }
    ...
    */
    public PKCS10CertificationRequest(java.lang.String r5, org.bouncycastle.asn1.x509.X509Name r6, java.security.PublicKey r7, org.bouncycastle.asn1.ASN1Set r8, java.security.PrivateKey r9, java.lang.String r10) throws java.security.SignatureException, java.security.NoSuchAlgorithmException, java.security.InvalidKeyException, java.security.NoSuchProviderException {
        ...
        L8d:
            ...
            java.lang.String r5 = android.support.v4.media.session.a.n(r5, r7)
            r6.<init>(r5)
            throw r6
        L9a:
            java.lang.IllegalArgumentException r5 = new java.lang.IllegalArgumentException
