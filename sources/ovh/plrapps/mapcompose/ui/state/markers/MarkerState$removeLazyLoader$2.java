...
final class MarkerState$removeLazyLoader$2 extends Lambda implements Function1<MarkerData, Boolean> {
    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Object obj) {
        MarkerData it = (MarkerData) obj;
        Intrinsics.h(it, "it");
        return Boolean.valueOf(it.b instanceof RenderingStrategy.LazyLoading);
    }
}
