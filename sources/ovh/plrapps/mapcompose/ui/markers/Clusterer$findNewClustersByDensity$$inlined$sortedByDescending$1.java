...
public final class Clusterer$findNewClustersByDensity$$inlined$sortedByDescending$1<T> implements Comparator {
    @Override // java.util.Comparator
    public final int compare(Object obj, Object obj2) {
        ((MarkerWindow) ((Map.Entry) obj2).getValue()).getClass();
        ((MarkerWindow) ((Map.Entry) obj).getValue()).getClass();
