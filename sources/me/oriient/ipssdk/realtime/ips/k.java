...
public final class k implements AutomaticSessionStopper.Delegate {
    ...
    public final Object stopSession(EngineStopReason engineStopReason, Continuation continuation) {
        ...
        if (positioningState == 0) {
            ...
            Positioning.access$stopCalibrationImpl(positioning, engineStopReason, new IPSCompletionListener() { // from class: me.oriient.ipssdk.realtime.ips.Positioning$AutomaticSessionStopperDelegateImpl$stopSession$2$1
                ...
                public void onCompleted() {
                    ...
                    loggerAccess$getLogger2.d(str2, "automatic stopCalibrating onCompleted() called");
                    safeContinuation.resumeWith(new Outcome.Success(Unit.f24250a));
                }
                ...
                public void onError(@NotNull IPSError error) {
                    ...
                    String str2 = Positioning.f25840a;
                    Intrinsics.g(str2, "access$getTAG$p(...)");
                    loggerAccess$getLogger2.d(str2, "automatic stopCalibrating onError() called with: error = " + error);
            ...
            Positioning.access$stopPositioningImpl(positioning, engineStopReason, new IPSCompletionListener() { // from class: me.oriient.ipssdk.realtime.ips.Positioning$AutomaticSessionStopperDelegateImpl$stopSession$2$2
                @Override // me.oriient.ipssdk.api.listeners.IPSCompletionListener
                public void onCompleted() {
                    Logger loggerAccess$getLogger2 = Positioning.access$getLogger(Positioning.INSTANCE);
                    String str2 = Positioning.f25840a;
