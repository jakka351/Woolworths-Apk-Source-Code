...
public final class P1 extends SuspendLambda implements Function2 {
    ...
    public P1(EventTaggingManagerImpl eventTaggingManagerImpl, EventTagRecord eventTagRecord, Continuation continuation) {
    ...
    public final Object invoke(Object obj, Object obj2) {
        return new P1(this.b, this.c, (Continuation) obj2).invokeSuspend(Unit.f24250a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.f25990a = 1;
            if (EventTaggingManagerImpl.access$onRequestSuccess(eventTaggingManagerImpl, eventTagRecord, this) == coroutineSingletons) {
