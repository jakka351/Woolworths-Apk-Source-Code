...
public final class V1 extends SuspendLambda implements Function2 {
    ...
    public V1(EventTaggingRestServiceImpl eventTaggingRestServiceImpl, TagRequest tagRequest, User user, String str, IPSCompletionListener iPSCompletionListener, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new V1(this.b, this.c, this.d, this.e, this.f, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return ((V1) create((CoroutineScope) obj, (Continuation) obj2)).invokeSuspend(Unit.f24250a);
    }
