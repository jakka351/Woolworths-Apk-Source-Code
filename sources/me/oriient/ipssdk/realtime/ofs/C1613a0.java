...
/* renamed from: me.oriient.ipssdk.realtime.ofs.a0, reason: case insensitive filesystem */
/* loaded from: classes8.dex */
public final class C1613a0 extends SuspendLambda implements Function2 {
    ...
    public C1613a0(String str, IPSBuildingListener iPSBuildingListener, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new C1613a0(this.b, this.c, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Object obj, Object obj2) {
        return new C1613a0(this.b, this.c, (Continuation) obj2).invokeSuspend(Unit.f24250a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            String str = this.b;
            this.f26040a = 1;
            obj = buildingRepositoryAccess$getBuildingRepository.fetchBuildingByClientId(str, this);
        ...
        if (outcome instanceof Outcome.Failure) {
            ...
            IPSError ipsError = ((oriientError instanceof ServerError) && ((ServerError) oriientError).getCode() == 404) ? new Error(oriientError, 4, 2) : ExtensionsKt.toIpsError(oriientError);
            ValidationService.safeFailListener(iPSBuildingListener2, ipsError);
        }
        return Unit.f24250a;
    }
}
