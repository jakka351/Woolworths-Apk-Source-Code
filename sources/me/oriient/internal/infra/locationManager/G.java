...
public final class G extends SuspendLambda implements Function2 {
    ...
    public G(ProxyLocationManager proxyLocationManager, Continuation continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            SharedFlow<Error> errors = this.b.currentLocationManager.getErrors();
            F f = new F(this.b);
            this.f24936a = 1;
            if (errors.collect(f, this) == coroutineSingletons) {
