...
public final class LoginRequestBody$$serializer implements GeneratedSerializer<LoginRequestBody> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("me.oriient.internal.services.auth.rest.LoginRequestBody", loginRequestBody$$serializer, 1);
    ...
    @NotNull
    public LoginRequestBody deserialize(@NotNull Decoder decoder) {
        ...
        return new LoginRequestBody(i, strJ);
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public void serialize(@NotNull Encoder encoder, @NotNull LoginRequestBody value) {
        Intrinsics.h(encoder, "encoder");
        Intrinsics.h(value, "value");
        SerialDescriptor b = getB();
        CompositeEncoder compositeEncoderB = encoder.b(b);
        compositeEncoderB.p(b, 0, value.f25040a);
