...
public final class LoginResponse$$serializer implements GeneratedSerializer<LoginResponse> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("me.oriient.internal.services.auth.rest.LoginResponse", loginResponse$$serializer, 4);
        pluginGeneratedSerialDescriptor.k("isSuspended", false);
        pluginGeneratedSerialDescriptor.k("accessToken", false);
        pluginGeneratedSerialDescriptor.k("accessTokenExpiry", false);
        pluginGeneratedSerialDescriptor.k("spaces", false);
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{BooleanSerializer.f24779a, StringSerializer.f24821a, LongSerializer.f24804a, LoginResponse.e[3]};
    }
    ...
    public LoginResponse deserialize(@NotNull Decoder decoder) {
        ...
        KSerializer[] kSerializerArr = LoginResponse.e;
        int i = 0;
        boolean zB = false;
        String strJ = null;
        List list = null;
        ...
        return new LoginResponse(i, zB, strJ, jF, list);
    }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull LoginResponse value) {
        ...
        LoginResponse.a(value, compositeEncoderB, b);
