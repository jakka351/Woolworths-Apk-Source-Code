...
public final class N extends Lambda implements Function1 {
    ...
    public N(String str, String str2, S s) {
        super(1);
        this.f25329a = str;
        this.b = str2;
    }
    ...
    public final Object invoke(Object obj) {
        ...
        Intrinsics.h(db, "db");
        List<DbPlaiCategories> listExecuteAsList = db.getPlaiCategoriesQueries().getCategoryById(this.f25329a, this.b).executeAsList();
