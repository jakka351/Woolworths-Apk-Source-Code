...
/* renamed from: me.oriient.internal.services.dataManager.building.b, reason: case insensitive filesystem */
/* loaded from: classes7.dex */
public final class C1234b extends SuspendLambda implements Function2 {

    /* renamed from: a, reason: collision with root package name */
    public int f25099a;
    public /* synthetic */ Object b;

    public C1234b(Continuation continuation) {
        super(2, continuation);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        C1234b c1234b = new C1234b(continuation);
        c1234b.b = obj;
        return c1234b;
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        C1234b c1234b = new C1234b((Continuation) obj2);
        c1234b.b = (BuildingClientId) obj;
        return c1234b.invokeSuspend(Unit.f24250a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        this.f25099a = 1;
        D d = (D) wVar;
        Object stringData$default = RestHelper.DefaultImpls.getStringData$default((RestHelper) d.b.getD(), "BuildingRest", ((OriientApiProvider) d.f25093a.getD()).getOriientApi().getRealtimeUrl() + "/v8/buildings/" + buildingClientId.getValue() + "?includeEntrances=true&includeExternalRegions=true&isClientBuilding=true&includeKiosks=true", false, new z(spaceId), this, 4, null);
