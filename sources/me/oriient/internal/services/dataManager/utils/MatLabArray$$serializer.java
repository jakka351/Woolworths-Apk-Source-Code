...
public final class MatLabArray$$serializer<T> implements GeneratedSerializer<MatLabArray<T>> {
    ...
    private MatLabArray$$serializer() {
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("me.oriient.internal.services.dataManager.utils.MatLabArray", this, 2);
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull MatLabArray<T> value) {
        ...
        MatLabArray.write$Self$internal_publishRelease(value, compositeEncoderB, b, this.typeSerial0);
