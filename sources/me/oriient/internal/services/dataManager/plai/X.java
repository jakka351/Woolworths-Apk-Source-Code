...
public final class X extends Lambda implements Function1 {
    ...
    public static final X f25291a = new X();
    ...
    public final Object invoke(Object obj) {
        ...
        Iterable iterable = (Iterable) JsonSerializationKt.parseAsJson(responseString, Reflection.c(KTypeProjection.Companion.a(Reflection.b(PlaiUrlResponse.class))));
        ArrayList arrayList = new ArrayList(CollectionsKt.s(iterable, 10));
        Iterator it = iterable.iterator();
        while (it.hasNext()) {
            arrayList.add(((PlaiUrlResponse) it.next()).a());
        }
        return arrayList;
    }
}
