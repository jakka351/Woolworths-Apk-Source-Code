...
/* renamed from: me.oriient.internal.services.dataManager.plai.j, reason: case insensitive filesystem */
/* loaded from: classes7.dex */
public final class C1360j extends Lambda implements Function1 {
    ...
    public C1360j(String str, String str2) {
        super(1);
        this.f25302a = str;
        this.b = str2;
    }
    ...
    public final Object invoke(Object obj) {
        ...
        Intrinsics.h(db, "db");
        List<DbPlaiProducts> listExecuteAsList = db.getPlaiProductsQueries().getCustomerTagProducts(this.f25302a, this.b).executeAsList();
