...
@Metadata(d1 = {"\u00006\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0003J\u0018\u0010\b\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\n0\tHÖ\u0001¢\u0006\u0002\u0010\u000bJ\u0011\u0010\f\u001a\u00020\u00022\u0006\u0010\r\u001a\u00020\u000eHÖ\u0001J\u0019\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\u0002HÖ\u0001R\u0014\u0010\u0004\u001a\u00020\u00058VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u0014"}, d2 = {"me/oriient/internal/services/dataManager/region/PlacementResponse.$serializer", "Lkotlinx/serialization/internal/GeneratedSerializer;", "Lme/oriient/internal/services/dataManager/region/PlacementResponse;", "()V", "descriptor", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "childSerializers", "", "Lkotlinx/serialization/KSerializer;", "()[Lkotlinx/serialization/KSerializer;", "deserialize", "decoder", "Lkotlinx/serialization/encoding/Decoder;", "serialize", "", "encoder", "Lkotlinx/serialization/encoding/Encoder;", "value", "internal_publishRelease"}, k = 1, mv = {1, 9, 0}, xi = 48)
@Deprecated
...
public final class PlacementResponse$$serializer implements GeneratedSerializer<PlacementResponse> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("me.oriient.internal.services.dataManager.region.PlacementResponse", placementResponse$$serializer, 8);
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{BuiltinSerializersKt.d(stringSerializer), BuiltinSerializersKt.d(IntSerializer.f24800a), BuiltinSerializersKt.d(stringSerializer), BuiltinSerializersKt.d(kSerializerArr[3]), BuiltinSerializersKt.d(kSerializerArr[4]), BuiltinSerializersKt.d(kSerializerArr[5]), BuiltinSerializersKt.d(DoubleSerializer.f24792a), BuiltinSerializersKt.d(kSerializerArr[7])};
    }
    ...
    public PlacementResponse deserialize(@NotNull Decoder decoder) {
        ...
        while (z) {
            ...
            switch (iU) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    list = (List) compositeDecoderB.k(b, 3, kSerializerArr[3], list);
                    i |= 8;
                    break;
                case 4:
                ...
                case 5:
                    ...
                    break;
                case 6:
                    d = (Double) compositeDecoderB.k(b, 6, DoubleSerializer.f24792a, d);
                    i |= 64;
                    break;
                case 7:
                    list4 = (List) compositeDecoderB.k(b, 7, kSerializerArr[7], list4);
                    i |= 128;
                    break;
                default:
        ...
        return new PlacementResponse(i, str, num, str2, list, list2, list3, d, list4, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull PlacementResponse value) {
        ...
        PlacementResponse.write$Self$internal_publishRelease(value, compositeEncoderB, b);
