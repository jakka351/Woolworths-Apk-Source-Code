...
public final class MapGrid$MapGridData$$serializer implements GeneratedSerializer<MapGrid.MapGridData> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("me.oriient.internal.services.dataManager.mapGrid.MapGrid.MapGridData", mapGrid$MapGridData$$serializer, 12);
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{StringSerializer.f24821a, MapGrid$MapGridData$Grid$$serializer.INSTANCE, mapGrid$MapGridData$Range$$serializer, mapGrid$MapGridData$Range$$serializer, MapGrid$MapGridData$CoarseGrid$$serializer.INSTANCE, mapGrid$MapGridData$CoarseRange$$serializer, mapGrid$MapGridData$CoarseRange$$serializer, MapGrid$MapGridData$GmmPdf$$serializer.INSTANCE, ByteSerializer.f24781a, doubleSerializer, kSerializerD, kSerializerD2};
    }
    ...
    @NotNull
    public MapGrid.MapGridData deserialize(@NotNull Decoder decoder) {
        Intrinsics.h(decoder, "decoder");
        SerialDescriptor b = getB();
        CompositeDecoder compositeDecoderB = decoder.b(b);
        MapGrid.MapGridData.GmmPdf gmmPdf = null;
        String strJ = null;
        MapGrid.MapGridData.Grid grid = null;
        MapGrid.MapGridData.Range range = null;
        MapGrid.MapGridData.Range range2 = null;
        MapGrid.MapGridData.CoarseGrid coarseGrid = null;
        MapGrid.MapGridData.CoarseRange coarseRange = null;
        MapGrid.MapGridData.CoarseRange coarseRange2 = null;
        double D = 0.0d;
        boolean z = true;
        int i = 0;
        byte bA = 0;
        ...
        while (z) {
            ...
            switch (iU) {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    grid = (MapGrid.MapGridData.Grid) compositeDecoderB.o(b, 1, MapGrid$MapGridData$Grid$$serializer.INSTANCE, grid);
                    i |= 2;
                    break;
                case 2:
                    range = (MapGrid.MapGridData.Range) compositeDecoderB.o(b, 2, MapGrid$MapGridData$Range$$serializer.INSTANCE, range);
                    i |= 4;
                    break;
                case 3:
                    range2 = (MapGrid.MapGridData.Range) compositeDecoderB.o(b, 3, MapGrid$MapGridData$Range$$serializer.INSTANCE, range2);
                    i |= 8;
                    break;
                case 4:
                    coarseGrid = (MapGrid.MapGridData.CoarseGrid) compositeDecoderB.o(b, 4, MapGrid$MapGridData$CoarseGrid$$serializer.INSTANCE, coarseGrid);
                    i |= 16;
                    break;
                case 5:
                    coarseRange = (MapGrid.MapGridData.CoarseRange) compositeDecoderB.o(b, 5, MapGrid$MapGridData$CoarseRange$$serializer.INSTANCE, coarseRange);
                    i |= 32;
                    break;
                case 6:
                    coarseRange2 = (MapGrid.MapGridData.CoarseRange) compositeDecoderB.o(b, 6, MapGrid$MapGridData$CoarseRange$$serializer.INSTANCE, coarseRange2);
                    i |= 64;
                    break;
                case 7:
                    gmmPdf = (MapGrid.MapGridData.GmmPdf) compositeDecoderB.o(b, 7, MapGrid$MapGridData$GmmPdf$$serializer.INSTANCE, gmmPdf);
                    i |= 128;
                    break;
                case 8:
        ...
        return new MapGrid.MapGridData(i, strJ, grid, range, range2, coarseGrid, coarseRange, coarseRange2, gmmPdf, bA, D, d, d2, null);
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public void serialize(@NotNull Encoder encoder, @NotNull MapGrid.MapGridData value) {
        Intrinsics.h(encoder, "encoder");
        Intrinsics.h(value, "value");
        SerialDescriptor b = getB();
        CompositeEncoder compositeEncoderB = encoder.b(b);
        MapGrid.MapGridData.write$Self$internal_publishRelease(value, compositeEncoderB, b);
