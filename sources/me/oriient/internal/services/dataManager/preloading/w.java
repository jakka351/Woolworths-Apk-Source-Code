...
public final class w extends SuspendLambda implements Function2 {
    ...
    public w(DataPreloadingManagerImpl dataPreloadingManagerImpl, n nVar, Continuation continuation) {
    ...
    public final Object invoke(Object obj, Object obj2) {
        return new w(this.b, this.c, (Continuation) obj2).invokeSuspend(Unit.f24250a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        ResultKt.b(obj);
        this.b.getLogger().d("DataPreloadingManager", "preloadDataImpl: calling building preloader");
        DataPreloader dataPreloader = this.b.buildingPreloader;
        String str = this.c.f25378a;
        this.f25386a = 1;
