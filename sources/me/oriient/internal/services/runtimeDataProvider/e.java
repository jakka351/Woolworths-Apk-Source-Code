...
public final class e extends SuspendLambda implements Function2 {
    ...
    public e(RuntimeDataManagerImpl runtimeDataManagerImpl, Continuation continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            StateFlow<InternalConfig> config = this.b.getConfigManager().getConfig();
            d dVar = new d(this.b);
            this.f25550a = 1;
            if (config.collect(dVar, this) == coroutineSingletons) {
