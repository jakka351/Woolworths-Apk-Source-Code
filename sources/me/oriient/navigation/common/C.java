...
public final class C extends SuspendLambda implements Function2 {
    ...
    public C(NavigationManagerImpl navigationManagerImpl, Continuation continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.b(obj);
            SharedFlow<NavigationPosition> positionUpdates = this.b.getPositionProvider().getPositionUpdates();
            B b = new B(this.b);
            this.f26207a = 1;
            if (positionUpdates.collect(b, this) == coroutineSingletons) {
